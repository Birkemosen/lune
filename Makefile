...
help:
	...
	@echo "  make build               Build Lune V6 firmware (auto-increments v1.0.0-N)"
	@echo "  make release             Compile a Lune V6 release without build suffix"
	@echo "  make release-firmware    Build the public Lune V6 release bundle (VERSION=v1.2.3)"
	...
	@echo "  make build-v6            Build V6 firmware (auto-increments v1.0.0-N)"
	@echo "  make release-v6          Compile a V6 release without build suffix"
...
config-v6 build-v6 build-verify-v6 deploy-v6 ota-v6 logs-v6 discover-v6 monitor-v6 erase-v6 erase-nvs-v6 clean-v6 dashboard-v6 dashboard-tooling-v6 dashboard-build-v6 dashboard-watch-v6 release-v6 release-deploy-v6 release-firmware-v6:
