...
`;F("ui-kit",$o);function ce(e){let t=b(e);return`<span class="help-badge" tabindex="0" role="img" aria-label="${String(t).replace(/"/g,"&quot;")}" data-i18n-label="${e}">?<span class="help-tip" data-i18n="${e}">${t}</span></span>`}function Go(e,t){let o=Math.abs(Number(e));return!Number.isFinite(o)||o<1e3?t:Math.pow(10,Math.floor(Math.log10(o))-1)}function Uo(e){let t=String(e),o=t.indexOf(".");return o<0?0:t.length-o-1}function re(e,t={}){let o=e.querySelector(t.title||".ui-card-title"),r=document.createElement("div");r.className="ui-form-banner",r.innerHTML='<span class="ui-form-banner-msg" data-i18n="form.unsaved">Unsaved changes</span><span class="ui-form-banner-btns"><button type="button" class="ui-form-discard" data-i18n="form.discard">Discard</button><button type="button" class="ui-form-apply" data-i18n="form.apply">Apply</button></span>',o?o.insertAdjacentElement("afterend",r):e.insertAdjacentElement("afterbegin",r);let n=[],a=()=>r.classList.toggle("show",n.some(l=>l.dirty)),i=(l,S)=>{l.dirty=S,a()};function d(l){return l.markDirty=()=>i(l,!0),n.push(l),l}function f(l,S){let A={dirty:!1,input:l},_=S.baseStep!=null?S.baseStep:parseFloat(l.step)||1,x=Uo(_),C=S.min!=null?S.min:l.min!==""?parseFloat(l.min):-1/0,M=S.max!=null?S.max:l.max!==""?parseFloat(l.max):1/0,W=H=>x>0?Number(H).toFixed(x):String(Math.round(Number(H)));if(!S.nostep){let H=document.createElement("div");H.className="ui-stepper",l.parentNode.insertBefore(H,l);let E=document.createElement("button");E.type="button",E.className="ui-step-btn",E.textContent="\u2212",E.tabIndex=-1,E.setAttribute("aria-label",b("common.decrease"));let Z=document.createElement("button");Z.type="button",Z.className="ui-step-btn",Z.textContent="+",Z.tabIndex=-1,Z.setAttribute("aria-label",b("common.increase")),H.appendChild(E),H.appendChild(l),H.appendChild(Z),l.readOnly=!0;let I=X=>{if(l.disabled)return;let U=parseFloat(l.value);Number.isFinite(U)||(U=parseFloat(l.placeholder)),Number.isFinite(U)||(U=0);let _e=Math.min(M,Math.max(C,U+X*Go(U,_)));l.value=W(_e),i(A,!0)};E.addEventListener("click",()=>I(-1)),Z.addEventListener("click",()=>I(1)),l.addEventListener("dblclick",()=>{l.disabled||(l.readOnly=!1,l.classList.add("editing"),l.focus(),l.select())}),l.addEventListener("blur",()=>{l.readOnly=!0,l.classList.remove("editing")}),l.addEventListener("keydown",X=>{X.key==="Enter"&&l.blur()})}return l.addEventListener("input",()=>i(A,!0)),A.sync=()=>{let H=S.read();l.value=H!=null&&Number.isFinite(Number(H))?W(H):""},A.commit=()=>{let H=parseFloat(l.value);Number.isFinite(H)&&S.commit(Math.min(M,Math.max(C,H)))},d(A)}function m(l,S){let A={dirty:!1,input:l};return l.addEventListener("input",()=>i(A,!0)),A.sync=()=>{let _=S.read();l.value=_!=null?_:""},A.commit=()=>S.commit(l.value.trim()),d(A)}function g(l,S){let A={dirty:!1,input:l};return l.addEventListener("change",()=>i(A,!0)),A.sync=()=>{let _=S.read();_!=null&&(l.value=_)},A.commit=()=>S.commit(l.value),d(A)}function z(l,S){let A={dirty:!1,input:l,staged:!1},_=l.closest(".ui-row"),x=()=>{l.classList.toggle("on",A.staged),_&&_.classList.toggle("is-on",A.staged),l.setAttribute("aria-checked",A.staged?"true":"false"),S.onChange&&S.onChange(A.staged)};return l.addEventListener("click",()=>{A.staged=!A.staged,i(A,!0),x()}),A.sync=()=>{A.staged=!!S.read(),x()},A.commit=()=>S.commit(A.staged),d(A)}function h(l){let S={dirty:!1,sync:l.sync,commit:l.commit};return d(S)}let c=()=>n.forEach(l=>{!l.dirty&&l.sync&&l.sync()}),u=()=>{n.forEach(l=>{l.dirty&&(l.commit&&l.commit(),l.dirty=!1)}),a(),t.onApply&&t.onApply()},y=()=>{n.forEach(l=>{l.dirty=!1,l.sync&&l.sync()}),a(),t.onDiscard&&t.onDiscard()};return r.querySelector(".ui-form-apply").addEventListener("click",u),r.querySelector(".ui-form-discard").addEventListener("click",y),k(r),{num:f,text:m,select:g,toggle:z,custom:h,refresh:c,apply:u,discard:y,isDirty:()=>n.some(l=>l.dirty)}}function ae(e){return e!=null&&!isNaN(e)?Math.round(e*10)/10+"\xB0C":"---"}function He(e){return e!=null&&!isNaN(e)?(e|0)+"%":"---"}function qe(e){if(!e||isNaN(e))return"---";e=e|0;var t=e/86400|0,o=e%86400/3600|0,r=e%3600/60|0;return t>0?t+"d "+o+"h "+r+"m":o>0?o+"h "+r+"m":r+"m"}function Kt(e){return e==null||isNaN(e)?"---":(e=e|0,e>-50?e+" dBm \u2590\u2590\u2590\u2590":e>-60?e+" dBm \u2590\u2590\u2590\u2591":e>-70?e+" dBm \u2590\u2590\u2591\u2591":e>-80?e+" dBm \u2590\u2591\u2591\u2591":e+" dBm \u2591\u2591\u2591\u2591")}function Jt(e){if(e==null||isNaN(e))return"hh:mm";let t=Math.round(Date.now()/1e3-e),o=new Date(t*1e3),r=n=>String(n).padStart(2,"0");return`${r(o.getHours())}:${r(o.getMinutes())}`}var Xo=`
.topbar {
  position: static;
  margin-bottom: 14px;
  padding: 12px;
...
`,en=T({tag:"hv6-header",render:Yo,onMount(e,t){let o=t.querySelector("#hdr-dot"),r=t.querySelector("#hdr-sync"),n=t.querySelector("#hdr-up"),a=t.querySelector("#hdr-wifi"),i=t.querySelector("#hdr-asgard"),d=t.querySelector("#hdr-asgard-val"),f=t.querySelector("#hdr-asgard-time"),m=t.querySelector("#hdr-fw"),g=t.querySelectorAll(".menu-link");function z(){let c=O("section");g.forEach(u=>{u.classList.toggle("active",u.getAttribute("data-section")===c)})}function h(){let c=O("live"),u=O("pendingWrites"),y=!!(window.HV6_DASHBOARD_CONFIG&&window.HV6_DASHBOARD_CONFIG.mock);o.classList.toggle("on",!!c);let l,S;u>0?(l=b("status.saving"),S="saving"):y?(l=window.HV6_DASHBOARD_CONFIG.mockLabel||b("status.mock"),S="synced"):c?(l=b("status.live"),S="synced"):(l=b("status.offline"),S="offline"),r.textContent=l,r.className="meta-chip meta-chip-state "+S,n.textContent=qe(L(s.uptime)),a.textContent=Kt(L(s.wifi));let A=L(s.asgardLastPushC),_=L(s.asgardLastPushAgeS),x=Y(s.asgardEnabled)&&A!=null&&Number.isFinite(A);i.hidden=!x,x&&(d.textContent=A.toFixed(2)+"\xB0C",f.textContent=Jt(_));let C=O("firmwareVersion")||N(s.firmware);m.textContent=C?"FW "+C:""}g.forEach(c=>{c.addEventListener("click",u=>{u.preventDefault(),zt(c.getAttribute("data-section"))})}),B("section",z),B("live",h),B("pendingWrites",h),B("firmwareVersion",h),w(s.uptime,h),w(s.wifi,h),w(s.asgardLastPushC,h),w(s.asgardLastPushAgeS,h),w(s.asgardEnabled,h),w(s.firmware,h),z(),k(t),h()}});var Ko=`
.connectivity-card {
...
`,dn=T({tag:"connectivity-card",render:Jo,onMount(e,t){let o=t.querySelector(".cc-ip"),r=t.querySelector(".cc-ssid"),n=t.querySelector(".cc-mac"),a=t.querySelector(".cc-up");function i(){o.textContent=N(s.ip)||"---",r.textContent=N(s.ssid)||"---",n.textContent=N(s.mac)||"---",a.textContent=qe(L(s.uptime))}w(s.ip,i),w(s.ssid,i),w(s.mac,i),w(s.uptime,i),k(t),i()}});var Qo="http://www.w3.org/2000/svg",er=`
.chart-card {
  border: 1px solid var(--panel-border);
  border-radius: 16px;
  background: var(--panel-bg-vibrant);
...
`;F("chart-kit",er);function oe(e,t,o){let r=document.createElementNS(Qo,e);if(t)for(let n in t)r.setAttribute(n,t[n]);return o!=null&&(r.textContent=o),r}function Qt(e){if(!e.length)return"";if(e.length<3)return"M "+e.map(r=>`${r.x.toFixed(2)} ${r.y.toFixed(2)}`).join(" L ");let t=.16,o=`M ${e[0].x.toFixed(2)} ${e[0].y.toFixed(2)}`;for(let r=0;r<e.length-1;r++){let n=e[r-1]||e[r],a=e[r],i=e[r+1],d=e[r+2]||i,f=a.x+(i.x-n.x)*t,m=a.y+(i.y-n.y)*t,g=i.x-(d.x-a.x)*t,z=i.y-(d.y-a.y)*t;o+=` C ${f.toFixed(2)} ${m.toFixed(2)}, ${g.toFixed(2)} ${z.toFixed(2)}, ${i.x.toFixed(2)} ${i.y.toFixed(2)}`}return o}function eo(e,t,o){let r=document.createElement("div");r.className="chart-tooltip",t.appendChild(r);let n=oe("g",{class:"chart-cursor",style:"display:none"}),a=oe("line",{class:"chart-cursor-line",y1:o.plotTop,y2:o.plotBottom});n.appendChild(a);let i=[];e.appendChild(n);function d(z){let h=0,c=1/0;for(let u=0;u<o.count;u++){let y=Math.abs(z-o.xAt(u));y<c&&(c=y,h=u)}return h}function f(z){let h=e.getScreenCTM();if(!h)return null;let c=e.createSVGPoint();return c.x=z.clientX,c.y=z.clientY,c.matrixTransform(h.inverse())}function m(z){if(!o.count)return;let h=f(z);if(!h)return;let c=d(h.x),u=o.xAt(c);a.setAttribute("x1",u),a.setAttribute("x2",u);let y=o.dots(c);for(;i.length<y.length;){let _=oe("circle",{class:"chart-cursor-dot",r:3.4});n.appendChild(_),i.push(_)}i.forEach((_,x)=>{x<y.length?(_.setAttribute("cx",u),_.setAttribute("cy",y[x].y),_.setAttribute("fill",y[x].color),_.style.display=""):_.style.display="none"}),n.style.display="";let l=o.rows(c).map(_=>`<div class="tt-row"><span class="tt-swatch" style="background:${_.color}"></span>${_.label}<span class="tt-val">${_.value}</span></div>`).join("");r.innerHTML=`<div class="tt-time">${o.label(c)}</div>${l}`,r.classList.add("show");let S=t.getBoundingClientRect(),A=z.clientX-S.left+14;A+r.offsetWidth>S.width-6&&(A=z.clientX-S.left-r.offsetWidth-14),r.style.left=Math.max(6,A)+"px",r.style.top=Math.max(6,z.clientY-S.top+12)+"px"}function g(){r.classList.remove("show"),n.style.display="none"}return e.addEventListener("pointermove",m),e.addEventListener("pointerleave",g),()=>{e.removeEventListener("pointermove",m),e.removeEventListener("pointerleave",g),r.remove()}}var Le=1e3,mt=180,ie=14,tr=42,or=44,ge=42,We=Le-ge-tr,me=mt-ie-or,be=ie+me,gt=24*3600,to=Q+2,oo=Q+3,Ie=Q+4,rr="var(--series-warm)",ar="var(--series-cool)",ro="var(--series-solar)",nr=`
...
`;F("graph-widgets",nr);var ao=()=>'<div class="chart-card"><div class="chart-head"><span class="chart-title" data-i18n="overview.graph.flowReturnDemand">Flow / Return / Demand</span><span class="chart-sub gw-dt">\u2014</span></div><div class="gw-controls" role="toolbar" data-i18n-label="overview.graph.layers" aria-label="Flow chart layers"><button type="button" class="gw-toggle" data-layer="flow" aria-pressed="true" data-i18n="overview.graph.layers.flow">Flow</button><button type="button" class="gw-toggle" data-layer="return" aria-pressed="true" data-i18n="overview.graph.layers.return">Return</button><button type="button" class="gw-toggle" data-layer="demand" aria-pressed="true" data-i18n="overview.graph.layers.demand">Demand</button></div><svg class="gw-flow"></svg></div>',no=()=>'<div class="chart-card"><div class="chart-head"><span class="chart-title" data-i18n="overview.graph.demandIndex">Demand Index</span><span class="chart-sub gw-demand-text">\u2014</span></div><svg class="gw-demand"></svg></div>',sr=e=>e.variant==="flow-return"?`<div class="graph-widgets">${ao()}</div>`:e.variant==="demand"?`<div class="graph-widgets">${no()}</div>`:`<div class="graph-widgets">${ao()}${no()}</div>`;function so(e,t){return Number.isFinite(e)?t==="%"?Math.round(e)+"%":e.toFixed(1):"\u2014"}function ir(e,t){return Number.isFinite(e)?t==="%"?Math.round(e)+"%":e.toFixed(1)+"\xB0":"\u2014"}function ft(e,t,o){let r=[];for(let n=0;n<e.length;n++){let a=e[n];if(!a||a[0]<o)continue;let i=a[t];i==null||!Number.isFinite(i)||r.push({t:a[0],v:i})}return r}var Ze=(e,t)=>ge+Math.max(0,Math.min(1,(e-t)/gt))*We;function lr(e,t,o){let r=Number(Date.now()/1e3)|0,n=3600,a=Math.ceil((r-gt)/n)*n,i=Math.floor(r/n)*n,d=Math.floor(r/n)*n;for(let m=a;m<=i;m+=n){let g=o-(r-m),z=Ze(g,t),h=new Date(m*1e3),c=m===d,u=be+16;e.appendChild(oe("text",{x:z,y:u,"text-anchor":"end",transform:`rotate(-45 ${z.toFixed(1)} ${u})`,class:"chart-hour"+(c?" now":"")},String(h.getHours()).padStart(2,"0")))}let f=Ze(o,t);e.appendChild(oe("line",{x1:f,y1:ie,x2:f,y2:be,stroke:"var(--series-solar)","stroke-width":"1","stroke-dasharray":"2 3",opacity:".55","vector-effect":"non-scaling-stroke"}))}function dr(e){let t=[];if(e.forEach(a=>a.forEach(i=>t.push(i.v))),!t.length)return{min:0,max:10};let o=Math.min(...t),r=Math.max(...t);o===r&&(o-=.5,r+=.5);let n=(r-o)*.1;return o-=n,r+=n,{min:o,max:r}}function cr(e,t,o){let r=e.filter(n=>n.unit==="C").map(n=>ft(t,n.index,o));return dr(r)}function io(e,t,o,r,n,a){e.innerHTML="",e.setAttribute("viewBox",`0 0 ${Le} ${mt}`),e.setAttribute("preserveAspectRatio","xMidYMid meet");let i=o.map(u=>ft(r,u.index,n));if(!i.some(u=>u.length))return e.appendChild(oe("text",{x:Le/2,y:mt/2,"text-anchor":"middle",class:"chart-empty"},"Collecting history\u2026")),null;let d=cr(o,r,n),f=Math.max(.001,d.max-d.min),m=u=>ie+(1-(u-d.min)/f)*me,g=u=>ie+(1-Math.max(0,Math.min(100,u))/100)*me,z=(u,y)=>u.unit==="%"?g(y):m(y);for(let u=0;u<3;u++){let y=u/2,l=ie+y*me;e.appendChild(oe("line",{x1:ge,y1:l,x2:ge+We,y2:l,class:"chart-grid"})),o.some(S=>S.unit==="C")&&e.appendChild(oe("text",{x:ge-6,y:l+4,"text-anchor":"end",class:"chart-tick"},so(d.max-f*y,"C")+"\xB0")),o.some(S=>S.unit==="%")&&e.appendChild(oe("text",{x:ge+We+6,y:l+4,"text-anchor":"start",class:"chart-tick"},so(100-100*y,"%")))}e.appendChild(oe("line",{x1:ge,y1:be,x2:ge+We,y2:be,class:"chart-axis"})),o.some(u=>u.unit==="C")&&e.appendChild(oe("text",{x:9,y:ie+me/2,transform:`rotate(-90 9 ${(ie+me/2).toFixed(1)})`,"text-anchor":"middle",class:"chart-axis-label"},b("overview.graph.axis.temp"))),o.some(u=>u.unit==="%")&&e.appendChild(oe("text",{x:Le-9,y:ie+me/2,transform:`rotate(90 ${Le-9} ${(ie+me/2).toFixed(1)})`,"text-anchor":"middle",class:"chart-axis-label"},b("overview.graph.axis.demand"))),lr(e,n,a),o.forEach((u,y)=>{let l=i[y].map(A=>({x:Ze(A.t,n),y:z(u,A.v)}));if(!l.length)return;let S=Qt(l);u.fill&&e.appendChild(oe("path",{d:S+` L ${l[l.length-1].x.toFixed(1)} ${be} L ${l[0].x.toFixed(1)} ${be} Z`,fill:u.fill,stroke:"none"})),e.appendChild(oe("path",{d:S,fill:"none",stroke:u.color,"stroke-width":String(u.width||2.2),"stroke-linecap":"round","stroke-linejoin":"round"}))});let h=[];for(let u=0;u<r.length;u++){let y=r[u];if(!y||y[0]<n)continue;let l=o.map(S=>y[S.index]);l.every(S=>S==null||!Number.isFinite(S))||h.push({t:y[0],vals:l})}if(!h.length)return null;let c=Date.now();return eo(e,t,{count:h.length,plotTop:ie,plotBottom:be,xAt:u=>Ze(h[u].t,n),label:u=>new Date(c-(a-h[u].t)*1e3).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),dots:u=>o.map((y,l)=>({y:z(y,h[u].vals[l]),color:y.color})).filter((y,l)=>Number.isFinite(h[u].vals[l])),rows:u=>o.map((y,l)=>({color:y.color,label:y.label,value:ir(h[u].vals[l],y.unit)})).filter((y,l)=>Number.isFinite(h[u].vals[l]))})}function Be(e,t,o){let r=ft(e,t,o);return r.length?r[r.length-1].v:null}var hn=T({tag:"graph-widgets",state:e=>({variant:e&&e.variant||"both"}),render:sr,onMount(e,t){let o=t.querySelector(".gw-dt"),r=t.querySelector(".gw-demand-text"),n=t.querySelector(".gw-flow"),a=t.querySelector(".gw-demand"),i=Array.from(t.querySelectorAll(".gw-toggle")),d={flow:!0,return:!0,demand:!0},f=null,m=null;function g(){i.forEach(c=>{let u=c.dataset.layer;c.classList.toggle("is-off",!d[u]),c.setAttribute("aria-pressed",d[u]?"true":"false")})}function z(){let c=[];return d.flow&&c.push({index:to,color:rr,label:b("overview.graph.layers.flow"),unit:"C",width:2.4}),d.return&&c.push({index:oo,color:ar,label:b("overview.graph.layers.return"),unit:"C",width:2}),d.demand&&c.push({index:Ie,color:ro,label:b("overview.graph.layers.demand"),unit:"%",width:1.8,fill:"rgba(255,193,77,.10)"}),c}function h(){let c=O("zoneStateHistory"),u=c&&Array.isArray(c.entries)?c.entries:[],y=c&&c.uptime_s||Number(Date.now()/1e3)|0,l=y-gt;if(n){f&&f();let S=Be(u,to,l),A=Be(u,oo,l),_=Be(u,Ie,l),x=[];S!=null&&A!=null&&x.push("\u0394 "+(S-A).toFixed(1)+"\xB0"),_!=null&&x.push(Math.round(_)+"%"),o.textContent=x.length?x.join(" \xB7 "):"\u2014",f=io(n,n.closest(".chart-card"),z(),u,l,y)}if(a){m&&m();let S=Be(u,Ie,l);r.textContent=S!=null?Math.round(S)+"%":"\u2014",m=io(a,a.closest(".chart-card"),[{index:Ie,color:ro,label:b("overview.graph.layers.demand"),unit:"%",width:2.2,fill:"var(--series-cool-fill)"}],u,l,y)}}i.forEach(c=>{c.addEventListener("click",()=>{let u=c.dataset.layer;d[u]=!d[u],!d.flow&&!d.return&&!d.demand&&(d[u]=!0),g(),h()})}),B("zoneStateHistory",h),k(t),g(),h()}});var fe={0:{labelKey:"state.off",color:"#2c4875"},1:{labelKey:"state.manual",color:"#7aa7ce"},2:{labelKey:"state.calibrating",color:"#ffd380"},3:{labelKey:"state.waitCal",color:"#4e6977"},4:{labelKey:"state.waitTemp",color:"#4e6977"},5:{labelKey:"state.heating",color:"#ff8531"},6:{labelKey:"state.idle",color:"#39354c"},7:{labelKey:"state.overheated",color:"#ff6361"},255:{labelKey:"",color:"transparent"}},Ae=24*3600,pr=Ae,Me=18,ht=4,ve=54,Ve=32,Se=4,$e=10,po=6,uo="#ffc14d",bt=9,lo=Q+1,mo=Se+Q*(Me+ht)-ht,vt=mo+po,je=mo+po+$e+Ve,ur=`
.timeline-card {
  border: 1px solid var(--panel-border);
  border-radius: 16px;
  background: var(--panel-bg-vibrant);
...
`;F("zone-state-timeline",ur);var mr=()=>`
...
`;function gr(e,t){if(!e||!e.entries||e.entries.length===0)return null;let o=e.entries,r=e.uptime_s||t||0,n=Number(Date.now()/1e3)|0,a=1e3,i=a-ve;function d(_){let x=(_+Ae)/pr;return ve+Math.max(0,Math.min(1,x))*i}function f(_){return _-r}let m="http://www.w3.org/2000/svg",g=document.createElementNS(m,"svg");g.setAttribute("viewBox","0 0 "+a+" "+je),g.classList.add("timeline-svg");let z=document.createElementNS(m,"rect");z.setAttribute("x",ve),z.setAttribute("y",Se),z.setAttribute("width",i),z.setAttribute("height",je-Se-Ve),z.setAttribute("fill","rgba(0,32,46,0.55)"),z.setAttribute("rx","4"),g.appendChild(z);let h=d(0),c=[-24,-18,-12,-6,0].map(_=>_*3600);for(let _ of c){let x=d(_),C=document.createElementNS(m,"line");C.setAttribute("x1",x),C.setAttribute("y1",Se),C.setAttribute("x2",x),C.setAttribute("y2",je-Ve),C.setAttribute("stroke",_===0?"var(--series-solar)":"rgba(120,146,200,.16)"),C.setAttribute("stroke-width","1"),_===0&&(C.setAttribute("stroke-dasharray","2 3"),C.setAttribute("opacity",".55"),C.setAttribute("vector-effect","non-scaling-stroke")),g.appendChild(C)}g.appendChild(fr(m,"text",{x:h+4,y:Se+11,"text-anchor":"start",fill:"rgba(255,211,128,.92)","font-size":"9","font-family":"Montserrat, sans-serif","font-weight":"600"},"now"));for(let _=0;_<Q;_++){let x=Se+_*(Me+ht),C=document.createElementNS(m,"rect");C.setAttribute("x",ve),C.setAttribute("y",x),C.setAttribute("width",i),C.setAttribute("height",Me),C.setAttribute("fill",_%2===0?"rgba(124,155,208,0.05)":"rgba(124,155,208,0.00)"),g.appendChild(C);let M=document.createElementNS(m,"text");M.setAttribute("x",ve-4),M.setAttribute("y",x+Me/2+1),M.setAttribute("text-anchor","end"),M.setAttribute("dominant-baseline","middle"),M.setAttribute("fill","rgba(233,222,210,.62)"),M.setAttribute("font-size","9.5"),M.setAttribute("font-family","Montserrat, sans-serif"),M.setAttribute("font-weight","600"),M.textContent="Z"+(_+1),g.appendChild(M);let W=o.map(E=>({rel:f(E[0]),state:E[_+1]})).filter(E=>E.rel>=-Ae&&E.rel<=0),H=(E,Z,I)=>{if(I===255)return;let X=fe[I]||fe[255];if(X.color==="transparent")return;let U=d(E),_e=d(Z),Ke=Math.max(1,_e-U),de=document.createElementNS(m,"rect");de.setAttribute("x",U),de.setAttribute("y",x+(Me-bt)/2),de.setAttribute("width",Ke),de.setAttribute("height",bt),de.setAttribute("fill",X.color),de.setAttribute("rx",String(bt/2)),de.setAttribute("opacity","0.9"),g.appendChild(de)};if(W.length){let E=W[0].rel,Z=W[0].state;for(let I=1;I<W.length;I++){let X=W[I];X.state!==Z&&(H(E,X.rel,Z),E=X.rel,Z=X.state)}H(E,0,Z)}}{let _=document.createElementNS(m,"rect");_.setAttribute("x",ve),_.setAttribute("y",vt),_.setAttribute("width",i),_.setAttribute("height",$e),_.setAttribute("fill","rgba(188,80,144,0.10)"),_.setAttribute("rx","2"),g.appendChild(_);let x=document.createElementNS(m,"text");x.setAttribute("x",ve-4),x.setAttribute("y",vt+$e/2+1),x.setAttribute("text-anchor","end"),x.setAttribute("dominant-baseline","middle"),x.setAttribute("fill","rgba(233,222,210,.62)"),x.setAttribute("font-size","8.5"),x.setAttribute("font-family","Montserrat, sans-serif"),x.setAttribute("font-weight","600"),x.textContent=b("overview.timeline.absorb"),g.appendChild(x);let C=o.map(M=>({rel:f(M[0]),on:M.length>lo?M[lo]:0})).filter(M=>M.rel>=-Ae&&M.rel<=0);if(C.length){let M=(E,Z)=>{let I=d(E),X=Math.max(1,d(Z)-I),U=document.createElementNS(m,"rect");U.setAttribute("x",I),U.setAttribute("y",vt),U.setAttribute("width",X),U.setAttribute("height",$e),U.setAttribute("fill",uo),U.setAttribute("rx","2"),U.setAttribute("opacity","0.9"),g.appendChild(U)},W=C[0].rel,H=C[0].on;for(let E=1;E<C.length;E++)C[E].on!==H&&(H&&M(W,C[E].rel),W=C[E].rel,H=C[E].on);H&&M(W,0)}}let u=je-Ve+15,y=3600,l=Math.ceil((n-Ae)/y)*y,S=Math.floor(n/y)*y,A=Math.floor(n/y)*y;for(let _=l;_<=S;_+=y){let x=_-n,C=d(x),M=new Date(_*1e3),W=String(M.getHours()).padStart(2,"0"),H=_===A,E=document.createElementNS(m,"text");E.setAttribute("x",C),E.setAttribute("y",u),E.setAttribute("text-anchor","end"),E.setAttribute("fill",H?"rgba(255,211,128,.95)":"rgba(202,219,248,.72)"),E.setAttribute("font-size","9"),E.setAttribute("font-family",'"Montserrat", sans-serif'),E.setAttribute("font-weight","500"),E.setAttribute("font-variant-numeric","tabular-nums lining-nums"),E.setAttribute("font-feature-settings",'"tnum" 1, "lnum" 1'),E.setAttribute("letter-spacing","0"),E.setAttribute("transform",`rotate(-45 ${C.toFixed(1)} ${u})`),E.textContent=W,g.appendChild(E)}return g}function fr(e,t,o,r){let n=document.createElementNS(e,t);for(let a in o)n.setAttribute(a,o[a]);return r!=null&&(n.textContent=r),n}function co(e){e.innerHTML="";let t=[{code:5,...fe[5]},{code:6,...fe[6]},{code:0,...fe[0]},{code:1,...fe[1]},{code:7,...fe[7]},{code:2,...fe[2]}];for(let r of t){let n=document.createElement("div");n.className="tl-legend-item",n.innerHTML='<span class="tl-legend-dot" style="background:'+r.color+'"></span>'+(r.labelKey?b(r.labelKey):""),e.appendChild(n)}let o=document.createElement("div");o.className="tl-legend-item",o.innerHTML='<span class="tl-legend-dot" style="background:'+uo+'"></span>'+b("overview.timeline.preheatAbsorption"),e.appendChild(o)}var kn=T({tag:"zone-state-timeline",render:mr,onMount(e,t){let o=t.querySelector(".tl-body"),r=t.querySelector(".timeline-legend");co(r);function n(){let a=O("zoneStateHistory"),i=(()=>{let f=O&&O("zoneStateHistory");return f&&f.uptime_s||Number(Date.now()/1e3)|0})();if(o.innerHTML="",!a||!a.entries||a.entries.length===0){let f=document.createElement("div");f.className="timeline-empty",f.textContent=b("overview.timeline.noHistory"),o.appendChild(f);return}let d=gr(a,i);d&&o.appendChild(d)}B("zoneStateHistory",n),B("zoneNames",n),w(s.drivers,n);for(let a=1;a<=Q;a++)w(p.enabled(a),n),w(p.state(a),n),w(p.temp(a),n),w(p.setpoint(a),n),w(p.preheatAdvance(a),n);k(t),n()}});var br=`
.zone-grid {
    display: grid;
...
`;F("zone-grid",br);var vr=()=>'<div class="zone-grid"></div>',Mn=T({tag:"zone-grid",render:vr,onMount(e,t){for(let o=1;o<=6;o++)t.appendChild(V("zone-card",{zone:o}))}});var hr=`
.zone-card {
	display: grid;
...
`;function go(e){return e!=null?Number(e).toFixed(2)+"x":"---"}function fo(e){return e!=null?Number(e).toFixed(0):"---"}function zr(e){return e!=null?Number(e).toFixed(2)+"C":"---"}function Sr(e,t){if(!t)return b("common.disabled");let o=String(e||"IDLE").toUpperCase();return o==="HEATING"?b("state.heating"):o==="IDLE"?b("state.idle"):o==="OFF"?b("state.off"):o==="FAULT"?b("common.fault"):o==="MANUAL"?b("state.manual"):o==="OVERHEATED"?b("state.overheated"):o==="CALIBRATING"?b("state.calibrating"):o}var $n=T({tag:"zone-detail",state:e=>({zone:e.zone,temp:"---",setpoint:"---",valve:"---",state:"---"}),render:wr,methods:{update(e,t){let o=O("selectedZone"),r=String(N(p.state(o))||"").toUpperCase(),n=Y(p.enabled(o));this.zone=o,e.dataset.zone=String(o),t.title.textContent=$(o),t.setpoint.textContent=ae(L(p.setpoint(o))),t.temp.textContent=ae(L(p.temp(o))),t.ret.textContent=ae(L("sensor-manifold_return_temperature")),t.valve.textContent=He(L(p.valve(o)));let a=t.badge;a.textContent=Sr(r,n);let i=n?r==="HEATING"?"badge-heating":r==="IDLE"?"badge-idle":r==="FAULT"?"badge-fault":"":"badge-disabled";a.className="zd-badge"+(i?" "+i:""),t.toggle.classList.toggle("on",n),t.orip.textContent=fo(L(p.motorOpenRipples(o))),t.crip.textContent=fo(L(p.motorCloseRipples(o))),t.ofac.textContent=go(L(p.motorOpenFactor(o))),t.cfac.textContent=go(L(p.motorCloseFactor(o))),t.ph.textContent=zr(L(p.preheatAdvance(o)));let d=String(N(p.motorLastFault(o))||"").toUpperCase(),f=d&&d!=="NONE"&&d!=="OK";t.fault.hidden=!f,f&&(t.faultVal.textContent=d)},incSetpoint(){let e=this.zone,t=L(p.setpoint(e))||20;at(e,Number((t+.5).toFixed(1)))},decSetpoint(){let e=this.zone,t=L(p.setpoint(e))||20;at(e,Number((t-.5).toFixed(1)))},toggleEnabled(){let e=this.zone,t=Y(p.enabled(e));Tt(e,!t)}},onMount(e,t){let o={title:t.querySelector(".zd-title"),setpoint:t.querySelector(".zd-setpoint"),temp:t.querySelector(".zd-temp"),ret:t.querySelector(".zd-ret"),valve:t.querySelector(".zd-valve"),badge:t.querySelector(".zd-badge"),toggle:t.querySelector(".btn-toggle"),inc:t.querySelector(".btn-inc"),dec:t.querySelector(".btn-dec"),orip:t.querySelector(".zd-orip"),crip:t.querySelector(".zd-crip"),ofac:t.querySelector(".zd-ofac"),cfac:t.querySelector(".zd-cfac"),ph:t.querySelector(".zd-ph"),fault:t.querySelector(".zd-fault"),faultVal:t.querySelector(".zd-fault-val")};o.inc.onclick=()=>e.incSetpoint(),o.dec.onclick=()=>e.decSetpoint(),o.toggle.onclick=()=>e.toggleEnabled();let r=()=>e.update(t,o),n=a=>{let i=O("selectedZone");(a===p.temp(i)||a===p.setpoint(i)||a===p.valve(i)||a===p.state(i)||a===p.enabled(i))&&r()};for(let a=1;a<=6;a++)w(p.temp(a),n),w(p.setpoint(a),n),w(p.valve(a),n),w(p.state(a),n),w(p.enabled(a),n),w(p.motorOpenRipples(a),r),w(p.motorCloseRipples(a),r),w(p.motorOpenFactor(a),r),w(p.motorCloseFactor(a),r),w(p.preheatAdvance(a),r),w(p.motorLastFault(a),r);w("sensor-manifold_return_temperature",r),B("selectedZone",r),k(t),r()}});var _r=`
...
`;F("zone-sensor-card",_r);var kr=()=>{let e='<option value="None" data-i18n="common.none">None</option>';for(let t=1;t<=8;t++)e+='<option value="Probe '+t+'">Probe '+t+"</option>";return`
  ...
  `};function bo(e,t){let o=e.value,r='<option value="None" data-i18n="common.none">'+b("common.none")+"</option>";for(let n=1;n<=6;n++)n!==t&&(r+='<option value="Zone '+n+'">'+b("common.zone")+" "+n+"</option>");e.innerHTML=r,e.value=o||"None"}function Cr(e){return e==="BLE"||e==="BLE Sensor"?"BLE Sensor":"Local Probe"}function Lr(e){return e==="BLE Sensor"?"BLE":"Local Probe"}function vo(e,t){let o='<option value="Local Probe" data-i18n="zone.sensor.localProbe">'+b("zone.sensor.localProbe")+'</option><option value="BLE Sensor" data-i18n="zone.sensor.bleSource">'+b("zone.sensor.bleSource")+"</option>";e.innerHTML!==o&&(e.innerHTML=o),e.value=t}function ho(e){let t=String(e||"").match(/\d+/);return t?Number(t[0]):0}var ts=T({tag:"zone-sensor-card",render:kr,onMount(e,t){let o=t.querySelector(".zs-probe"),r=t.querySelector(".zs-source"),n=t.querySelector(".zs-ble"),a=t.querySelector(".zs-sync"),i=t.querySelector(".zs-row-ble"),d=t.querySelector(".zs-scan"),f=t.querySelector(".zs-scan-list"),m=t.querySelector(".merge-visual"),g=t.querySelector(".merge-rail"),z=t.querySelector(".merge-caption"),h=0;function c(){return O("selectedZone")}function u(){i.style.display=r.value==="BLE Sensor"?"":"none"}function y(){let x=c(),C=ho(a.value),M=[];for(let Z=1;Z<=6;Z++)Z!==x&&ho(N(p.syncTo(Z)))===x&&M.push(Z);let W=C>0&&C!==x,H=W||M.length>0;if(m.classList.toggle("is-solo",!H),!H){g.innerHTML='<span class="merge-pill primary">'+$(x)+'</span><span class="merge-link"></span><span class="merge-pill">'+b("zone.sensor.noMerge")+"</span>",z.textContent=b("zone.sensor.soloCaption");return}if(W){g.innerHTML='<span class="merge-pill secondary">'+$(x)+'</span><span class="merge-link"></span><span class="merge-pill primary">'+$(C)+"</span>",z.textContent=b("zone.sensor.followsCaption",{zone:$(x),target:$(C)});return}let E='<span class="merge-pill primary">'+$(x)+"</span>";for(let Z of M)E+='<span class="merge-link"></span><span class="merge-pill secondary">'+$(Z)+"</span>";g.innerHTML=E,z.textContent=b("zone.sensor.primaryCaption",{zone:$(x),zones:M.map($).join(", ")})}let l=re(t);vo(r,"Local Probe"),l.select(o,{read:()=>N(p.probe(c()))||void 0,commit:x=>ze(c(),"zone_probe",x)}),l.select(r,{read:()=>Cr(String(N(p.tempSource(c()))||"")),commit:x=>ze(c(),"zone_temp_source",Lr(x))}),l.select(a,{read:()=>N(p.syncTo(c()))||"None",commit:x=>ze(c(),"zone_sync_to",x)});let S=l.text(n,{read:()=>N(p.ble(c()))||"",commit:x=>Ce(c(),"zone_ble_mac",x)});r.addEventListener("change",u),a.addEventListener("change",y);function A(){let x=c();h!==x?(bo(a,x),h=x,f.style.display="none",l.discard()):l.refresh(),u(),y()}function _(x){let C=c();(x===p.probe(C)||x===p.tempSource(C)||x===p.syncTo(C)||x===p.ble(C)||/^select-zone_\d+_sync_to$/.test(x))&&(l.refresh(),u(),y())}d.addEventListener("click",()=>{if(d.disabled)return;d.disabled=!0,d.textContent="\u2026",f.style.display="",f.innerHTML='<div class="scan-msg">'+b("zone.sensor.scanning")+"</div>";let x=new AbortController,C=setTimeout(()=>x.abort(),8e3);fetch("/api/hv6/v1/ble-scan",{cache:"no-store",signal:x.signal}).then(M=>{if(!M.ok)throw new Error("HTTP "+M.status);return M.json()}).then(M=>{if(clearTimeout(C),d.disabled=!1,d.textContent=b("zone.sensor.scan"),!M.ok||!M.sensors||M.sensors.length===0){f.innerHTML='<div class="scan-msg">'+b("zone.sensor.noSensors")+"</div>";return}let W=c(),H=(N(p.ble(W))||"").toUpperCase(),E=I=>String(I).replace(/[&<>"']/g,X=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[X]),Z="";for(let I of M.sensors){let X=I.mac.toUpperCase(),U=I.name?E(I.name):"",_e=I.temp_c!=null?I.temp_c.toFixed(1)+"\xB0C":"\u2014",Ke=I.rssi!=null?I.rssi+" dBm":"",de=I.age_s<60?b("common.secondsAgo",{value:I.age_s}):b("common.minutesAgo",{value:Math.round(I.age_s/60)}),Je="";X===H?Je='<span class="ble-badge">'+b("zone.sensor.assignedThisZone")+"</span>":I.zone>0&&(Je='<span class="ble-badge">'+b("zone.sensor.zoneBadge",{zone:I.zone})+"</span>");let Lo=U?`<div class="ble-mac">${U}</div><div class="ble-meta">${X}</div>`:`<div class="ble-mac">${X}</div>`;Z+=`<div class="ble-scan-item">
              <div>
                ${Lo}
                <div class="ble-meta">${_e} &nbsp;${Ke} &nbsp;${de}</div>
                ${Je}
              </div>
              <button class="btn-assign" data-mac="${X}">${b("zone.sensor.assign")}</button>
            </div>`}f.innerHTML=Z,f.querySelectorAll(".btn-assign").forEach(I=>{I.addEventListener("click",()=>{n.value=I.dataset.mac,S.markDirty(),f.style.display="none"})})}).catch(M=>{clearTimeout(C),d.disabled=!1,d.textContent=b("zone.sensor.scan");let W=M&&M.name==="AbortError"?b("zone.sensor.scanTimeout"):b("zone.sensor.scanFailed");f.innerHTML='<div class="scan-msg">'+W+"</div>"})}),B("selectedZone",A);for(let x=1;x<=6;x++)w(p.probe(x),_),w(p.tempSource(x),_),w(p.syncTo(x),_),w(p.ble(x),_);k(t),A()}});var Ar=`
...
`,cs=T({tag:"zone-room-card",render:Mr,onMount(e,t){let o=t.querySelector(".zr-friendly"),r=t.querySelector(".zr-area"),n=t.querySelector(".zr-spacing"),a=t.querySelector(".zr-pipe"),i=t.querySelector(".wall-btn-group").querySelectorAll(".wall-btn");function d(){return O("selectedZone")}let f=re(t);f.text(o,{read:()=>ue(d())||"",commit:c=>Ot(d(),c)}),f.num(r,{read:()=>L(p.area(d())),commit:c=>nt(d(),"zone_area_m2",c)}),f.num(n,{read:()=>L(p.spacing(d())),commit:c=>nt(d(),"zone_pipe_spacing_mm",c||200)}),f.select(a,{read:()=>N(p.pipeType(d()))||"Unknown",commit:c=>ze(d(),"zone_pipe_type",c)});let m=[];function g(){i.forEach(c=>{let u=c.dataset.wall;c.classList.toggle("active",u==="None"?m.length===0:m.includes(u))})}let z=f.custom({sync:()=>{let c=N(p.exteriorWalls(d()))||"None";m=c==="None"?[]:c.split(",").filter(Boolean),g()},commit:()=>Ce(d(),"zone_exterior_walls",m.length?m.join(","):"None")});i.forEach(c=>{c.addEventListener("click",()=>{let u=c.dataset.wall,y=m.slice();if(u==="None")y=[];else{let l=y.indexOf(u);l>=0?y.splice(l,1):y.push(u)}m=["N","S","E","W"].filter(l=>y.includes(l)),g(),z.markDirty()})});function h(c){let u=d();(c===p.area(u)||c===p.spacing(u)||c===p.pipeType(u)||c===p.exteriorWalls(u))&&f.refresh()}B("selectedZone",f.discard),B("zoneNames",f.refresh);for(let c=1;c<=6;c++)w(p.area(c),h),w(p.spacing(c),h),w(p.pipeType(c),h),w(p.exteriorWalls(c),h);k(t),f.refresh()}});var le=6,Er="#6E7E96",wo="#5C6B85",Fr="#7aa7ce",Nr="#9DBC78",Tr="#FF8531",Dr="#FFA600",Pr="#7aa7ce",Rr="#FFEAD2",Or="#6E7E96",xo="#B9CBD8",Ge="#5C6B85",xt="#A6B9C7",zo="#A6B9C7",yo="#7aa7ce",Hr="#66BB6A",qr="#FF6361",j={w:1160,h:310,boxX:452,boxY:34,boxW:256,boxH:68,topBarY:0,topBarH:24,srcY:102,fanY:158,zoneY:232,zoneXs:[92,286,480,674,868,1062],srcSpread:15,bgDstHW:28,srcHW:7},D={w:760,h:340,boxX:38,boxY:132,boxW:142,boxH:72,srcX:180,endX:386,nameX:446,midY:168,zoneYs:[58,104,150,196,242,288],spread:8,bgDstHW:15,srcHW:4},Ir=`
.flow-wrap {
  width: 100%;
  border-radius: 18px;
  overflow: hidden;
...
`;F("flow-diagram",Ir);function Br(e,t){let o=String(ue(e)||"").trim();if(!o)return"";let r=o.toUpperCase();return r.length>t?r.slice(0,Math.max(1,t-1))+"\u2026":r}function Wr(e){if(!e)return null;let t=String(e).match(/(\d+)/);if(!t)return null;let o=Number(t[1]);return Number.isFinite(o)&&o>=1&&o<=8?o:null}function Zr(e,t){return t?e==null||Number.isNaN(e)?wo:e<.15?Fr:e<.4?Nr:e<.7?Tr:Dr:Er}function So(e){let t=e==="desktop"?"0 1":"1 0",o=[];o.push("<defs>"),o.push('<pattern id="'+e+'-fdots" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse"><circle cx="10" cy="10" r="1" fill="rgba(92,138,196,0.26)"/></pattern>'),o.push('<radialGradient id="'+e+'-fglow" cx="32%" cy="18%" r="78%"><stop offset="0%" stop-color="rgba(122,167,206,0.18)"/><stop offset="52%" stop-color="rgba(240,121,91,0.08)"/><stop offset="100%" stop-color="transparent"/></radialGradient>'),o.push('<linearGradient id="'+e+'-boxgrad" x1="0" y1="0" x2="'+t.split(" ")[0]+'" y2="'+t.split(" ")[1]+'"><stop offset="0%" stop-color="#9E4A18"/><stop offset="100%" stop-color="#ff8531"/></linearGradient>');for(let r=1;r<=le;r++)o.push('<linearGradient id="'+e+"-rg"+r+'" x1="0" y1="0" x2="'+t.split(" ")[0]+'" y2="'+t.split(" ")[1]+'">'),o.push('<stop id="'+e+"-rgs"+r+'" offset="0%" stop-color="#ff8531"/>'),o.push('<stop id="'+e+"-rga"+r+'" offset="100%" stop-color="#7aa7ce"/>'),o.push("</linearGradient>");return o.push("</defs>"),o.join("")}function Ue(e,t,o){let r=j.boxX+j.boxW/2+(e-2.5)*j.srcSpread,n=j.srcY,a=j.zoneXs[e],i=j.zoneY-20,d=j.fanY,f=j.fanY+34;return"M"+(r-t).toFixed(1)+" "+n+" C"+(r-t).toFixed(1)+" "+d+" "+(a-o).toFixed(1)+" "+f+" "+(a-o).toFixed(1)+" "+i+" L"+(a+o).toFixed(1)+" "+i+" C"+(a+o).toFixed(1)+" "+f+" "+(r+t).toFixed(1)+" "+d+" "+(r+t).toFixed(1)+" "+n+"Z"}function Xe(e,t,o){let r=D.midY+(e-2.5)*D.spread,n=D.zoneYs[e],a=D.endX-D.srcX,i=D.srcX+a*.34,d=D.srcX+a*.7;return"M"+D.srcX+" "+(r-t).toFixed(1)+" C"+i+" "+(r-t).toFixed(1)+" "+d+" "+(n-o).toFixed(1)+" "+D.endX+" "+(n-o).toFixed(1)+" L"+D.endX+" "+(n+o).toFixed(1)+" C"+d+" "+(n+o).toFixed(1)+" "+i+" "+(r+t).toFixed(1)+" "+D.srcX+" "+(r+t).toFixed(1)+"Z"}function _o(e,t,o){return'<rect width="'+e+'" height="'+t+'" rx="22" fill="var(--card)"/><rect width="'+e+'" height="'+t+'" rx="22" fill="url(#'+o+'-fdots)" opacity="0.48"/><rect width="'+e+'" height="'+t+'" rx="22" fill="url(#'+o+'-fglow)"/>'}function ko(e){let t=e==="desktop"?j:D,o=e==="desktop"?t.boxY+27:t.boxY+29,r=e==="desktop"?t.boxY+56:t.boxY+58;return'<rect x="'+t.boxX+'" y="'+t.boxY+'" width="'+t.boxW+'" height="'+t.boxH+'" rx="7" fill="#ff8531"/><text id="'+e+'-fd-flow-label" x="'+(t.boxX+t.boxW/2)+'" y="'+o+'" text-anchor="middle" font-size="'+(e==="desktop"?18:17)+'" font-weight="800" fill="var(--text-on-accent)" letter-spacing="2">'+b("overview.flowDiagram.flow")+'</text><text id="'+e+'-fd-flow-temp" class="flow-metric" x="'+(t.boxX+t.boxW/2)+'" y="'+r+'" text-anchor="middle" font-size="'+(e==="desktop"?26:24)+'" fill="var(--text-on-accent)">---</text>'}function jr(){let e=[],t=j.w,o=j.h,r=j.zoneY-20;e.push('<svg class="flow-svg flow-svg-desktop" viewBox="0 5 '+t+" "+(o-5)+'" preserveAspectRatio="xMidYMid meet">'),e.push(So("desktop")),e.push(_o(t,o,"desktop")),e.push('<rect x="'+j.boxX+'" y="'+j.topBarY+'" width="'+j.boxW+'" height="'+j.topBarH+'" fill="url(#desktop-boxgrad)" rx="5"/>'),e.push(ko("desktop")),e.push('<text id="desktop-fd-ret-temp" x="'+(j.boxX+j.boxW+24)+'" y="'+(j.boxY+20)+'" font-size="15" font-weight="800" fill="#7aa7ce" font-family="var(--mono)">'+b("overview.flowDiagram.returnShort")+" ---</text>"),e.push('<text id="desktop-fd-dt-label" x="'+(j.boxX+j.boxW+24)+'" y="'+(j.boxY+42)+'" font-size="12" font-weight="800" fill="'+zo+'" letter-spacing="2">'+b("overview.flowDiagram.dt")+"</text>"),e.push('<text id="desktop-fd-dt" x="'+(j.boxX+j.boxW+24)+'" y="'+(j.boxY+65)+'" class="flow-metric" font-size="22" fill="#ff8531">---</text>');for(let n=1;n<=le;n++)e.push('<path d="'+Ue(n-1,j.srcHW,j.bgDstHW)+'" fill="#021824" opacity="0.9"/>');for(let n=1;n<=le;n++)e.push('<path id="desktop-fd-path-'+n+'" class="flow-ribbon" d="'+Ue(n-1,j.srcHW,j.bgDstHW)+'" fill="url(#desktop-rg'+n+')" opacity="1"/>');e.push('<line x1="54" y1="'+r+'" x2="'+(t-54)+'" y2="'+r+'" stroke="#ff8531" stroke-width="2" opacity=".42"/>');for(let n=1;n<=le;n++){let a=j.zoneXs[n-1];e.push('<g class="flow-zone-hit">'),e.push('<line x1="'+a+'" y1="'+(r-8)+'" x2="'+a+'" y2="'+(r+8)+'" stroke="#ff8531" stroke-width="2" opacity=".5"/>'),e.push('<text id="desktop-fd-zn'+n+'" x="'+a+'" y="'+(r-13)+'" text-anchor="middle" font-size="13" fill="#FFEAD2" font-weight="800" letter-spacing="1.8">Z'+n+"</text>"),e.push('<text id="desktop-fd-zf'+n+'" x="'+a+'" y="'+(r+20)+'" text-anchor="middle" font-size="9.5" fill="#AFC1CD" font-weight="700" letter-spacing=".8">---</text>'),e.push('<text id="desktop-fd-zsp'+n+'" x="'+a+'" y="'+(r+20)+'" text-anchor="middle" font-size="9" fill="'+Ge+'" font-weight="600" font-family="var(--mono)"></text>'),e.push('<text id="desktop-fd-zt'+n+'" x="'+a+'" y="'+(r+42)+'" text-anchor="middle" class="flow-metric" font-size="15" fill="#F6ECE0">---\xB0C</text>'),e.push('<text id="desktop-fd-zv'+n+'" x="'+(a-28)+'" y="'+(r+61)+'" text-anchor="middle" class="flow-metric" font-size="13" fill="#C3D0D9">---%</text>'),e.push('<text id="desktop-fd-zr'+n+'" x="'+(a+28)+'" y="'+(r+61)+'" text-anchor="middle" class="flow-metric" font-size="13" fill="#C3D0D9">---</text>'),e.push("</g>")}return e.push("</svg>"),e.join("")}function Vr(){let e=[],t=D.w,o=D.h;e.push('<svg class="flow-svg flow-svg-mobile" viewBox="0 0 '+t+" "+o+'" preserveAspectRatio="xMidYMid meet">'),e.push(So("mobile")),e.push(_o(t,o,"mobile")),e.push('<rect x="0" y="'+D.boxY+'" width="'+(D.boxX-6)+'" height="'+D.boxH+'" fill="url(#mobile-boxgrad)" rx="4"/>'),e.push(ko("mobile"));for(let r=1;r<=le;r++)e.push('<path d="'+Xe(r-1,D.srcHW,D.bgDstHW)+'" fill="#021824" opacity="0.9"/>');for(let r=1;r<=le;r++)e.push('<path id="mobile-fd-path-'+r+'" class="flow-ribbon" d="'+Xe(r-1,D.srcHW,D.bgDstHW)+'" fill="url(#mobile-rg'+r+')" opacity="1"/>');e.push('<rect x="'+(D.boxX+9)+'" y="'+(D.boxY+D.boxH+9)+'" width="'+(D.boxW-18)+'" height="60" rx="8" fill="rgba(2,29,43,.74)"/>'),e.push('<text id="mobile-fd-ret-temp" x="'+(D.boxX+D.boxW/2)+'" y="'+(D.boxY+D.boxH+27)+'" text-anchor="middle" font-size="12.5" font-weight="800" fill="#7aa7ce" font-family="var(--mono)">'+b("overview.flowDiagram.returnShort")+" ---</text>"),e.push('<text id="mobile-fd-dt-label" x="'+(D.boxX+D.boxW/2)+'" y="'+(D.boxY+D.boxH+43)+'" text-anchor="middle" font-size="9.5" font-weight="800" fill="'+zo+'" letter-spacing="1.1">'+b("overview.flowDiagram.dt")+"</text>"),e.push('<text id="mobile-fd-dt" x="'+(D.boxX+D.boxW/2)+'" y="'+(D.boxY+D.boxH+63)+'" text-anchor="middle" class="flow-metric" font-size="19" fill="#ff8531">---</text>'),e.push('<line x1="'+D.endX+'" y1="34" x2="'+D.endX+'" y2="'+(o-34)+'" stroke="#ff8531" stroke-width="2" opacity=".48"/>'),e.push('<text id="mobile-fd-temp-head" x="506" y="30" font-size="10" fill="'+xt+'" font-weight="700" letter-spacing="1.5">'+b("overview.graph.layers.temp").toUpperCase()+"</text>"),e.push('<text id="mobile-fd-flow-head" x="592" y="30" font-size="10" fill="'+xt+'" font-weight="700" letter-spacing="1.5">'+b("overview.flowDiagram.flow")+"</text>"),e.push('<text id="mobile-fd-ret-head" x="678" y="30" font-size="10" fill="'+xt+'" font-weight="700" letter-spacing="1.5">'+b("overview.flowDiagram.returnShort")+"</text>");for(let r=1;r<=le;r++){let n=D.zoneYs[r-1];e.push('<line x1="'+(D.endX-8)+'" y1="'+n+'" x2="'+(D.endX+8)+'" y2="'+n+'" stroke="#ff8531" stroke-width="2" opacity=".5"/>'),e.push('<text id="mobile-fd-zn'+r+'" x="'+(D.endX-14)+'" y="'+(n+4)+'" text-anchor="end" font-size="12" fill="#FFEAD2" font-weight="800" letter-spacing="1.4">Z'+r+"</text>"),e.push('<text id="mobile-fd-zf'+r+'" x="'+D.nameX+'" y="'+(n-8)+'" text-anchor="middle" font-size="9" fill="#AFC1CD" font-weight="700" letter-spacing=".7">---</text>'),e.push('<text id="mobile-fd-zsp'+r+'" x="'+D.nameX+'" y="'+(n+7)+'" text-anchor="middle" font-size="8.5" fill="'+Ge+'" font-weight="600" font-family="var(--mono)"></text>'),e.push('<text id="mobile-fd-zt'+r+'" x="506" y="'+(n+4)+'" class="flow-metric" font-size="13.5" fill="#F6ECE0">---\xB0C</text>'),e.push('<text id="mobile-fd-zv'+r+'" x="592" y="'+(n+4)+'" class="flow-metric" font-size="13.5" fill="#C3D0D9">---%</text>'),e.push('<text id="mobile-fd-zr'+r+'" x="678" y="'+(n+4)+'" class="flow-metric" font-size="13.5" fill="#C3D0D9">---</text>')}return e.push("</svg>"),e.join("")}var $r=()=>'<div class="flow-wrap">'+jr()+Vr()+"</div>";T({tag:"flow-diagram",render:$r,onMount(e,t){let o=["desktop","mobile"],r={};o.forEach(m=>{r[m]={flowEl:t.querySelector("#"+m+"-fd-flow-temp"),flowLabelEl:t.querySelector("#"+m+"-fd-flow-label"),retEl:t.querySelector("#"+m+"-fd-ret-temp"),dtLabelEl:t.querySelector("#"+m+"-fd-dt-label"),dtEl:t.querySelector("#"+m+"-fd-dt"),zones:new Array(le+1)};for(let g=1;g<=le;g++)r[m].zones[g]={textTemp:t.querySelector("#"+m+"-fd-zt"+g),textSetpoint:t.querySelector("#"+m+"-fd-zsp"+g),textFlow:t.querySelector("#"+m+"-fd-zv"+g),textRet:t.querySelector("#"+m+"-fd-zr"+g),label:t.querySelector("#"+m+"-fd-zn"+g),friendly:t.querySelector("#"+m+"-fd-zf"+g),path:t.querySelector("#"+m+"-fd-path-"+g)}});function n(m,g){m&&(m.textContent=g)}function a(m,g,z,h,c){let u=r[m];n(u.flowLabelEl,b("overview.flowDiagram.flow")),n(u.flowEl,ae(g)),n(u.retEl,b("overview.flowDiagram.returnShort")+" "+ae(z)),n(u.dtLabelEl,b("overview.flowDiagram.dt")),n(u.dtEl,h==null?"---":h.toFixed(1)+"\xB0C"),u.dtEl&&u.dtEl.setAttribute("fill",c)}function i(){n(t.querySelector("#mobile-fd-temp-head"),b("overview.graph.layers.temp").toUpperCase()),n(t.querySelector("#mobile-fd-flow-head"),b("overview.flowDiagram.flow")),n(t.querySelector("#mobile-fd-ret-head"),b("overview.flowDiagram.returnShort"))}function d(m,g,z){let h=r[m].zones[g];if(!h)return;let{enabled:c,pct:u,temp:y,setpoint:l,valve:S,returnTemp:A,hasReturn:_}=z,x=Br(g,m==="desktop"?11:12),C=ae(y),M=l!=null?ae(l):"";n(h.label,"Z"+g),n(h.friendly,m==="desktop"?(x||"---")+(M?" ("+M+")":""):x||"---"),n(h.textTemp,C),n(h.textSetpoint,m==="desktop"?"":M?"("+M+")":""),n(h.textFlow,He(S)),n(h.textRet,_?ae(A):"---"),h.label.setAttribute("fill",c?Rr:Or),h.friendly.setAttribute("fill",c?xo:Ge),h.textSetpoint.setAttribute("fill",c?xo:Ge),h.textFlow.setAttribute("fill",Zr(u,c)),h.textRet.setAttribute("fill",_&&c?Pr:wo);let W=h.path;if(!c)W.setAttribute("d",m==="desktop"?Ue(g-1,1,2):Xe(g-1,1,2)),W.setAttribute("fill","#021824"),W.setAttribute("opacity","0.38");else{let H=m==="desktop"?j:D,E=Math.max(2.5,u*H.bgDstHW),Z=Math.max(1.3,u*H.srcHW);W.setAttribute("d",m==="desktop"?Ue(g-1,Z,E):Xe(g-1,Z,E)),W.setAttribute("fill","url(#"+m+"-rg"+g+")"),W.setAttribute("opacity","1")}}function f(){let m=L(s.flow),g=L(s.ret),z=m!=null&&g!=null?Number(m)-Number(g):null,h=z==null||z<3?yo:z>8?qr:Hr;o.forEach(c=>a(c,m,g,z,h));for(let c=1;c<=le;c++){let u=L(p.temp(c)),y=L(p.setpoint(c)),l=L(p.valve(c)),S=Y(p.enabled(c)),A=String(N(p.tempSource(c))||"Local Probe"),_=Wr(N(p.probe(c))||""),x=_?L(p.probeTemp(_)):null,C=A!=="Local Probe"&&x!=null&&!Number.isNaN(Number(x)),M=l!=null?Math.max(0,Math.min(100,Number(l)))/100:0,W={enabled:S,pct:M,temp:u,setpoint:y,valve:l,returnTemp:x,hasReturn:C};o.forEach(H=>d(H,c,W))}}w(s.flow,f),w(s.ret,f),B("zoneNames",f);for(let m=1;m<=le;m++)w(p.temp(m),f),w(p.setpoint(m),f),w(p.valve(m),f),w(p.enabled(m),f),w(p.probe(m),f),w(p.tempSource(m),f);for(let m=1;m<=8;m++)w(p.probeTemp(m),f);i(),f()}});var Gr={1:{label:"E",color:"#ff6361"},2:{label:"W",color:"#ffd380"},3:{label:"I",color:"#79d17e"},4:{label:"C",color:"#7aa7ce"},5:{label:"D",color:"rgba(214,228,255,.7)"},6:{label:"V",color:"rgba(214,228,255,.5)"},7:{label:"VV",color:"rgba(214,228,255,.4)"}},Ur=`
.logs-view {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`;function Yr(e){let t=Gr[e.level]||{label:"?",color:"var(--text-secondary)"},o=Co(e.tag||""),r=Co(e.msg||"");return'<div class="log-line"><span class="lv" style="color:'+t.color+'">'+t.label+'</span><span class="tag">'+o+'</span><span class="msg">'+r+"</span></div>"}function Co(e){return String(e).replace(/[&<>]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[t])}var zs=T({tag:"logs-view",render:Xr,onMount(e,t){let o=t.querySelector(".logs-stream"),r=t.querySelector(".pause-btn"),n=t.querySelector(".clear-btn"),a=!1;function i(){if(a)return;let d=Lt();if(!d||!d.length){o.innerHTML='<div class="logs-empty">'+b("logs.waiting")+"</div>";return}let f=o.scrollHeight-o.scrollTop-o.clientHeight<40;o.innerHTML=d.map(Yr).join(""),f&&(o.scrollTop=o.scrollHeight)}r.addEventListener("click",()=>{a=!a,r.textContent=a?b("logs.resume"):b("logs.pause"),r.classList.toggle("on",a),a||i()}),n.addEventListener("click",()=>{At()}),B("deviceLog",i),k(t),i()}});var Kr=`
.diag-i2c {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`,Ms=T({tag:"diag-i2c",render:Jr,onMount(e,t){let o=t.querySelector("#i2c-result");function r(){o.textContent=O("i2cResult")||b("diagnostics.i2c.empty")}t.querySelector("#btn-i2c-scan").addEventListener("click",()=>{Pt()}),B("i2cResult",r),k(t),r()}});var Qr=`
.diag-manual-badge {
  display: none;
  align-items: center;
  gap: 10px;
...
`,Ps=T({tag:"diag-manual-badge",render:ea,onMount(e,t){let o=t.classList.contains("diag-manual-badge")?t:t.querySelector(".diag-manual-badge");function r(){let n=!!O("manualMode");o&&o.classList.toggle("on",n)}B("manualMode",r),k(t),r()}});var ta=`
.diag-zone-motor {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`;F("diag-zone-motor",ta);var oa=e=>{let t=e.zone||O("selectedZone")||1,o="";for(let r=1;r<=6;r++)o+='<option value="'+r+'"'+(r===t?" selected":"")+">"+b("common.zone")+" "+r+"</option>";return`
  ...
  `},Zs=T({tag:"diag-zone-motor-card",render:oa,onMount(e,t){let o=Number(e.zone||O("selectedZone")||1),r=!!O("manualMode"),n=t.querySelector(".manual-mode-toggle"),a=t.querySelector(".motor-gated"),i=t.querySelector(".motor-zone-select"),d=t.querySelector(".motor-target-input"),f=t.querySelector(".motor-open-btn"),m=t.querySelector(".motor-close-btn"),g=t.querySelector(".motor-stop-btn"),z=()=>{let y=i.value||String(o),l="";for(let S=1;S<=6;S++)l+='<option value="'+S+'">'+b("common.zone")+" "+S+"</option>";i.innerHTML=l,i.value=y};function h(y){r=!!y,n&&(n.classList.toggle("on",r),n.setAttribute("aria-checked",r?"true":"false")),a&&a.classList.toggle("locked",!r),[i,d,f,m,g].forEach(l=>{l&&(l.disabled=!r)})}function c(){let y=!r;if(h(y),y){it(!0);for(let l=1;l<=6;l++)st(l)}else it(!1)}function u(){let y=L(p.motorTarget(o));d&&y!=null?d.value=Number(y).toFixed(0):d&&(d.value="0")}i==null||i.addEventListener("change",()=>{o=Number(i.value||1),u()}),n==null||n.addEventListener("click",c),n==null||n.addEventListener("keydown",y=>{y.key!==" "&&y.key!=="Enter"||(y.preventDefault(),c())});for(let y=1;y<=6;y++)w(p.motorTarget(y),u);u(),h(r),B("manualMode",()=>{h(!!O("manualMode"))}),k(t),d==null||d.addEventListener("change",y=>{if(!r)return;let l=y.target.value;Ht(o,l)}),f==null||f.addEventListener("click",()=>{r&&qt(o,1e4)}),m==null||m.addEventListener("click",()=>{r&&It(o,1e4)}),g==null||g.addEventListener("click",()=>{r&&st(o)})}});var ra=`
.diag-zone-recovery {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`;F("diag-zone-recovery",ra);var aa=()=>`
  ...
  `,Ys=T({tag:"diag-zone-recovery-card",render:aa,onMount(e,t){let o=Number(O("selectedZone")||1),r=t.querySelector(".recovery-fault-btn"),n=t.querySelector(".recovery-factors-btn"),a=t.querySelector(".recovery-relearn-btn"),i=t.querySelector(".recovery-status");B("selectedZone",()=>{o=Number(O("selectedZone")||1)});let d=null;function f(g,z){i.textContent=g,i.className="recovery-status show "+(z?"ok":"err"),clearTimeout(d),d=setTimeout(()=>{i.classList.remove("show")},4e3)}function m(g,z){let h=g(o);f(z,!0),h&&typeof h.then=="function"&&h.then(c=>{c&&c.ok===!1&&f(b("diagnostics.recovery.rejected"),!1)}).catch(()=>f(b("diagnostics.recovery.unreachable"),!1))}r==null||r.addEventListener("click",()=>{m(Bt,"\u2713 "+b("diagnostics.recovery.faultSent",{zone:$(o)}))}),n==null||n.addEventListener("click",()=>{confirm(b("diagnostics.recovery.confirmFactors",{zone:$(o)}))&&m(Wt,"\u2713 "+b("diagnostics.recovery.factorsReset",{zone:$(o)}))}),a==null||a.addEventListener("click",()=>{confirm(b("diagnostics.recovery.confirmRelearn",{zone:$(o)}))&&m(Zt,"\u2713 "+b("diagnostics.recovery.relearnStarted",{zone:$(o)}))}),k(t)}});var na=`
...
`;F("asgard-bridge-status-card",ia);var la=()=>`
...
`,pi=T({tag:"asgard-bridge-status-card",render:la,onMount(e,t){let o=t.querySelector(".role-badge"),r=t.querySelector(".ab-peer"),n=t.querySelector(".ab-push"),a=t.querySelector(".ab-setpoint"),i=t.querySelector(".ab-zones"),d=t.querySelector(".ab-error");function f(){let m=N(s.asgardRole)||"slave";o.textContent=m,o.className="role-badge "+(m==="master"?"master":"slave");let g=N(s.asgardPeerStatus)||b("common.na");r.textContent=g,r.classList.toggle("warn",g==="stale"||g==="unreachable");let z=L(s.asgardLastPushC),h=L(s.asgardLastPushAgeS);if(z!=null&&Number.isFinite(z)&&h!=null){let S=h<120?b("diagnostics.asgard.ageSeconds",{value:Math.round(h)}):b("diagnostics.asgard.ageMinutes",{value:Math.round(h/60)});n.textContent=`${z.toFixed(2)}\xB0C (${S})`}else n.textContent="\u2014";let c=L(s.asgardSetpointC);a.textContent=c!=null&&Number.isFinite(c)?`${c.toFixed(1)}\xB0C`:"\u2014";let u=L(s.asgardLocalZones),y=L(s.asgardPeerZones);i.textContent=u!=null?`${u} ${b("common.local")} + ${y||0} ${b("common.peer")}`:"\u2014";let l=N(s.asgardLastError);d.textContent=l||"\u2014",d.classList.toggle("warn",!!l)}[s.asgardRole,s.asgardPeerStatus,s.asgardLastPushC,s.asgardSetpointC,s.asgardLastPushAgeS,s.asgardLocalZones,s.asgardPeerZones,s.asgardLastError].forEach(m=>w(m,f)),k(t),f()}});var da=`
...
`;F("settings-manifold-card",da);var ca=()=>{let e="";for(let o=1;o<=8;o++)e+="<option>Probe "+o+"</option>";let t="";for(let o=1;o<=8;o++)t+='<div class="probe-cell"><div class="probe-name">Probe '+o+'</div><div class="probe-temp" data-probe="'+o+'">---</div></div>';return`
    <div class="ui-card settings-manifold-card">
      <div class="ui-card-title"><span class="ui-title-text"><span data-i18n="settings.manifold.title">Manifold Configuration</span>${ce("settings.manifold.help")}</span></div>
      <div class="ui-row">
  ...
  `},wi=T({tag:"settings-manifold-card",render:ca,onMount(e,t){let o=t.querySelector(".sm-type"),r=t.querySelector(".sm-flow"),n=t.querySelector(".sm-ret"),a=re(t);a.select(o,{read:()=>N(s.manifoldType)||"NO (Normally Open)",commit:d=>ne("manifold_type",d)}),a.select(r,{read:()=>N(s.manifoldFlowProbe)||"Probe 7",commit:d=>ne("manifold_flow_probe",d)}),a.select(n,{read:()=>N(s.manifoldReturnProbe)||"Probe 8",commit:d=>ne("manifold_return_probe",d)});function i(){for(let d=1;d<=8;d++){let f=t.querySelector('[data-probe="'+d+'"]');f&&(f.textContent=ae(L(p.probeTemp(d))))}}w(s.manifoldType,a.refresh),w(s.manifoldFlowProbe,a.refresh),w(s.manifoldReturnProbe,a.refresh);for(let d=1;d<=8;d++)w(p.probeTemp(d),i);k(t),a.refresh(),i()}});var pa=()=>`
  <div class="ui-card settings-minimum-flow-card">
    <div class="ui-card-title"><span class="ui-title-text"><span data-i18n="settings.minFlow.title">Minimum Zone Flow</span>${ce("settings.minFlow.help")}</span></div>
    <div class="ui-row">
...
`,Mi=T({tag:"settings-minimum-flow-card",render:pa,onMount(e,t){let o=t.querySelector(".smf-always"),r=t.querySelector(".smf-pct"),n=re(t);n.toggle(o,{read:()=>Y(s.minimumFlowAlways),commit:a=>{let i=a?"on":"off";v(s.minimumFlowAlways,{state:i}),ne("minimum_flow_always",i).catch(()=>v(s.minimumFlowAlways,{state:a?"off":"on"}))}}),n.num(r,{read:()=>L(s.minZoneFlowPct),commit:a=>{v(s.minZoneFlowPct,{value:a}),se("min_zone_flow_pct",a)}}),w(s.minimumFlowAlways,n.refresh),w(s.minZoneFlowPct,n.refresh),k(t),n.refresh()}});var ua=`
...
`;F("settings-control-card",ua);var ma=()=>`
...
`,Pi=T({tag:"settings-control-card",render:ma,onMount(e,t){k(t),t.querySelector(".sc-reset-probe-map").addEventListener("click",()=>{pe("reset_1wire_probe_map_reboot")}),t.querySelector(".sc-dump-1wire").addEventListener("click",()=>{pe("dump_1wire_probe_diagnostics")}),t.querySelector(".sc-restart").addEventListener("click",()=>{pe("restart")})}});var ga=`
...
`;F("settings-motor-calibration-card",ga);var Ye=[{cls:"safe-runtime",key:"generic_runtime_limit_seconds",id:s.genericRuntimeLimitSeconds,labelKey:"settings.motor.maxSafeRuntime",unit:"s"},{cls:"close-threshold",key:"close_threshold_multiplier",id:s.closeThresholdMultiplier,labelKey:"settings.motor.closeThreshold",unit:"x"},{cls:"close-slope-threshold",key:"close_slope_threshold",id:s.closeSlopeThreshold,labelKey:"settings.motor.closeSlope",unit:"mA/s"},{cls:"close-slope-floor",key:"close_slope_current_factor",id:s.closeSlopeCurrentFactor,labelKey:"settings.motor.closeSlopeFloor",unit:"x"},{cls:"open-threshold",key:"open_threshold_multiplier",id:s.openThresholdMultiplier,labelKey:"settings.motor.openThreshold",unit:"x"},{cls:"open-slope-threshold",key:"open_slope_threshold",id:s.openSlopeThreshold,labelKey:"settings.motor.openSlope",unit:"mA/s"},{cls:"open-slope-floor",key:"open_slope_current_factor",id:s.openSlopeCurrentFactor,labelKey:"settings.motor.openSlopeFloor",unit:"x"},{cls:"open-ripple-limit",key:"open_ripple_limit_factor",id:s.openRippleLimitFactor,labelKey:"settings.motor.openRippleLimit",unit:"x"},{cls:"relearn-movements",key:"relearn_after_movements",id:s.relearnAfterMovements,labelKey:"settings.motor.relearnMovements",unit:"count"},{cls:"relearn-hours",key:"relearn_after_hours",id:s.relearnAfterHours,labelKey:"settings.motor.relearnHours",unit:"h"},{cls:"learn-min-samples",key:"learned_factor_min_samples",id:s.learnedFactorMinSamples,labelKey:"settings.motor.learnMinSamples",unit:"count"},{cls:"learn-max-deviation",key:"learned_factor_max_deviation_pct",id:s.learnedFactorMaxDeviationPct,labelKey:"settings.motor.learnMaxDeviation",unit:"%"}],fa=()=>{let e="";for(let t=0;t<Ye.length;t++){let o=Ye[t];if(o.key==="generic_runtime_limit_seconds")continue;let r=ba(o.key)?"1":"0.1";e+='<div class="ui-row"><span class="ui-label"><span data-i18n="'+o.labelKey+'">'+b(o.labelKey)+"</span> ("+o.unit+')</span><span class="ui-field"><input type="number" class="ui-input smc-'+o.cls+'" value="0" step="'+r+'"></span></div>'}return`
  ...
  `};function ba(e){return e==="learned_factor_min_samples"||e==="generic_runtime_limit_seconds"||e==="relearn_after_movements"||e==="relearn_after_hours"}var ji=T({tag:"settings-motor-calibration-card",render:fa,onMount(e,t){let o=t.querySelector(".smc-profile"),r=t.querySelector(".smc-safe-runtime"),n=t.querySelector(".mc-drivers-toggle"),a=re(t);function i(f){if(f==="HmIP VdMot"&&se("hmip_runtime_limit_seconds",40),f==="Generic"){let m=Number(L(s.genericRuntimeLimitSeconds));(!Number.isFinite(m)||m<=0)&&se("generic_runtime_limit_seconds",45)}}a.toggle(n,{read:()=>Y(s.drivers),commit:f=>Dt(f)}),a.select(o,{read:()=>N(s.motorProfileDefault)||"HmIP VdMot",commit:f=>{ne("motor_profile_default",f),i(f)}});function d(){let f=N(s.motorProfileDefault)||"HmIP VdMot";r.disabled=f==="HmIP VdMot"}a.num(r,{read:()=>(N(s.motorProfileDefault)||"HmIP VdMot")==="HmIP VdMot"?40:L(s.genericRuntimeLimitSeconds),commit:f=>{o.value==="Generic"&&se("generic_runtime_limit_seconds",f)}});for(let f=0;f<Ye.length;f++){let m=Ye[f];if(m.key==="generic_runtime_limit_seconds")continue;let g=t.querySelector(".smc-"+m.cls);g&&(a.num(g,{read:()=>L(m.id),commit:z=>se(m.key,z)}),w(m.id,a.refresh))}w(s.drivers,a.refresh),w(s.motorProfileDefault,()=>{a.refresh(),d()}),w(s.genericRuntimeLimitSeconds,a.refresh),w(s.hmipRuntimeLimitSeconds,a.refresh),k(t),i(N(s.motorProfileDefault)||"HmIP VdMot"),a.refresh(),d()}});var va=`
.settings-asgard-card .ui-row:last-child { margin-bottom: 0; }
`;F("settings-asgard-card",va);var ha=()=>`
  <div class="ui-card settings-asgard-card">
    <div class="ui-card-title">
      <span class="ui-title-text"><span data-i18n="settings.asgard.title">Modulating Heat Source</span>${ce("settings.asgard.help")}</span>
    </div>
...
`,Qi=T({tag:"settings-asgard-card",render:ha,onMount(e,t){let o=t.querySelector(".sa-enable"),r=t.querySelector(".sa-coord"),n=t.querySelector(".sa-host"),a=t.querySelector(".sa-port"),i=t.querySelector(".sa-entity"),d=t.querySelector(".sa-peer"),f=t.querySelector(".sa-interval"),m=t.querySelector(".sa-body"),g=re(t);function z(y,l,S){return A=>{let _=A?"on":"off";v(y,{state:_}),ne(l,_).catch(x=>{console.error(`[Asgard] Failed to update ${S}:`,x),v(y,{state:A?"off":"on"})})}}let h=y=>m.classList.toggle("is-disabled",!y);g.toggle(o,{read:()=>Y(s.asgardEnabled),commit:z(s.asgardEnabled,"asgard_enabled","enabled"),onChange:h}),g.toggle(r,{read:()=>Y(s.asgardCoordinator),commit:z(s.asgardCoordinator,"asgard_coordinator","coordinator")});function c(y,l){return S=>{v(y,{state:S}),Rt(l,S).catch(A=>console.error(`[Asgard] Failed to update ${l}:`,A))}}g.text(n,{read:()=>N(s.asgardHost),commit:c(s.asgardHost,"asgard_host")}),g.text(i,{read:()=>N(s.asgardEntityName),commit:c(s.asgardEntityName,"asgard_entity_name")}),g.text(d,{read:()=>N(s.asgardPeerHost),commit:c(s.asgardPeerHost,"asgard_peer_host")});function u(y,l){return S=>{v(y,{value:S}),se(l,S).catch(A=>console.error(`[Asgard] Failed to update ${l}:`,A))}}g.num(a,{read:()=>L(s.asgardPort),commit:u(s.asgardPort,"asgard_port")}),g.num(f,{read:()=>L(s.asgardPushIntervalS),commit:u(s.asgardPushIntervalS,"asgard_push_interval_s")}),w(s.asgardEnabled,g.refresh),w(s.asgardCoordinator,g.refresh),w(s.asgardHost,g.refresh),w(s.asgardEntityName,g.refresh),w(s.asgardPeerHost,g.refresh),w(s.asgardPort,g.refresh),w(s.asgardPushIntervalS,g.refresh),k(t),g.refresh()}});var xa=`
...
`;F("smart-preheat-card",xa);var ya=()=>`
  <div class="ui-card smart-preheat-card">
    <div class="ui-card-title"><span class="ui-title-text"><span data-i18n="settings.preheat.title">Preheat</span>${ce("settings.preheat.help")}</span></div>
    <div class="ui-row">
