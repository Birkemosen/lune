...
`../lune-rev2.1/`. This is an electrical design review; it is not a
...
> `git restore --source=refs/snapshots/pre-hardware-cleanup -- devices/lune-v6/hardware/lune-rev2.1`
