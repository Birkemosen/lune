...
export const key = {
  ...
  sensorId: (zone) => 'text-zone_' + zone + '_sensor_id',
...
export const gkey = {
  ...
  // Published by the firmware in /state so Diagnostics can explain the last boot.
  resetReason: 'text_sensor-reset_reason',
  ...
  bleClockSyncEnabled: 'switch-ble_clock_sync_enabled',
  bleClockSyncIntervalMin: 'number-ble_clock_sync_interval_min',
  bleClockSyncLastOkS: 'sensor-ble_clock_sync_last_ok_s',
  bleClockSyncLastError: 'text-ble_clock_sync_last_error',
  bleClockSyncAdvertising: 'binary_sensor-ble_clock_sync_advertising',
