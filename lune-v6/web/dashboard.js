...
`;O("ui-kit",Fn);function ve(t){let e=d(t);return`<span class="help-badge" tabindex="0" role="img" aria-label="${String(e).replace(/"/g,"&quot;")}" data-i18n-label="${t}">?<span class="help-tip" data-i18n="${t}">${e}</span></span>`}function Tn(t,e){let o=Math.abs(Number(t));return!Number.isFinite(o)||o<1e3?e:Math.pow(10,Math.floor(Math.log10(o))-1)}function Nn(t){let e=String(t),o=e.indexOf(".");return o<0?0:e.length-o-1}function xe(t,e={}){let o=t.querySelector(e.title||".ui-card-title"),a=document.createElement("div");a.className="ui-form-banner",a.innerHTML='<span class="ui-form-banner-msg" data-i18n="form.unsaved">Unsaved changes</span><span class="ui-form-banner-btns"><button type="button" class="ui-form-discard" data-i18n="form.discard">Discard</button><button type="button" class="ui-form-apply" data-i18n="form.apply">Apply</button></span>',o?o.insertAdjacentElement("afterend",a):t.insertAdjacentElement("afterbegin",a);let n=[],r=()=>a.classList.toggle("show",n.some(v=>v.dirty)),s=(v,k)=>{v.dirty=k,r()};function c(v){return v.markDirty=()=>s(v,!0),n.push(v),v}function p(v,k){let T={dirty:!1,input:v},S=k.baseStep!=null?k.baseStep:parseFloat(v.step)||1,D=Nn(S),M=k.min!=null?k.min:v.min!==""?parseFloat(v.min):-1/0,I=k.max!=null?k.max:v.max!==""?parseFloat(v.max):1/0,K=j=>D>0?Number(j).toFixed(D):String(Math.round(Number(j)));if(!k.nostep){let j=document.createElement("div");j.className="ui-stepper",v.parentNode.insertBefore(j,v);let R=document.createElement("button");R.type="button",R.className="ui-step-btn",R.textContent="\u2212",R.setAttribute("aria-label",d("common.decrease"));let X=document.createElement("button");X.type="button",X.className="ui-step-btn",X.textContent="+",X.setAttribute("aria-label",d("common.increase")),j.appendChild(R),j.appendChild(v),j.appendChild(X);let te=H=>{if(v.disabled)return;let C=parseFloat(v.value);Number.isFinite(C)||(C=parseFloat(v.placeholder)),Number.isFinite(C)||(C=0);let w=Math.min(I,Math.max(M,C+H*Tn(C,S)));v.value=K(w),s(T,!0)};R.addEventListener("click",()=>te(-1)),X.addEventListener("click",()=>te(1)),v.addEventListener("keydown",H=>{H.key==="Enter"&&v.blur()})}return v.addEventListener("input",()=>s(T,!0)),T.sync=()=>{let j=k.read();v.value=j!=null&&Number.isFinite(Number(j))?K(j):""},T.commit=()=>{let j=parseFloat(v.value);Number.isFinite(j)&&k.commit(Math.min(I,Math.max(M,j)))},c(T)}function g(v,k){let T={dirty:!1,input:v};return v.addEventListener("input",()=>s(T,!0)),T.sync=()=>{let S=k.read();v.value=S!=null?S:""},T.commit=()=>k.commit(v.value.trim()),c(T)}function l(v,k){let T={dirty:!1,input:v};return v.addEventListener("change",()=>s(T,!0)),T.sync=()=>{let S=k.read();S!=null&&(v.value=S)},T.commit=()=>k.commit(v.value),c(T)}function m(v,k){let T={dirty:!1,input:v,staged:!1},S=v.closest(".ui-row"),D=()=>{v.classList.toggle("on",T.staged),S&&S.classList.toggle("is-on",T.staged),v.setAttribute("aria-checked",T.staged?"true":"false"),k.onChange&&k.onChange(T.staged)};return v.addEventListener("click",()=>{T.staged=!T.staged,s(T,!0),D()}),T.sync=()=>{T.staged=!!k.read(),D()},T.commit=()=>k.commit(T.staged),c(T)}function u(v){let k={dirty:!1,sync:v.sync,commit:v.commit};return c(k)}let f=()=>n.forEach(v=>{!v.dirty&&v.sync&&v.sync()}),b=()=>{n.forEach(v=>{v.dirty&&(v.commit&&v.commit(),v.dirty=!1)}),r(),e.onApply&&e.onApply()},y=()=>{n.forEach(v=>{v.dirty=!1,v.sync&&v.sync()}),r(),e.onDiscard&&e.onDiscard()};return a.querySelector(".ui-form-apply").addEventListener("click",b),a.querySelector(".ui-form-discard").addEventListener("click",y),L(a),{num:p,text:g,select:l,toggle:m,custom:u,refresh:f,apply:b,discard:y,isDirty:()=>n.some(v=>v.dirty)}}var Dn=`
...
`;O("hv6-header",Dn);var Rn=()=>`
  ...
  </nav>`,tr={overview:["Overview","Local heating status and current exceptions"],zones:["Zones","Physical loops, applied targets and valve state"],diagnostics:["Diagnostics","Health, evidence and recovery"],motorlab:["Motor lab","Instrumented stroke capture and endstop thresholds"],settings:["Settings","Device configuration and safety"],help:["Help","Guidance for operating Lune V6"]};function ar(t){t&&(Pe(t.section),t.focus==="touch"&&requestAnimationFrame(()=>{let e=document.querySelector(".touch-settings");e&&(e.open=!0);let o=document.querySelector(".settings-touch-card");o&&o.scrollIntoView({behavior:"smooth",block:"center"})}))}function or(t){return t?t.kind==="touch"?d("status.attention.approveTouch"):t.kind==="faults"?t.count===1?d("status.attention.zoneFaultOne"):d("status.attention.zoneFaultMany",{count:t.count}):"":""}P({tag:"hv6-header",render:Rn,onMount(t,e){let o=e.querySelector("#hdr-live"),a=e.querySelector("#v6-view-title"),n=e.querySelector("#v6-view-subtitle"),r=e.querySelector("#hdr-update"),s=e.querySelector("#hdr-attention");function c(){let l=N("firmwareUpdateAvailable");r.hidden=!l,l&&(r.textContent=d("status.updateAvailable",{version:l.latest}),r.title=d("settings.firmware.badgeTitle"))}function p(){let l=Co(),m=N("section")||"overview",u=!!(l&&l.section!==m);s.hidden=!u,u?(s.textContent=or(l),s.title=or(l),s.dataset.kind=l.kind):delete s.dataset.kind}r.addEventListener("click",()=>{Pe("settings");let l=document.querySelector(".settings-firmware-card");if(!l)return;let m=l.closest("details");m&&(m.open=!0),l.scrollIntoView({behavior:"smooth",block:"center"})}),s.addEventListener("click",()=>{ar(Co())});function g(){let l=N("section")||"overview",m=tr[l]||tr.overview;a.textContent=m[0],n.textContent=m[1],o.textContent=N("live")?d("status.live"):d("status.offline"),o.classList.toggle("is-live",!!N("live")),p()}Z("section",g),Z("live",g),Z("firmwareUpdateAvailable",c),z(i.authorityProposalPending,p);for(let l=1;l<=6;l++)z(h.state(l),p),z(h.motorLastFault(l),p);L(e),g(),c(),p()}});P({tag:"hv6-sidebar",render:Pn,onMount(t,e){let o=e,a=e.querySelectorAll("[data-section]"),n=e.querySelector(".v6-more-toggle"),r=e.querySelector('[data-section="settings"]'),s=e.querySelector('[data-section="zones"]'),c=e.querySelector('[data-section="diagnostics"]');function p(m,u,f,b){if(!m)return;let y=m.querySelector("[data-nav-dot]");y&&(y.hidden=!u,u?(m.setAttribute("aria-label",`${f}, ${b}`),m.title=b):(m.removeAttribute("aria-label"),m.removeAttribute("title")))}function g(){let m=jt(),u=_o(),f=u===1?d("status.attention.zoneFaultOne"):d("status.attention.zoneFaultMany",{count:u});if(p(r,m,d("nav.settings"),d("status.attention.approveTouch")),p(s,u>0,d("nav.zones"),f),p(c,u>0,d("nav.diagnostics"),f),n){let b=n.querySelector("[data-nav-dot]");b&&(b.hidden=!m,b.classList.toggle("is-warn",!1)),m?(n.setAttribute("aria-label",d("status.attention.moreHasSettings")),n.title=d("status.attention.approveTouch")):(n.removeAttribute("aria-label"),n.removeAttribute("title"))}}function l(){let m=N("section");a.forEach(u=>{u.dataset.section&&(u.dataset.section===m?u.classList.add("active"):u.classList.remove("active"),u.setAttribute("aria-current",u.dataset.section===m?"page":"false"))}),g()}a.forEach(m=>m.addEventListener("click",u=>{u.preventDefault();let f=m.dataset.section;f==="settings"&&jt()?ar({kind:"touch",section:"settings",focus:"touch"}):Pe(f),o.classList.contains("more-open")&&(o.classList.remove("more-open"),n&&n.setAttribute("aria-expanded","false"))})),n&&n.addEventListener("click",()=>{let m=o.classList.toggle("more-open");n.setAttribute("aria-expanded",String(m))}),Z("section",l),z(i.authorityProposalPending,g);for(let m=1;m<=6;m++)z(h.state(m),g),z(h.motorLastFault(m),g);L(e),l()}});function ue(t){return t!=null&&!isNaN(t)?Math.round(t*10)/10+"\xB0C":"---"}function mt(t){return t!=null&&!isNaN(t)?(t|0)+"%":"---"}function rr(t){if(t==null||isNaN(t)||t<0)return"---";t=t|0;var e=t/86400|0,o=t%86400/3600|0,a=t%3600/60|0;return e>0?e+"d "+o+"h "+a+"m":o>0?o+"h "+a+"m":a+"m"}var On=`
.connectivity-card {
...
`,Ll=P({tag:"connectivity-card",render:In,onMount(t,e){let o=e.querySelector(".cc-ip"),a=e.querySelector(".cc-ssid"),n=e.querySelector(".cc-mac"),r=e.querySelector(".cc-up"),s=e.querySelector(".cc-ver"),c=0,p=Date.now(),g=!1;function l(){if(!g){r.textContent="---";return}let f=Math.max(0,Math.floor((Date.now()-p)/1e3)),b=rr(c+f);r.textContent!==b&&(r.textContent=b)}function m(){o.textContent=_(i.ip)||"---",a.textContent=_(i.ssid)||"---",n.textContent=_(i.mac)||"---",s.textContent=_(i.firmware)||"---";let f=A(i.uptime);if(f!=null&&!isNaN(f)&&f>=0){let b=f|0;(!g||b!==c)&&(c=b,p=Date.now(),g=!0)}l()}z(i.ip,m),z(i.ssid,m),z(i.mac,m),z(i.firmware,m),z(i.uptime,m);let u=setInterval(l,1e3);e.addEventListener("hv6-unmount",()=>clearInterval(u),{once:!0}),L(e),m()}});var qn="http://www.w3.org/2000/svg",Hn=`
.chart-card {
  border: 1px solid var(--panel-border);
  border-radius: 8px;
  background: var(--panel-bg-vibrant);
...
`;O("chart-kit",Hn);function G(t,e,o){let a=document.createElementNS(qn,t);if(e)for(let n in e)a.setAttribute(n,e[n]);return o!=null&&(a.textContent=o),a}function gt(t){if(!t.length)return"";if(t.length<3)return"M "+t.map(a=>`${a.x.toFixed(2)} ${a.y.toFixed(2)}`).join(" L ");let e=.16,o=`M ${t[0].x.toFixed(2)} ${t[0].y.toFixed(2)}`;for(let a=0;a<t.length-1;a++){let n=t[a-1]||t[a],r=t[a],s=t[a+1],c=t[a+2]||s,p=r.x+(s.x-n.x)*e,g=r.y+(s.y-n.y)*e,l=s.x-(c.x-r.x)*e,m=s.y-(c.y-r.y)*e;o+=` C ${p.toFixed(2)} ${g.toFixed(2)}, ${l.toFixed(2)} ${m.toFixed(2)}, ${s.x.toFixed(2)} ${s.y.toFixed(2)}`}return o}function no(t,e,o){let a=t.filter(c=>Number.isFinite(c));if(!a.length)return{min:e,max:o};let n=Math.min(...a),r=Math.max(...a);n===r&&(n-=1,r+=1);let s=(r-n)*.12;return{min:n-s,max:r+s}}function bt(t,e,o){let a=document.createElement("div");a.className="chart-tooltip",e.appendChild(a);let n=G("g",{class:"chart-cursor",style:"display:none"}),r=G("line",{class:"chart-cursor-line",y1:o.plotTop,y2:o.plotBottom});n.appendChild(r);let s=[];t.appendChild(n);function c(m){let u=0,f=1/0;for(let b=0;b<o.count;b++){let y=Math.abs(m-o.xAt(b));y<f&&(f=y,u=b)}return u}function p(m){let u=t.getScreenCTM();if(!u)return null;let f=t.createSVGPoint();return f.x=m.clientX,f.y=m.clientY,f.matrixTransform(u.inverse())}function g(m){if(!o.count)return;let u=p(m);if(!u)return;let f=c(u.x),b=o.xAt(f);r.setAttribute("x1",b),r.setAttribute("x2",b);let y=o.dots(f);for(;s.length<y.length;){let S=G("circle",{class:"chart-cursor-dot",r:3.4});n.appendChild(S),s.push(S)}s.forEach((S,D)=>{D<y.length?(S.setAttribute("cx",b),S.setAttribute("cy",y[D].y),S.setAttribute("fill",y[D].color),S.style.display=""):S.style.display="none"}),n.style.display="";let v=o.rows(f).map(S=>`<div class="tt-row"><span class="tt-swatch" style="background:${S.color}"></span>${S.label}<span class="tt-val">${S.value}</span></div>`).join("");a.innerHTML=`<div class="tt-time">${o.label(f)}</div>${v}`,a.classList.add("show");let k=e.getBoundingClientRect(),T=m.clientX-k.left+14;T+a.offsetWidth>k.width-6&&(T=m.clientX-k.left-a.offsetWidth-14),a.style.left=Math.max(6,T)+"px",a.style.top=Math.max(6,m.clientY-k.top+12)+"px"}function l(){a.classList.remove("show"),n.style.display="none"}return t.addEventListener("pointermove",g),t.addEventListener("pointerleave",l),()=>{t.removeEventListener("pointermove",g),t.removeEventListener("pointerleave",l),a.remove()}}var Lt=1e3,$o=180,Ne=14,Bn=42,$n=44,Ue=42,lo=Lt-Ue-Bn,Ze=$o-Ne-$n,ot=Ne+Ze,jo=24*3600,nr=ye+2,sr=ye+3,so=ye+4,jn="var(--series-warm)",Vn="var(--series-cool)",ir="var(--series-solar)",Zn=`
...
`;O("graph-widgets",Zn);var lr=()=>'<div class="chart-card"><div class="chart-head"><span class="chart-title" data-i18n="overview.graph.flowReturnDemand">Flow / Return / Demand</span><span class="chart-sub gw-dt">\u2014</span></div><div class="gw-controls" role="toolbar" data-i18n-label="overview.graph.layers" aria-label="Flow chart layers"><button type="button" class="gw-toggle" data-layer="flow" aria-pressed="true" data-i18n="overview.graph.layers.flow">Flow</button><button type="button" class="gw-toggle" data-layer="return" aria-pressed="true" data-i18n="overview.graph.layers.return">Return</button><button type="button" class="gw-toggle" data-layer="demand" aria-pressed="true" data-i18n="overview.graph.layers.demand">Demand</button></div><svg class="gw-flow"></svg></div>',cr=()=>'<div class="chart-card"><div class="chart-head"><span class="chart-title" data-i18n="overview.graph.demandIndex">Demand Index</span><span class="chart-sub gw-demand-text">\u2014</span></div><svg class="gw-demand"></svg></div>',Un=t=>t.variant==="flow-return"?`<div class="graph-widgets">${lr()}</div>`:t.variant==="demand"?`<div class="graph-widgets">${cr()}</div>`:`<div class="graph-widgets">${lr()}${cr()}</div>`;function dr(t,e){return Number.isFinite(t)?e==="%"?Math.round(t)+"%":t.toFixed(1):"\u2014"}function Wn(t,e){return Number.isFinite(t)?e==="%"?Math.round(t)+"%":t.toFixed(1)+"\xB0":"\u2014"}function Vo(t,e,o){let a=[];for(let n=0;n<t.length;n++){let r=t[n];if(!r||r[0]<o)continue;let s=r[e];s==null||!Number.isFinite(s)||a.push({t:r[0],v:s})}return a}var co=(t,e)=>Ue+Math.max(0,Math.min(1,(t-e)/jo))*lo;function Kn(t,e,o){let a=Number(Date.now()/1e3)|0,n=3600,r=Math.ceil((a-jo)/n)*n,s=Math.floor(a/n)*n,c=Math.floor(a/n)*n;for(let g=r;g<=s;g+=n){let l=o-(a-g),m=co(l,e),u=new Date(g*1e3),f=g===c,b=ot+16;t.appendChild(G("text",{x:m,y:b,"text-anchor":"end",transform:`rotate(-45 ${m.toFixed(1)} ${b})`,class:"chart-hour"+(f?" now":"")},String(u.getHours()).padStart(2,"0")))}let p=co(o,e);t.appendChild(G("line",{x1:p,y1:Ne,x2:p,y2:ot,stroke:"var(--series-solar)","stroke-width":"1","stroke-dasharray":"2 3",opacity:".55","vector-effect":"non-scaling-stroke"}))}function Gn(t){let e=[];if(t.forEach(r=>r.forEach(s=>e.push(s.v))),!e.length)return{min:0,max:10};let o=Math.min(...e),a=Math.max(...e);o===a&&(o-=.5,a+=.5);let n=(a-o)*.1;return o-=n,a+=n,{min:o,max:a}}function Xn(t,e,o){let a=t.filter(n=>n.unit==="C").map(n=>Vo(e,n.index,o));return Gn(a)}function pr(t,e,o,a,n,r){t.innerHTML="",t.setAttribute("viewBox",`0 0 ${Lt} ${$o}`),t.setAttribute("preserveAspectRatio","xMidYMid meet");let s=o.map(b=>Vo(a,b.index,n));if(!s.some(b=>b.length))return t.appendChild(G("text",{x:Lt/2,y:$o/2,"text-anchor":"middle",class:"chart-empty"},"Collecting history\u2026")),null;let c=Xn(o,a,n),p=Math.max(.001,c.max-c.min),g=b=>Ne+(1-(b-c.min)/p)*Ze,l=b=>Ne+(1-Math.max(0,Math.min(100,b))/100)*Ze,m=(b,y)=>b.unit==="%"?l(y):g(y);for(let b=0;b<3;b++){let y=b/2,v=Ne+y*Ze;t.appendChild(G("line",{x1:Ue,y1:v,x2:Ue+lo,y2:v,class:"chart-grid"})),o.some(k=>k.unit==="C")&&t.appendChild(G("text",{x:Ue-6,y:v+4,"text-anchor":"end",class:"chart-tick"},dr(c.max-p*y,"C")+"\xB0")),o.some(k=>k.unit==="%")&&t.appendChild(G("text",{x:Ue+lo+6,y:v+4,"text-anchor":"start",class:"chart-tick"},dr(100-100*y,"%")))}t.appendChild(G("line",{x1:Ue,y1:ot,x2:Ue+lo,y2:ot,class:"chart-axis"})),o.some(b=>b.unit==="C")&&t.appendChild(G("text",{x:9,y:Ne+Ze/2,transform:`rotate(-90 9 ${(Ne+Ze/2).toFixed(1)})`,"text-anchor":"middle",class:"chart-axis-label"},d("overview.graph.axis.temp"))),o.some(b=>b.unit==="%")&&t.appendChild(G("text",{x:Lt-9,y:Ne+Ze/2,transform:`rotate(90 ${Lt-9} ${(Ne+Ze/2).toFixed(1)})`,"text-anchor":"middle",class:"chart-axis-label"},d("overview.graph.axis.demand"))),Kn(t,n,r),o.forEach((b,y)=>{let v=s[y].map(T=>({x:co(T.t,n),y:m(b,T.v)}));if(!v.length)return;let k=gt(v);b.fill&&t.appendChild(G("path",{d:k+` L ${v[v.length-1].x.toFixed(1)} ${ot} L ${v[0].x.toFixed(1)} ${ot} Z`,fill:b.fill,stroke:"none"})),t.appendChild(G("path",{d:k,fill:"none",stroke:b.color,"stroke-width":String(b.width||2.2),"stroke-linecap":"round","stroke-linejoin":"round"}))});let u=[];for(let b=0;b<a.length;b++){let y=a[b];if(!y||y[0]<n)continue;let v=o.map(k=>y[k.index]);v.every(k=>k==null||!Number.isFinite(k))||u.push({t:y[0],vals:v})}if(!u.length)return null;let f=Date.now();return bt(t,e,{count:u.length,plotTop:Ne,plotBottom:ot,xAt:b=>co(u[b].t,n),label:b=>new Date(f-(r-u[b].t)*1e3).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),dots:b=>o.map((y,v)=>({y:m(y,u[b].vals[v]),color:y.color})).filter((y,v)=>Number.isFinite(u[b].vals[v])),rows:b=>o.map((y,v)=>({color:y.color,label:y.label,value:Wn(u[b].vals[v],y.unit)})).filter((y,v)=>Number.isFinite(u[b].vals[v]))})}function io(t,e,o){let a=Vo(t,e,o);return a.length?a[a.length-1].v:null}var Pl=P({tag:"graph-widgets",state:t=>({variant:t&&t.variant||"both"}),render:Un,onMount(t,e){let o=e.querySelector(".gw-dt"),a=e.querySelector(".gw-demand-text"),n=e.querySelector(".gw-flow"),r=e.querySelector(".gw-demand"),s=Array.from(e.querySelectorAll(".gw-toggle")),c={flow:!0,return:!0,demand:!0},p=null,g=null;function l(){s.forEach(f=>{let b=f.dataset.layer;f.classList.toggle("is-off",!c[b]),f.setAttribute("aria-pressed",c[b]?"true":"false")})}function m(){let f=[];return c.flow&&f.push({index:nr,color:jn,label:d("overview.graph.layers.flow"),unit:"C",width:2.4}),c.return&&f.push({index:sr,color:Vn,label:d("overview.graph.layers.return"),unit:"C",width:2}),c.demand&&f.push({index:so,color:ir,label:d("overview.graph.layers.demand"),unit:"%",width:1.8,fill:"rgba(255,193,77,.10)"}),f}function u(){let f=N("zoneStateHistory"),b=f&&Array.isArray(f.entries)?f.entries:[],y=f&&f.uptime_s||Number(Date.now()/1e3)|0,v=y-jo;if(n){p&&p();let k=io(b,nr,v),T=io(b,sr,v),S=io(b,so,v),D=[];k!=null&&T!=null&&D.push("\u0394 "+(k-T).toFixed(1)+"\xB0"),S!=null&&D.push(Math.round(S)+"%"),o.textContent=D.length?D.join(" \xB7 "):"\u2014",p=pr(n,n.closest(".chart-card"),m(),b,v,y)}if(r){g&&g();let k=io(b,so,v);a.textContent=k!=null?Math.round(k)+"%":"\u2014",g=pr(r,r.closest(".chart-card"),[{index:so,color:ir,label:d("overview.graph.layers.demand"),unit:"%",width:2.2,fill:"var(--series-cool-fill)"}],b,v,y)}}s.forEach(f=>{f.addEventListener("click",()=>{let b=f.dataset.layer;c[b]=!c[b],!c.flow&&!c.return&&!c.demand&&(c[b]=!0),l(),u()})}),Z("zoneStateHistory",u),L(e),l(),u()}});var We={0:{labelKey:"state.off",color:"#2c4875"},1:{labelKey:"state.manual",color:"#7aa7ce"},2:{labelKey:"state.calibrating",color:"#ffd380"},3:{labelKey:"state.waitCal",color:"#4e6977"},4:{labelKey:"state.waitTemp",color:"#4e6977"},5:{labelKey:"state.heating",color:"var(--accent)"},6:{labelKey:"state.idle",color:"#39354c"},7:{labelKey:"state.overheated",color:"#ff6361"},255:{labelKey:"",color:"transparent"}},Mt=24*3600,Yn=Mt,At=18,Wo=4,at=54,uo=32,ft=4,mo=10,gr=6,br="#ffc14d",Zo=9,ur=ye+1,fr=ft+ye*(At+Wo)-Wo,Uo=fr+gr,po=fr+gr+mo+uo,Jn=`
.timeline-card {
  border: 1px solid var(--panel-border);
  border-radius: 8px;
  background: var(--panel-bg-vibrant);
...
`;O("zone-state-timeline",Jn);var Qn=()=>`
...
`;function es(t,e){if(!t||!t.entries||t.entries.length===0)return null;let o=t.entries,a=t.uptime_s||e||0,n=Number(Date.now()/1e3)|0,r=1e3,s=r-at;function c(S){let D=(S+Mt)/Yn;return at+Math.max(0,Math.min(1,D))*s}function p(S){return S-a}let g="http://www.w3.org/2000/svg",l=document.createElementNS(g,"svg");l.setAttribute("viewBox","0 0 "+r+" "+po),l.classList.add("timeline-svg");let m=document.createElementNS(g,"rect");m.setAttribute("x",at),m.setAttribute("y",ft),m.setAttribute("width",s),m.setAttribute("height",po-ft-uo),m.setAttribute("fill","rgba(0,32,46,0.55)"),m.setAttribute("rx","4"),l.appendChild(m);let u=c(0),f=[-24,-18,-12,-6,0].map(S=>S*3600);for(let S of f){let D=c(S),M=document.createElementNS(g,"line");M.setAttribute("x1",D),M.setAttribute("y1",ft),M.setAttribute("x2",D),M.setAttribute("y2",po-uo),M.setAttribute("stroke",S===0?"var(--series-solar)":"rgba(120,146,200,.16)"),M.setAttribute("stroke-width","1"),S===0&&(M.setAttribute("stroke-dasharray","2 3"),M.setAttribute("opacity",".55"),M.setAttribute("vector-effect","non-scaling-stroke")),l.appendChild(M)}l.appendChild(ts(g,"text",{x:u+4,y:ft+11,"text-anchor":"start",fill:"rgba(255,211,128,.92)","font-size":"9","font-family":"Montserrat, sans-serif","font-weight":"600"},"now"));for(let S=0;S<ye;S++){let D=ft+S*(At+Wo),M=document.createElementNS(g,"rect");M.setAttribute("x",at),M.setAttribute("y",D),M.setAttribute("width",s),M.setAttribute("height",At),M.setAttribute("fill",S%2===0?"rgba(124,155,208,0.05)":"rgba(124,155,208,0.00)"),l.appendChild(M);let I=document.createElementNS(g,"text");I.setAttribute("x",at-4),I.setAttribute("y",D+At/2+1),I.setAttribute("text-anchor","end"),I.setAttribute("dominant-baseline","middle"),I.setAttribute("fill","rgba(233,222,210,.62)"),I.setAttribute("font-size","9.5"),I.setAttribute("font-family","Montserrat, sans-serif"),I.setAttribute("font-weight","600"),I.textContent="Z"+(S+1),l.appendChild(I);let K=o.map(R=>({rel:p(R[0]),state:R[S+1]})).filter(R=>R.rel>=-Mt&&R.rel<=0),j=(R,X,te)=>{if(te===255)return;let H=We[te]||We[255];if(H.color==="transparent")return;let C=c(R),w=c(X),q=Math.max(1,w-C),F=document.createElementNS(g,"rect");F.setAttribute("x",C),F.setAttribute("y",D+(At-Zo)/2),F.setAttribute("width",q),F.setAttribute("height",Zo),F.setAttribute("fill",H.color),F.setAttribute("rx",String(Zo/2)),F.setAttribute("opacity","0.9"),l.appendChild(F)};if(K.length){let R=K[0].rel,X=K[0].state;for(let te=1;te<K.length;te++){let H=K[te];H.state!==X&&(j(R,H.rel,X),R=H.rel,X=H.state)}j(R,0,X)}}{let S=document.createElementNS(g,"rect");S.setAttribute("x",at),S.setAttribute("y",Uo),S.setAttribute("width",s),S.setAttribute("height",mo),S.setAttribute("fill","rgba(188,80,144,0.10)"),S.setAttribute("rx","2"),l.appendChild(S);let D=document.createElementNS(g,"text");D.setAttribute("x",at-4),D.setAttribute("y",Uo+mo/2+1),D.setAttribute("text-anchor","end"),D.setAttribute("dominant-baseline","middle"),D.setAttribute("fill","rgba(233,222,210,.62)"),D.setAttribute("font-size","8.5"),D.setAttribute("font-family","Montserrat, sans-serif"),D.setAttribute("font-weight","600"),D.textContent=d("overview.timeline.absorb"),l.appendChild(D);let M=o.map(I=>({rel:p(I[0]),on:I.length>ur?I[ur]:0})).filter(I=>I.rel>=-Mt&&I.rel<=0);if(M.length){let I=(R,X)=>{let te=c(R),H=Math.max(1,c(X)-te),C=document.createElementNS(g,"rect");C.setAttribute("x",te),C.setAttribute("y",Uo),C.setAttribute("width",H),C.setAttribute("height",mo),C.setAttribute("fill",br),C.setAttribute("rx","2"),C.setAttribute("opacity","0.9"),l.appendChild(C)},K=M[0].rel,j=M[0].on;for(let R=1;R<M.length;R++)M[R].on!==j&&(j&&I(K,M[R].rel),K=M[R].rel,j=M[R].on);j&&I(K,0)}}let b=po-uo+15,y=3600,v=Math.ceil((n-Mt)/y)*y,k=Math.floor(n/y)*y,T=Math.floor(n/y)*y;for(let S=v;S<=k;S+=y){let D=S-n,M=c(D),I=new Date(S*1e3),K=String(I.getHours()).padStart(2,"0"),j=S===T,R=document.createElementNS(g,"text");R.setAttribute("x",M),R.setAttribute("y",b),R.setAttribute("text-anchor","end"),R.setAttribute("fill",j?"rgba(255,211,128,.95)":"rgba(202,219,248,.72)"),R.setAttribute("font-size","9"),R.setAttribute("font-family",'"Montserrat", sans-serif'),R.setAttribute("font-weight","500"),R.setAttribute("font-variant-numeric","tabular-nums lining-nums"),R.setAttribute("font-feature-settings",'"tnum" 1, "lnum" 1'),R.setAttribute("letter-spacing","0"),R.setAttribute("transform",`rotate(-45 ${M.toFixed(1)} ${b})`),R.textContent=K,l.appendChild(R)}return l}function ts(t,e,o,a){let n=document.createElementNS(t,e);for(let r in o)n.setAttribute(r,o[r]);return a!=null&&(n.textContent=a),n}function mr(t){t.innerHTML="";let e=[{code:5,...We[5]},{code:6,...We[6]},{code:0,...We[0]},{code:1,...We[1]},{code:7,...We[7]},{code:2,...We[2]}];for(let a of e){let n=document.createElement("div");n.className="tl-legend-item",n.innerHTML='<span class="tl-legend-dot" style="background:'+a.color+'"></span>'+(a.labelKey?d(a.labelKey):""),t.appendChild(n)}let o=document.createElement("div");o.className="tl-legend-item",o.innerHTML='<span class="tl-legend-dot" style="background:'+br+'"></span>'+d("overview.timeline.preheatAbsorption"),t.appendChild(o)}var jl=P({tag:"zone-state-timeline",render:Qn,onMount(t,e){let o=e.querySelector(".tl-body"),a=e.querySelector(".timeline-legend");mr(a);function n(){let r=N("zoneStateHistory"),s=(()=>{let p=N&&N("zoneStateHistory");return p&&p.uptime_s||Number(Date.now()/1e3)|0})();if(o.innerHTML="",!r||!r.entries||r.entries.length===0){let p=document.createElement("div");p.className="timeline-empty",p.textContent=d("overview.timeline.noHistory"),o.appendChild(p);return}let c=es(r,s);c&&o.appendChild(c)}Z("zoneStateHistory",n),Z("zoneNames",n),z(i.drivers,n);for(let r=1;r<=ye;r++)z(h.enabled(r),n),z(h.state(r),n),z(h.temp(r),n),z(h.setpoint(r),n),z(h.preheatAdvance(r),n);L(e),n()}});var os=`
.zone-grid {
    display: grid;
...
`;O("zone-grid",os);var as=()=>'<div class="zone-grid" aria-label="Zones"></div>',Wl=P({tag:"zone-grid",state:t=>({selection:t.selection!==!1,navigate:t.navigate!==!1}),render:as,onMount(t,e){for(let o=1;o<=6;o++)e.appendChild(Q("zone-card",{zone:o,selection:t.selection,navigate:t.navigate}))}});var rs=`
.zone-card {
...
`,tc=P({tag:"zone-card",state:t=>({zone:t.zone,selection:t.selection!==!1,navigate:t.navigate!==!1}),render:ns,onMount(t,e){let o=t.zone,a=h.temp(o),n=h.state(o),r=h.enabled(o),s=e.querySelector(".zc-state-label"),c=e.querySelector(".zc-zone-name"),p=e.querySelector(".zc-friendly"),g=e.querySelector(".zc-temp"),l=e.querySelector(".zc-target"),m=e.querySelector(".zc-valve-value");function u(){var I;let b=ce(r),y=String(_(n)||"").toUpperCase()||"OFF",v=String(_(h.motorLastFault(o))||"").toUpperCase(),k=v&&v!=="NONE"&&v!=="OK",T=b&&(y==="FAULT"||k)?"FAULT":y,S=t.selection&&N("selectedZone")===o,D=pt(o);c.innerHTML=Oe(o),p.textContent=D?"":"---",p.hidden=!!D,e.setAttribute("aria-label",Se(o)),g.textContent=ue(A(a)),l.textContent=d("zone.card.setpoint",{value:ue((I=A(h.effectiveSetpoint(o)))!=null?I:A(h.setpoint(o)))}),m.textContent=mt(A(h.valve(o)));let M=b?T:"OFF";s.textContent=M==="HEATING"?d("state.heating"):M==="IDLE"?d("state.idle"):M==="FAULT"?d("common.fault"):M==="MANUAL"?d("state.manual"):M==="OVERHEATED"?d("state.overheated"):M==="CALIBRATING"?d("state.calibrating"):d("state.off"),e.title=k?d("zone.card.fault",{fault:v}):"",e.classList.toggle("active",S),S?e.setAttribute("aria-current","location"):e.removeAttribute("aria-current"),e.setAttribute("aria-label",`${c.textContent}, ${g.textContent}, ${l.textContent}, ${s.textContent}. Open details.`),e.classList.toggle("disabled",!b),e.classList.toggle("zs-heating",b&&M==="HEATING"),e.classList.toggle("zs-fault",b&&M==="FAULT"),e.classList.toggle("zs-idle",b&&M==="IDLE"),e.classList.toggle("zs-off",!b||M==="OFF")}function f(){Vt(o),t.navigate&&Pe("zones"),e.dispatchEvent(new CustomEvent("zone-open",{bubbles:!0,detail:{zone:o}}))}e.addEventListener("click",f),z(a,u),z(h.setpoint(o),u),z(h.effectiveSetpoint(o),u),z(h.valve(o),u),z(n,u),z(r,u),z(h.motorLastFault(o),u),Z("selectedZone",u),Z("zoneNames",u),u()}});var ss=`
...
`,hr=5,vr=35,bo=.5;function ht(t){return t==null||Number.isNaN(Number(t))?"":(Math.round(Number(t)*10)/10).toFixed(1)}function ls(t){if(t==null)return null;let e=String(t).trim().replace(",",".").replace(/[^\d.+-]/g,"");if(!e)return null;let o=Number(e);if(!Number.isFinite(o))return null;let a=Math.round(o/bo)*bo;return Math.min(vr,Math.max(hr,Number(a.toFixed(1))))}function cs(t){let e=Number(A(h.setpoint(t)));return Number.isFinite(e)?e:null}function go(t){let e=Number(A(h.coordinatorOffset(t)));return Number.isFinite(e)?e:0}function Ke(t){let e=Number(A(h.effectiveSetpoint(t)));if(Number.isFinite(e))return e;let o=cs(t);return o==null?null:Number((o+go(t)).toFixed(1))}function Et(t){return Math.min(vr,Math.max(hr,Number(Number(t).toFixed(1))))}function ds(t,e){if(!e)return d("common.disabled");let o=String(t||"IDLE").toUpperCase();return o==="HEATING"?d("state.heating"):o==="IDLE"?d("state.idle"):o==="OFF"?d("state.off"):o==="FAULT"?d("common.fault"):o==="MANUAL"?d("state.manual"):o==="OVERHEATED"?d("state.overheated"):o==="CALIBRATING"?d("state.calibrating"):o}var dc=P({tag:"zone-detail",state:t=>({zone:t.zone,temp:"---",setpoint:"---",valve:"---",state:"---"}),render:is,methods:{update(t,e){var p;let o=N("selectedZone"),a=String(_(h.state(o))||"").toUpperCase(),n=ce(h.enabled(o));this.zone=o,t.dataset.zone=String(o),document.activeElement!==e.setpoint&&(e.setpoint.value=ht(Ke(o))),e.base.textContent=ue((p=A(h.baseSetpoint(o)))!=null?p:A(h.setpoint(o)));let r=A(h.coordinatorOffset(o));e.offset.textContent=r==null?"---":(r>0?"+":"")+Number(r).toFixed(1)+"\xB0C",e.temp.textContent=ue(A(h.temp(o))),e.ret.textContent=ue(A("sensor-manifold_return_temperature")),e.valve.textContent=mt(A(h.valve(o)));let s=e.badge;s.textContent=ds(a,n);let c=n?a==="HEATING"?"badge-heating":a==="IDLE"?"badge-idle":a==="FAULT"?"badge-fault":"":"badge-disabled";s.className="zd-badge"+(c?" "+c:""),e.toggle.classList.toggle("on",n)},commitSetpoint(t){let e=this.zone,o=ls(t);if(o==null)return null;let a=Et(o-go(e));return Jt(e,a),Ke(e)},incSetpoint(){let t=this.zone,e=Ke(t),o=Et((e==null?20:e)+bo);Jt(t,Et(o-go(t)))},decSetpoint(){let t=this.zone,e=Ke(t),o=Et((e==null?20:e)-bo);Jt(t,Et(o-go(t)))},toggleEnabled(){let t=this.zone,e=ce(h.enabled(t));_a(t,!e)}},onMount(t,e){let o={setpoint:e.querySelector(".zd-setpoint"),temp:e.querySelector(".zd-temp"),base:e.querySelector(".zd-base"),offset:e.querySelector(".zd-offset"),ret:e.querySelector(".zd-ret"),valve:e.querySelector(".zd-valve"),badge:e.querySelector(".zd-badge"),toggle:e.querySelector(".btn-toggle"),inc:e.querySelector(".btn-inc"),dec:e.querySelector(".btn-dec")};o.inc.onclick=()=>t.incSetpoint(),o.dec.onclick=()=>t.decSetpoint(),o.toggle.onclick=()=>t.toggleEnabled();let a=()=>{let s=t.commitSetpoint(o.setpoint.value);o.setpoint.value=s!=null?ht(s):ht(Ke(t.zone))};o.setpoint.addEventListener("keydown",s=>{s.key==="Enter"?(s.preventDefault(),o.setpoint.blur()):s.key==="Escape"?(s.preventDefault(),o.setpoint.value=ht(Ke(t.zone)),o.setpoint.blur()):s.key==="ArrowUp"?(s.preventDefault(),t.incSetpoint(),o.setpoint.value=ht(Ke(t.zone))):s.key==="ArrowDown"&&(s.preventDefault(),t.decSetpoint(),o.setpoint.value=ht(Ke(t.zone)))}),o.setpoint.addEventListener("blur",a),o.setpoint.addEventListener("focus",()=>{requestAnimationFrame(()=>o.setpoint.select())});let n=()=>t.update(e,o),r=s=>{let c=N("selectedZone");(s===h.temp(c)||s===h.setpoint(c)||s===h.baseSetpoint(c)||s===h.effectiveSetpoint(c)||s===h.coordinatorOffset(c)||s===h.valve(c)||s===h.state(c)||s===h.enabled(c))&&n()};for(let s=1;s<=6;s++)z(h.temp(s),r),z(h.setpoint(s),r),z(h.baseSetpoint(s),r),z(h.effectiveSetpoint(s),r),z(h.coordinatorOffset(s),r),z(h.valve(s),r),z(h.state(s),r),z(h.enabled(s),r);z("sensor-manifold_return_temperature",n),Z("selectedZone",n),L(e),n()}});var ps=`
...
`;O("zone-sensor-card",ps);var us=()=>`
  ...
  `;function ms(t){return t==="BLE"||t==="BLE Sensor"?"BLE Sensor":"Local Probe"}function gs(t){return t==="BLE Sensor"?"BLE":"Local Probe"}function xr(t,e){let o='<option value="Local Probe" data-i18n="zone.sensor.localProbe">'+d("zone.sensor.localProbe")+'</option><option value="BLE Sensor" data-i18n="zone.sensor.bleSource">'+d("zone.sensor.bleSource")+"</option>";t.innerHTML!==o&&(t.innerHTML=o),t.value=e}var xc=P({tag:"zone-sensor-card",render:us,onMount(t,e){let o=e.querySelector(".zs-source"),a=e.querySelector(".zs-ble"),n=e.querySelector(".zs-row-ble"),r=e.querySelector(".zs-scan"),s=e.querySelector(".zs-scan-list"),c=0;function p(){return N("selectedZone")}function g(){n.style.display=o.value==="BLE Sensor"?"":"none"}let l=xe(e);xr(o,"Local Probe"),l.select(o,{read:()=>ms(String(_(h.tempSource(p()))||"")),commit:b=>Ve(p(),"zone_temp_source",gs(b))});let m=l.text(a,{read:()=>_(h.ble(p()))||"",commit:b=>Ro(p(),"zone_ble_mac",b)});o.addEventListener("change",g);function u(){let b=p();c!==b?(c=b,s.style.display="none",l.discard()):l.refresh(),g()}function f(b){let y=p();(b===h.tempSource(y)||b===h.ble(y))&&(l.refresh(),g())}r.addEventListener("click",()=>{if(r.disabled)return;r.disabled=!0,r.textContent="\u2026",s.style.display="",s.innerHTML='<div class="scan-msg">'+d("zone.sensor.scanning")+"</div>";let b=new AbortController,y=setTimeout(()=>b.abort(),8e3);fetch("/api/hv6/v1/ble-scan",{cache:"no-store",signal:b.signal}).then(v=>{if(!v.ok)throw new Error("HTTP "+v.status);return v.json()}).then(v=>{if(clearTimeout(y),r.disabled=!1,r.textContent=d("zone.sensor.scan"),!v.ok||!v.sensors||v.sensors.length===0){s.innerHTML='<div class="scan-msg">'+d("zone.sensor.noSensors")+"</div>";return}let k=p(),T=(_(h.ble(k))||"").toUpperCase(),S=M=>String(M).replace(/[&<>"']/g,I=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[I]),D="";for(let M of v.sensors){let I=M.mac.toUpperCase(),K=M.name?S(M.name):"",j=M.temp_c!=null?M.temp_c.toFixed(1)+"\xB0C":"\u2014",R=M.rssi!=null?M.rssi+" dBm":"",X=M.age_s<60?d("common.secondsAgo",{value:M.age_s}):d("common.minutesAgo",{value:Math.round(M.age_s/60)}),te="";I===T?te='<span class="ble-badge">'+d("zone.sensor.assignedThisZone")+"</span>":M.zone>0&&(te='<span class="ble-badge">'+d("zone.sensor.zoneBadge",{zone:M.zone})+"</span>");let H=K?`<div class="ble-mac">${K}</div><div class="ble-meta">${I}</div>`:`<div class="ble-mac">${I}</div>`;D+=`<div class="ble-scan-item">
              <div>
                ${H}
                <div class="ble-meta">${j} &nbsp;${R} &nbsp;${X}</div>
                ${te}
              </div>
              <button class="btn-assign" data-mac="${I}">${d("zone.sensor.assign")}</button>
            </div>`}s.innerHTML=D,s.querySelectorAll(".btn-assign").forEach(M=>{M.addEventListener("click",()=>{a.value=M.dataset.mac,m.markDirty(),s.style.display="none"})})}).catch(v=>{clearTimeout(y),r.disabled=!1,r.textContent=d("zone.sensor.scan");let k=v&&v.name==="AbortError"?d("zone.sensor.scanTimeout"):d("zone.sensor.scanFailed");s.innerHTML='<div class="scan-msg">'+k+"</div>"})}),Z("selectedZone",u);for(let b=1;b<=6;b++)z(h.tempSource(b),f),z(h.ble(b),f);L(e),u()}});var bs=".zone-coordination-card { height: 100%; }";O("zone-coordination-card",bs);var fs=()=>`
...
`;function yr(t,e){let o=t.value,a='<option value="None" data-i18n="common.none">'+d("common.none")+"</option>";for(let n=1;n<=6;n++)n!==e&&(a+='<option value="Zone '+n+'">'+d("common.zone")+" "+n+"</option>");t.innerHTML=a,t.value=o||"None"}var Mc=P({tag:"zone-coordination-card",render:fs,onMount(t,e){let o=e.querySelector(".zc-sync"),a=0;function n(){return N("selectedZone")}let r=xe(e);r.select(o,{read:()=>_(h.syncTo(n()))||"None",commit:p=>Ve(n(),"zone_sync_to",p)});function s(){let p=n();a!==p?(yr(o,p),a=p,r.discard()):r.refresh()}function c(p){let g=n();(p===h.syncTo(g)||/^select-zone_\d+_sync_to$/.test(p))&&r.refresh()}Z("selectedZone",s);for(let p=1;p<=6;p++)z(h.syncTo(p),c);L(e),s()}});var hs=".zone-room-card { height: 100%; }";O("zone-room-card",hs);var vs=()=>`
...
`,Pc=P({tag:"zone-room-card",render:vs,onMount(t,e){let o=e.querySelector(".zr-friendly");function a(){return N("selectedZone")}let n=xe(e);n.text(o,{read:()=>kt(a())||"",commit:r=>Aa(a(),r)}),Z("selectedZone",n.discard),Z("zoneNames",n.refresh),L(e),n.refresh()}});var xs=`
...
`;O("zone-actuator-card",xs);function wr(t){return t!=null?Number(t).toFixed(2)+"x":"---"}function kr(t){return t!=null?Number(t).toFixed(0):"---"}function ys(t){return t!=null?Number(t).toFixed(2)+"C":"---"}var ws=()=>`
...
`,Vc=P({tag:"zone-actuator-card",render:ws,onMount(t,e){var p,g,l;let o=Number(N("selectedZone")||1),a={orip:e.querySelector(".za-orip"),crip:e.querySelector(".za-crip"),ofac:e.querySelector(".za-ofac"),cfac:e.querySelector(".za-cfac"),ph:e.querySelector(".za-ph"),fault:e.querySelector(".za-fault"),faultVal:e.querySelector(".za-fault-val"),faultBtn:e.querySelector(".recovery-fault-btn"),factorsBtn:e.querySelector(".recovery-factors-btn"),relearnBtn:e.querySelector(".recovery-relearn-btn"),status:e.querySelector(".za-status")};function n(){o=Number(N("selectedZone")||1),a.orip.textContent=kr(A(h.motorOpenRipples(o))),a.crip.textContent=kr(A(h.motorCloseRipples(o))),a.ofac.textContent=wr(A(h.motorOpenFactor(o))),a.cfac.textContent=wr(A(h.motorCloseFactor(o))),a.ph.textContent=ys(A(h.preheatAdvance(o)));let m=String(_(h.motorLastFault(o))||"").toUpperCase(),u=m&&m!=="NONE"&&m!=="OK";a.fault.hidden=!u,u&&(a.faultVal.textContent=m)}let r=null;function s(m,u){a.status.textContent=m,a.status.className="za-status show "+(u?"ok":"err"),clearTimeout(r),r=setTimeout(()=>{a.status.classList.remove("show")},4e3)}function c(m,u){let f=m(o);s(u,!0),f&&typeof f.then=="function"&&f.then(b=>{b&&b.ok===!1&&s(d("diagnostics.recovery.rejected"),!1)}).catch(()=>s(d("diagnostics.recovery.unreachable"),!1))}(p=a.faultBtn)==null||p.addEventListener("click",()=>{c(Da,"\u2713 "+d("diagnostics.recovery.faultSent",{zone:Se(o)}))}),(g=a.factorsBtn)==null||g.addEventListener("click",()=>{confirm(d("diagnostics.recovery.confirmFactors",{zone:Se(o)}))&&c(Ra,"\u2713 "+d("diagnostics.recovery.factorsReset",{zone:Se(o)}))}),(l=a.relearnBtn)==null||l.addEventListener("click",()=>{confirm(d("diagnostics.recovery.confirmRelearn",{zone:Se(o)}))&&c(Pa,"\u2713 "+d("diagnostics.recovery.relearnStarted",{zone:Se(o)}))}),Z("selectedZone",n);for(let m=1;m<=6;m++)z(h.motorOpenRipples(m),n),z(h.motorCloseRipples(m),n),z(h.motorOpenFactor(m),n),z(h.motorCloseFactor(m),n),z(h.preheatAdvance(m),n),z(h.motorLastFault(m),n);L(e),n()}});var De=6,ks="var(--flow-disabled)",Sr="var(--flow-unknown)",_r="var(--accent)",Ft="var(--flow-return)",Go="var(--text-strong)",zs="var(--flow-disabled)",rt="var(--flow-label)",fo="var(--flow-disabled)",Ko="var(--flow-label)",Cr="var(--flow-label)",zr="var(--flow-return)",Ss="#66BB6A",_s="#FF6361",ee={w:1160,h:372,boxX:440,boxY:26,boxW:280,boxH:90,srcY:116,fanY:168,zoneY:262,zoneXs:[92,286,480,674,868,1062],srcSpread:15,bgDstHW:28,srcHW:7},V={w:760,h:424,boxX:26,boxY:148,boxW:168,boxH:92,srcX:196,endX:386,nameX:446,midY:190,zoneYs:[56,120,184,248,312,376],spread:10,bgDstHW:15,srcHW:4},Cs=`
.flow-wrap {
  width: 100%;
  border-radius: 8px;
  overflow: hidden;
...
`;O("flow-diagram",Cs);function Ls(t,e){let o=String(kt(t)||"").trim();if(!o)return"";let a=o.toUpperCase();return a.length>e?a.slice(0,Math.max(1,e-1))+"\u2026":a}function Ms(t){if(!t)return null;let e=String(t).match(/(\d+)/);if(!e)return null;let o=Number(e[1]);return Number.isFinite(o)&&o>=1&&o<=8?o:null}function As(t,e){return e?t==null||Number.isNaN(t)?Sr:t>0?_r:rt:ks}function Lr(t){let e=t==="desktop"?"0 1":"1 0",o=[];o.push("<defs>");for(let a=1;a<=De;a++)o.push('<linearGradient id="'+t+"-rg"+a+'" x1="0" y1="0" x2="'+e.split(" ")[0]+'" y2="'+e.split(" ")[1]+'">'),o.push('<stop id="'+t+"-rgs"+a+'" offset="0%" stop-color="var(--accent)" stop-opacity=".96"/>'),o.push('<stop id="'+t+"-rga"+a+'" offset="100%" stop-color="var(--accent)" stop-opacity=".7"/>'),o.push("</linearGradient>");return o.push("</defs>"),o.join("")}function Es(t){let e=ee.boxX+ee.boxW/2+(t-2.5)*ee.srcSpread,o=ee.zoneXs[t];return"M"+e.toFixed(1)+" "+ee.srcY+" C"+e.toFixed(1)+" "+ee.fanY+" "+o.toFixed(1)+" "+(ee.fanY+34)+" "+o.toFixed(1)+" "+(ee.zoneY-20)}function Fs(t){let e=V.midY+(t-2.5)*V.spread,o=V.zoneYs[t],a=V.endX-V.srcX;return"M"+V.srcX+" "+e.toFixed(1)+" C"+(V.srcX+a*.34)+" "+e.toFixed(1)+" "+(V.srcX+a*.7)+" "+o.toFixed(1)+" "+V.endX+" "+o.toFixed(1)}function Mr(t,e,o){let a=ee.boxX+ee.boxW/2+(t-2.5)*ee.srcSpread,n=ee.srcY,r=ee.zoneXs[t],s=ee.zoneY-20,c=ee.fanY,p=ee.fanY+34;return"M"+(a-e).toFixed(1)+" "+n+" C"+(a-e).toFixed(1)+" "+c+" "+(r-o).toFixed(1)+" "+p+" "+(r-o).toFixed(1)+" "+s+" L"+(r+o).toFixed(1)+" "+s+" C"+(r+o).toFixed(1)+" "+p+" "+(a+e).toFixed(1)+" "+c+" "+(a+e).toFixed(1)+" "+n+"Z"}function Ar(t,e,o){let a=V.midY+(t-2.5)*V.spread,n=V.zoneYs[t],r=V.endX-V.srcX,s=V.srcX+r*.34,c=V.srcX+r*.7;return"M"+V.srcX+" "+(a-e).toFixed(1)+" C"+s+" "+(a-e).toFixed(1)+" "+c+" "+(n-o).toFixed(1)+" "+V.endX+" "+(n-o).toFixed(1)+" L"+V.endX+" "+(n+o).toFixed(1)+" C"+c+" "+(n+o).toFixed(1)+" "+s+" "+(a+e).toFixed(1)+" "+V.srcX+" "+(a+e).toFixed(1)+"Z"}function Er(t,e,o){return'<rect width="'+t+'" height="'+e+'" rx="10" fill="var(--surface-raised)"/>'}function Fr(t){let e=t==="desktop"?ee:V,o=t==="desktop"?e.boxY+34:e.boxY+36,a=t==="desktop"?e.boxY+74:e.boxY+76;return'<rect x="'+e.boxX+'" y="'+e.boxY+'" width="'+e.boxW+'" height="'+e.boxH+'" rx="7" fill="var(--flow-source-bg)" stroke="var(--accent)" stroke-width="2"/><text id="'+t+'-fd-flow-label" x="'+(e.boxX+e.boxW/2)+'" y="'+o+'" text-anchor="middle" font-size="'+(t==="desktop"?28:27)+'" font-weight="800" fill="var(--accent)" letter-spacing="2">'+d("overview.flowDiagram.flow")+'</text><text id="'+t+'-fd-flow-temp" class="flow-metric" x="'+(e.boxX+e.boxW/2)+'" y="'+a+'" text-anchor="middle" font-size="'+(t==="desktop"?40:37)+'" fill="var(--text-strong)">---</text>'}function Ts(){let t=[],e=ee.w,o=ee.h,a=ee.zoneY-20;t.push('<svg class="flow-svg flow-svg-desktop" viewBox="0 5 '+e+" "+(o-5)+'" preserveAspectRatio="xMidYMid meet" aria-hidden="true" focusable="false">'),t.push(Lr("desktop")),t.push(Er(e,o,"desktop")),t.push(Fr("desktop")),t.push('<text id="desktop-fd-ret-temp" x="'+(ee.boxX+ee.boxW+24)+'" y="'+(ee.boxY+28)+'" font-size="24" font-weight="800" fill="'+Ft+'" font-family="var(--mono)">'+d("overview.flowDiagram.returnShort")+" ---</text>"),t.push('<text id="desktop-fd-dt-label" x="'+(ee.boxX+ee.boxW+24)+'" y="'+(ee.boxY+54)+'" font-size="19" font-weight="800" fill="'+Cr+'" letter-spacing="1.4">'+d("overview.flowDiagram.dt")+"</text>"),t.push('<text id="desktop-fd-dt" x="'+(ee.boxX+ee.boxW+24)+'" y="'+(ee.boxY+86)+'" class="flow-metric" font-size="34" fill="var(--accent)">---</text>');for(let n=1;n<=De;n++)t.push('<path id="desktop-fd-track-'+n+'" class="flow-track" d="'+Es(n-1)+'" opacity=".7"/>');for(let n=1;n<=De;n++)t.push('<path id="desktop-fd-path-'+n+'" class="flow-ribbon" d="'+Mr(n-1,ee.srcHW,ee.bgDstHW)+'" fill="url(#desktop-rg'+n+')" opacity="1"/>');t.push('<line x1="54" y1="'+a+'" x2="'+(e-54)+'" y2="'+a+'" stroke="var(--flow-track)" stroke-width="2" opacity=".72"/>');for(let n=1;n<=De;n++){let r=ee.zoneXs[n-1];t.push('<g class="flow-zone-hit">'),t.push('<line id="desktop-fd-tick-'+n+'" x1="'+r+'" y1="'+(a-10)+'" x2="'+r+'" y2="'+(a+10)+'" stroke="var(--flow-track)" stroke-width="2"/>'),t.push('<text id="desktop-fd-zn'+n+'" x="'+r+'" y="'+(a-18)+'" text-anchor="middle" font-size="22" fill="'+Go+'" font-weight="800" letter-spacing="1.5">Z'+n+"</text>"),t.push('<text id="desktop-fd-zf'+n+'" x="'+r+'" y="'+(a+30)+'" text-anchor="middle" font-size="17.5" fill="'+rt+'" font-weight="700" letter-spacing=".35">---</text>'),t.push('<text id="desktop-fd-zsp'+n+'" x="'+r+'" y="'+(a+30)+'" text-anchor="middle" font-size="15.5" fill="'+fo+'" font-weight="600" font-family="var(--mono)"></text>'),t.push('<text id="desktop-fd-zt'+n+'" x="'+r+'" y="'+(a+60)+'" text-anchor="middle" class="flow-metric" font-size="24" fill="var(--text-strong)">---\xB0C</text>'),t.push('<text id="desktop-fd-zv'+n+'" x="'+(r-40)+'" y="'+(a+90)+'" text-anchor="middle" class="flow-metric" font-size="20" fill="'+rt+'">---%</text>'),t.push('<text id="desktop-fd-zr'+n+'" x="'+(r+40)+'" y="'+(a+90)+'" text-anchor="middle" class="flow-metric" font-size="20" fill="'+Ft+'">---</text>'),t.push("</g>")}return t.push("</svg>"),t.join("")}function Ns(){let t=[],e=V.w,o=V.h;t.push('<svg class="flow-svg flow-svg-mobile" viewBox="0 0 '+e+" "+o+'" preserveAspectRatio="xMidYMid meet" aria-hidden="true" focusable="false">'),t.push(Lr("mobile")),t.push(Er(e,o,"mobile")),t.push(Fr("mobile"));for(let a=1;a<=De;a++)t.push('<path id="mobile-fd-track-'+a+'" class="flow-track" d="'+Fs(a-1)+'" opacity=".7"/>');for(let a=1;a<=De;a++)t.push('<path id="mobile-fd-path-'+a+'" class="flow-ribbon" d="'+Ar(a-1,V.srcHW,V.bgDstHW)+'" fill="url(#mobile-rg'+a+')" opacity="1"/>');t.push('<rect x="'+(V.boxX+6)+'" y="'+(V.boxY+V.boxH+10)+'" width="'+(V.boxW-12)+'" height="84" rx="8" fill="var(--flow-source-bg)" stroke="var(--flow-return)" stroke-opacity=".7"/>'),t.push('<text id="mobile-fd-ret-temp" x="'+(V.boxX+V.boxW/2)+'" y="'+(V.boxY+V.boxH+36)+'" text-anchor="middle" font-size="21" font-weight="800" fill="'+Ft+'" font-family="var(--mono)">'+d("overview.flowDiagram.returnShort")+" ---</text>"),t.push('<text id="mobile-fd-dt-label" x="'+(V.boxX+V.boxW/2)+'" y="'+(V.boxY+V.boxH+56)+'" text-anchor="middle" font-size="15.5" font-weight="800" fill="'+Cr+'" letter-spacing=".7">'+d("overview.flowDiagram.dt")+"</text>"),t.push('<text id="mobile-fd-dt" x="'+(V.boxX+V.boxW/2)+'" y="'+(V.boxY+V.boxH+82)+'" text-anchor="middle" class="flow-metric" font-size="27" fill="var(--accent)">---</text>'),t.push('<line x1="'+V.endX+'" y1="38" x2="'+V.endX+'" y2="'+(o-28)+'" stroke="var(--flow-track)" stroke-width="2" opacity=".72"/>'),t.push('<text id="mobile-fd-temp-head" x="506" y="34" font-size="17" fill="'+Ko+'" font-weight="700" letter-spacing="1">'+d("overview.graph.layers.temp").toUpperCase()+"</text>"),t.push('<text id="mobile-fd-flow-head" x="592" y="34" font-size="17" fill="'+Ko+'" font-weight="700" letter-spacing="1">'+d("overview.flowDiagram.flow")+"</text>"),t.push('<text id="mobile-fd-ret-head" x="678" y="34" font-size="17" fill="'+Ko+'" font-weight="700" letter-spacing="1">'+d("overview.flowDiagram.returnShort")+"</text>");for(let a=1;a<=De;a++){let n=V.zoneYs[a-1];t.push('<line id="mobile-fd-tick-'+a+'" x1="'+(V.endX-10)+'" y1="'+n+'" x2="'+(V.endX+10)+'" y2="'+n+'" stroke="var(--flow-track)" stroke-width="2"/>'),t.push('<text id="mobile-fd-zn'+a+'" x="'+(V.endX-14)+'" y="'+(n+7)+'" text-anchor="end" font-size="21" fill="'+Go+'" font-weight="800" letter-spacing="1.1">Z'+a+"</text>"),t.push('<text id="mobile-fd-zf'+a+'" x="'+V.nameX+'" y="'+(n-12)+'" text-anchor="middle" font-size="17" fill="'+rt+'" font-weight="700" letter-spacing=".3">---</text>'),t.push('<text id="mobile-fd-zsp'+a+'" x="'+V.nameX+'" y="'+(n+12)+'" text-anchor="middle" font-size="15.5" fill="'+fo+'" font-weight="600" font-family="var(--mono)"></text>'),t.push('<text id="mobile-fd-zt'+a+'" x="506" y="'+(n+7)+'" class="flow-metric" font-size="22" fill="var(--text-strong)">---\xB0C</text>'),t.push('<text id="mobile-fd-zv'+a+'" x="592" y="'+(n+7)+'" class="flow-metric" font-size="22" fill="'+rt+'">---%</text>'),t.push('<text id="mobile-fd-zr'+a+'" x="678" y="'+(n+7)+'" class="flow-metric" font-size="22" fill="'+Ft+'">---</text>')}return t.push("</svg>"),t.join("")}var Ds=()=>'<div class="flow-wrap" role="img" aria-label="'+d("overview.flowDiagram.flow")+'">'+Ts()+Ns()+"</div>";P({tag:"flow-diagram",render:Ds,onMount(t,e){let o=["desktop","mobile"],a={};o.forEach(g=>{a[g]={flowEl:e.querySelector("#"+g+"-fd-flow-temp"),flowLabelEl:e.querySelector("#"+g+"-fd-flow-label"),retEl:e.querySelector("#"+g+"-fd-ret-temp"),dtLabelEl:e.querySelector("#"+g+"-fd-dt-label"),dtEl:e.querySelector("#"+g+"-fd-dt"),zones:new Array(De+1)};for(let l=1;l<=De;l++)a[g].zones[l]={textTemp:e.querySelector("#"+g+"-fd-zt"+l),textSetpoint:e.querySelector("#"+g+"-fd-zsp"+l),textFlow:e.querySelector("#"+g+"-fd-zv"+l),textRet:e.querySelector("#"+g+"-fd-zr"+l),label:e.querySelector("#"+g+"-fd-zn"+l),friendly:e.querySelector("#"+g+"-fd-zf"+l),track:e.querySelector("#"+g+"-fd-track-"+l),tick:e.querySelector("#"+g+"-fd-tick-"+l),path:e.querySelector("#"+g+"-fd-path-"+l)}});function n(g,l){g&&(g.textContent=l)}function r(g,l,m,u,f){let b=a[g];n(b.flowLabelEl,d("overview.flowDiagram.flow")),n(b.flowEl,ue(l)),n(b.retEl,d("overview.flowDiagram.returnShort")+" "+ue(m)),n(b.dtLabelEl,d("overview.flowDiagram.dt")),n(b.dtEl,u==null?"---":u.toFixed(1)+"\xB0C"),b.dtEl&&b.dtEl.setAttribute("fill",f)}function s(){n(e.querySelector("#mobile-fd-temp-head"),d("overview.graph.layers.temp").toUpperCase()),n(e.querySelector("#mobile-fd-flow-head"),d("overview.flowDiagram.flow")),n(e.querySelector("#mobile-fd-ret-head"),d("overview.flowDiagram.returnShort"))}function c(g,l,m){let u=a[g].zones[l];if(!u)return;let{enabled:f,pct:b,temp:y,setpoint:v,valve:k,returnTemp:T,hasReturn:S}=m,D=Ls(l,g==="desktop"?12:11),M=ue(y),I=v!=null?ue(v):"";n(u.label,"Z"+l),n(u.friendly,g==="desktop"?(D||"---")+(I?" ("+I+")":""):D||"---"),n(u.textTemp,M),n(u.textSetpoint,g==="desktop"?"":I?"("+I+")":""),n(u.textFlow,mt(k)),n(u.textRet,S?ue(T):"---"),u.label.setAttribute("fill",f?Go:zs),u.friendly.setAttribute("fill",f?rt:fo),u.textSetpoint.setAttribute("fill",f?rt:fo),u.textFlow.setAttribute("fill",As(b,f)),u.textRet.setAttribute("fill",S&&f?Ft:Sr);let K=f&&b!=null&&b>0;u.track.setAttribute("opacity",f?".78":".38"),u.track.setAttribute("stroke-dasharray",f?"none":"5 7"),u.tick.setAttribute("stroke",K?_r:"var(--flow-track)"),u.tick.setAttribute("stroke-width",K?"3":"2");let j=u.path;if(!K)j.setAttribute("opacity","0");else{let R=g==="desktop"?ee:V,X=Math.max(2.5,b*R.bgDstHW),te=Math.max(1.3,b*R.srcHW);j.setAttribute("d",g==="desktop"?Mr(l-1,te,X):Ar(l-1,te,X)),j.setAttribute("fill","url(#"+g+"-rg"+l+")"),j.setAttribute("opacity",".96")}}function p(){let g=A(i.flow),l=A(i.ret),m=g!=null&&l!=null?Number(g)-Number(l):null,u=m==null||m<3?zr:m>8?_s:Ss;o.forEach(f=>r(f,g,l,m,u));for(let f=1;f<=De;f++){let b=A(h.temp(f)),y=A(h.setpoint(f)),v=A(h.valve(f)),k=ce(h.enabled(f)),T=String(_(h.tempSource(f))||"Local Probe"),S=Ms(_(h.probe(f))||""),D=S?A(h.probeTemp(S)):null,M=T!=="Local Probe"&&D!=null&&!Number.isNaN(Number(D)),I=v!=null?Math.max(0,Math.min(100,Number(v)))/100:null,K={enabled:k,pct:I,temp:b,setpoint:y,valve:v,returnTemp:D,hasReturn:M};o.forEach(j=>c(j,f,K))}}z(i.flow,p),z(i.ret,p),Z("zoneNames",p);for(let g=1;g<=De;g++)z(h.temp(g),p),z(h.setpoint(g),p),z(h.valve(g),p),z(h.enabled(g),p),z(h.probe(g),p),z(h.tempSource(g),p);for(let g=1;g<=8;g++)z(h.probeTemp(g),p);s(),p()}});var Rs={1:{label:"E",color:"#ff6361"},2:{label:"W",color:"#ffd380"},3:{label:"I",color:"#79d17e"},4:{label:"C",color:"#7aa7ce"},5:{label:"D",color:"rgba(214,228,255,.7)"},6:{label:"V",color:"rgba(214,228,255,.5)"},7:{label:"VV",color:"rgba(214,228,255,.4)"}},Ps=`
.logs-view {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`;function Is(t){let e=Rs[t.level]||{label:"?",color:"var(--text-secondary)"},o=Tr(t.tag||""),a=Tr(t.msg||"");return'<div class="log-line"><span class="lv" style="color:'+e.color+'">'+e.label+'</span><span class="tag">'+o+'</span><span class="msg">'+a+"</span></div>"}function Tr(t){return String(t).replace(/[&<>]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[e])}var ad=P({tag:"logs-view",render:Os,onMount(t,e){let o=e.querySelector(".logs-stream"),a=e.querySelector(".pause-btn"),n=e.querySelector(".clear-btn"),r=e.querySelector(".download-btn"),s=!1;function c(){if(s)return;let p=Kt();if(!p||!p.length){o.innerHTML='<div class="logs-empty">'+d("logs.waiting")+"</div>";return}let g=o.scrollHeight-o.scrollTop-o.clientHeight<40;o.innerHTML=p.map(Is).join(""),g&&(o.scrollTop=o.scrollHeight)}a.addEventListener("click",()=>{s=!s,a.textContent=s?d("logs.resume"):d("logs.pause"),a.classList.toggle("on",s),s||c()}),n.addEventListener("click",()=>{da()}),r.addEventListener("click",()=>{r.disabled=!0,Ua().catch(p=>{console.error("[Logs] download failed:",p),window.alert(d("logs.downloadFailed"))}).finally(()=>{r.disabled=!1})}),Z("deviceLog",c),L(e),c()}});var qs=`
.diag-i2c {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`,dd=P({tag:"diag-i2c",render:Hs,onMount(t,e){let o=e.querySelector("#i2c-result");function a(){o.textContent=N("i2cResult")||d("diagnostics.i2c.empty")}e.querySelector("#btn-i2c-scan").addEventListener("click",()=>{Ca()}),Z("i2cResult",a),L(e),a()}});var Bs=`
.diag-manual-badge {
  display: none;
  align-items: center;
  gap: 10px;
...
`,fd=P({tag:"diag-manual-badge",render:$s,onMount(t,e){let o=e.classList.contains("diag-manual-badge")?e:e.querySelector(".diag-manual-badge");function a(){let n=!!N("manualMode");o&&o.classList.toggle("on",n)}Z("manualMode",a),L(e),a()}});var js=`
.diag-zone-motor {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`;O("diag-zone-motor",js);var Vs=t=>{let e=t.zone||N("selectedZone")||1,o="";for(let a=1;a<=6;a++)o+='<option value="'+a+'"'+(a===e?" selected":"")+">"+d("common.zone")+" "+a+"</option>";return`
  ...
  `},Sd=P({tag:"diag-zone-motor-card",render:Vs,onMount(t,e){let o=Number(t.zone||N("selectedZone")||1),a=!!N("manualMode"),n=e.querySelector(".manual-mode-toggle"),r=e.querySelector(".motor-gated"),s=e.querySelector(".motor-zone-select"),c=e.querySelector(".motor-target-input"),p=e.querySelector(".motor-open-btn"),g=e.querySelector(".motor-close-btn"),l=e.querySelector(".motor-stop-btn"),m=()=>{let y=s.value||String(o),v="";for(let k=1;k<=6;k++)v+='<option value="'+k+'">'+d("common.zone")+" "+k+"</option>";s.innerHTML=v,s.value=y};function u(y){a=!!y,n&&(n.classList.toggle("on",a),n.setAttribute("aria-checked",a?"true":"false")),r&&r.classList.toggle("locked",!a),[s,c,p,g,l].forEach(v=>{v&&(v.disabled=!a)})}function f(){let y=!a;if(u(y),y){Ct(!0);for(let v=1;v<=6;v++)Po(v)}else Ct(!1)}function b(){let y=A(h.motorTarget(o));c&&y!=null?c.value=Number(y).toFixed(0):c&&(c.value="0")}s==null||s.addEventListener("change",()=>{o=Number(s.value||1),b()}),n==null||n.addEventListener("click",f),n==null||n.addEventListener("keydown",y=>{y.key!==" "&&y.key!=="Enter"||(y.preventDefault(),f())});for(let y=1;y<=6;y++)z(h.motorTarget(y),b);b(),u(a),Z("manualMode",()=>{u(!!N("manualMode"))}),L(e),c==null||c.addEventListener("change",y=>{if(!a)return;let v=y.target.value;Ea(o,v)}),p==null||p.addEventListener("click",()=>{a&&Qt(o,1e4)}),g==null||g.addEventListener("click",()=>{a&&eo(o,1e4)}),l==null||l.addEventListener("click",()=>{a&&Po(o)})}});var Tt={FREE_TRAVEL:0,CONTACT:1,UNDER_LOAD:2,STOPPING:3};function Nt(t){switch(Number(t)){case Tt.CONTACT:return"contact";case Tt.UNDER_LOAD:return"load";case Tt.STOPPING:return"stopping";default:return"free"}}function Yo(t){let e=t||[];for(let o=0;o<e.length;o++){let a=Number(e[o].stroke_phase)||0;if(a===Tt.CONTACT||a===Tt.UNDER_LOAD)return e[o]}return null}function Ge(t,e,o){if(e[o]==null)return null;let a=Number(t[e[o]]);return Number.isFinite(a)?a:null}function Nr(t){let e=String(t||"").split(/\r?\n/).filter(r=>r.trim());if(e.length<2)return[];let o=e[0].split(",").map(r=>r.trim()),a={};for(let r=0;r<o.length;r++)a[o[r]]=r;let n=[];for(let r=1;r<e.length;r++){let s=e[r].split(",");if(s.length<6)continue;let c=p=>Number(s[a[p]]);n.push({t_ms:c("t_ms")||0,motion_count:c("motion_count")||0,current_ma:c("current_ma"),adc_current_raw:Ge(s,a,"adc_current_raw"),drive_on:c("drive_on")===1,direction_open:c("direction_open")===1,armed:c("armed")===1,stroke_phase:c("stroke_phase")||0,tacho_period_us:Ge(s,a,"tacho_period_us"),tacho_amp_raw:Ge(s,a,"tacho_amp_raw"),bemf_raw_a:Ge(s,a,"bemf_raw_a"),bemf_raw_b:Ge(s,a,"bemf_raw_b"),bemf_differential_raw:Ge(s,a,"bemf_differential_raw"),bemf_separation_us:Ge(s,a,"bemf_separation_us"),bemf_valid:a.bemf_valid!=null?c("bemf_valid")===1:null,bemf_moving:a.bemf_moving!=null?c("bemf_moving")===1:null,invalid_bemf_samples:Ge(s,a,"invalid_bemf_samples")})}return n}function Zs(t){let e=0,o=0;for(let a=0;a<t.length;a++)t[a].drive_on&&(t[a].direction_open?e+=1:o+=1);return e>=o?"open":"close"}function Us(t,e){if(!t.length)return null;let o=t.slice().sort((n,r)=>n-r),a=Math.min(o.length-1,Math.max(0,Math.round((o.length-1)*e)));return o[a]}function Ee(t){return Math.round(t*10)/10}function Xo(t,e,o){return Math.min(o,Math.max(e,t))}function Ws(t){let e=Number(t);return!Number.isFinite(e)||e<=0?null:1e6/e}function Dr(t){let e=[];if(!t.length)return e;let o=t[0].t_ms,a=t[t.length-1].t_ms;for(let n=o;n+500<=a;n+=500){let r=t.reduce((p,g)=>Math.abs(g.t_ms-n)<Math.abs(p.t_ms-n)?g:p,t[0]),s=t.reduce((p,g)=>Math.abs(g.t_ms-(n+500))<Math.abs(p.t_ms-(n+500))?g:p,t[0]),c=(s.t_ms-r.t_ms)/1e3;c>.2&&e.push({t_ms:n+500,slope:(s.current_ma-r.current_ma)/c})}return e}function Dt(t){let e=t||[],o=[];for(let s=0;s<e.length;s++){let c=e[s],p=c.tacho_period_us!=null?c.tacho_period_us:c.tacho_cadence_us!=null?c.tacho_cadence_us:null;o.push({t_ms:c.t_ms,period_us:p,rate_hz:Ws(p)})}let a=e.filter(s=>s.drive_on&&Number.isFinite(s.current_ma)),n=a.length>=2?a:e.filter(s=>Number.isFinite(s.current_ma)),r=Dr(n);return{cadence:o,slopes:r,count:e.length,truncated:e.length>=2e3,window_ms:2e3*2}}function Rr(t,e){let o=e||Zs(t),a=t.filter(C=>C.drive_on&&Number.isFinite(C.current_ma)&&(o==="open"?C.direction_open:!C.direction_open));if(a.length<8)return{direction:o,ok:!1,reason:"too_few_samples"};let n=a[0].t_ms,r=a[a.length-1].t_ms,s=a.filter(C=>C.t_ms>=n+650),c=s.length>12?s:a,p=Math.max(1,r-(c[0]?c[0].t_ms:n)),g=c.filter(C=>C.t_ms<c[0].t_ms+p*.7),l=c.filter(C=>C.t_ms>=c[0].t_ms+p*.8),m=(g.length?g:c).map(C=>C.current_ma),u=(l.length?l:c.slice(-Math.max(4,c.length/8|0))).map(C=>C.current_ma),f=m.reduce((C,w)=>C+w,0)/m.length,b=Math.max(...a.map(C=>C.current_ma)),y=Math.max(...u),v=Math.max(0,a[a.length-1].motion_count-a[0].motion_count),k=Dr(c),T=k.filter(C=>C.t_ms<c[0].t_ms+p*.7).map(C=>C.slope),S=k.filter(C=>C.t_ms>=c[0].t_ms+p*.75).map(C=>C.slope),D=S.length?Math.max(...S):0,M=Us(T.map(Math.abs),.9)||0,I=o==="close"?.55:.68,K=f>.5?y/f:0,j=Ee(Xo(1+I*Math.max(0,K-1),1.25,2.4)),R=Ee(Xo(Math.max(M*2.2,D*.42,.4),.4,8)),X=Ee(Xo(1+.35*Math.max(0,K-1),1.15,1.8)),te=o==="open"?1.15:null,H=Yo(a);return{direction:o,ok:!0,start_ms:n,end_ms:r,runtime_ms:r-n,mean_ma:Ee(f),peak_ma:Ee(b),stall_peak_ma:Ee(y),ripples:v,max_stall_slope_ma_s:Ee(D),travel_slope_ma_s:Ee(M),measured_factor:Ee(K),suggested_factor:j,suggested_slope:R,suggested_slope_floor:X,suggested_ripple_limit:te,pin_seen:!!H,pin_t_ms:H?H.t_ms:null,pin_motion_count:H?H.motion_count:null,pin_current_ma:H?Ee(H.current_ma):null,samples:a}}function Pr(t,e){if(!t||!t.ok)return[];let o=t.mean_ma,a=Number(e&&e.factor)||t.suggested_factor;return[{id:"mean",value:o},{id:"threshold",value:Ee(o*a)},{id:"suggested",value:Ee(o*t.suggested_factor)},{id:"cap",value:100}]}var Rt=920,Pt=200,Or=56,ne={t:16,r:18,b:32,l:52},Re=Rt-ne.l-ne.r,xt=Pt-ne.t-ne.b,Jo="var(--accent)",ta="var(--series-cool)",Ks="var(--state-warn)",Gs="var(--state-ok)",Xs="var(--state-danger)",ho="var(--state-warn)",Qo="var(--series-cool)",ea="var(--accent)",Ys="var(--state-ok)",Ir={free:"rgba(var(--accent-rgb),.10)",contact:"rgba(245,158,11,.22)",load:"rgba(52,211,153,.20)",stopping:"rgba(239,68,68,.18)"},qr={free:"",contact:"lab-hatch-contact",load:"lab-hatch-load",stopping:"lab-hatch-stop"},Js=`
...
`;O("motor-lab-charts",Js);function vt(t,e,o=xt){let a=e.max-e.min||1;return ne.t+o-(t-e.min)/a*o}function vo(t,e,o,a=Pt){t.appendChild(G("text",{class:"chart-axis-label",x:ne.l,y:a-8},"0 s")),t.appendChild(G("text",{class:"chart-axis-label",x:ne.l+Re-48,y:a-8},(o/1e3).toFixed(1)+" s"))}function oa(t,e,o=xt){for(let a=0;a<=4;a++){let n=ne.t+o*a/4;t.appendChild(G("line",{class:"chart-grid",x1:ne.l,x2:ne.l+Re,y1:n,y2:n}));let r=e.max-(e.max-e.min)*a/4;t.appendChild(G("text",{class:"chart-tick",x:8,y:n+4},r.toFixed(0)))}}function Qs(t){if(!t.length)return[];let e=[],o=0,a=Number(t[0].stroke_phase)||0;for(let n=1;n<t.length;n++){let r=Number(t[n].stroke_phase)||0;r!==a&&(e.push({phase:a,start:o,end:n-1}),o=n,a=r)}return e.push({phase:a,start:o,end:t.length-1}),e}function ei(t){let e=t.querySelector("defs");return e||(e=G("defs"),[["lab-hatch-contact","M0 4 L4 0","var(--state-warn)"],["lab-hatch-load","M0 0 L4 4","var(--state-ok)"],["lab-hatch-stop","M0 2 L4 2","var(--state-danger)"]].forEach(([a,n,r])=>{let s=G("pattern",{id:a,width:4,height:4,patternUnits:"userSpaceOnUse"});s.appendChild(G("path",{d:n,stroke:r,"stroke-width":"1",fill:"none"})),e.appendChild(s)}),t.appendChild(e),e)}function Ot(t,e,o){let a=document.createElement("div");a.className="chart-card",a.setAttribute("role","img"),a.setAttribute("aria-label",d(o||t));let n=document.createElement("div");return n.className="chart-head",n.innerHTML='<span class="chart-title">'+d(t)+'</span><span class="chart-sub">'+e+"</span>",a.appendChild(n),a}function ti(t,e,o){let a=Ot(e,d(o||"diagnostics.lab.empty"),e),n=document.createElement("div");n.className="lab-empty",n.textContent=d("diagnostics.lab.empty"),a.appendChild(n),t.appendChild(a)}function xo(t,e,o){return t?d("diagnostics.lab.res.live"):o&&o.truncated?d("diagnostics.lab.res.traceTruncated",{n:2e3}):e&&e.ok?d("diagnostics.lab.res.trace",{direction:d("diagnostics.lab.dir."+e.direction),ms:e.runtime_ms}):d("diagnostics.lab.res.traceReady")}function oi(t,e,o,a,n,r){if(!r.current&&!r.overlays)return;let s=Dt(e),c=Ot("diagnostics.lab.chart.current",xo(n,o,s),"diagnostics.lab.chart.currentAria");if(s.truncated){let k=document.createElement("div");k.className="lab-chart-warn",k.textContent=d("diagnostics.lab.res.ringWarn",{n:2e3,s:s.window_ms/1e3}),c.appendChild(k)}if(!e.length){let k=document.createElement("div");k.className="lab-empty",k.textContent=d("diagnostics.lab.empty"),c.appendChild(k),t.appendChild(c);return}let p=e.map(k=>k.current_ma).filter(Number.isFinite),g=(a||[]).map(k=>k.value).filter(Number.isFinite),l=no(p.concat([0,40],g),0,50);l.min=0;let m=e[0].t_ms,u=Math.max(1,e[e.length-1].t_ms-m),f=k=>ne.l+(e[k].t_ms-m)/u*Re,b=e.map((k,T)=>({x:f(T),y:vt(k.current_ma,l)})),y=G("svg",{viewBox:"0 0 "+Rt+" "+Pt,role:"img"});if(oa(y,l),vo(y,m,u),r.overlays){let k={mean:ta,threshold:Ks,suggested:Gs,cap:Xs};(a||[]).forEach(T=>{let S=vt(T.value,l);y.appendChild(G("line",{x1:ne.l,x2:ne.l+Re,y1:S,y2:S,stroke:k[T.id],"stroke-dasharray":T.id==="mean"?"0":"5 4","stroke-width":T.id==="mean"?"1.4":"1.2","vector-effect":"non-scaling-stroke",opacity:T.id==="cap"?".45":".9"}))})}let v=o&&o.ok&&o.pin_seen?{t_ms:o.pin_t_ms,current_ma:o.pin_current_ma,motion_count:o.pin_motion_count,stroke_phase:1}:Yo(e);if(v&&Number.isFinite(v.t_ms)){let k=ne.l+(v.t_ms-m)/u*Re;y.appendChild(G("line",{x1:k,x2:k,y1:ne.t,y2:ne.t+xt,stroke:ho,"stroke-dasharray":"3 4","stroke-width":"1.4","vector-effect":"non-scaling-stroke",opacity:".95"})),y.appendChild(G("circle",{cx:k,cy:vt(Number(v.current_ma)||0,l),r:4.2,fill:ho,stroke:"var(--bg)","stroke-width":"1.5"})),y.appendChild(G("text",{class:"chart-tick",x:Math.min(k+6,ne.l+Re-64),y:ne.t+12,fill:ho},d("diagnostics.lab.pinMark")))}r.current&&y.appendChild(G("path",{d:gt(b),fill:"none",stroke:Jo,"stroke-width":"2.2","vector-effect":"non-scaling-stroke"})),c.appendChild(y),t.appendChild(c),bt(y,c,{count:e.length,plotTop:ne.t,plotBottom:ne.t+xt,xAt:f,label:k=>((e[k].t_ms-m)/1e3).toFixed(2)+" s",dots:k=>r.current?[{y:b[k].y,color:Jo}]:[],rows:k=>[{color:Jo,label:d("diagnostics.lab.currentMa"),value:Number(e[k].current_ma).toFixed(1)+" mA"},{color:ta,label:d("diagnostics.lab.motion"),value:String(e[k].motion_count)},{color:ho,label:d("diagnostics.lab.stroke"),value:d("diagnostics.lab.stroke."+Nt(e[k].stroke_phase))}]})}function ai(t,e,o,a){if(!a.phase)return;let n=Dt(e),r=Ot("diagnostics.lab.chart.phase",xo(o,null,n),"diagnostics.lab.chart.phaseAria");if(!e.length){let u=document.createElement("div");u.className="lab-empty",u.textContent=d("diagnostics.lab.empty"),r.appendChild(u),t.appendChild(r);return}let s=e[0].t_ms,c=Math.max(1,e[e.length-1].t_ms-s),p=Or+ne.b,g=G("svg",{viewBox:"0 0 "+Rt+" "+p,class:"lab-phase-strip",role:"img"});ei(g);let l=10,m=Or-18;Qs(e).forEach(u=>{let f=ne.l+(e[u.start].t_ms-s)/c*Re,b=ne.l+(e[u.end].t_ms-s)/c*Re,y=Nt(u.phase),v=Math.max(2,b-f);g.appendChild(G("rect",{x:f,y:l,width:v,height:m,fill:Ir[y]||Ir.free,stroke:"var(--separator)","stroke-width":"1"})),qr[y]&&g.appendChild(G("rect",{x:f,y:l,width:v,height:m,fill:"url(#"+qr[y]+")",opacity:".55"})),v>54&&g.appendChild(G("text",{x:f+6,y:l+m/2+3},d("diagnostics.lab.stroke."+y))),g.appendChild(G("line",{x1:b,x2:b,y1:l,y2:l+m,stroke:"var(--text-muted)","stroke-width":"1",opacity:".55"}))}),vo(g,s,c,p),r.appendChild(g),t.appendChild(r)}function ri(t,e,o,a){if(!a.cadence)return;let n=Dt(e),r=Ot("diagnostics.lab.chart.cadence",xo(o,null,n),"diagnostics.lab.chart.cadenceAria"),s=n.cadence.map(f=>f.rate_hz).filter(f=>f!=null&&Number.isFinite(f));if(!s.length){let f=document.createElement("div");f.className="lab-empty",f.textContent=d("diagnostics.lab.chart.cadenceEmpty"),r.appendChild(f),t.appendChild(r);return}let c=no(s.concat([0]),0,Math.max(10,...s));c.min=0;let p=e[0].t_ms,g=Math.max(1,e[e.length-1].t_ms-p),l=[],m=[];n.cadence.forEach((f,b)=>{f.rate_hz==null||!Number.isFinite(f.rate_hz)||(l.push({x:ne.l+(f.t_ms-p)/g*Re,y:vt(f.rate_hz,c)}),m.push(b))});let u=G("svg",{viewBox:"0 0 "+Rt+" "+Pt,role:"img"});oa(u,c),vo(u,p,g),u.appendChild(G("path",{d:gt(l),fill:"none",stroke:Qo,"stroke-width":"2","vector-effect":"non-scaling-stroke"})),r.appendChild(u),t.appendChild(r),bt(u,r,{count:l.length,plotTop:ne.t,plotBottom:ne.t+xt,xAt:f=>l[f].x,label:f=>((n.cadence[m[f]].t_ms-p)/1e3).toFixed(2)+" s",dots:f=>[{y:l[f].y,color:Qo}],rows:f=>{let b=n.cadence[m[f]];return[{color:Qo,label:d("diagnostics.lab.cadence"),value:b.rate_hz.toFixed(1)+" /s"},{color:ta,label:d("diagnostics.lab.tachoPeriod"),value:Math.round(b.period_us)+" \xB5s"}]}})}function ni(t,e,o,a,n){if(!n.slope)return;let r=Dt(e),s=Ot("diagnostics.lab.chart.slope",xo(a,o,r),"diagnostics.lab.chart.slopeAria");if(!r.slopes.length){let b=document.createElement("div");b.className="lab-empty",b.textContent=d("diagnostics.lab.chart.slopeEmpty"),s.appendChild(b),t.appendChild(s);return}let c=r.slopes.map(b=>b.slope),p=o&&o.ok?o.suggested_slope:null,g=no(c.concat(p!=null?[p,0]:[0]),-2,8),l=e[0].t_ms,m=Math.max(1,e[e.length-1].t_ms-l),u=r.slopes.map(b=>({x:ne.l+(b.t_ms-l)/m*Re,y:vt(b.slope,g)})),f=G("svg",{viewBox:"0 0 "+Rt+" "+Pt,role:"img"});if(oa(f,g),vo(f,l,m),p!=null){let b=vt(p,g);f.appendChild(G("line",{x1:ne.l,x2:ne.l+Re,y1:b,y2:b,stroke:Ys,"stroke-dasharray":"5 4","stroke-width":"1.3","vector-effect":"non-scaling-stroke"}))}f.appendChild(G("path",{d:gt(u),fill:"none",stroke:ea,"stroke-width":"2","vector-effect":"non-scaling-stroke"})),s.appendChild(f),t.appendChild(s),bt(f,s,{count:u.length,plotTop:ne.t,plotBottom:ne.t+xt,xAt:b=>u[b].x,label:b=>((r.slopes[b].t_ms-l)/1e3).toFixed(2)+" s",dots:b=>[{y:u[b].y,color:ea}],rows:b=>[{color:ea,label:d("diagnostics.lab.slope"),value:r.slopes[b].slope.toFixed(2)+" mA/s"}]})}function Br(t,e){let o=e&&e.samples||[],a=e&&e.analysis,n=!!(e&&e.live),r=e&&e.overlays,s=Object.assign({current:!0,overlays:!0,phase:!0,cadence:!0,slope:!0},e&&e.visible);t.innerHTML="";let c=document.createElement("div");c.className="motor-lab-charts";let p=document.createElement("div");return p.className="gw-controls",p.setAttribute("role","toolbar"),p.setAttribute("aria-label",d("diagnostics.lab.chart.layers")),[["current","diagnostics.lab.chart.layer.current"],["overlays","diagnostics.lab.chart.layer.overlays"],["phase","diagnostics.lab.chart.layer.phase"],["cadence","diagnostics.lab.chart.layer.cadence"],["slope","diagnostics.lab.chart.layer.slope"]].forEach(([l,m])=>{let u=document.createElement("button");u.type="button",u.className="gw-toggle"+(s[l]?"":" is-off"),u.dataset.layer=l,u.setAttribute("aria-pressed",s[l]?"true":"false"),u.textContent=d(m),p.appendChild(u)}),c.appendChild(p),o.length?(oi(c,o,a,r,n,s),ai(c,o,n,s),ri(c,o,n,s),ni(c,o,a,n,s)):ti(c,"diagnostics.lab.chart.current","diagnostics.lab.chartLive"),t.appendChild(c),p}var si=250,$r=2e4,It=["setup","arm","seat","open","close","review"],ii=`
...
`;function jr(t){return t==="open"?{factor:A(i.openThresholdMultiplier),slope:A(i.openSlopeThreshold),floor:A(i.openSlopeCurrentFactor),ripple:A(i.openRippleLimitFactor)}:{factor:A(i.closeThresholdMultiplier),slope:A(i.closeSlopeThreshold),floor:A(i.closeSlopeCurrentFactor)}}function qt(t){let e=jr(t.direction),o=t.direction==="open"?"open":"close",a=[{key:o+"_threshold_multiplier",labelKey:t.direction==="open"?"settings.motor.openThreshold":"settings.motor.closeThreshold",current:e.factor,suggested:t.suggested_factor,unit:"x"},{key:o+"_slope_threshold",labelKey:t.direction==="open"?"settings.motor.openSlope":"settings.motor.closeSlope",current:e.slope,suggested:t.suggested_slope,unit:"mA/s"},{key:o+"_slope_current_factor",labelKey:t.direction==="open"?"settings.motor.openSlopeFloor":"settings.motor.closeSlopeFloor",current:e.floor,suggested:t.suggested_slope_floor,unit:"x"}];return t.direction==="open"&&t.suggested_ripple_limit!=null&&a.push({key:"open_ripple_limit_factor",labelKey:"settings.motor.openRippleLimit",current:e.ripple,suggested:t.suggested_ripple_limit,unit:"x"}),a}function aa(t){return d(t?"common.on":"common.off")}function ra(){return{current:null,mean:null,peak:null,slope:null,runtime:0,motion:0,busy:!1,direction:"\u2014",stroke:0,pinSeen:!1,pinAt:null,pinMa:null,tachoPeriodUs:null,tachoCadenceUs:null,cadenceHz:null,faultCode:0,armed:!1,backend:"\u2014",invalidSamples:0,tachoRejected:0}}var Hd=P({tag:"diag-motor-lab",render:li,onMount(t,e){let o=Number(N("selectedZone")||1),a="setup",n="idle",r={active:!1,aborted:!1,direction:null,timer:null,live:[],started:0},s={open:null,close:null,seat:null},c={samples:[],analysis:null,live:!1},p={current:!0,overlays:!0,phase:!0,cadence:!0,slope:!0},g=[],l=ra(),m=e.querySelector(".lab-step-chip"),u=e.querySelector(".lab-zone-chip"),f=e.querySelector(".lab-banner"),b=e.querySelector(".lab-guide"),y=e.querySelector(".lab-kicker"),v=e.querySelector(".lab-stage h3"),k=e.querySelector(".lab-stage p"),T=e.querySelector(".lab-setup"),S=e.querySelector(".lab-zone"),D=e.querySelector(".lab-phase-label"),M=e.querySelector(".lab-log"),I=e.querySelector(".lab-chart"),K=e.querySelector(".lab-metrics"),j=e.querySelector(".lab-suggest"),R=e.querySelector(".lab-primary"),X=e.querySelector(".lab-secondary"),te=e.querySelector(".lab-estop"),H={current:e.querySelector('[data-k="current"]'),mean:e.querySelector('[data-k="mean"]'),peak:e.querySelector('[data-k="peak"]'),slope:e.querySelector('[data-k="slope"]'),runtime:e.querySelector('[data-k="runtime"]'),motion:e.querySelector('[data-k="motion"]'),cadence:e.querySelector('[data-k="cadence"]'),direction:e.querySelector('[data-k="direction"]'),drivers:e.querySelector('[data-k="drivers"]'),busy:e.querySelector('[data-k="busy"]'),stroke:e.querySelector('[data-k="stroke"]'),pin:e.querySelector('[data-k="pin"]'),armed:e.querySelector('[data-k="armed"]'),backend:e.querySelector('[data-k="backend"]'),fault:e.querySelector('[data-k="fault"]'),invalid:e.querySelector('[data-k="invalid"]'),tachoRejected:e.querySelector('[data-k="tachoRejected"]')};function C(E){return It.indexOf(E)}function w(){return Se(o)}function q(){let E=String(o);S.innerHTML=Array.from({length:6},(Y,oe)=>'<option value="'+(oe+1)+'">'+Se(oe+1).replace(/</g,"&lt;")+"</option>").join(""),S.value=E,S.setAttribute("aria-label",d("diagnostics.lab.motor")),u.textContent=w(),u.setAttribute("aria-label",d("diagnostics.lab.motor"))}function F(E,Y){let oe=new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"});g.push(oe+"  "+d(E,Y)),g.length>8&&g.shift(),M.innerHTML=g.map(se=>"<div>"+se+"</div>").join(""),M.scrollTop=M.scrollHeight}function ie(E){f.textContent=E||"",f.classList.toggle("show",!!E)}function ae(E,Y){n=E,D.dataset.kind=Y||"",D.textContent=d("diagnostics.lab.phase."+E)}function B(){let E=Nt(l.stroke);H.current.textContent=l.current==null?"\u2014":l.current.toFixed(1)+" mA",H.mean.textContent=l.mean==null?"\u2014":l.mean.toFixed(1)+" mA",H.peak.textContent=l.peak==null?"\u2014":l.peak.toFixed(1)+" mA",H.slope.textContent=l.slope==null?"\u2014":l.slope.toFixed(1)+" mA/s",H.runtime.textContent=l.runtime?(l.runtime/1e3).toFixed(1)+" s":"\u2014",H.motion.textContent=l.motion?String(l.motion):"\u2014",H.cadence.textContent=l.cadenceHz==null?"\u2014":l.cadenceHz.toFixed(1)+" /s",H.direction.textContent=l.direction,H.drivers.textContent=aa(ce(i.drivers)),H.busy.textContent=aa(l.busy),H.armed.textContent=aa(l.armed),H.backend.textContent=l.backend||"\u2014",H.fault.textContent=l.faultCode?String(l.faultCode):d("common.ok"),H.invalid.textContent=String(l.invalidSamples||0),H.tachoRejected.textContent=String(l.tachoRejected||0),H.stroke.textContent=d("diagnostics.lab.stroke."+E),H.stroke.dataset.phase=E,l.pinSeen?(H.pin.textContent=d("diagnostics.lab.pinSeen",{count:l.pinAt}),H.pin.dataset.seen="true"):(H.pin.textContent=d("diagnostics.lab.pinWaiting"),H.pin.dataset.seen="false")}function me(){let E=c.analysis?Pr(c.analysis,jr(c.analysis.direction)):[],Y=Br(I,{samples:c.samples,analysis:c.analysis,live:c.live,overlays:E,visible:p});Y&&Y.addEventListener("click",oe=>{let se=oe.target.closest(".gw-toggle");if(!se)return;let W=se.dataset.layer;p[W]=!p[W],Object.keys(p).some(fe=>p[fe])||(p[W]=!0),me()})}function be(E,Y,oe){c={analysis:E&&E.ok?E:null,samples:Y||[],live:!!oe},c.analysis&&(l.mean=c.analysis.mean_ma,l.peak=c.analysis.peak_ma,l.slope=c.analysis.max_stall_slope_ma_s),me();let se=[];if(a==="review"?(s.open&&se.push(...qt(s.open)),s.close&&se.push(...qt(s.close))):c.analysis&&se.push(...qt(c.analysis)),!c.analysis&&a!=="review"){K.innerHTML="",j.hidden=!0;return}let W=a==="review"?s.close||s.open:c.analysis;if(!W){K.innerHTML="",j.hidden=!0;return}let pe=W.pin_seen?d("diagnostics.lab.pinMetric",{ms:W.pin_t_ms,count:W.pin_motion_count}):d("diagnostics.lab.pinWaiting"),fe=[[d("diagnostics.lab.mean"),W.mean_ma.toFixed(1)+" mA"],[d("diagnostics.lab.peak"),W.peak_ma.toFixed(1)+" mA"],[d("diagnostics.lab.runtime"),(W.runtime_ms/1e3).toFixed(1)+" s"],[d("diagnostics.lab.ripples"),String(W.ripples)],[d("diagnostics.lab.pin"),pe]];if(a==="review"&&s.open&&s.close){fe[0]=[d("diagnostics.lab.mean"),s.open.mean_ma.toFixed(1)+" / "+s.close.mean_ma.toFixed(1)+" mA"],fe[1]=[d("diagnostics.lab.peak"),s.open.peak_ma.toFixed(1)+" / "+s.close.peak_ma.toFixed(1)+" mA"];let de=s.close.pin_seen?d("diagnostics.lab.pinMetric",{ms:s.close.pin_t_ms,count:s.close.pin_motion_count}):d("diagnostics.lab.pinWaiting");fe[4]=[d("diagnostics.lab.pin"),de]}K.innerHTML=fe.map(de=>'<div class="lab-metric"><span>'+de[0]+"</span><strong>"+de[1]+"</strong></div>").join(""),j.querySelector("tbody").innerHTML=se.map(de=>"<tr><td>"+d(de.labelKey)+"</td><td>"+Number(de.current).toFixed(1)+" "+de.unit+'</td><td class="better">'+Number(de.suggested).toFixed(1)+" "+de.unit+"</td></tr>").join(""),j.hidden=!se.length}function re(){let E=a==="halted",Y=E?"setup":a,oe=C(Y),se=E?"halted":"active";m.dataset.state=se,m.textContent=E?d("diagnostics.lab.halted"):d("diagnostics.lab.stepChip",{step:oe+1,total:It.length,name:d("diagnostics.lab.steps."+Y)}),y.textContent=E?d("diagnostics.lab.halted"):d("diagnostics.lab.stepOf",{step:oe+1,total:It.length}),v.textContent=d("diagnostics.lab."+(E?"halt":Y)+".title");let W=a==="seat"&&s.seat||a==="open"&&s.open||a==="close"&&s.close,pe=E?"diagnostics.lab.halt.copy":W?"diagnostics.lab."+Y+".done":"diagnostics.lab."+Y+".copy";k.textContent=d(pe);let fe=a==="setup";b.dataset.setup=fe?"true":"false",T.hidden=!fe,S.disabled=!fe||r.active,u.hidden=fe,u.textContent=w(),te.dataset.armed=r.active?"true":"false",B();let de=r.active,_e={key:"diagnostics.lab.next",disabled:de,action:"next"},Be=null;a==="setup"?_e={key:"diagnostics.lab.setup.action",disabled:!1,action:"start"}:a==="arm"?_e={key:"diagnostics.lab.arm.action",disabled:de,action:"arm"}:a==="seat"?_e={key:s.seat?"diagnostics.lab.next":"diagnostics.lab.seat.action",disabled:de,action:s.seat?"next":"seat"}:a==="open"?_e={key:s.open?"diagnostics.lab.next":"diagnostics.lab.open.action",disabled:de,action:s.open?"next":"open"}:a==="close"?_e={key:s.close?"diagnostics.lab.next":"diagnostics.lab.close.action",disabled:de,action:s.close?"next":"close"}:a==="review"?(_e={key:"diagnostics.lab.apply",disabled:!(s.open||s.close),action:"apply"},Be={key:"diagnostics.lab.restart",action:"restart"}):E&&(_e={key:"diagnostics.lab.restart",disabled:!1,action:"restart"}),de&&(_e={key:"diagnostics.lab.runningAction",disabled:!0,action:"none"}),!de&&(a==="seat"||a==="open"||a==="close")&&!s[a==="seat"?"seat":a]&&n==="failed"&&(_e={key:"diagnostics.lab.retry",disabled:!1,action:a}),!de&&W&&(a==="seat"||a==="open"||a==="close")&&(Be={key:"diagnostics.lab.restart",action:"restart"}),R.dataset.action=_e.action,R.disabled=!!_e.disabled,R.textContent=d(_e.key),Be?(X.hidden=!1,X.dataset.action=Be.action,X.textContent=d(Be.key)):(X.hidden=!0,X.dataset.action="")}function Fe(){r.timer&&clearInterval(r.timer),r.timer=null}function he(E){if(a=E,(E==="arm"||E==="setup")&&ie(""),E==="review"){let Y=s.close||s.open;be(Y,Y?Y.samples:[],!1),ae("done","ok")}else E==="setup"&&be(null,[],!1);re()}async function Xe(){if(!r.active){r.active=!0,ae("arming","run"),re(),F("diagnostics.lab.log.arming",{zone:o});try{if(N("manualMode")||(Te("manualMode",!0),await Ct(!0),F("diagnostics.lab.log.manual")),r.aborted||(ce(i.drivers)||(await _t(!0),F("diagnostics.lab.log.drivers")),r.aborted))return;l.busy=!1,l.armed=!0,ae("armed","ok"),F("diagnostics.lab.log.armed"),r.active=!1,he("seat")}catch(E){r.active=!1,ae("failed","halt"),F("diagnostics.lab.log.armFailed"),re()}}}async function it(E,Y,oe){ae("analyzing","run"),re();let se=Nr(E),W=Rr(se,Y),pe=W.ok?W.samples:se;if(oe&&(s[oe]=W.ok?W:null),be(W,pe,!1),!W.ok)ae("failed","halt"),F(oe==="seat"?"diagnostics.lab.log.seatShort":"diagnostics.lab.log.weak"),oe==="seat"&&(s.seat={short:!0},F("diagnostics.lab.log.seatContinue"));else if(ae("done","ok"),F("diagnostics.lab.log.captured",{direction:d("diagnostics.lab.dir."+W.direction),peak:W.peak_ma.toFixed(1)}),W.pin_seen){let fe=l.pinSeen;l.pinSeen=!0,l.pinAt=W.pin_motion_count,l.pinMa=W.pin_current_ma,l.stroke=1,fe||F("diagnostics.lab.log.pinTrace",{count:W.pin_motion_count,ma:W.pin_current_ma.toFixed(1),ms:W.pin_t_ms})}else(oe==="close"||oe==="seat")&&F("diagnostics.lab.log.pinMissing")}async function He(E,Y){for(let oe=0;oe<6;oe++){if(r.aborted)return;try{ae("fetching","run"),re();let se=await Na();F("diagnostics.lab.log.trace"),await it(se,E,Y);return}catch(se){if(se&&se.code==="motor_busy"){await new Promise(W=>setTimeout(W,250));continue}ae("failed","halt"),F("diagnostics.lab.log.traceFailed"),be(null,r.live,!0);return}}ae("failed","halt")}function lt(E){let Y=E.map(se=>se.current_ma).filter(Number.isFinite);if(!Y.length)return;let oe=Y.reduce((se,W)=>se+W,0);if(l.mean=Math.round(oe/Y.length*10)/10,l.peak=Math.round(Math.max(...Y)*10)/10,E.length>=2){let se=E[Math.max(0,E.length-3)],W=E[E.length-1],pe=(W.t_ms-se.t_ms)/1e3;pe>.05&&(l.slope=Math.round((W.current_ma-se.current_ma)/pe*10)/10)}}async function qe(E,Y){if(!r.active){r={active:!0,aborted:!1,direction:E,timer:null,live:[],started:Date.now()},l=ra(),l.direction=d("diagnostics.lab.dir."+E),ae("starting","run"),re(),be(null,[],!0),F("diagnostics.lab.log.starting",{direction:d("diagnostics.lab.dir."+E),zone:o});try{if(E==="open"?await Qt(o,1e4):await eo(o,1e4),r.aborted)return;ae("waiting","run"),re();let oe=!1,se=async()=>{if(!r.aborted)try{let W=await Ta(),pe=W&&W.data&&W.data.motor_safety?W.data.motor_safety:{},fe=Number(pe.current_ma),de=!!pe.motor_busy,_e=pe.drive_on!=null?!!pe.drive_on:de;de&&!oe&&(oe=!0,ae("running","run"),F("diagnostics.lab.log.busy")),l.busy=de,l.runtime=Date.now()-r.started,l.motion=Number(pe.motion_evidence_count)||l.motion,l.stroke=Number(pe.stroke_phase)||0,l.tachoPeriodUs=Number(pe.tacho_period_us)||l.tachoPeriodUs,l.tachoCadenceUs=Number(pe.tacho_cadence_us)||l.tachoCadenceUs;let Be=l.tachoPeriodUs||l.tachoCadenceUs;l.cadenceHz=Be>0?1e6/Be:null,l.faultCode=Number(pe.fault_code)||0,l.armed=!!pe.armed,l.backend=pe.backend||l.backend,l.invalidSamples=Number(pe.invalid_samples)||0,l.tachoRejected=Number(pe.tacho_rejected)||0,!l.pinSeen&&(l.stroke===1||l.stroke===2)&&(l.pinSeen=!0,l.pinAt=l.motion,l.pinMa=Number.isFinite(fe)?fe:l.current,F("diagnostics.lab.log.pin",{count:l.pinAt,ma:Number(l.pinMa||0).toFixed(1)})),Number.isFinite(fe)&&(l.current=fe,r.live.push({t_ms:Date.now()-r.started,current_ma:fe,motion_count:l.motion,drive_on:_e,direction_open:E==="open",stroke_phase:l.stroke,tacho_period_us:l.tachoPeriodUs,tacho_cadence_us:l.tachoCadenceUs,armed:l.armed,fault_code:l.faultCode,backend:l.backend}),lt(r.live),be(null,r.live,!0)),B(),(oe&&!de||Date.now()-r.started>$r)&&(Fe(),l.busy=!1,oe&&F("diagnostics.lab.log.stopped"),r.active=!1,await He(E,Y),re())}catch(W){Date.now()-r.started>$r&&(Fe(),r.active=!1,ae("failed","halt"),F("diagnostics.lab.log.traceFailed"),re())}};r.timer=setInterval(se,si),se()}catch(oe){r.active=!1,ae("failed","halt"),F("diagnostics.lab.log.startFailed"),re()}}}function wt(){Fe(),r={active:!1,aborted:!1,direction:null,timer:null,live:[],started:0},s={open:null,close:null,seat:null},l=ra(),g.length=0,M.innerHTML="",ie(""),ae("idle"),he("setup")}async function Bt(){r.aborted=!0,r.active=!1,Fe(),l.busy=!1,ie(d("diagnostics.lab.estopDone")),ae("halted","halt"),F("diagnostics.lab.log.estop"),a="halted",re();try{await Fa()}catch(E){}B()}function ko(){let E=C(a);E<0||E>=It.length-1||he(It[E+1])}function Ye(E){if(E==="start"){F("diagnostics.lab.log.selected",{zone:o}),he("arm");return}if(E==="arm")return Xe();if(E==="seat")return qe("close","seat");if(E==="open")return qe("open","open");if(E==="close")return qe("close","close");if(E==="next")return ko();if(E==="restart")return wt();if(E==="apply"){let Y=[];s.open&&Y.push(...qt(s.open)),s.close&&Y.push(...qt(s.close)),Y.forEach(oe=>Me(oe.key,oe.suggested)),ae("applied","ok"),F("diagnostics.lab.log.applied"),re()}}R.addEventListener("click",()=>Ye(R.dataset.action)),X.addEventListener("click",()=>Ye(X.dataset.action)),te.addEventListener("click",Bt),S.addEventListener("change",()=>{o=Number(S.value||1),u.textContent=w()});function ct(E){E.key==="Escape"&&N("section")==="motorlab"&&(E.preventDefault(),Bt())}window.addEventListener("keydown",ct),q(),ae("idle"),be(null,[],!1),re(),z(i.drivers,B),Z("manualMode",B),Z("selectedZone",()=>{a==="setup"&&(o=Number(N("selectedZone")||o),S.value=String(o))}),L(e)}});var ci=`
...
`,Kd=P({tag:"diag-system-card",render:di,onMount(t,e){let o=e.querySelector('[data-k="cpu0"]'),a=e.querySelector('[data-k="cpu1"]'),n=e.querySelector('[data-k="heap"]'),r=e.querySelector('[data-k="psram"]'),s=e.querySelector('[data-bar="cpu0"]'),c=e.querySelector('[data-bar="cpu1"]'),p=e.querySelector('[data-k="reset"]'),g=(u,f,b)=>{if(b==null||!Number.isFinite(Number(b))){u.textContent="\u2014",u.classList.remove("warn"),f.style.width="0%";return}let y=Math.max(0,Math.min(100,Number(b)));u.textContent=y.toFixed(0)+"%",u.classList.toggle("warn",y>=90),f.style.width=y+"%"},l=(u,f,b)=>{if(f==null||!Number.isFinite(Number(f))){u.textContent="\u2014";return}let y=Number(f);u.textContent=y+" KB",u.classList.toggle("warn",b!=null&&y<b)},m=()=>{g(o,s,A(i.cpuLoadCore0)),g(a,c,A(i.cpuLoadCore1)),l(n,A(i.freeInternalKb),48),l(r,A(i.freePsramKb),null);let u=String(_(i.resetReason)||N("resetReason")||"").trim();p.textContent=u||"\u2014"};e.querySelector(".sys-dump").addEventListener("click",()=>{Oa().catch(u=>console.error("[System] dump failed:",u))}),z(i.cpuLoadCore0,m),z(i.cpuLoadCore1,m),z(i.freeInternalKb,m),z(i.freePsramKb,m),z(i.resetReason,m),Z("resetReason",m),L(e),m()}});var pi=`
...
`;O("settings-manifold-card",pi);var ui=()=>{let t="";for(let o=1;o<=8;o++)t+="<option>Probe "+o+"</option>";let e="";for(let o=1;o<=8;o++)e+='<div class="probe-cell"><div class="probe-name">Probe '+o+'</div><div class="probe-temp" data-probe="'+o+'">---</div></div>';return`
  ...
  `},rp=P({tag:"settings-manifold-card",render:ui,onMount(t,e){let o=e.querySelector(".sm-type"),a=e.querySelector(".sm-flow"),n=e.querySelector(".sm-ret"),r=xe(e);r.select(o,{read:()=>_(i.manifoldType)||"NO (Normally Open)",commit:c=>Ae("manifold_type",c)}),r.select(a,{read:()=>_(i.manifoldFlowProbe)||"Probe 7",commit:c=>Ae("manifold_flow_probe",c)}),r.select(n,{read:()=>_(i.manifoldReturnProbe)||"Probe 8",commit:c=>Ae("manifold_return_probe",c)});function s(){for(let c=1;c<=8;c++){let p=e.querySelector('[data-probe="'+c+'"]');p&&(p.textContent=ue(A(h.probeTemp(c))))}}z(i.manifoldType,r.refresh),z(i.manifoldFlowProbe,r.refresh),z(i.manifoldReturnProbe,r.refresh);for(let c=1;c<=8;c++)z(h.probeTemp(c),s);L(e),r.refresh(),s()}});var mi=`
...
`;O("settings-touch-card",mi);var gi=()=>`
...
`,xp=P({tag:"settings-minimum-flow-card",render:bi,onMount(t,e){let o=e.querySelector(".smf-always"),a=e.querySelector(".smf-pct"),n=e.querySelector(".smf-pct-row"),r=xe(e),s=c=>{n.hidden=!c,n.setAttribute("aria-hidden",c?"false":"true"),a.disabled=!c};r.toggle(o,{read:()=>ce(i.minimumFlowAlways),onChange:s,commit:c=>{let p=c?"on":"off";x(i.minimumFlowAlways,{state:p}),Ae("minimum_flow_always",p).catch(()=>x(i.minimumFlowAlways,{state:c?"off":"on"}))}}),r.num(a,{read:()=>A(i.minZoneFlowPct),commit:c=>{x(i.minZoneFlowPct,{value:c}),Me("min_zone_flow_pct",c)}}),z(i.minimumFlowAlways,r.refresh),z(i.minZoneFlowPct,r.refresh),L(e),r.refresh()}});var fi=`
...
`;O("settings-return-temp-card",fi);function nt(t){return!!(t&&t!=="None")}function hi(t){return"Probe "+t}function vi(){for(let t=1;t<=6;t++)if(nt(_(h.probe(t))))return!0;return!1}function xi(){let t="";for(let e=1;e<=8;e++)t+='<option value="Probe '+e+'">Probe '+e+"</option>";return t}var yi=()=>{let t=xi(),e="";for(let o=1;o<=6;o++)e+=`
  ...
  `},Mp=P({tag:"settings-return-temp-card",render:yi,onMount(t,e){let o=e.querySelector(".srt-enabled"),a=e.querySelector(".srt-zones"),n=Array.from(e.querySelectorAll(".srt-probe")),r=Object.create(null);function s(m){return r[m]||hi(m)}function c(m){a.hidden=!m,a.setAttribute("aria-hidden",m?"false":"true");for(let u of n)u.disabled=!m}function p(){for(let m=1;m<=6;m++){let u=e.querySelector('[data-zone-label="'+m+'"]');u&&(u.innerHTML=Oe(m))}}let g=xe(e),l;for(let m of n){let u=Number(m.dataset.zone);g.select(m,{read:()=>{let f=_(h.probe(u));return nt(f)?(r[u]=f,f):s(u)},commit:f=>{!l||!l.staged||(r[u]=f,Ve(u,"zone_probe",f))}})}l=g.toggle(o,{read:()=>vi(),onChange:m=>{if(m)for(let u of n){let f=Number(u.dataset.zone);nt(u.value)||(u.value=s(f)),nt(u.value)&&(r[f]=u.value)}else for(let u of n){let f=Number(u.dataset.zone);nt(u.value)&&(r[f]=u.value)}c(m)},commit:m=>{if(!m){for(let u of n){let f=Number(u.dataset.zone);nt(u.value)&&(r[f]=u.value),Ve(f,"zone_probe","None")}return}for(let u of n){let f=Number(u.dataset.zone),b=nt(u.value)?u.value:s(f);r[f]=b,Ve(f,"zone_probe",b)}}});for(let m=1;m<=6;m++)z(h.probe(m),g.refresh),z(h.name(m),p);L(e),p(),g.refresh()}});var wi=[{value:"15",labelKey:"settings.bleClock.interval15"},{value:"60",labelKey:"settings.bleClock.interval60"},{value:"360",labelKey:"settings.bleClock.interval360"},{value:"1440",labelKey:"settings.bleClock.interval1440"}];function ki(){if(String(_(i.bleClockSyncAdvertising)||"").toLowerCase()==="on")return d("common.clockSyncing");let t=String(_(i.bleClockSyncLastError)||"").trim();if(t==="clock_invalid")return d("settings.bleClock.waitingClock");if(t==="ble_busy")return d("settings.bleClock.busy");if(t)return t;let e=Number(A(i.bleClockSyncLastOkS)||0);if(!e)return d("settings.bleClock.never");let o=Math.max(0,Math.round(Date.now()/1e3)-e);if(o<60)return d("common.secondsAgo",{value:o});if(o<3600)return d("common.minutesAgo",{value:Math.round(o/60)});let a=Math.round(o/3600);return d("settings.bleClock.hoursAgo",{value:a})}var zi=()=>`
...
`,Pp=P({tag:"settings-ble-clock-card",render:zi,onMount(t,e){let o=e.querySelector(".sbc-enabled"),a=e.querySelector(".sbc-interval"),n=e.querySelector(".sbc-status"),r=e.querySelector(".sbc-now"),s=xe(e),c=()=>{let g=a.value;a.innerHTML=wi.map(l=>`<option value="${l.value}">${d(l.labelKey)}</option>`).join(""),g&&(a.value=g)},p=()=>{n.textContent=ki()};c(),s.toggle(o,{read:()=>ce(i.bleClockSyncEnabled),commit:g=>{let l=g?"on":"off";x(i.bleClockSyncEnabled,{state:l}),Ae("ble_clock_sync_enabled",l).catch(()=>x(i.bleClockSyncEnabled,{state:g?"off":"on"}))}}),s.select(a,{read:()=>String(Math.round(Number(A(i.bleClockSyncIntervalMin))||60)),commit:g=>{let l=Number(g);x(i.bleClockSyncIntervalMin,{value:l}),Me("ble_clock_sync_interval_min",l)}}),r.addEventListener("click",()=>{x(i.bleClockSyncAdvertising,{state:"on"}),p(),Le("ble_clock_sync_now")}),z(i.bleClockSyncEnabled,s.refresh),z(i.bleClockSyncIntervalMin,s.refresh),z(i.bleClockSyncLastOkS,p),z(i.bleClockSyncLastError,p),z(i.bleClockSyncAdvertising,p),L(e),s.refresh(),p()}});var Si=`
...
`;O("settings-control-card",Si);var _i=()=>`
...
`,$p=P({tag:"settings-control-card",render:_i,onMount(t,e){L(e),e.querySelector(".sc-reset-probe-map").addEventListener("click",()=>{window.confirm("Reset the 1-Wire probe map and restart V6? Probe assignments must be discovered again.")&&Le("reset_1wire_probe_map_reboot")}),e.querySelector(".sc-dump-1wire").addEventListener("click",()=>{Le("dump_1wire_probe_diagnostics")}),e.querySelector(".sc-restart").addEventListener("click",()=>{window.confirm("Restart Lune V6 now? Heating continues after the controller has started again.")&&Le("restart")})}});var Ci=`
...
`;O("settings-motor-calibration-card",Ci);var yo=[{cls:"safe-runtime",key:"generic_runtime_limit_seconds",id:i.genericRuntimeLimitSeconds,labelKey:"settings.motor.maxSafeRuntime",unit:"s"},{cls:"close-threshold",key:"close_threshold_multiplier",id:i.closeThresholdMultiplier,labelKey:"settings.motor.closeThreshold",unit:"x"},{cls:"close-slope-threshold",key:"close_slope_threshold",id:i.closeSlopeThreshold,labelKey:"settings.motor.closeSlope",unit:"mA/s"},{cls:"close-slope-floor",key:"close_slope_current_factor",id:i.closeSlopeCurrentFactor,labelKey:"settings.motor.closeSlopeFloor",unit:"x"},{cls:"open-threshold",key:"open_threshold_multiplier",id:i.openThresholdMultiplier,labelKey:"settings.motor.openThreshold",unit:"x"},{cls:"open-slope-threshold",key:"open_slope_threshold",id:i.openSlopeThreshold,labelKey:"settings.motor.openSlope",unit:"mA/s"},{cls:"open-slope-floor",key:"open_slope_current_factor",id:i.openSlopeCurrentFactor,labelKey:"settings.motor.openSlopeFloor",unit:"x"},{cls:"open-ripple-limit",key:"open_ripple_limit_factor",id:i.openRippleLimitFactor,labelKey:"settings.motor.openRippleLimit",unit:"x"},{cls:"relearn-movements",key:"relearn_after_movements",id:i.relearnAfterMovements,labelKey:"settings.motor.relearnMovements",unit:"count"},{cls:"relearn-hours",key:"relearn_after_hours",id:i.relearnAfterHours,labelKey:"settings.motor.relearnHours",unit:"h"},{cls:"learn-min-samples",key:"learned_factor_min_samples",id:i.learnedFactorMinSamples,labelKey:"settings.motor.learnMinSamples",unit:"count"},{cls:"learn-max-deviation",key:"learned_factor_max_deviation_pct",id:i.learnedFactorMaxDeviationPct,labelKey:"settings.motor.learnMaxDeviation",unit:"%"}],Li=()=>{let t="";for(let e=0;e<yo.length;e++){let o=yo[e];if(o.key==="generic_runtime_limit_seconds")continue;let a=Mi(o.key)?"1":"0.1";t+='<div class="ui-row"><span class="ui-label"><span data-i18n="'+o.labelKey+'">'+d(o.labelKey)+"</span> ("+o.unit+')</span><span class="ui-field"><input type="number" class="ui-input smc-'+o.cls+'" value="0" step="'+a+'"></span></div>'}return`
  ...
  `};function Mi(t){return t==="learned_factor_min_samples"||t==="generic_runtime_limit_seconds"||t==="relearn_after_movements"||t==="relearn_after_hours"}var Yp=P({tag:"settings-motor-calibration-card",render:Li,onMount(t,e){let o=e.querySelector(".smc-profile"),a=e.querySelector(".smc-safe-runtime"),n=e.querySelector(".mc-drivers-toggle"),r=xe(e);function s(p){if(p==="HmIP VdMot"&&Me("hmip_runtime_limit_seconds",40),p==="Generic"){let g=Number(A(i.genericRuntimeLimitSeconds));(!Number.isFinite(g)||g<=0)&&Me("generic_runtime_limit_seconds",45)}}r.toggle(n,{read:()=>ce(i.drivers),commit:p=>_t(p)}),r.select(o,{read:()=>_(i.motorProfileDefault)||"HmIP VdMot",commit:p=>{Ae("motor_profile_default",p),s(p)}});function c(){let p=_(i.motorProfileDefault)||"HmIP VdMot";a.disabled=p==="HmIP VdMot"}r.num(a,{read:()=>(_(i.motorProfileDefault)||"HmIP VdMot")==="HmIP VdMot"?40:A(i.genericRuntimeLimitSeconds),commit:p=>{o.value==="Generic"&&Me("generic_runtime_limit_seconds",p)}});for(let p=0;p<yo.length;p++){let g=yo[p];if(g.key==="generic_runtime_limit_seconds")continue;let l=e.querySelector(".smc-"+g.cls);l&&(r.num(l,{read:()=>A(g.id),commit:m=>Me(g.key,m)}),z(g.id,r.refresh))}z(i.drivers,r.refresh),z(i.motorProfileDefault,()=>{r.refresh(),c()}),z(i.genericRuntimeLimitSeconds,r.refresh),z(i.hmipRuntimeLimitSeconds,r.refresh),L(e),s(_(i.motorProfileDefault)||"HmIP VdMot"),r.refresh(),c()}});var Ai=600*1e3,Vr=600,Ei=`
...
`;O("settings-firmware-card",Ei);var Fi=()=>`
...
`;function Zr(t){let e=String(t||"").trim().replace(/^v/i,"").match(/^(\d+)\.(\d+)\.(\d+)/);return e?[Number(e[1]),Number(e[2]),Number(e[3])]:null}function Ht(t,e){let o=Zr(t);if(!o)return!1;let a=Zr(e);if(!a)return!0;for(let n=0;n<3;n++)if(o[n]!==a[n])return o[n]>a[n];return!1}function Ur(t){return String(t).replace(/[&<>]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[e])}function Ti(t){let e=String(t||"").trim();return e.length<=Vr?e:e.slice(0,Vr).replace(/\s+\S*$/,"")+"\u2026"}function Ni(){let t=document.querySelector(".settings-backup-card");if(!t)return;let e=t.closest("details");e&&(e.open=!0),t.scrollIntoView({behavior:"smooth",block:"center"});let o=t.querySelector(".sbk-save");o&&o.focus({preventScroll:!0})}var su=P({tag:"settings-firmware-card",render:Fi,onMount(t,e){let o=e.querySelector(".sfw-version"),a=e.querySelector(".sfw-status"),n=e.querySelector(".sfw-check"),r=e.querySelector(".sfw-banner"),s=e.querySelector(".sfw-hop"),c=e.querySelector(".sfw-notes"),p=e.querySelector(".sfw-install"),g=e.querySelector(".sfw-asset"),l=e.querySelector(".sfw-jump"),m=e.querySelector(".sfw-file"),u=e.querySelector(".sfw-choose"),f=e.querySelector(".sfw-upload"),b=e.querySelector(".sfw-filename"),y=e.querySelector(".sfw-progress"),v=y.querySelector("i"),k=e.querySelector(".sfw-upload-status"),T=null,S=!1,D=0,M=!1,I=()=>_(i.firmware)||N("firmwareVersion")||"",K=(C,w)=>{a.textContent=C||"",a.className="ui-sublabel sfw-status"+(w?" "+w:"")},j=()=>{let C=dt.firmware_update;if(!C||C.available!==!0)return null;let w=String(C.latest||"").trim();return w?{tag:w,notes:d("settings.firmware.deviceReported"),asset:Io(w)}:null},R=()=>{let C=j();return T?C&&Ht(C.tag,T.tag)?C:T:C},X=()=>{o.textContent=I()||d("settings.firmware.unknownVersion")},te=()=>{let C=R(),w=!!C&&Ht(C.tag,I());if(r.hidden=!w,!w){Te("firmwareUpdateAvailable",null);return}s.innerHTML=Ur(I()||d("settings.firmware.unknownVersion"))+" <span>\u2192</span> "+Ur(C.tag),c.textContent=Ti(C.notes)||d("common.noData"),g.href=C.asset.url,g.setAttribute("download",C.asset.name),g.title=C.asset.name,Te("firmwareUpdateAvailable",{current:I(),latest:C.tag,url:C.asset.url})},H=C=>{S||!C&&D&&Date.now()-D<Ai||(S=!0,D=Date.now(),n.disabled=!0,K(d("settings.firmware.checking")),Promise.resolve(Ia()).catch(()=>{}),Ba().then(w=>{T=w,te();let q=Ht(w.tag,I());K(q?d("settings.firmware.availableStatus",{version:w.tag}):d("settings.firmware.upToDate"),q?null:"ok")}).catch(w=>{T=null,te();let q=j();if(q){K(Ht(q.tag,I())?d("settings.firmware.availableStatus",{version:q.tag}):d("settings.firmware.upToDate"),Ht(q.tag,I())?null:"ok");return}if((w instanceof je?w.code:"network")==="no_releases"){K(d("settings.firmware.noReleases"),"ok");return}K(d("settings.firmware.checkFailed"),"err")}).finally(()=>{S=!1,n.disabled=!1}))};n.addEventListener("click",()=>H(!0)),l.addEventListener("click",Ni),p.addEventListener("click",()=>{let C=R();C&&window.confirm(d("settings.firmware.confirmInstall",{version:C.tag}))&&(p.disabled=!0,p.textContent=d("settings.firmware.installing"),Promise.resolve(qa()).then(()=>K(d("settings.firmware.installStarted"))).catch(()=>{K(d("settings.firmware.installFailed"),"err"),p.disabled=!1,p.textContent=d("settings.firmware.install")}))}),u.addEventListener("click",()=>m.click()),m.addEventListener("change",()=>{let C=m.files&&m.files[0];b.textContent=C?C.name:d("settings.firmware.noFile"),f.disabled=!C||M,k.textContent="",k.className="ui-note sfw-upload-status"}),f.addEventListener("click",()=>{let C=m.files&&m.files[0];!C||M||window.confirm(d("settings.firmware.confirmUpload",{file:C.name}))&&(M=!0,f.disabled=!0,u.disabled=!0,y.hidden=!1,v.style.width="0%",k.className="ui-note sfw-upload-status",k.textContent=d("settings.firmware.uploading",{value:0}),Promise.resolve(Ha()).catch(w=>console.warn("[Firmware] prepare rejected, continuing with upload:",w)).then(()=>$a(C,w=>{v.style.width=w+"%",k.textContent=d("settings.firmware.uploading",{value:w})})).then(()=>{v.style.width="100%",k.className="ui-note sfw-upload-status",k.textContent=d("settings.firmware.uploadDone")}).catch(w=>{console.error("[Firmware] upload failed:",w),y.hidden=!0,k.textContent=d("settings.firmware.uploadFailed")}).finally(()=>{M=!1,u.disabled=!1,f.disabled=!1}))}),Z("section",()=>{N("section")==="settings"&&H(!1)}),z(i.firmware,()=>{X(),te()}),z("firmware_update",te),L(e),X(),N("section")==="settings"&&H(!1)}});var Di=`
...
`;O("settings-backup-card",Di);var Ri=()=>`
...
`;O("smart-preheat-card",Hi);var Bi=()=>`
...
`,Au=P({tag:"smart-preheat-card",render:Bi,onMount(t,e){let o=e.querySelector(".absorb-toggle"),a=e.querySelector(".absorb-badge"),n=e.querySelector(".absorb-band"),r=e.querySelector(".absorb-delta"),s=e.querySelector(".absorb-body"),c=xe(e),p=l=>{s&&s.classList.toggle("is-disabled",!l)};c.toggle(o,{read:()=>ce(i.preheatAbsorbEnabled),onChange:p,commit:l=>{let m=l?"on":"off";x(i.preheatAbsorbEnabled,{state:m}),Ae("preheat_absorb_enabled",m)}}),c.num(n,{read:()=>A(i.preheatAbsorbBandC),commit:l=>{x(i.preheatAbsorbBandC,{value:l}),Me("preheat_absorb_band_c",l)}}),c.num(r,{read:()=>A(i.preheatDetectDeltaC),commit:l=>{x(i.preheatDetectDeltaC,{value:l}),Me("preheat_detect_delta_c",l)}});function g(){let l=String(_(i.preheatAbsorbing)||"").toLowerCase()==="active";a.textContent=l?d("common.active"):d("common.idle"),a.classList.toggle("active",l)}z(i.preheatAbsorbEnabled,c.refresh),z(i.preheatAbsorbing,g),z(i.preheatAbsorbBandC,c.refresh),z(i.preheatDetectDeltaC,c.refresh),L(e),c.refresh(),g()}});function Jr(t){let e=String(t||"").trim();return/^v?\d+\.\d+\.\d+-.+/.test(e)}na();var $i=`
...
<div class="ftr">Lune V6 \xB7 Local manifold controller</div></main></div></div></div>`;P({tag:"app-root",render:ji,onMount(t,e){e.querySelector(".hdr").appendChild(Q("hv6-header")),e.querySelector(".side-nav-slot").appendChild(Q("hv6-sidebar")),e.querySelector(".flow-diagram-slot").appendChild(Q("flow-diagram")),e.querySelector(".hydraulic-history-slot").appendChild(Q("graph-widgets",{variant:"flow-return"})),e.querySelector(".timeline-slot").appendChild(Q("zone-state-timeline")),e.querySelector(".connectivity-slot").appendChild(Q("connectivity-card")),e.querySelector(".zone-detail-slot").appendChild(Q("zone-detail",{zone:N("selectedZone")})),e.querySelector(".zone-sensor-slot").appendChild(Q("zone-sensor-card")),e.querySelector(".zone-coordination-slot").appendChild(Q("zone-coordination-card")),e.querySelector(".zone-actuator-slot").appendChild(Q("zone-actuator-card")),e.querySelector(".zone-room-slot").appendChild(Q("zone-room-card")),e.querySelector(".touch-slot").appendChild(Q("settings-touch-card")),e.querySelector(".manifold-slot").appendChild(Q("settings-manifold-card")),e.querySelector(".return-temp-slot").appendChild(Q("settings-return-temp-card")),e.querySelector(".minimum-flow-slot").appendChild(Q("settings-minimum-flow-card")),e.querySelector(".ble-clock-slot").appendChild(Q("settings-ble-clock-card")),e.querySelector(".preheat-slot").appendChild(Q("smart-preheat-card")),e.querySelector(".motor-slot").appendChild(Q("settings-motor-calibration-card")),e.querySelector(".firmware-slot").appendChild(Q("settings-firmware-card")),e.querySelector(".backup-slot").appendChild(Q("settings-backup-card")),e.querySelector(".appearance-slot").appendChild(Q("settings-appearance-card")),e.querySelector(".diag-actions-slot").appendChild(Q("settings-control-card")),e.querySelector(".manual-control-col").appendChild(Q("diag-manual-badge")),e.querySelector(".manual-control-col").appendChild(Q("diag-zone-motor-card",{zone:N("selectedZone")||1}));let o=e.querySelector(".motor-lab-slot"),a=e.querySelector('.sec[data-section="motorlab"]');function n(){let w=Jr(_(i.firmware)||N("firmwareVersion")),q=e.querySelector('.v6-side-link[data-section="motorlab"]');q&&(q.hidden=!w),a&&(a.hidden=!w),w&&o&&!o.firstChild&&o.appendChild(Q("diag-motor-lab")),!w&&N("section")==="motorlab"&&Pe("diagnostics")}z(i.firmware,n),Z("firmwareVersion",n),Z("section",n),n(),e.querySelector(".logs-main-col").appendChild(Q("logs-view")),e.querySelector(".system-health-slot").appendChild(Q("diag-system-card")),e.querySelector(".diag-health-slot").appendChild(Q("connectivity-card")),e.querySelector(".diag-health-slot").appendChild(Q("diag-i2c"));let r=e.querySelectorAll(".sec"),s=e.querySelector(".shell"),c=e.querySelector(".zone-detail-view"),p=e.querySelector(".selected-zone-title"),g=e.querySelector(".zone-overview-strip"),l=e.querySelector(".mobile-zone-dock"),m=e.querySelector(".mobile-zone-dock .zone-chipstrip");function u(w){let q=ce(h.enabled(w)),F=String(_(h.state(w))||"").toUpperCase()||"OFF",ie=String(_(h.motorLastFault(w))||"").toUpperCase();return q?q&&(F==="FAULT"||ie&&ie!=="NONE"&&ie!=="OK")?"FAULT":F:"OFF"}function f(w){return w==="HEATING"?d("state.heating"):w==="IDLE"?d("state.idle"):w==="FAULT"?d("common.fault"):w==="MANUAL"?d("state.manual"):w==="OVERHEATED"?d("state.overheated"):w==="CALIBRATING"?d("state.calibrating"):d("state.off")}function b(w){return w==="HEATING"||w==="CALLING"?"zs-heating":w==="FAULT"?"zs-fault":w==="IDLE"?"zs-idle":"zs-off"}function y(w){let q=String(w||"").trim();if(!q||/^none$/i.test(q)||q==="0"||q==="-1")return 0;let F=q.match(/(\d+)/),ie=F?Number(F[1]):0;return ie>=1&&ie<=6?ie:0}function v(){var ae;let w=[0,0,0,0,0,0,0];for(let B=1;B<=6;B++)w[B]=y(_(h.syncTo(B)));let q=[0,0,0,0,0,0,0];for(let B=1;B<=6;B++){let me=B;for(let be=0;be<6;be++){let re=w[me];if(!re||re<1||re>6)break;if(re===B){me=B;break}me=re}q[B]=me}let F={};for(let B=1;B<=6;B++)(F[ae=q[B]]||(F[ae]=[])).push(B);let ie=[[],[],[],[],[],[],[]];for(let B=1;B<=6;B++){let me=F[q[B]]||[B],be=me.length>1&&me.some(re=>w[re]>0);ie[B]=be?me.filter(re=>re!==B):[]}return{roots:q,partners:ie}}function k(){return window.matchMedia("(min-width: 901px)").matches}function T(){let w=v(),q=N("selectedZone")||1,F=k();g.setAttribute("role",F?"group":"list"),g.setAttribute("aria-label",F?"Select zone":"Zone status overview"),g.innerHTML=Array.from({length:6},(ie,ae)=>{var Y;let B=ae+1,me=B===q,be=Se(B),re=Oe(B),Fe=ue(A(h.temp(B))),he=ue((Y=A(h.effectiveSetpoint(B)))!=null?Y:A(h.setpoint(B))),Xe=u(B),it=f(Xe),He=b(Xe),lt=w.partners[B],qe=lt.length>0,wt=qe?d("overview.zone.mergedWith",{zones:lt.map(Mo).join(", ")}):"",Bt=qe&&lt.includes(B+1)&&w.roots[B]===w.roots[B+1],ko=qe&&lt.includes(B-1)&&w.roots[B]===w.roots[B-1],Ye=[qe?"is-merged":"",Bt?"zo-pair-start":"",ko?"zo-pair-cont":""].filter(Boolean).join(" "),ct=`${be}, ${Fe} / ${he}, ${it}${wt?", "+wt:""}`.replace(/"/g,"&quot;"),E=qe?`<span class="zo-merge">${wt}</span>`:"";return F?`<button type="button" class="zone-overview-card ${He}${Ye?" "+Ye:""}" data-zone-select="${B}" aria-current="${me?"true":"false"}" aria-label="${ct}" title="${ct}" tabindex="${me?"0":"-1"}"><span class="zo-status" aria-hidden="true"></span><span class="zo-title zone-label-compact">${re}</span><span class="zo-temps">${Fe} / ${he}</span>${E}</button>`:`<div class="zone-overview-card ${He}${Ye?" "+Ye:""}" role="listitem" aria-label="${ct}" title="${ct}"><span class="zo-status" aria-hidden="true"></span><span class="zo-title zone-label-compact">${re}</span><span class="zo-temps">${Fe} / ${he}</span>${E}</div>`}).join("")}function S(){let w=N("selectedZone")||1;m.innerHTML=Array.from({length:6},(q,F)=>{let ie=F+1,ae=ie===w,B=Se(ie),me=Oe(ie),be=B.replace(/"/g,"&quot;");return`<button type="button" class="zone-chip zone-label-compact" role="tab" aria-selected="${ae}" aria-label="${be}" title="${be}" tabindex="${ae?"0":"-1"}" data-zone-select="${ie}">${me}</button>`}).join("")}function D(){T(),S()}function M(){let w=N("section")==="zones";l.hidden=!w,l.setAttribute("aria-hidden",w?"false":"true"),s.classList.toggle("has-zone-dock",w)}function I(w){Vt(w)}function K(){let w=N("section")||"overview";r.forEach(q=>q.classList.toggle("active",q.dataset.section===w)),R()}function j(){let w=[],q=0,F=0;for(let he=1;he<=6;he++){let Xe=String(_(h.enabled(he))).toLowerCase()==="on",it=String(_(h.state(he))).toLowerCase(),He=String(_(h.motorLastFault(he))).toLowerCase();Xe&&w.push(he),Xe&&["heating","calling"].includes(it)&&q++,(it==="fault"||He!==""&&He!=="none"&&He!=="ok")&&F++}let ie=A(i.flow),ae=A(i.ret),B=String(_(i.authorityState)||"").replace(/_/g," "),me=F===0&&N("live"),be=`<div class="status-summary-main"><span class="eyebrow">System status</span><h2 class="${me?"status-ok":N("live")?"status-warn":"status-danger"}">${me?"Operating normally":N("live")?"Needs attention":"Device offline"}</h2><p>${F?F+" zone fault"+(F===1?"":"s")+" require attention.":N("live")?"V6 is running local control safely.":"Unable to read current manifold state."}</p></div><div class="status-fact"><span class="eyebrow">Heating</span><strong>${q} zones</strong><small>${w.length} enabled</small></div><div class="status-fact"><span class="eyebrow">Flow</span><strong>${ue(ie)}</strong><small>Return ${ue(ae)}</small></div><div class="status-fact"><span class="eyebrow">Touch</span><strong>${B||"not connected"}</strong><small>${A(i.authorityLeaseRemainingS)?Math.round(A(i.authorityLeaseRemainingS))+" s lease":"local control"}</small></div>`,re=ce(i.authorityConfigured),Fe=String(_(i.drivers)||"off");e.querySelector(".overview-status").innerHTML=be,e.querySelector(".hydraulic-summary").textContent=`${q} heating \xB7 Flow ${ue(ie)} \xB7 Return ${ue(ae)}`,e.querySelector(".settings-readiness").innerHTML=`<div class="status-summary-main"><span class="eyebrow">Configuration</span><h2 class="${N("live")?"status-ok":"status-danger"}">${N("live")?"Ready":"Waiting for device"}</h2><p>V6 validates and saves changes locally.</p></div><div class="status-fact"><span class="eyebrow">Device</span><strong>${N("live")?"Live":"Offline"}</strong><small>local controller</small></div><div class="status-fact"><span class="eyebrow">Touch</span><strong>${re?"Approved":"Not approved"}</strong><small>${re?"authenticated control":"local control only"}</small></div><div class="status-fact"><span class="eyebrow">Drivers</span><strong>${Fe}</strong><small>motor outputs</small></div>`,e.querySelector(".diagnostics-readiness").innerHTML=`<div class="status-summary-main"><span class="eyebrow">Overall health</span><h2 class="${F?"status-danger":me?"status-ok":"status-warn"}">${F?F+" issue"+(F===1?"":"s"):me?"Healthy":"Awaiting data"}</h2><p>${F?"Resolve current exceptions before using service controls.":"No active motor faults reported."}</p></div><div class="status-fact"><span class="eyebrow">Zone faults</span><strong>${F}</strong><small>${F?"requires review":"none reported"}</small></div><div class="status-fact"><span class="eyebrow">Drivers</span><strong>${Fe}</strong><small>motor outputs</small></div><div class="status-fact"><span class="eyebrow">Touch</span><strong>${B||"not connected"}</strong><small>${re?"approved":"local control"}</small></div>`,[e.querySelector(".overview-attention"),e.querySelector(".diagnostics-attention")].forEach(he=>{he.hidden=!F,he.innerHTML=F?`<strong>Review ${F} zone fault${F===1?"":"s"}</strong><span>Open Zones to inspect the affected valve and sensor state.</span>`:""})}function R(){let w=N("selectedZone")||1,q=N("section")==="zones";p.innerHTML=Oe(w),D(),M(),c.hidden=!q}function X(w){let q=w.target.closest("[data-zone-select]");q&&I(Number(q.dataset.zoneSelect))}function te(w){k()&&X(w)}function H(w){if(!k()||!["ArrowLeft","ArrowRight","Home","End"].includes(w.key))return;w.preventDefault();let q=N("selectedZone")||1,F=w.key==="Home"?1:w.key==="End"?6:w.key==="ArrowLeft"?q===1?6:q-1:q===6?1:q+1;I(F),requestAnimationFrame(()=>{var ie;return(ie=g.querySelector(`[data-zone-select="${F}"]`))==null?void 0:ie.focus()})}function C(w){if(!["ArrowLeft","ArrowRight","Home","End"].includes(w.key))return;w.preventDefault();let q=N("selectedZone")||1,F=w.key==="Home"?1:w.key==="End"?6:w.key==="ArrowLeft"?q===1?6:q-1:q===6?1:q+1;I(F),requestAnimationFrame(()=>{var ie;return(ie=m.querySelector(`[data-zone-select="${F}"]`))==null?void 0:ie.focus()})}g.addEventListener("click",te),g.addEventListener("keydown",H),window.matchMedia("(min-width: 901px)").addEventListener("change",T),m.addEventListener("click",X),m.addEventListener("keydown",C),e.querySelectorAll("[data-open-zones]").forEach(w=>w.addEventListener("click",()=>Pe("zones"))),e.querySelectorAll("[data-help-section]").forEach(w=>w.addEventListener("click",q=>{q.preventDefault(),Pe(w.dataset.helpSection)})),Z("section",K),Z("selectedZone",R),Z("live",j),Z("zoneNames",()=>{D(),j()});for(let w=1;w<=6;w++)[h.temp(w),h.setpoint(w),h.effectiveSetpoint(w),h.valve(w),h.state(w),h.enabled(w),h.motorLastFault(w),h.syncTo(w)].forEach(q=>z(q,()=>{j(),D()}));[i.flow,i.ret,i.authorityConfigured,i.authorityState,i.authorityLeaseRemainingS,i.drivers].forEach(w=>z(w,j)),L(e),K(),R(),j()}});function Vi(){let t=document.getElementById("app");if(!t)throw new Error("Dashboard root #app not found");t.innerHTML="",t.appendChild(Q("app-root")),Ja()}Vi();})();
