...
// scratch backs GET /api/v1/logs?since=<seq>; the smart FIFO backs
// GET /api/v1/logs/download. Both are RAM-only; lost on reboot.
// -----------------------------------------------------------------------
...
class LV6Dashboard : public Component, public AsyncWebHandler {
 ...
 protected:
  ...
  // or POST /api/v1/commands). Does not enable heap tracing by default —
