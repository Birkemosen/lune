# =============================================================================
# LV6 Zone Controller — ESPHome External Component
# =============================================================================
...
AUTO_LOAD = ["lv6_config_store", "lv6_valve_controller"]
...
CONFIG_SCHEMA = cv.Schema(
    {
        cv.GenerateID(): cv.declare_id(Lv6ZoneController),
        cv.Required(CONF_CONFIG_STORE_ID): cv.use_id(Lv6ConfigStore),
        cv.Required(CONF_VALVE_CONTROLLER_ID): cv.use_id(Lv6ValveController),
