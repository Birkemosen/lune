...
#include <cassert>
#include <cstring>
using namespace esphome::hv6_asgard_bridge::asgard_url;
int main() {
  char url[320];
  ...
  assert(!request_succeeded(true, 500));
  assert(request_succeeded(true, 204));
  using namespace esphome::hv6_asgard_bridge::asgard_confirmation;
