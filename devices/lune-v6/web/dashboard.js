...
`;F("ui-kit",Yo);function pe(e){let t=b(e);return`<span class="help-badge" tabindex="0" role="img" aria-label="${String(t).replace(/"/g,"&quot;")}" data-i18n-label="${e}">?<span class="help-tip" data-i18n="${e}">${t}</span></span>`}function Ko(e,t){let o=Math.abs(Number(e));return!Number.isFinite(o)||o<1e3?t:Math.pow(10,Math.floor(Math.log10(o))-1)}function Jo(e){let t=String(e),o=t.indexOf(".");return o<0?0:t.length-o-1}function re(e,t={}){let o=e.querySelector(t.title||".ui-card-title"),r=document.createElement("div");r.className="ui-form-banner",r.innerHTML='<span class="ui-form-banner-msg" data-i18n="form.unsaved">Unsaved changes</span><span class="ui-form-banner-btns"><button type="button" class="ui-form-discard" data-i18n="form.discard">Discard</button><button type="button" class="ui-form-apply" data-i18n="form.apply">Apply</button></span>',o?o.insertAdjacentElement("afterend",r):e.insertAdjacentElement("afterbegin",r);let n=[],a=()=>r.classList.toggle("show",n.some(l=>l.dirty)),i=(l,S)=>{l.dirty=S,a()};function d(l){return l.markDirty=()=>i(l,!0),n.push(l),l}function f(l,S){let A={dirty:!1,input:l},_=S.baseStep!=null?S.baseStep:parseFloat(l.step)||1,x=Jo(_),C=S.min!=null?S.min:l.min!==""?parseFloat(l.min):-1/0,M=S.max!=null?S.max:l.max!==""?parseFloat(l.max):1/0,W=H=>x>0?Number(H).toFixed(x):String(Math.round(Number(H)));if(!S.nostep){let H=document.createElement("div");H.className="ui-stepper",l.parentNode.insertBefore(H,l);let E=document.createElement("button");E.type="button",E.className="ui-step-btn",E.textContent="\u2212",E.tabIndex=-1,E.setAttribute("aria-label",b("common.decrease"));let Z=document.createElement("button");Z.type="button",Z.className="ui-step-btn",Z.textContent="+",Z.tabIndex=-1,Z.setAttribute("aria-label",b("common.increase")),H.appendChild(E),H.appendChild(l),H.appendChild(Z),l.readOnly=!0;let I=X=>{if(l.disabled)return;let U=parseFloat(l.value);Number.isFinite(U)||(U=parseFloat(l.placeholder)),Number.isFinite(U)||(U=0);let ke=Math.min(M,Math.max(C,U+X*Ko(U,_)));l.value=W(ke),i(A,!0)};E.addEventListener("click",()=>I(-1)),Z.addEventListener("click",()=>I(1)),l.addEventListener("dblclick",()=>{l.disabled||(l.readOnly=!1,l.classList.add("editing"),l.focus(),l.select())}),l.addEventListener("blur",()=>{l.readOnly=!0,l.classList.remove("editing")}),l.addEventListener("keydown",X=>{X.key==="Enter"&&l.blur()})}return l.addEventListener("input",()=>i(A,!0)),A.sync=()=>{let H=S.read();l.value=H!=null&&Number.isFinite(Number(H))?W(H):""},A.commit=()=>{let H=parseFloat(l.value);Number.isFinite(H)&&S.commit(Math.min(M,Math.max(C,H)))},d(A)}function m(l,S){let A={dirty:!1,input:l};return l.addEventListener("input",()=>i(A,!0)),A.sync=()=>{let _=S.read();l.value=_!=null?_:""},A.commit=()=>S.commit(l.value.trim()),d(A)}function g(l,S){let A={dirty:!1,input:l};return l.addEventListener("change",()=>i(A,!0)),A.sync=()=>{let _=S.read();_!=null&&(l.value=_)},A.commit=()=>S.commit(l.value),d(A)}function z(l,S){let A={dirty:!1,input:l,staged:!1},_=l.closest(".ui-row"),x=()=>{l.classList.toggle("on",A.staged),_&&_.classList.toggle("is-on",A.staged),l.setAttribute("aria-checked",A.staged?"true":"false"),S.onChange&&S.onChange(A.staged)};return l.addEventListener("click",()=>{A.staged=!A.staged,i(A,!0),x()}),A.sync=()=>{A.staged=!!S.read(),x()},A.commit=()=>S.commit(A.staged),d(A)}function h(l){let S={dirty:!1,sync:l.sync,commit:l.commit};return d(S)}let c=()=>n.forEach(l=>{!l.dirty&&l.sync&&l.sync()}),u=()=>{n.forEach(l=>{l.dirty&&(l.commit&&l.commit(),l.dirty=!1)}),a(),t.onApply&&t.onApply()},y=()=>{n.forEach(l=>{l.dirty=!1,l.sync&&l.sync()}),a(),t.onDiscard&&t.onDiscard()};return r.querySelector(".ui-form-apply").addEventListener("click",u),r.querySelector(".ui-form-discard").addEventListener("click",y),k(r),{num:f,text:m,select:g,toggle:z,custom:h,refresh:c,apply:u,discard:y,isDirty:()=>n.some(l=>l.dirty)}}function ae(e){return e!=null&&!isNaN(e)?Math.round(e*10)/10+"\xB0C":"---"}function qe(e){return e!=null&&!isNaN(e)?(e|0)+"%":"---"}function Ie(e){if(!e||isNaN(e))return"---";e=e|0;var t=e/86400|0,o=e%86400/3600|0,r=e%3600/60|0;return t>0?t+"d "+o+"h "+r+"m":o>0?o+"h "+r+"m":r+"m"}function eo(e){return e==null||isNaN(e)?"---":(e=e|0,e>-50?e+" dBm \u2590\u2590\u2590\u2590":e>-60?e+" dBm \u2590\u2590\u2590\u2591":e>-70?e+" dBm \u2590\u2590\u2591\u2591":e>-80?e+" dBm \u2590\u2591\u2591\u2591":e+" dBm \u2591\u2591\u2591\u2591")}function to(e){if(e==null||isNaN(e))return"hh:mm";let t=Math.round(Date.now()/1e3-e),o=new Date(t*1e3),r=n=>String(n).padStart(2,"0");return`${r(o.getHours())}:${r(o.getMinutes())}`}var Qo=`
.topbar {
  position: static;
  margin-bottom: 14px;
  padding: 12px;
...
`,mn=T({tag:"connectivity-card",render:or,onMount(e,t){let o=t.querySelector(".cc-ip"),r=t.querySelector(".cc-ssid"),n=t.querySelector(".cc-mac"),a=t.querySelector(".cc-up");function i(){o.textContent=N(s.ip)||"---",r.textContent=N(s.ssid)||"---",n.textContent=N(s.mac)||"---",a.textContent=Ie(L(s.uptime))}w(s.ip,i),w(s.ssid,i),w(s.mac,i),w(s.uptime,i),k(t),i()}});var rr="http://www.w3.org/2000/svg",ar=`
.chart-card {
  border: 1px solid var(--panel-border);
  border-radius: 16px;
  background: var(--panel-bg-vibrant);
...
`;F("graph-widgets",dr);var io=()=>'<div class="chart-card"><div class="chart-head"><span class="chart-title" data-i18n="overview.graph.flowReturnDemand">Flow / Return / Demand</span><span class="chart-sub gw-dt">\u2014</span></div><div class="gw-controls" role="toolbar" data-i18n-label="overview.graph.layers" aria-label="Flow chart layers"><button type="button" class="gw-toggle" data-layer="flow" aria-pressed="true" data-i18n="overview.graph.layers.flow">Flow</button><button type="button" class="gw-toggle" data-layer="return" aria-pressed="true" data-i18n="overview.graph.layers.return">Return</button><button type="button" class="gw-toggle" data-layer="demand" aria-pressed="true" data-i18n="overview.graph.layers.demand">Demand</button></div><svg class="gw-flow"></svg></div>',lo=()=>'<div class="chart-card"><div class="chart-head"><span class="chart-title" data-i18n="overview.graph.demandIndex">Demand Index</span><span class="chart-sub gw-demand-text">\u2014</span></div><svg class="gw-demand"></svg></div>',cr=e=>e.variant==="flow-return"?`<div class="graph-widgets">${io()}</div>`:e.variant==="demand"?`<div class="graph-widgets">${lo()}</div>`:`<div class="graph-widgets">${io()}${lo()}</div>`;function co(e,t){return Number.isFinite(e)?t==="%"?Math.round(e)+"%":e.toFixed(1):"\u2014"}function pr(e,t){return Number.isFinite(e)?t==="%"?Math.round(e)+"%":e.toFixed(1)+"\xB0":"\u2014"}function vt(e,t,o){let r=[];for(let n=0;n<e.length;n++){let a=e[n];if(!a||a[0]<o)continue;let i=a[t];i==null||!Number.isFinite(i)||r.push({t:a[0],v:i})}return r}var je=(e,t)=>fe+Math.max(0,Math.min(1,(e-t)/bt))*Ze;function ur(e,t,o){let r=Number(Date.now()/1e3)|0,n=3600,a=Math.ceil((r-bt)/n)*n,i=Math.floor(r/n)*n,d=Math.floor(r/n)*n;for(let m=a;m<=i;m+=n){let g=o-(r-m),z=je(g,t),h=new Date(m*1e3),c=m===d,u=ve+16;e.appendChild(oe("text",{x:z,y:u,"text-anchor":"end",transform:`rotate(-45 ${z.toFixed(1)} ${u})`,class:"chart-hour"+(c?" now":"")},String(h.getHours()).padStart(2,"0")))}let f=je(o,t);e.appendChild(oe("line",{x1:f,y1:le,x2:f,y2:ve,stroke:"var(--series-solar)","stroke-width":"1","stroke-dasharray":"2 3",opacity:".55","vector-effect":"non-scaling-stroke"}))}function mr(e){let t=[];if(e.forEach(a=>a.forEach(i=>t.push(i.v))),!t.length)return{min:0,max:10};let o=Math.min(...t),r=Math.max(...t);o===r&&(o-=.5,r+=.5);let n=(r-o)*.1;return o-=n,r+=n,{min:o,max:r}}function gr(e,t,o){let r=e.filter(n=>n.unit==="C").map(n=>vt(t,n.index,o));return mr(r)}function po(e,t,o,r,n,a){e.innerHTML="",e.setAttribute("viewBox",`0 0 ${Ae} ${ft}`),e.setAttribute("preserveAspectRatio","xMidYMid meet");let i=o.map(u=>vt(r,u.index,n));if(!i.some(u=>u.length))return e.appendChild(oe("text",{x:Ae/2,y:ft/2,"text-anchor":"middle",class:"chart-empty"},"Collecting history\u2026")),null;let d=gr(o,r,n),f=Math.max(.001,d.max-d.min),m=u=>le+(1-(u-d.min)/f)*ge,g=u=>le+(1-Math.max(0,Math.min(100,u))/100)*ge,z=(u,y)=>u.unit==="%"?g(y):m(y);for(let u=0;u<3;u++){let y=u/2,l=le+y*ge;e.appendChild(oe("line",{x1:fe,y1:l,x2:fe+Ze,y2:l,class:"chart-grid"})),o.some(S=>S.unit==="C")&&e.appendChild(oe("text",{x:fe-6,y:l+4,"text-anchor":"end",class:"chart-tick"},co(d.max-f*y,"C")+"\xB0")),o.some(S=>S.unit==="%")&&e.appendChild(oe("text",{x:fe+Ze+6,y:l+4,"text-anchor":"start",class:"chart-tick"},co(100-100*y,"%")))}e.appendChild(oe("line",{x1:fe,y1:ve,x2:fe+Ze,y2:ve,class:"chart-axis"})),o.some(u=>u.unit==="C")&&e.appendChild(oe("text",{x:9,y:le+ge/2,transform:`rotate(-90 9 ${(le+ge/2).toFixed(1)})`,"text-anchor":"middle",class:"chart-axis-label"},b("overview.graph.axis.temp"))),o.some(u=>u.unit==="%")&&e.appendChild(oe("text",{x:Ae-9,y:le+ge/2,transform:`rotate(90 ${Ae-9} ${(le+ge/2).toFixed(1)})`,"text-anchor":"middle",class:"chart-axis-label"},b("overview.graph.axis.demand"))),ur(e,n,a),o.forEach((u,y)=>{let l=i[y].map(A=>({x:je(A.t,n),y:z(u,A.v)}));if(!l.length)return;let S=oo(l);u.fill&&e.appendChild(oe("path",{d:S+` L ${l[l.length-1].x.toFixed(1)} ${ve} L ${l[0].x.toFixed(1)} ${ve} Z`,fill:u.fill,stroke:"none"})),e.appendChild(oe("path",{d:S,fill:"none",stroke:u.color,"stroke-width":String(u.width||2.2),"stroke-linecap":"round","stroke-linejoin":"round"}))});let h=[];for(let u=0;u<r.length;u++){let y=r[u];if(!y||y[0]<n)continue;let l=o.map(S=>y[S.index]);l.every(S=>S==null||!Number.isFinite(S))||h.push({t:y[0],vals:l})}if(!h.length)return null;let c=Date.now();return ro(e,t,{count:h.length,plotTop:le,plotBottom:ve,xAt:u=>je(h[u].t,n),label:u=>new Date(c-(a-h[u].t)*1e3).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),dots:u=>o.map((y,l)=>({y:z(y,h[u].vals[l]),color:y.color})).filter((y,l)=>Number.isFinite(h[u].vals[l])),rows:u=>o.map((y,l)=>({color:y.color,label:y.label,value:pr(h[u].vals[l],y.unit)})).filter((y,l)=>Number.isFinite(h[u].vals[l]))})}function We(e,t,o){let r=vt(e,t,o);return r.length?r[r.length-1].v:null}var zn=T({tag:"graph-widgets",state:e=>({variant:e&&e.variant||"both"}),render:cr,onMount(e,t){let o=t.querySelector(".gw-dt"),r=t.querySelector(".gw-demand-text"),n=t.querySelector(".gw-flow"),a=t.querySelector(".gw-demand"),i=Array.from(t.querySelectorAll(".gw-toggle")),d={flow:!0,return:!0,demand:!0},f=null,m=null;function g(){i.forEach(c=>{let u=c.dataset.layer;c.classList.toggle("is-off",!d[u]),c.setAttribute("aria-pressed",d[u]?"true":"false")})}function z(){let c=[];return d.flow&&c.push({index:ao,color:ir,label:b("overview.graph.layers.flow"),unit:"C",width:2.4}),d.return&&c.push({index:no,color:lr,label:b("overview.graph.layers.return"),unit:"C",width:2}),d.demand&&c.push({index:Be,color:so,label:b("overview.graph.layers.demand"),unit:"%",width:1.8,fill:"rgba(255,193,77,.10)"}),c}function h(){let c=O("zoneStateHistory"),u=c&&Array.isArray(c.entries)?c.entries:[],y=c&&c.uptime_s||Number(Date.now()/1e3)|0,l=y-bt;if(n){f&&f();let S=We(u,ao,l),A=We(u,no,l),_=We(u,Be,l),x=[];S!=null&&A!=null&&x.push("\u0394 "+(S-A).toFixed(1)+"\xB0"),_!=null&&x.push(Math.round(_)+"%"),o.textContent=x.length?x.join(" \xB7 "):"\u2014",f=po(n,n.closest(".chart-card"),z(),u,l,y)}if(a){m&&m();let S=We(u,Be,l);r.textContent=S!=null?Math.round(S)+"%":"\u2014",m=po(a,a.closest(".chart-card"),[{index:Be,color:so,label:b("overview.graph.layers.demand"),unit:"%",width:2.2,fill:"var(--series-cool-fill)"}],u,l,y)}}i.forEach(c=>{c.addEventListener("click",()=>{let u=c.dataset.layer;d[u]=!d[u],!d.flow&&!d.return&&!d.demand&&(d[u]=!0),g(),h()})}),B("zoneStateHistory",h),k(t),g(),h()}});var be={0:{labelKey:"state.off",color:"#2c4875"},1:{labelKey:"state.manual",color:"#7aa7ce"},2:{labelKey:"state.calibrating",color:"#ffd380"},3:{labelKey:"state.waitCal",color:"#4e6977"},4:{labelKey:"state.waitTemp",color:"#4e6977"},5:{labelKey:"state.heating",color:"#ff8531"},6:{labelKey:"state.idle",color:"#39354c"},7:{labelKey:"state.overheated",color:"#ff6361"},255:{labelKey:"",color:"transparent"}},Me=24*3600,fr=Me,Ee=18,yt=4,he=54,$e=32,_e=4,Ge=10,go=6,fo="#ffc14d",ht=9,uo=Q+1,bo=_e+Q*(Ee+yt)-yt,xt=bo+go,Ve=bo+go+Ge+$e,br=`
.timeline-card {
  border: 1px solid var(--panel-border);
  border-radius: 16px;
  background: var(--panel-bg-vibrant);
...
`;F("zone-state-timeline",br);var vr=()=>`
...
`;function hr(e,t){if(!e||!e.entries||e.entries.length===0)return null;let o=e.entries,r=e.uptime_s||t||0,n=Number(Date.now()/1e3)|0,a=1e3,i=a-he;function d(_){let x=(_+Me)/fr;return he+Math.max(0,Math.min(1,x))*i}function f(_){return _-r}let m="http://www.w3.org/2000/svg",g=document.createElementNS(m,"svg");g.setAttribute("viewBox","0 0 "+a+" "+Ve),g.classList.add("timeline-svg");let z=document.createElementNS(m,"rect");z.setAttribute("x",he),z.setAttribute("y",_e),z.setAttribute("width",i),z.setAttribute("height",Ve-_e-$e),z.setAttribute("fill","rgba(0,32,46,0.55)"),z.setAttribute("rx","4"),g.appendChild(z);let h=d(0),c=[-24,-18,-12,-6,0].map(_=>_*3600);for(let _ of c){let x=d(_),C=document.createElementNS(m,"line");C.setAttribute("x1",x),C.setAttribute("y1",_e),C.setAttribute("x2",x),C.setAttribute("y2",Ve-$e),C.setAttribute("stroke",_===0?"var(--series-solar)":"rgba(120,146,200,.16)"),C.setAttribute("stroke-width","1"),_===0&&(C.setAttribute("stroke-dasharray","2 3"),C.setAttribute("opacity",".55"),C.setAttribute("vector-effect","non-scaling-stroke")),g.appendChild(C)}g.appendChild(xr(m,"text",{x:h+4,y:_e+11,"text-anchor":"start",fill:"rgba(255,211,128,.92)","font-size":"9","font-family":"Montserrat, sans-serif","font-weight":"600"},"now"));for(let _=0;_<Q;_++){let x=_e+_*(Ee+yt),C=document.createElementNS(m,"rect");C.setAttribute("x",he),C.setAttribute("y",x),C.setAttribute("width",i),C.setAttribute("height",Ee),C.setAttribute("fill",_%2===0?"rgba(124,155,208,0.05)":"rgba(124,155,208,0.00)"),g.appendChild(C);let M=document.createElementNS(m,"text");M.setAttribute("x",he-4),M.setAttribute("y",x+Ee/2+1),M.setAttribute("text-anchor","end"),M.setAttribute("dominant-baseline","middle"),M.setAttribute("fill","rgba(233,222,210,.62)"),M.setAttribute("font-size","9.5"),M.setAttribute("font-family","Montserrat, sans-serif"),M.setAttribute("font-weight","600"),M.textContent="Z"+(_+1),g.appendChild(M);let W=o.map(E=>({rel:f(E[0]),state:E[_+1]})).filter(E=>E.rel>=-Me&&E.rel<=0),H=(E,Z,I)=>{if(I===255)return;let X=be[I]||be[255];if(X.color==="transparent")return;let U=d(E),ke=d(Z),Je=Math.max(1,ke-U),ce=document.createElementNS(m,"rect");ce.setAttribute("x",U),ce.setAttribute("y",x+(Ee-ht)/2),ce.setAttribute("width",Je),ce.setAttribute("height",ht),ce.setAttribute("fill",X.color),ce.setAttribute("rx",String(ht/2)),ce.setAttribute("opacity","0.9"),g.appendChild(ce)};if(W.length){let E=W[0].rel,Z=W[0].state;for(let I=1;I<W.length;I++){let X=W[I];X.state!==Z&&(H(E,X.rel,Z),E=X.rel,Z=X.state)}H(E,0,Z)}}{let _=document.createElementNS(m,"rect");_.setAttribute("x",he),_.setAttribute("y",xt),_.setAttribute("width",i),_.setAttribute("height",Ge),_.setAttribute("fill","rgba(188,80,144,0.10)"),_.setAttribute("rx","2"),g.appendChild(_);let x=document.createElementNS(m,"text");x.setAttribute("x",he-4),x.setAttribute("y",xt+Ge/2+1),x.setAttribute("text-anchor","end"),x.setAttribute("dominant-baseline","middle"),x.setAttribute("fill","rgba(233,222,210,.62)"),x.setAttribute("font-size","8.5"),x.setAttribute("font-family","Montserrat, sans-serif"),x.setAttribute("font-weight","600"),x.textContent=b("overview.timeline.absorb"),g.appendChild(x);let C=o.map(M=>({rel:f(M[0]),on:M.length>uo?M[uo]:0})).filter(M=>M.rel>=-Me&&M.rel<=0);if(C.length){let M=(E,Z)=>{let I=d(E),X=Math.max(1,d(Z)-I),U=document.createElementNS(m,"rect");U.setAttribute("x",I),U.setAttribute("y",xt),U.setAttribute("width",X),U.setAttribute("height",Ge),U.setAttribute("fill",fo),U.setAttribute("rx","2"),U.setAttribute("opacity","0.9"),g.appendChild(U)},W=C[0].rel,H=C[0].on;for(let E=1;E<C.length;E++)C[E].on!==H&&(H&&M(W,C[E].rel),W=C[E].rel,H=C[E].on);H&&M(W,0)}}let u=Ve-$e+15,y=3600,l=Math.ceil((n-Me)/y)*y,S=Math.floor(n/y)*y,A=Math.floor(n/y)*y;for(let _=l;_<=S;_+=y){let x=_-n,C=d(x),M=new Date(_*1e3),W=String(M.getHours()).padStart(2,"0"),H=_===A,E=document.createElementNS(m,"text");E.setAttribute("x",C),E.setAttribute("y",u),E.setAttribute("text-anchor","end"),E.setAttribute("fill",H?"rgba(255,211,128,.95)":"rgba(202,219,248,.72)"),E.setAttribute("font-size","9"),E.setAttribute("font-family",'"Montserrat", sans-serif'),E.setAttribute("font-weight","500"),E.setAttribute("font-variant-numeric","tabular-nums lining-nums"),E.setAttribute("font-feature-settings",'"tnum" 1, "lnum" 1'),E.setAttribute("letter-spacing","0"),E.setAttribute("transform",`rotate(-45 ${C.toFixed(1)} ${u})`),E.textContent=W,g.appendChild(E)}return g}function xr(e,t,o,r){let n=document.createElementNS(e,t);for(let a in o)n.setAttribute(a,o[a]);return r!=null&&(n.textContent=r),n}function mo(e){e.innerHTML="";let t=[{code:5,...be[5]},{code:6,...be[6]},{code:0,...be[0]},{code:1,...be[1]},{code:7,...be[7]},{code:2,...be[2]}];for(let r of t){let n=document.createElement("div");n.className="tl-legend-item",n.innerHTML='<span class="tl-legend-dot" style="background:'+r.color+'"></span>'+(r.labelKey?b(r.labelKey):""),e.appendChild(n)}let o=document.createElement("div");o.className="tl-legend-item",o.innerHTML='<span class="tl-legend-dot" style="background:'+fo+'"></span>'+b("overview.timeline.preheatAbsorption"),e.appendChild(o)}var Mn=T({tag:"zone-state-timeline",render:vr,onMount(e,t){let o=t.querySelector(".tl-body"),r=t.querySelector(".timeline-legend");mo(r);function n(){let a=O("zoneStateHistory"),i=(()=>{let f=O&&O("zoneStateHistory");return f&&f.uptime_s||Number(Date.now()/1e3)|0})();if(o.innerHTML="",!a||!a.entries||a.entries.length===0){let f=document.createElement("div");f.className="timeline-empty",f.textContent=b("overview.timeline.noHistory"),o.appendChild(f);return}let d=hr(a,i);d&&o.appendChild(d)}B("zoneStateHistory",n),B("zoneNames",n),w(s.drivers,n);for(let a=1;a<=Q;a++)w(p.enabled(a),n),w(p.state(a),n),w(p.temp(a),n),w(p.setpoint(a),n),w(p.preheatAdvance(a),n);k(t),n()}});var yr=`
.zone-grid {
    display: grid;
...
`;F("zone-grid",yr);var wr=()=>'<div class="zone-grid"></div>',Tn=T({tag:"zone-grid",render:wr,onMount(e,t){for(let o=1;o<=6;o++)t.appendChild(V("zone-card",{zone:o}))}});var zr=`
.zone-card {
	display: grid;
...
`;function vo(e){return e!=null?Number(e).toFixed(2)+"x":"---"}function ho(e){return e!=null?Number(e).toFixed(0):"---"}function Cr(e){return e!=null?Number(e).toFixed(2)+"C":"---"}function Lr(e,t){if(!t)return b("common.disabled");let o=String(e||"IDLE").toUpperCase();return o==="HEATING"?b("state.heating"):o==="IDLE"?b("state.idle"):o==="OFF"?b("state.off"):o==="FAULT"?b("common.fault"):o==="MANUAL"?b("state.manual"):o==="OVERHEATED"?b("state.overheated"):o==="CALIBRATING"?b("state.calibrating"):o}var Yn=T({tag:"zone-detail",state:e=>({zone:e.zone,temp:"---",setpoint:"---",valve:"---",state:"---"}),render:kr,methods:{update(e,t){let o=O("selectedZone"),r=String(N(p.state(o))||"").toUpperCase(),n=Y(p.enabled(o));this.zone=o,e.dataset.zone=String(o),t.title.textContent=$(o),t.setpoint.textContent=ae(L(p.setpoint(o))),t.temp.textContent=ae(L(p.temp(o))),t.ret.textContent=ae(L("sensor-manifold_return_temperature")),t.valve.textContent=qe(L(p.valve(o)));let a=t.badge;a.textContent=Lr(r,n);let i=n?r==="HEATING"?"badge-heating":r==="IDLE"?"badge-idle":r==="FAULT"?"badge-fault":"":"badge-disabled";a.className="zd-badge"+(i?" "+i:""),t.toggle.classList.toggle("on",n),t.orip.textContent=ho(L(p.motorOpenRipples(o))),t.crip.textContent=ho(L(p.motorCloseRipples(o))),t.ofac.textContent=vo(L(p.motorOpenFactor(o))),t.cfac.textContent=vo(L(p.motorCloseFactor(o))),t.ph.textContent=Cr(L(p.preheatAdvance(o)));let d=String(N(p.motorLastFault(o))||"").toUpperCase(),f=d&&d!=="NONE"&&d!=="OK";t.fault.hidden=!f,f&&(t.faultVal.textContent=d)},incSetpoint(){let e=this.zone,t=L(p.setpoint(e))||20;nt(e,Number((t+.5).toFixed(1)))},decSetpoint(){let e=this.zone,t=L(p.setpoint(e))||20;nt(e,Number((t-.5).toFixed(1)))},toggleEnabled(){let e=this.zone,t=Y(p.enabled(e));Pt(e,!t)}},onMount(e,t){let o={title:t.querySelector(".zd-title"),setpoint:t.querySelector(".zd-setpoint"),temp:t.querySelector(".zd-temp"),ret:t.querySelector(".zd-ret"),valve:t.querySelector(".zd-valve"),badge:t.querySelector(".zd-badge"),toggle:t.querySelector(".btn-toggle"),inc:t.querySelector(".btn-inc"),dec:t.querySelector(".btn-dec"),orip:t.querySelector(".zd-orip"),crip:t.querySelector(".zd-crip"),ofac:t.querySelector(".zd-ofac"),cfac:t.querySelector(".zd-cfac"),ph:t.querySelector(".zd-ph"),fault:t.querySelector(".zd-fault"),faultVal:t.querySelector(".zd-fault-val")};o.inc.onclick=()=>e.incSetpoint(),o.dec.onclick=()=>e.decSetpoint(),o.toggle.onclick=()=>e.toggleEnabled();let r=()=>e.update(t,o),n=a=>{let i=O("selectedZone");(a===p.temp(i)||a===p.setpoint(i)||a===p.valve(i)||a===p.state(i)||a===p.enabled(i))&&r()};for(let a=1;a<=6;a++)w(p.temp(a),n),w(p.setpoint(a),n),w(p.valve(a),n),w(p.state(a),n),w(p.enabled(a),n),w(p.motorOpenRipples(a),r),w(p.motorCloseRipples(a),r),w(p.motorOpenFactor(a),r),w(p.motorCloseFactor(a),r),w(p.preheatAdvance(a),r),w(p.motorLastFault(a),r);w("sensor-manifold_return_temperature",r),B("selectedZone",r),k(t),r()}});var Ar=`
...
`;F("zone-sensor-card",Ar);var Mr=()=>{let e='<option value="None" data-i18n="common.none">None</option>';for(let t=1;t<=8;t++)e+='<option value="Probe '+t+'">Probe '+t+"</option>";return`
  ...
  `};function xo(e,t){let o=e.value,r='<option value="None" data-i18n="common.none">'+b("common.none")+"</option>";for(let n=1;n<=6;n++)n!==t&&(r+='<option value="Zone '+n+'">'+b("common.zone")+" "+n+"</option>");e.innerHTML=r,e.value=o||"None"}function Er(e){return e==="BLE"||e==="BLE Sensor"?"BLE Sensor":"Local Probe"}function Fr(e){return e==="BLE Sensor"?"BLE":"Local Probe"}function yo(e,t){let o='<option value="Local Probe" data-i18n="zone.sensor.localProbe">'+b("zone.sensor.localProbe")+'</option><option value="BLE Sensor" data-i18n="zone.sensor.bleSource">'+b("zone.sensor.bleSource")+"</option>";e.innerHTML!==o&&(e.innerHTML=o),e.value=t}function wo(e){let t=String(e||"").match(/\d+/);return t?Number(t[0]):0}var ns=T({tag:"zone-sensor-card",render:Mr,onMount(e,t){let o=t.querySelector(".zs-probe"),r=t.querySelector(".zs-source"),n=t.querySelector(".zs-ble"),a=t.querySelector(".zs-sync"),i=t.querySelector(".zs-row-ble"),d=t.querySelector(".zs-scan"),f=t.querySelector(".zs-scan-list"),m=t.querySelector(".merge-visual"),g=t.querySelector(".merge-rail"),z=t.querySelector(".merge-caption"),h=0;function c(){return O("selectedZone")}function u(){i.style.display=r.value==="BLE Sensor"?"":"none"}function y(){let x=c(),C=wo(a.value),M=[];for(let Z=1;Z<=6;Z++)Z!==x&&wo(N(p.syncTo(Z)))===x&&M.push(Z);let W=C>0&&C!==x,H=W||M.length>0;if(m.classList.toggle("is-solo",!H),!H){g.innerHTML='<span class="merge-pill primary">'+$(x)+'</span><span class="merge-link"></span><span class="merge-pill">'+b("zone.sensor.noMerge")+"</span>",z.textContent=b("zone.sensor.soloCaption");return}if(W){g.innerHTML='<span class="merge-pill secondary">'+$(x)+'</span><span class="merge-link"></span><span class="merge-pill primary">'+$(C)+"</span>",z.textContent=b("zone.sensor.followsCaption",{zone:$(x),target:$(C)});return}let E='<span class="merge-pill primary">'+$(x)+"</span>";for(let Z of M)E+='<span class="merge-link"></span><span class="merge-pill secondary">'+$(Z)+"</span>";g.innerHTML=E,z.textContent=b("zone.sensor.primaryCaption",{zone:$(x),zones:M.map($).join(", ")})}let l=re(t);yo(r,"Local Probe"),l.select(o,{read:()=>N(p.probe(c()))||void 0,commit:x=>Se(c(),"zone_probe",x)}),l.select(r,{read:()=>Er(String(N(p.tempSource(c()))||"")),commit:x=>Se(c(),"zone_temp_source",Fr(x))}),l.select(a,{read:()=>N(p.syncTo(c()))||"None",commit:x=>Se(c(),"zone_sync_to",x)});let S=l.text(n,{read:()=>N(p.ble(c()))||"",commit:x=>Le(c(),"zone_ble_mac",x)});r.addEventListener("change",u),a.addEventListener("change",y);function A(){let x=c();h!==x?(xo(a,x),h=x,f.style.display="none",l.discard()):l.refresh(),u(),y()}function _(x){let C=c();(x===p.probe(C)||x===p.tempSource(C)||x===p.syncTo(C)||x===p.ble(C)||/^select-zone_\d+_sync_to$/.test(x))&&(l.refresh(),u(),y())}d.addEventListener("click",()=>{if(d.disabled)return;d.disabled=!0,d.textContent="\u2026",f.style.display="",f.innerHTML='<div class="scan-msg">'+b("zone.sensor.scanning")+"</div>";let x=new AbortController,C=setTimeout(()=>x.abort(),8e3);fetch("/api/hv6/v1/ble-scan",{cache:"no-store",signal:x.signal}).then(M=>{if(!M.ok)throw new Error("HTTP "+M.status);return M.json()}).then(M=>{if(clearTimeout(C),d.disabled=!1,d.textContent=b("zone.sensor.scan"),!M.ok||!M.sensors||M.sensors.length===0){f.innerHTML='<div class="scan-msg">'+b("zone.sensor.noSensors")+"</div>";return}let W=c(),H=(N(p.ble(W))||"").toUpperCase(),E=I=>String(I).replace(/[&<>"']/g,X=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[X]),Z="";for(let I of M.sensors){let X=I.mac.toUpperCase(),U=I.name?E(I.name):"",ke=I.temp_c!=null?I.temp_c.toFixed(1)+"\xB0C":"\u2014",Je=I.rssi!=null?I.rssi+" dBm":"",ce=I.age_s<60?b("common.secondsAgo",{value:I.age_s}):b("common.minutesAgo",{value:Math.round(I.age_s/60)}),Qe="";X===H?Qe='<span class="ble-badge">'+b("zone.sensor.assignedThisZone")+"</span>":I.zone>0&&(Qe='<span class="ble-badge">'+b("zone.sensor.zoneBadge",{zone:I.zone})+"</span>");let Eo=U?`<div class="ble-mac">${U}</div><div class="ble-meta">${X}</div>`:`<div class="ble-mac">${X}</div>`;Z+=`<div class="ble-scan-item">
              <div>
                ${Eo}
                <div class="ble-meta">${ke} &nbsp;${Je} &nbsp;${ce}</div>
                ${Qe}
              </div>
              <button class="btn-assign" data-mac="${X}">${b("zone.sensor.assign")}</button>
            </div>`}f.innerHTML=Z,f.querySelectorAll(".btn-assign").forEach(I=>{I.addEventListener("click",()=>{n.value=I.dataset.mac,S.markDirty(),f.style.display="none"})})}).catch(M=>{clearTimeout(C),d.disabled=!1,d.textContent=b("zone.sensor.scan");let W=M&&M.name==="AbortError"?b("zone.sensor.scanTimeout"):b("zone.sensor.scanFailed");f.innerHTML='<div class="scan-msg">'+W+"</div>"})}),B("selectedZone",A);for(let x=1;x<=6;x++)w(p.probe(x),_),w(p.tempSource(x),_),w(p.syncTo(x),_),w(p.ble(x),_);k(t),A()}});var Nr=`
...
`,gs=T({tag:"zone-room-card",render:Tr,onMount(e,t){let o=t.querySelector(".zr-friendly"),r=t.querySelector(".zr-area"),n=t.querySelector(".zr-spacing"),a=t.querySelector(".zr-pipe"),i=t.querySelector(".wall-btn-group").querySelectorAll(".wall-btn");function d(){return O("selectedZone")}let f=re(t);f.text(o,{read:()=>me(d())||"",commit:c=>qt(d(),c)}),f.num(r,{read:()=>L(p.area(d())),commit:c=>st(d(),"zone_area_m2",c)}),f.num(n,{read:()=>L(p.spacing(d())),commit:c=>st(d(),"zone_pipe_spacing_mm",c||200)}),f.select(a,{read:()=>N(p.pipeType(d()))||"Unknown",commit:c=>Se(d(),"zone_pipe_type",c)});let m=[];function g(){i.forEach(c=>{let u=c.dataset.wall;c.classList.toggle("active",u==="None"?m.length===0:m.includes(u))})}let z=f.custom({sync:()=>{let c=N(p.exteriorWalls(d()))||"None";m=c==="None"?[]:c.split(",").filter(Boolean),g()},commit:()=>Le(d(),"zone_exterior_walls",m.length?m.join(","):"None")});i.forEach(c=>{c.addEventListener("click",()=>{let u=c.dataset.wall,y=m.slice();if(u==="None")y=[];else{let l=y.indexOf(u);l>=0?y.splice(l,1):y.push(u)}m=["N","S","E","W"].filter(l=>y.includes(l)),g(),z.markDirty()})});function h(c){let u=d();(c===p.area(u)||c===p.spacing(u)||c===p.pipeType(u)||c===p.exteriorWalls(u))&&f.refresh()}B("selectedZone",f.discard),B("zoneNames",f.refresh);for(let c=1;c<=6;c++)w(p.area(c),h),w(p.spacing(c),h),w(p.pipeType(c),h),w(p.exteriorWalls(c),h);k(t),f.refresh()}});var de=6,Dr="#6E7E96",_o="#5C6B85",Pr="#7aa7ce",Rr="#9DBC78",Or="#FF8531",Hr="#FFA600",qr="#7aa7ce",Ir="#FFEAD2",Br="#6E7E96",zo="#B9CBD8",Ue="#5C6B85",wt="#A6B9C7",ko="#A6B9C7",So="#7aa7ce",Wr="#66BB6A",Zr="#FF6361",j={w:1160,h:310,boxX:452,boxY:34,boxW:256,boxH:68,topBarY:0,topBarH:24,srcY:102,fanY:158,zoneY:232,zoneXs:[92,286,480,674,868,1062],srcSpread:15,bgDstHW:28,srcHW:7},D={w:760,h:340,boxX:38,boxY:132,boxW:142,boxH:72,srcX:180,endX:386,nameX:446,midY:168,zoneYs:[58,104,150,196,242,288],spread:8,bgDstHW:15,srcHW:4},jr=`
.flow-wrap {
  width: 100%;
  border-radius: 18px;
  overflow: hidden;
...
`;function ea(e){let t=Kr[e.level]||{label:"?",color:"var(--text-secondary)"},o=Mo(e.tag||""),r=Mo(e.msg||"");return'<div class="log-line"><span class="lv" style="color:'+t.color+'">'+t.label+'</span><span class="tag">'+o+'</span><span class="msg">'+r+"</span></div>"}function Mo(e){return String(e).replace(/[&<>]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[t])}var Cs=T({tag:"logs-view",render:Qr,onMount(e,t){let o=t.querySelector(".logs-stream"),r=t.querySelector(".pause-btn"),n=t.querySelector(".clear-btn"),a=!1;function i(){if(a)return;let d=Mt();if(!d||!d.length){o.innerHTML='<div class="logs-empty">'+b("logs.waiting")+"</div>";return}let f=o.scrollHeight-o.scrollTop-o.clientHeight<40;o.innerHTML=d.map(ea).join(""),f&&(o.scrollTop=o.scrollHeight)}r.addEventListener("click",()=>{a=!a,r.textContent=a?b("logs.resume"):b("logs.pause"),r.classList.toggle("on",a),a||i()}),n.addEventListener("click",()=>{Et()}),B("deviceLog",i),k(t),i()}});var ta=`
.diag-i2c {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`,Ts=T({tag:"diag-i2c",render:oa,onMount(e,t){let o=t.querySelector("#i2c-result");function r(){o.textContent=O("i2cResult")||b("diagnostics.i2c.empty")}t.querySelector("#btn-i2c-scan").addEventListener("click",()=>{Ot()}),B("i2cResult",r),k(t),r()}});var ra=`
.diag-manual-badge {
  display: none;
  align-items: center;
  gap: 10px;
...
`,qs=T({tag:"diag-manual-badge",render:aa,onMount(e,t){let o=t.classList.contains("diag-manual-badge")?t:t.querySelector(".diag-manual-badge");function r(){let n=!!O("manualMode");o&&o.classList.toggle("on",n)}B("manualMode",r),k(t),r()}});var na=`
.diag-zone-motor {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`;F("diag-zone-motor",na);var sa=e=>{let t=e.zone||O("selectedZone")||1,o="";for(let r=1;r<=6;r++)o+='<option value="'+r+'"'+(r===t?" selected":"")+">"+b("common.zone")+" "+r+"</option>";return`
...
`;F("diag-zone-recovery",ia);var la=()=>`
  ...
  `,ei=T({tag:"diag-zone-recovery-card",render:la,onMount(e,t){let o=Number(O("selectedZone")||1),r=t.querySelector(".recovery-fault-btn"),n=t.querySelector(".recovery-factors-btn"),a=t.querySelector(".recovery-relearn-btn"),i=t.querySelector(".recovery-status");B("selectedZone",()=>{o=Number(O("selectedZone")||1)});let d=null;function f(g,z){i.textContent=g,i.className="recovery-status show "+(z?"ok":"err"),clearTimeout(d),d=setTimeout(()=>{i.classList.remove("show")},4e3)}function m(g,z){let h=g(o);f(z,!0),h&&typeof h.then=="function"&&h.then(c=>{c&&c.ok===!1&&f(b("diagnostics.recovery.rejected"),!1)}).catch(()=>f(b("diagnostics.recovery.unreachable"),!1))}r==null||r.addEventListener("click",()=>{m(Zt,"\u2713 "+b("diagnostics.recovery.faultSent",{zone:$(o)}))}),n==null||n.addEventListener("click",()=>{confirm(b("diagnostics.recovery.confirmFactors",{zone:$(o)}))&&m(jt,"\u2713 "+b("diagnostics.recovery.factorsReset",{zone:$(o)}))}),a==null||a.addEventListener("click",()=>{confirm(b("diagnostics.recovery.confirmRelearn",{zone:$(o)}))&&m(Vt,"\u2713 "+b("diagnostics.recovery.relearnStarted",{zone:$(o)}))}),k(t)}});var da=`
...
`;F("asgard-bridge-status-card",pa);var ua=()=>`
...
`;F("settings-manifold-card",ma);var ga=()=>{let e="";for(let o=1;o<=8;o++)e+="<option>Probe "+o+"</option>";let t="";for(let o=1;o<=8;o++)t+='<div class="probe-cell"><div class="probe-name">Probe '+o+'</div><div class="probe-temp" data-probe="'+o+'">---</div></div>';return`
...
`,Ti=T({tag:"settings-minimum-flow-card",render:fa,onMount(e,t){let o=t.querySelector(".smf-always"),r=t.querySelector(".smf-pct"),n=re(t);n.toggle(o,{read:()=>Y(s.minimumFlowAlways),commit:a=>{let i=a?"on":"off";v(s.minimumFlowAlways,{state:i}),ne("minimum_flow_always",i).catch(()=>v(s.minimumFlowAlways,{state:a?"off":"on"}))}}),n.num(r,{read:()=>L(s.minZoneFlowPct),commit:a=>{v(s.minZoneFlowPct,{value:a}),se("min_zone_flow_pct",a)}}),w(s.minimumFlowAlways,n.refresh),w(s.minZoneFlowPct,n.refresh),k(t),n.refresh()}});var ba=`
...
`;F("settings-control-card",ba);var va=()=>`
...
`,qi=T({tag:"settings-control-card",render:va,onMount(e,t){k(t),t.querySelector(".sc-reset-probe-map").addEventListener("click",()=>{ue("reset_1wire_probe_map_reboot")}),t.querySelector(".sc-dump-1wire").addEventListener("click",()=>{ue("dump_1wire_probe_diagnostics")}),t.querySelector(".sc-restart").addEventListener("click",()=>{ue("restart")})}});var ha=`
...
`;F("settings-motor-calibration-card",ha);var Ke=[{cls:"safe-runtime",key:"generic_runtime_limit_seconds",id:s.genericRuntimeLimitSeconds,labelKey:"settings.motor.maxSafeRuntime",unit:"s"},{cls:"close-threshold",key:"close_threshold_multiplier",id:s.closeThresholdMultiplier,labelKey:"settings.motor.closeThreshold",unit:"x"},{cls:"close-slope-threshold",key:"close_slope_threshold",id:s.closeSlopeThreshold,labelKey:"settings.motor.closeSlope",unit:"mA/s"},{cls:"close-slope-floor",key:"close_slope_current_factor",id:s.closeSlopeCurrentFactor,labelKey:"settings.motor.closeSlopeFloor",unit:"x"},{cls:"open-threshold",key:"open_threshold_multiplier",id:s.openThresholdMultiplier,labelKey:"settings.motor.openThreshold",unit:"x"},{cls:"open-slope-threshold",key:"open_slope_threshold",id:s.openSlopeThreshold,labelKey:"settings.motor.openSlope",unit:"mA/s"},{cls:"open-slope-floor",key:"open_slope_current_factor",id:s.openSlopeCurrentFactor,labelKey:"settings.motor.openSlopeFloor",unit:"x"},{cls:"open-ripple-limit",key:"open_ripple_limit_factor",id:s.openRippleLimitFactor,labelKey:"settings.motor.openRippleLimit",unit:"x"},{cls:"relearn-movements",key:"relearn_after_movements",id:s.relearnAfterMovements,labelKey:"settings.motor.relearnMovements",unit:"count"},{cls:"relearn-hours",key:"relearn_after_hours",id:s.relearnAfterHours,labelKey:"settings.motor.relearnHours",unit:"h"},{cls:"learn-min-samples",key:"learned_factor_min_samples",id:s.learnedFactorMinSamples,labelKey:"settings.motor.learnMinSamples",unit:"count"},{cls:"learn-max-deviation",key:"learned_factor_max_deviation_pct",id:s.learnedFactorMaxDeviationPct,labelKey:"settings.motor.learnMaxDeviation",unit:"%"}],xa=()=>{let e="";for(let t=0;t<Ke.length;t++){let o=Ke[t];if(o.key==="generic_runtime_limit_seconds")continue;let r=ya(o.key)?"1":"0.1";e+='<div class="ui-row"><span class="ui-label"><span data-i18n="'+o.labelKey+'">'+b(o.labelKey)+"</span> ("+o.unit+')</span><span class="ui-field"><input type="number" class="ui-input smc-'+o.cls+'" value="0" step="'+r+'"></span></div>'}return`
  ...
  `};function ya(e){return e==="learned_factor_min_samples"||e==="generic_runtime_limit_seconds"||e==="relearn_after_movements"||e==="relearn_after_hours"}var Ui=T({tag:"settings-motor-calibration-card",render:xa,onMount(e,t){let o=t.querySelector(".smc-profile"),r=t.querySelector(".smc-safe-runtime"),n=t.querySelector(".mc-drivers-toggle"),a=re(t);function i(f){if(f==="HmIP VdMot"&&se("hmip_runtime_limit_seconds",40),f==="Generic"){let m=Number(L(s.genericRuntimeLimitSeconds));(!Number.isFinite(m)||m<=0)&&se("generic_runtime_limit_seconds",45)}}a.toggle(n,{read:()=>Y(s.drivers),commit:f=>Rt(f)}),a.select(o,{read:()=>N(s.motorProfileDefault)||"HmIP VdMot",commit:f=>{ne("motor_profile_default",f),i(f)}});function d(){let f=N(s.motorProfileDefault)||"HmIP VdMot";r.disabled=f==="HmIP VdMot"}a.num(r,{read:()=>(N(s.motorProfileDefault)||"HmIP VdMot")==="HmIP VdMot"?40:L(s.genericRuntimeLimitSeconds),commit:f=>{o.value==="Generic"&&se("generic_runtime_limit_seconds",f)}});for(let f=0;f<Ke.length;f++){let m=Ke[f];if(m.key==="generic_runtime_limit_seconds")continue;let g=t.querySelector(".smc-"+m.cls);g&&(a.num(g,{read:()=>L(m.id),commit:z=>se(m.key,z)}),w(m.id,a.refresh))}w(s.drivers,a.refresh),w(s.motorProfileDefault,()=>{a.refresh(),d()}),w(s.genericRuntimeLimitSeconds,a.refresh),w(s.hmipRuntimeLimitSeconds,a.refresh),k(t),i(N(s.motorProfileDefault)||"HmIP VdMot"),a.refresh(),d()}});var wa=`
.settings-asgard-card .ui-row:last-child { margin-bottom: 0; }
`;F("settings-asgard-card",wa);var za=()=>`
...
`;F("smart-preheat-card",Sa);var _a=()=>`
