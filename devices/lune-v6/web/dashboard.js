...
`;F("ui-kit",Ko);function pe(e){let t=f(e);return`<span class="help-badge" tabindex="0" role="img" aria-label="${String(t).replace(/"/g,"&quot;")}" data-i18n-label="${e}">?<span class="help-tip" data-i18n="${e}">${t}</span></span>`}function Jo(e,t){let o=Math.abs(Number(e));return!Number.isFinite(o)||o<1e3?t:Math.pow(10,Math.floor(Math.log10(o))-1)}function Qo(e){let t=String(e),o=t.indexOf(".");return o<0?0:t.length-o-1}function re(e,t={}){let o=e.querySelector(t.title||".ui-card-title"),r=document.createElement("div");r.className="ui-form-banner",r.innerHTML='<span class="ui-form-banner-msg" data-i18n="form.unsaved">Unsaved changes</span><span class="ui-form-banner-btns"><button type="button" class="ui-form-discard" data-i18n="form.discard">Discard</button><button type="button" class="ui-form-apply" data-i18n="form.apply">Apply</button></span>',o?o.insertAdjacentElement("afterend",r):e.insertAdjacentElement("afterbegin",r);let n=[],a=()=>r.classList.toggle("show",n.some(l=>l.dirty)),i=(l,k)=>{l.dirty=k,a()};function d(l){return l.markDirty=()=>i(l,!0),n.push(l),l}function b(l,k){let A={dirty:!1,input:l},S=k.baseStep!=null?k.baseStep:parseFloat(l.step)||1,x=Qo(S),L=k.min!=null?k.min:l.min!==""?parseFloat(l.min):-1/0,M=k.max!=null?k.max:l.max!==""?parseFloat(l.max):1/0,W=H=>x>0?Number(H).toFixed(x):String(Math.round(Number(H)));if(!k.nostep){let H=document.createElement("div");H.className="ui-stepper",l.parentNode.insertBefore(H,l);let E=document.createElement("button");E.type="button",E.className="ui-step-btn",E.textContent="\u2212",E.tabIndex=-1,E.setAttribute("aria-label",f("common.decrease"));let Z=document.createElement("button");Z.type="button",Z.className="ui-step-btn",Z.textContent="+",Z.tabIndex=-1,Z.setAttribute("aria-label",f("common.increase")),H.appendChild(E),H.appendChild(l),H.appendChild(Z),l.readOnly=!0;let I=X=>{if(l.disabled)return;let U=parseFloat(l.value);Number.isFinite(U)||(U=parseFloat(l.placeholder)),Number.isFinite(U)||(U=0);let _e=Math.min(M,Math.max(L,U+X*Jo(U,S)));l.value=W(_e),i(A,!0)};E.addEventListener("click",()=>I(-1)),Z.addEventListener("click",()=>I(1)),l.addEventListener("dblclick",()=>{l.disabled||(l.readOnly=!1,l.classList.add("editing"),l.focus(),l.select())}),l.addEventListener("blur",()=>{l.readOnly=!0,l.classList.remove("editing")}),l.addEventListener("keydown",X=>{X.key==="Enter"&&l.blur()})}return l.addEventListener("input",()=>i(A,!0)),A.sync=()=>{let H=k.read();l.value=H!=null&&Number.isFinite(Number(H))?W(H):""},A.commit=()=>{let H=parseFloat(l.value);Number.isFinite(H)&&k.commit(Math.min(M,Math.max(L,H)))},d(A)}function m(l,k){let A={dirty:!1,input:l};return l.addEventListener("input",()=>i(A,!0)),A.sync=()=>{let S=k.read();l.value=S!=null?S:""},A.commit=()=>k.commit(l.value.trim()),d(A)}function g(l,k){let A={dirty:!1,input:l};return l.addEventListener("change",()=>i(A,!0)),A.sync=()=>{let S=k.read();S!=null&&(l.value=S)},A.commit=()=>k.commit(l.value),d(A)}function z(l,k){let A={dirty:!1,input:l,staged:!1},S=l.closest(".ui-row"),x=()=>{l.classList.toggle("on",A.staged),S&&S.classList.toggle("is-on",A.staged),l.setAttribute("aria-checked",A.staged?"true":"false"),k.onChange&&k.onChange(A.staged)};return l.addEventListener("click",()=>{A.staged=!A.staged,i(A,!0),x()}),A.sync=()=>{A.staged=!!k.read(),x()},A.commit=()=>k.commit(A.staged),d(A)}function y(l){let k={dirty:!1,sync:l.sync,commit:l.commit};return d(k)}let p=()=>n.forEach(l=>{!l.dirty&&l.sync&&l.sync()}),u=()=>{n.forEach(l=>{l.dirty&&(l.commit&&l.commit(),l.dirty=!1)}),a(),t.onApply&&t.onApply()},h=()=>{n.forEach(l=>{l.dirty=!1,l.sync&&l.sync()}),a(),t.onDiscard&&t.onDiscard()};return r.querySelector(".ui-form-apply").addEventListener("click",u),r.querySelector(".ui-form-discard").addEventListener("click",h),_(r),{num:b,text:m,select:g,toggle:z,custom:y,refresh:p,apply:u,discard:h,isDirty:()=>n.some(l=>l.dirty)}}function ae(e){return e!=null&&!isNaN(e)?Math.round(e*10)/10+"\xB0C":"---"}function Ie(e){return e!=null&&!isNaN(e)?(e|0)+"%":"---"}function Be(e){if(!e||isNaN(e))return"---";e=e|0;var t=e/86400|0,o=e%86400/3600|0,r=e%3600/60|0;return t>0?t+"d "+o+"h "+r+"m":o>0?o+"h "+r+"m":r+"m"}function eo(e){return e==null||isNaN(e)?"---":(e=e|0,e>-50?e+" dBm \u2590\u2590\u2590\u2590":e>-60?e+" dBm \u2590\u2590\u2590\u2591":e>-70?e+" dBm \u2590\u2590\u2591\u2591":e>-80?e+" dBm \u2590\u2591\u2591\u2591":e+" dBm \u2591\u2591\u2591\u2591")}function to(e){if(e==null||isNaN(e))return"hh:mm";let t=Math.round(Date.now()/1e3-e),o=new Date(t*1e3),r=n=>String(n).padStart(2,"0");return`${r(o.getHours())}:${r(o.getMinutes())}`}var er=`
.topbar {
  position: static;
  margin-bottom: 14px;
  padding: 11px 14px;
...
`,sn=N({tag:"hv6-header",render:tr,onMount(e,t){let o=t.querySelector("#hdr-dot"),r=t.querySelector("#hdr-sync"),n=t.querySelector("#hdr-up"),a=t.querySelector("#hdr-wifi"),i=t.querySelector("#hdr-asgard"),d=t.querySelector("#hdr-asgard-val"),b=t.querySelector("#hdr-asgard-time"),m=t.querySelector("#hdr-fw");function g(){let z=O("live"),y=O("pendingWrites"),p=!!(window.HV6_DASHBOARD_CONFIG&&window.HV6_DASHBOARD_CONFIG.mock);o.classList.toggle("on",!!z);let u,h;y>0?(u=f("status.saving"),h="saving"):p?(u=window.HV6_DASHBOARD_CONFIG.mockLabel||f("status.mock"),h="synced"):z?(u=f("status.live"),h="synced"):(u=f("status.offline"),h="offline"),r.textContent=u,r.className="meta-chip meta-chip-state "+h,n.textContent=Be(C(s.uptime)),a.textContent=eo(C(s.wifi));let l=C(s.asgardLastPushC),k=C(s.asgardLastPushAgeS),A=Y(s.asgardEnabled)&&l!=null&&Number.isFinite(l);i.hidden=!A,A&&(d.textContent=l.toFixed(2)+"\xB0C",b.textContent=to(k));let S=O("firmwareVersion")||T(s.firmware);m.textContent=S?"FW "+S:""}B("live",g),B("pendingWrites",g),B("firmwareVersion",g),w(s.uptime,g),w(s.wifi,g),w(s.asgardLastPushC,g),w(s.asgardLastPushAgeS,g),w(s.asgardEnabled,g),w(s.firmware,g),_(t),g()}}),or=()=>`
  <nav class="side-nav">
...
`;N({tag:"hv6-sidebar",render:or,onMount(e,t){let o=t.querySelectorAll(".side-link");function r(){let n=O("section");o.forEach(a=>{a.classList.toggle("active",a.getAttribute("data-section")===n)})}o.forEach(n=>{n.addEventListener("click",a=>{a.preventDefault(),kt(n.getAttribute("data-section"))})}),B("section",r),_(t),r()}});var rr=`
.connectivity-card {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`,bn=N({tag:"connectivity-card",render:ar,onMount(e,t){let o=t.querySelector(".cc-ip"),r=t.querySelector(".cc-ssid"),n=t.querySelector(".cc-mac"),a=t.querySelector(".cc-up");function i(){o.textContent=T(s.ip)||"---",r.textContent=T(s.ssid)||"---",n.textContent=T(s.mac)||"---",a.textContent=Be(C(s.uptime))}w(s.ip,i),w(s.ssid,i),w(s.mac,i),w(s.uptime,i),_(t),i()}});var nr="http://www.w3.org/2000/svg",sr=`
.chart-card {
  border: 1px solid var(--panel-border);
  border-radius: 8px;
  background: var(--panel-bg-vibrant);
...
`;F("chart-kit",sr);function oe(e,t,o){let r=document.createElementNS(nr,e);if(t)for(let n in t)r.setAttribute(n,t[n]);return o!=null&&(r.textContent=o),r}function oo(e){if(!e.length)return"";if(e.length<3)return"M "+e.map(r=>`${r.x.toFixed(2)} ${r.y.toFixed(2)}`).join(" L ");let t=.16,o=`M ${e[0].x.toFixed(2)} ${e[0].y.toFixed(2)}`;for(let r=0;r<e.length-1;r++){let n=e[r-1]||e[r],a=e[r],i=e[r+1],d=e[r+2]||i,b=a.x+(i.x-n.x)*t,m=a.y+(i.y-n.y)*t,g=i.x-(d.x-a.x)*t,z=i.y-(d.y-a.y)*t;o+=` C ${b.toFixed(2)} ${m.toFixed(2)}, ${g.toFixed(2)} ${z.toFixed(2)}, ${i.x.toFixed(2)} ${i.y.toFixed(2)}`}return o}function ro(e,t,o){let r=document.createElement("div");r.className="chart-tooltip",t.appendChild(r);let n=oe("g",{class:"chart-cursor",style:"display:none"}),a=oe("line",{class:"chart-cursor-line",y1:o.plotTop,y2:o.plotBottom});n.appendChild(a);let i=[];e.appendChild(n);function d(z){let y=0,p=1/0;for(let u=0;u<o.count;u++){let h=Math.abs(z-o.xAt(u));h<p&&(p=h,y=u)}return y}function b(z){let y=e.getScreenCTM();if(!y)return null;let p=e.createSVGPoint();return p.x=z.clientX,p.y=z.clientY,p.matrixTransform(y.inverse())}function m(z){if(!o.count)return;let y=b(z);if(!y)return;let p=d(y.x),u=o.xAt(p);a.setAttribute("x1",u),a.setAttribute("x2",u);let h=o.dots(p);for(;i.length<h.length;){let S=oe("circle",{class:"chart-cursor-dot",r:3.4});n.appendChild(S),i.push(S)}i.forEach((S,x)=>{x<h.length?(S.setAttribute("cx",u),S.setAttribute("cy",h[x].y),S.setAttribute("fill",h[x].color),S.style.display=""):S.style.display="none"}),n.style.display="";let l=o.rows(p).map(S=>`<div class="tt-row"><span class="tt-swatch" style="background:${S.color}"></span>${S.label}<span class="tt-val">${S.value}</span></div>`).join("");r.innerHTML=`<div class="tt-time">${o.label(p)}</div>${l}`,r.classList.add("show");let k=t.getBoundingClientRect(),A=z.clientX-k.left+14;A+r.offsetWidth>k.width-6&&(A=z.clientX-k.left-r.offsetWidth-14),r.style.left=Math.max(6,A)+"px",r.style.top=Math.max(6,z.clientY-k.top+12)+"px"}function g(){r.classList.remove("show"),n.style.display="none"}return e.addEventListener("pointermove",m),e.addEventListener("pointerleave",g),()=>{e.removeEventListener("pointermove",m),e.removeEventListener("pointerleave",g),r.remove()}}var Ae=1e3,bt=180,le=14,ir=42,lr=44,be=42,je=Ae-be-ir,me=bt-le-lr,ve=le+me,ft=24*3600,ao=Q+2,no=Q+3,We=Q+4,dr="var(--series-warm)",cr="var(--series-cool)",so="var(--series-solar)",pr=`
...
`;F("graph-widgets",pr);var io=()=>'<div class="chart-card"><div class="chart-head"><span class="chart-title" data-i18n="overview.graph.flowReturnDemand">Flow / Return / Demand</span><span class="chart-sub gw-dt">\u2014</span></div><div class="gw-controls" role="toolbar" data-i18n-label="overview.graph.layers" aria-label="Flow chart layers"><button type="button" class="gw-toggle" data-layer="flow" aria-pressed="true" data-i18n="overview.graph.layers.flow">Flow</button><button type="button" class="gw-toggle" data-layer="return" aria-pressed="true" data-i18n="overview.graph.layers.return">Return</button><button type="button" class="gw-toggle" data-layer="demand" aria-pressed="true" data-i18n="overview.graph.layers.demand">Demand</button></div><svg class="gw-flow"></svg></div>',lo=()=>'<div class="chart-card"><div class="chart-head"><span class="chart-title" data-i18n="overview.graph.demandIndex">Demand Index</span><span class="chart-sub gw-demand-text">\u2014</span></div><svg class="gw-demand"></svg></div>',gr=e=>e.variant==="flow-return"?`<div class="graph-widgets">${io()}</div>`:e.variant==="demand"?`<div class="graph-widgets">${lo()}</div>`:`<div class="graph-widgets">${io()}${lo()}</div>`;function co(e,t){return Number.isFinite(e)?t==="%"?Math.round(e)+"%":e.toFixed(1):"\u2014"}function ur(e,t){return Number.isFinite(e)?t==="%"?Math.round(e)+"%":e.toFixed(1)+"\xB0":"\u2014"}function vt(e,t,o){let r=[];for(let n=0;n<e.length;n++){let a=e[n];if(!a||a[0]<o)continue;let i=a[t];i==null||!Number.isFinite(i)||r.push({t:a[0],v:i})}return r}var Ve=(e,t)=>be+Math.max(0,Math.min(1,(e-t)/ft))*je;function mr(e,t,o){let r=Number(Date.now()/1e3)|0,n=3600,a=Math.ceil((r-ft)/n)*n,i=Math.floor(r/n)*n,d=Math.floor(r/n)*n;for(let m=a;m<=i;m+=n){let g=o-(r-m),z=Ve(g,t),y=new Date(m*1e3),p=m===d,u=ve+16;e.appendChild(oe("text",{x:z,y:u,"text-anchor":"end",transform:`rotate(-45 ${z.toFixed(1)} ${u})`,class:"chart-hour"+(p?" now":"")},String(y.getHours()).padStart(2,"0")))}let b=Ve(o,t);e.appendChild(oe("line",{x1:b,y1:le,x2:b,y2:ve,stroke:"var(--series-solar)","stroke-width":"1","stroke-dasharray":"2 3",opacity:".55","vector-effect":"non-scaling-stroke"}))}function br(e){let t=[];if(e.forEach(a=>a.forEach(i=>t.push(i.v))),!t.length)return{min:0,max:10};let o=Math.min(...t),r=Math.max(...t);o===r&&(o-=.5,r+=.5);let n=(r-o)*.1;return o-=n,r+=n,{min:o,max:r}}function fr(e,t,o){let r=e.filter(n=>n.unit==="C").map(n=>vt(t,n.index,o));return br(r)}function po(e,t,o,r,n,a){e.innerHTML="",e.setAttribute("viewBox",`0 0 ${Ae} ${bt}`),e.setAttribute("preserveAspectRatio","xMidYMid meet");let i=o.map(u=>vt(r,u.index,n));if(!i.some(u=>u.length))return e.appendChild(oe("text",{x:Ae/2,y:bt/2,"text-anchor":"middle",class:"chart-empty"},"Collecting history\u2026")),null;let d=fr(o,r,n),b=Math.max(.001,d.max-d.min),m=u=>le+(1-(u-d.min)/b)*me,g=u=>le+(1-Math.max(0,Math.min(100,u))/100)*me,z=(u,h)=>u.unit==="%"?g(h):m(h);for(let u=0;u<3;u++){let h=u/2,l=le+h*me;e.appendChild(oe("line",{x1:be,y1:l,x2:be+je,y2:l,class:"chart-grid"})),o.some(k=>k.unit==="C")&&e.appendChild(oe("text",{x:be-6,y:l+4,"text-anchor":"end",class:"chart-tick"},co(d.max-b*h,"C")+"\xB0")),o.some(k=>k.unit==="%")&&e.appendChild(oe("text",{x:be+je+6,y:l+4,"text-anchor":"start",class:"chart-tick"},co(100-100*h,"%")))}e.appendChild(oe("line",{x1:be,y1:ve,x2:be+je,y2:ve,class:"chart-axis"})),o.some(u=>u.unit==="C")&&e.appendChild(oe("text",{x:9,y:le+me/2,transform:`rotate(-90 9 ${(le+me/2).toFixed(1)})`,"text-anchor":"middle",class:"chart-axis-label"},f("overview.graph.axis.temp"))),o.some(u=>u.unit==="%")&&e.appendChild(oe("text",{x:Ae-9,y:le+me/2,transform:`rotate(90 ${Ae-9} ${(le+me/2).toFixed(1)})`,"text-anchor":"middle",class:"chart-axis-label"},f("overview.graph.axis.demand"))),mr(e,n,a),o.forEach((u,h)=>{let l=i[h].map(A=>({x:Ve(A.t,n),y:z(u,A.v)}));if(!l.length)return;let k=oo(l);u.fill&&e.appendChild(oe("path",{d:k+` L ${l[l.length-1].x.toFixed(1)} ${ve} L ${l[0].x.toFixed(1)} ${ve} Z`,fill:u.fill,stroke:"none"})),e.appendChild(oe("path",{d:k,fill:"none",stroke:u.color,"stroke-width":String(u.width||2.2),"stroke-linecap":"round","stroke-linejoin":"round"}))});let y=[];for(let u=0;u<r.length;u++){let h=r[u];if(!h||h[0]<n)continue;let l=o.map(k=>h[k.index]);l.every(k=>k==null||!Number.isFinite(k))||y.push({t:h[0],vals:l})}if(!y.length)return null;let p=Date.now();return ro(e,t,{count:y.length,plotTop:le,plotBottom:ve,xAt:u=>Ve(y[u].t,n),label:u=>new Date(p-(a-y[u].t)*1e3).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),dots:u=>o.map((h,l)=>({y:z(h,y[u].vals[l]),color:h.color})).filter((h,l)=>Number.isFinite(y[u].vals[l])),rows:u=>o.map((h,l)=>({color:h.color,label:h.label,value:ur(y[u].vals[l],h.unit)})).filter((h,l)=>Number.isFinite(y[u].vals[l]))})}function Ze(e,t,o){let r=vt(e,t,o);return r.length?r[r.length-1].v:null}var kn=N({tag:"graph-widgets",state:e=>({variant:e&&e.variant||"both"}),render:gr,onMount(e,t){let o=t.querySelector(".gw-dt"),r=t.querySelector(".gw-demand-text"),n=t.querySelector(".gw-flow"),a=t.querySelector(".gw-demand"),i=Array.from(t.querySelectorAll(".gw-toggle")),d={flow:!0,return:!0,demand:!0},b=null,m=null;function g(){i.forEach(p=>{let u=p.dataset.layer;p.classList.toggle("is-off",!d[u]),p.setAttribute("aria-pressed",d[u]?"true":"false")})}function z(){let p=[];return d.flow&&p.push({index:ao,color:dr,label:f("overview.graph.layers.flow"),unit:"C",width:2.4}),d.return&&p.push({index:no,color:cr,label:f("overview.graph.layers.return"),unit:"C",width:2}),d.demand&&p.push({index:We,color:so,label:f("overview.graph.layers.demand"),unit:"%",width:1.8,fill:"rgba(255,193,77,.10)"}),p}function y(){let p=O("zoneStateHistory"),u=p&&Array.isArray(p.entries)?p.entries:[],h=p&&p.uptime_s||Number(Date.now()/1e3)|0,l=h-ft;if(n){b&&b();let k=Ze(u,ao,l),A=Ze(u,no,l),S=Ze(u,We,l),x=[];k!=null&&A!=null&&x.push("\u0394 "+(k-A).toFixed(1)+"\xB0"),S!=null&&x.push(Math.round(S)+"%"),o.textContent=x.length?x.join(" \xB7 "):"\u2014",b=po(n,n.closest(".chart-card"),z(),u,l,h)}if(a){m&&m();let k=Ze(u,We,l);r.textContent=k!=null?Math.round(k)+"%":"\u2014",m=po(a,a.closest(".chart-card"),[{index:We,color:so,label:f("overview.graph.layers.demand"),unit:"%",width:2.2,fill:"var(--series-cool-fill)"}],u,l,h)}}i.forEach(p=>{p.addEventListener("click",()=>{let u=p.dataset.layer;d[u]=!d[u],!d.flow&&!d.return&&!d.demand&&(d[u]=!0),g(),y()})}),B("zoneStateHistory",y),_(t),g(),y()}});var fe={0:{labelKey:"state.off",color:"#2c4875"},1:{labelKey:"state.manual",color:"#7aa7ce"},2:{labelKey:"state.calibrating",color:"#ffd380"},3:{labelKey:"state.waitCal",color:"#4e6977"},4:{labelKey:"state.waitTemp",color:"#4e6977"},5:{labelKey:"state.heating",color:"#ff8531"},6:{labelKey:"state.idle",color:"#39354c"},7:{labelKey:"state.overheated",color:"#ff6361"},255:{labelKey:"",color:"transparent"}},Me=24*3600,vr=Me,Ee=18,yt=4,he=54,Ge=32,ke=4,Ue=10,mo=6,bo="#ffc14d",ht=9,go=Q+1,fo=ke+Q*(Ee+yt)-yt,xt=fo+mo,$e=fo+mo+Ue+Ge,hr=`
.timeline-card {
  border: 1px solid var(--panel-border);
  border-radius: 8px;
  background: var(--panel-bg-vibrant);
...
`;F("zone-state-timeline",hr);var xr=()=>`
...
`;function yr(e,t){if(!e||!e.entries||e.entries.length===0)return null;let o=e.entries,r=e.uptime_s||t||0,n=Number(Date.now()/1e3)|0,a=1e3,i=a-he;function d(S){let x=(S+Me)/vr;return he+Math.max(0,Math.min(1,x))*i}function b(S){return S-r}let m="http://www.w3.org/2000/svg",g=document.createElementNS(m,"svg");g.setAttribute("viewBox","0 0 "+a+" "+$e),g.classList.add("timeline-svg");let z=document.createElementNS(m,"rect");z.setAttribute("x",he),z.setAttribute("y",ke),z.setAttribute("width",i),z.setAttribute("height",$e-ke-Ge),z.setAttribute("fill","rgba(0,32,46,0.55)"),z.setAttribute("rx","4"),g.appendChild(z);let y=d(0),p=[-24,-18,-12,-6,0].map(S=>S*3600);for(let S of p){let x=d(S),L=document.createElementNS(m,"line");L.setAttribute("x1",x),L.setAttribute("y1",ke),L.setAttribute("x2",x),L.setAttribute("y2",$e-Ge),L.setAttribute("stroke",S===0?"var(--series-solar)":"rgba(120,146,200,.16)"),L.setAttribute("stroke-width","1"),S===0&&(L.setAttribute("stroke-dasharray","2 3"),L.setAttribute("opacity",".55"),L.setAttribute("vector-effect","non-scaling-stroke")),g.appendChild(L)}g.appendChild(wr(m,"text",{x:y+4,y:ke+11,"text-anchor":"start",fill:"rgba(255,211,128,.92)","font-size":"9","font-family":"Montserrat, sans-serif","font-weight":"600"},"now"));for(let S=0;S<Q;S++){let x=ke+S*(Ee+yt),L=document.createElementNS(m,"rect");L.setAttribute("x",he),L.setAttribute("y",x),L.setAttribute("width",i),L.setAttribute("height",Ee),L.setAttribute("fill",S%2===0?"rgba(124,155,208,0.05)":"rgba(124,155,208,0.00)"),g.appendChild(L);let M=document.createElementNS(m,"text");M.setAttribute("x",he-4),M.setAttribute("y",x+Ee/2+1),M.setAttribute("text-anchor","end"),M.setAttribute("dominant-baseline","middle"),M.setAttribute("fill","rgba(233,222,210,.62)"),M.setAttribute("font-size","9.5"),M.setAttribute("font-family","Montserrat, sans-serif"),M.setAttribute("font-weight","600"),M.textContent="Z"+(S+1),g.appendChild(M);let W=o.map(E=>({rel:b(E[0]),state:E[S+1]})).filter(E=>E.rel>=-Me&&E.rel<=0),H=(E,Z,I)=>{if(I===255)return;let X=fe[I]||fe[255];if(X.color==="transparent")return;let U=d(E),_e=d(Z),Qe=Math.max(1,_e-U),ce=document.createElementNS(m,"rect");ce.setAttribute("x",U),ce.setAttribute("y",x+(Ee-ht)/2),ce.setAttribute("width",Qe),ce.setAttribute("height",ht),ce.setAttribute("fill",X.color),ce.setAttribute("rx",String(ht/2)),ce.setAttribute("opacity","0.9"),g.appendChild(ce)};if(W.length){let E=W[0].rel,Z=W[0].state;for(let I=1;I<W.length;I++){let X=W[I];X.state!==Z&&(H(E,X.rel,Z),E=X.rel,Z=X.state)}H(E,0,Z)}}{let S=document.createElementNS(m,"rect");S.setAttribute("x",he),S.setAttribute("y",xt),S.setAttribute("width",i),S.setAttribute("height",Ue),S.setAttribute("fill","rgba(188,80,144,0.10)"),S.setAttribute("rx","2"),g.appendChild(S);let x=document.createElementNS(m,"text");x.setAttribute("x",he-4),x.setAttribute("y",xt+Ue/2+1),x.setAttribute("text-anchor","end"),x.setAttribute("dominant-baseline","middle"),x.setAttribute("fill","rgba(233,222,210,.62)"),x.setAttribute("font-size","8.5"),x.setAttribute("font-family","Montserrat, sans-serif"),x.setAttribute("font-weight","600"),x.textContent=f("overview.timeline.absorb"),g.appendChild(x);let L=o.map(M=>({rel:b(M[0]),on:M.length>go?M[go]:0})).filter(M=>M.rel>=-Me&&M.rel<=0);if(L.length){let M=(E,Z)=>{let I=d(E),X=Math.max(1,d(Z)-I),U=document.createElementNS(m,"rect");U.setAttribute("x",I),U.setAttribute("y",xt),U.setAttribute("width",X),U.setAttribute("height",Ue),U.setAttribute("fill",bo),U.setAttribute("rx","2"),U.setAttribute("opacity","0.9"),g.appendChild(U)},W=L[0].rel,H=L[0].on;for(let E=1;E<L.length;E++)L[E].on!==H&&(H&&M(W,L[E].rel),W=L[E].rel,H=L[E].on);H&&M(W,0)}}let u=$e-Ge+15,h=3600,l=Math.ceil((n-Me)/h)*h,k=Math.floor(n/h)*h,A=Math.floor(n/h)*h;for(let S=l;S<=k;S+=h){let x=S-n,L=d(x),M=new Date(S*1e3),W=String(M.getHours()).padStart(2,"0"),H=S===A,E=document.createElementNS(m,"text");E.setAttribute("x",L),E.setAttribute("y",u),E.setAttribute("text-anchor","end"),E.setAttribute("fill",H?"rgba(255,211,128,.95)":"rgba(202,219,248,.72)"),E.setAttribute("font-size","9"),E.setAttribute("font-family",'"Montserrat", sans-serif'),E.setAttribute("font-weight","500"),E.setAttribute("font-variant-numeric","tabular-nums lining-nums"),E.setAttribute("font-feature-settings",'"tnum" 1, "lnum" 1'),E.setAttribute("letter-spacing","0"),E.setAttribute("transform",`rotate(-45 ${L.toFixed(1)} ${u})`),E.textContent=W,g.appendChild(E)}return g}function wr(e,t,o,r){let n=document.createElementNS(e,t);for(let a in o)n.setAttribute(a,o[a]);return r!=null&&(n.textContent=r),n}function uo(e){e.innerHTML="";let t=[{code:5,...fe[5]},{code:6,...fe[6]},{code:0,...fe[0]},{code:1,...fe[1]},{code:7,...fe[7]},{code:2,...fe[2]}];for(let r of t){let n=document.createElement("div");n.className="tl-legend-item",n.innerHTML='<span class="tl-legend-dot" style="background:'+r.color+'"></span>'+(r.labelKey?f(r.labelKey):""),e.appendChild(n)}let o=document.createElement("div");o.className="tl-legend-item",o.innerHTML='<span class="tl-legend-dot" style="background:'+bo+'"></span>'+f("overview.timeline.preheatAbsorption"),e.appendChild(o)}var Fn=N({tag:"zone-state-timeline",render:xr,onMount(e,t){let o=t.querySelector(".tl-body"),r=t.querySelector(".timeline-legend");uo(r);function n(){let a=O("zoneStateHistory"),i=(()=>{let b=O&&O("zoneStateHistory");return b&&b.uptime_s||Number(Date.now()/1e3)|0})();if(o.innerHTML="",!a||!a.entries||a.entries.length===0){let b=document.createElement("div");b.className="timeline-empty",b.textContent=f("overview.timeline.noHistory"),o.appendChild(b);return}let d=yr(a,i);d&&o.appendChild(d)}B("zoneStateHistory",n),B("zoneNames",n),w(s.drivers,n);for(let a=1;a<=Q;a++)w(c.enabled(a),n),w(c.state(a),n),w(c.temp(a),n),w(c.setpoint(a),n),w(c.preheatAdvance(a),n);_(t),n()}});var zr=`
.zone-grid {
    display: grid;
...
`;F("zone-grid",zr);var Sr=()=>'<div class="zone-grid"></div>',Pn=N({tag:"zone-grid",render:Sr,onMount(e,t){for(let o=1;o<=6;o++)t.appendChild(V("zone-card",{zone:o}))}});var kr=`
.zone-card {
	display: grid;
...
`;F("zone-card",kr);var _r=e=>`
	<div class="zone-card" data-zone="${e.zone}">
		...
		<div class="zc-friendly">${ue(e.zone)||"---"}</div>
	</div>
`,Zn=N({tag:"zone-card",state:e=>({zone:e.zone}),render:_r,onMount(e,t){let o=e.zone,r=c.temp(o),n=c.state(o),a=c.enabled(o),i=t.querySelector(".zc-state-label"),d=t.querySelector(".zc-dot"),b=t.querySelector(".zc-link"),m=t.querySelector(".zc-zone-name"),g=t.querySelector(".zc-friendly");function z(p){let u=String(p||"").match(/\d+/);return u?Number(u[0]):0}function y(){let p=Y(a),u=String(T(n)||"").toUpperCase()||"OFF",h=String(T(c.motorLastFault(o))||"").toUpperCase(),l=h&&h!=="NONE"&&h!=="OK",k=p&&(u==="FAULT"||l)?"FAULT":u,A=O("selectedZone")===o,S=ue(o);m.textContent=$(o),g.textContent=S||ae(C(r));let x=p?k:"OFF";i.textContent=x==="HEATING"?f("state.heating"):x==="IDLE"?f("state.idle"):x==="FAULT"?f("common.fault"):x==="MANUAL"?f("state.manual"):x==="OVERHEATED"?f("state.overheated"):x==="CALIBRATING"?f("state.calibrating"):f("state.off");let L=z(T(c.syncTo(o))),M=[];for(let I=1;I<=6;I++)I!==o&&z(T(c.syncTo(I)))===o&&M.push(I);let W=L>0&&L!==o||M.length>0;b.hidden=!W,b.textContent=L>0&&L!==o?f("zone.card.linkZone",{zone:L}):M.length>1?f("zone.card.groupCount",{count:M.length}):f("zone.card.linkZone",{zone:M[0]});let H=L>0&&L!==o?f("zone.card.groupedWith",{zones:$(L)}):M.length>0?f("zone.card.groupedWith",{zones:M.map($).join(", ")}):"";t.title=l?f("zone.card.fault",{fault:h}):H;let E=x==="HEATING"?"#ffd380":x==="IDLE"?"#7aa7ce":x==="FAULT"?"#ff6361":"#6E7E96",Z=x==="HEATING"?"#ff8531":x==="IDLE"?"#7aa7ce":x==="FAULT"?"#ff6361":"rgba(120,146,200,.35)";i.style.color=E,d.style.background=Z,d.style.boxShadow=x==="HEATING"?"0 0 5px rgba(255,133,49,.6)":x==="FAULT"?"0 0 5px rgba(255,100,100,.6)":"",t.classList.toggle("active",A),t.classList.toggle("disabled",!p),t.classList.toggle("zs-heating",p&&x==="HEATING"),t.classList.toggle("zs-fault",p&&x==="FAULT"),t.classList.toggle("zs-idle",p&&x!=="HEATING"&&x!=="FAULT"),t.classList.toggle("zs-off",!p)}t.addEventListener("click",()=>{_t(o)}),w(r,y),w(n,y),w(a,y),w(c.motorLastFault(o),y);for(let p=1;p<=6;p++)w(c.syncTo(p),y);B("selectedZone",y),B("zoneNames",y),y()}});var Cr=`
.zone-detail {
...
`;function vo(e){return e!=null?Number(e).toFixed(2)+"x":"---"}function ho(e){return e!=null?Number(e).toFixed(0):"---"}function Ar(e){return e!=null?Number(e).toFixed(2)+"C":"---"}function Mr(e,t){if(!t)return f("common.disabled");let o=String(e||"IDLE").toUpperCase();return o==="HEATING"?f("state.heating"):o==="IDLE"?f("state.idle"):o==="OFF"?f("state.off"):o==="FAULT"?f("common.fault"):o==="MANUAL"?f("state.manual"):o==="OVERHEATED"?f("state.overheated"):o==="CALIBRATING"?f("state.calibrating"):o}var Jn=N({tag:"zone-detail",state:e=>({zone:e.zone,temp:"---",setpoint:"---",valve:"---",state:"---"}),render:Lr,methods:{update(e,t){let o=O("selectedZone"),r=String(T(c.state(o))||"").toUpperCase(),n=Y(c.enabled(o));this.zone=o,e.dataset.zone=String(o),t.title.textContent=$(o),t.setpoint.textContent=ae(C(c.setpoint(o))),t.temp.textContent=ae(C(c.temp(o))),t.ret.textContent=ae(C("sensor-manifold_return_temperature")),t.valve.textContent=Ie(C(c.valve(o)));let a=t.badge;a.textContent=Mr(r,n);let i=n?r==="HEATING"?"badge-heating":r==="IDLE"?"badge-idle":r==="FAULT"?"badge-fault":"":"badge-disabled";a.className="zd-badge"+(i?" "+i:""),t.toggle.classList.toggle("on",n),t.orip.textContent=ho(C(c.motorOpenRipples(o))),t.crip.textContent=ho(C(c.motorCloseRipples(o))),t.ofac.textContent=vo(C(c.motorOpenFactor(o))),t.cfac.textContent=vo(C(c.motorCloseFactor(o))),t.ph.textContent=Ar(C(c.preheatAdvance(o)));let d=String(T(c.motorLastFault(o))||"").toUpperCase(),b=d&&d!=="NONE"&&d!=="OK";t.fault.hidden=!b,b&&(t.faultVal.textContent=d)},incSetpoint(){let e=this.zone,t=C(c.setpoint(e))||20;nt(e,Number((t+.5).toFixed(1)))},decSetpoint(){let e=this.zone,t=C(c.setpoint(e))||20;nt(e,Number((t-.5).toFixed(1)))},toggleEnabled(){let e=this.zone,t=Y(c.enabled(e));Pt(e,!t)}},onMount(e,t){let o={title:t.querySelector(".zd-title"),setpoint:t.querySelector(".zd-setpoint"),temp:t.querySelector(".zd-temp"),ret:t.querySelector(".zd-ret"),valve:t.querySelector(".zd-valve"),badge:t.querySelector(".zd-badge"),toggle:t.querySelector(".btn-toggle"),inc:t.querySelector(".btn-inc"),dec:t.querySelector(".btn-dec"),orip:t.querySelector(".zd-orip"),crip:t.querySelector(".zd-crip"),ofac:t.querySelector(".zd-ofac"),cfac:t.querySelector(".zd-cfac"),ph:t.querySelector(".zd-ph"),fault:t.querySelector(".zd-fault"),faultVal:t.querySelector(".zd-fault-val")};o.inc.onclick=()=>e.incSetpoint(),o.dec.onclick=()=>e.decSetpoint(),o.toggle.onclick=()=>e.toggleEnabled();let r=()=>e.update(t,o),n=a=>{let i=O("selectedZone");(a===c.temp(i)||a===c.setpoint(i)||a===c.valve(i)||a===c.state(i)||a===c.enabled(i))&&r()};for(let a=1;a<=6;a++)w(c.temp(a),n),w(c.setpoint(a),n),w(c.valve(a),n),w(c.state(a),n),w(c.enabled(a),n),w(c.motorOpenRipples(a),r),w(c.motorCloseRipples(a),r),w(c.motorOpenFactor(a),r),w(c.motorCloseFactor(a),r),w(c.preheatAdvance(a),r),w(c.motorLastFault(a),r);w("sensor-manifold_return_temperature",r),B("selectedZone",r),_(t),r()}});var Er=`
...
`;F("zone-sensor-card",Er);var Fr=()=>{let e='<option value="None" data-i18n="common.none">None</option>';for(let t=1;t<=8;t++)e+='<option value="Probe '+t+'">Probe '+t+"</option>";return`
  ...
  `};function xo(e,t){let o=e.value,r='<option value="None" data-i18n="common.none">'+f("common.none")+"</option>";for(let n=1;n<=6;n++)n!==t&&(r+='<option value="Zone '+n+'">'+f("common.zone")+" "+n+"</option>");e.innerHTML=r,e.value=o||"None"}function Nr(e){return e==="BLE"||e==="BLE Sensor"?"BLE Sensor":"Local Probe"}function Tr(e){return e==="BLE Sensor"?"BLE":"Local Probe"}function yo(e,t){let o='<option value="Local Probe" data-i18n="zone.sensor.localProbe">'+f("zone.sensor.localProbe")+'</option><option value="BLE Sensor" data-i18n="zone.sensor.bleSource">'+f("zone.sensor.bleSource")+"</option>";e.innerHTML!==o&&(e.innerHTML=o),e.value=t}function wo(e){let t=String(e||"").match(/\d+/);return t?Number(t[0]):0}var is=N({tag:"zone-sensor-card",render:Fr,onMount(e,t){let o=t.querySelector(".zs-probe"),r=t.querySelector(".zs-source"),n=t.querySelector(".zs-ble"),a=t.querySelector(".zs-sync"),i=t.querySelector(".zs-row-ble"),d=t.querySelector(".zs-scan"),b=t.querySelector(".zs-scan-list"),m=t.querySelector(".merge-visual"),g=t.querySelector(".merge-rail"),z=t.querySelector(".merge-caption"),y=0;function p(){return O("selectedZone")}function u(){i.style.display=r.value==="BLE Sensor"?"":"none"}function h(){let x=p(),L=wo(a.value),M=[];for(let Z=1;Z<=6;Z++)Z!==x&&wo(T(c.syncTo(Z)))===x&&M.push(Z);let W=L>0&&L!==x,H=W||M.length>0;if(m.classList.toggle("is-solo",!H),!H){g.innerHTML='<span class="merge-pill primary">'+$(x)+'</span><span class="merge-link"></span><span class="merge-pill">'+f("zone.sensor.noMerge")+"</span>",z.textContent=f("zone.sensor.soloCaption");return}if(W){g.innerHTML='<span class="merge-pill secondary">'+$(x)+'</span><span class="merge-link"></span><span class="merge-pill primary">'+$(L)+"</span>",z.textContent=f("zone.sensor.followsCaption",{zone:$(x),target:$(L)});return}let E='<span class="merge-pill primary">'+$(x)+"</span>";for(let Z of M)E+='<span class="merge-link"></span><span class="merge-pill secondary">'+$(Z)+"</span>";g.innerHTML=E,z.textContent=f("zone.sensor.primaryCaption",{zone:$(x),zones:M.map($).join(", ")})}let l=re(t);yo(r,"Local Probe"),l.select(o,{read:()=>T(c.probe(p()))||void 0,commit:x=>Se(p(),"zone_probe",x)}),l.select(r,{read:()=>Nr(String(T(c.tempSource(p()))||"")),commit:x=>Se(p(),"zone_temp_source",Tr(x))}),l.select(a,{read:()=>T(c.syncTo(p()))||"None",commit:x=>Se(p(),"zone_sync_to",x)});let k=l.text(n,{read:()=>T(c.ble(p()))||"",commit:x=>Le(p(),"zone_ble_mac",x)});r.addEventListener("change",u),a.addEventListener("change",h);function A(){let x=p();y!==x?(xo(a,x),y=x,b.style.display="none",l.discard()):l.refresh(),u(),h()}function S(x){let L=p();(x===c.probe(L)||x===c.tempSource(L)||x===c.syncTo(L)||x===c.ble(L)||/^select-zone_\d+_sync_to$/.test(x))&&(l.refresh(),u(),h())}d.addEventListener("click",()=>{if(d.disabled)return;d.disabled=!0,d.textContent="\u2026",b.style.display="",b.innerHTML='<div class="scan-msg">'+f("zone.sensor.scanning")+"</div>";let x=new AbortController,L=setTimeout(()=>x.abort(),8e3);fetch("/api/hv6/v1/ble-scan",{cache:"no-store",signal:x.signal}).then(M=>{if(!M.ok)throw new Error("HTTP "+M.status);return M.json()}).then(M=>{if(clearTimeout(L),d.disabled=!1,d.textContent=f("zone.sensor.scan"),!M.ok||!M.sensors||M.sensors.length===0){b.innerHTML='<div class="scan-msg">'+f("zone.sensor.noSensors")+"</div>";return}let W=p(),H=(T(c.ble(W))||"").toUpperCase(),E=I=>String(I).replace(/[&<>"']/g,X=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[X]),Z="";for(let I of M.sensors){let X=I.mac.toUpperCase(),U=I.name?E(I.name):"",_e=I.temp_c!=null?I.temp_c.toFixed(1)+"\xB0C":"\u2014",Qe=I.rssi!=null?I.rssi+" dBm":"",ce=I.age_s<60?f("common.secondsAgo",{value:I.age_s}):f("common.minutesAgo",{value:Math.round(I.age_s/60)}),et="";X===H?et='<span class="ble-badge">'+f("zone.sensor.assignedThisZone")+"</span>":I.zone>0&&(et='<span class="ble-badge">'+f("zone.sensor.zoneBadge",{zone:I.zone})+"</span>");let Eo=U?`<div class="ble-mac">${U}</div><div class="ble-meta">${X}</div>`:`<div class="ble-mac">${X}</div>`;Z+=`<div class="ble-scan-item">
              <div>
                ${Eo}
                <div class="ble-meta">${_e} &nbsp;${Qe} &nbsp;${ce}</div>
                ${et}
              </div>
              <button class="btn-assign" data-mac="${X}">${f("zone.sensor.assign")}</button>
            </div>`}b.innerHTML=Z,b.querySelectorAll(".btn-assign").forEach(I=>{I.addEventListener("click",()=>{n.value=I.dataset.mac,k.markDirty(),b.style.display="none"})})}).catch(M=>{clearTimeout(L),d.disabled=!1,d.textContent=f("zone.sensor.scan");let W=M&&M.name==="AbortError"?f("zone.sensor.scanTimeout"):f("zone.sensor.scanFailed");b.innerHTML='<div class="scan-msg">'+W+"</div>"})}),B("selectedZone",A);for(let x=1;x<=6;x++)w(c.probe(x),S),w(c.tempSource(x),S),w(c.syncTo(x),S),w(c.ble(x),S);_(t),A()}});var Dr=`
...
`,fs=N({tag:"zone-room-card",render:Pr,onMount(e,t){let o=t.querySelector(".zr-friendly"),r=t.querySelector(".zr-area"),n=t.querySelector(".zr-spacing"),a=t.querySelector(".zr-pipe"),i=t.querySelector(".wall-btn-group").querySelectorAll(".wall-btn");function d(){return O("selectedZone")}let b=re(t);b.text(o,{read:()=>ue(d())||"",commit:p=>qt(d(),p)}),b.num(r,{read:()=>C(c.area(d())),commit:p=>st(d(),"zone_area_m2",p)}),b.num(n,{read:()=>C(c.spacing(d())),commit:p=>st(d(),"zone_pipe_spacing_mm",p||200)}),b.select(a,{read:()=>T(c.pipeType(d()))||"Unknown",commit:p=>Se(d(),"zone_pipe_type",p)});let m=[];function g(){i.forEach(p=>{let u=p.dataset.wall;p.classList.toggle("active",u==="None"?m.length===0:m.includes(u))})}let z=b.custom({sync:()=>{let p=T(c.exteriorWalls(d()))||"None";m=p==="None"?[]:p.split(",").filter(Boolean),g()},commit:()=>Le(d(),"zone_exterior_walls",m.length?m.join(","):"None")});i.forEach(p=>{p.addEventListener("click",()=>{let u=p.dataset.wall,h=m.slice();if(u==="None")h=[];else{let l=h.indexOf(u);l>=0?h.splice(l,1):h.push(u)}m=["N","S","E","W"].filter(l=>h.includes(l)),g(),z.markDirty()})});function y(p){let u=d();(p===c.area(u)||p===c.spacing(u)||p===c.pipeType(u)||p===c.exteriorWalls(u))&&b.refresh()}B("selectedZone",b.discard),B("zoneNames",b.refresh);for(let p=1;p<=6;p++)w(c.area(p),y),w(c.spacing(p),y),w(c.pipeType(p),y),w(c.exteriorWalls(p),y);_(t),b.refresh()}});var de=6,Rr="#6E7E96",ko="#5C6B85",Or="#7aa7ce",Hr="#9DBC78",qr="#FF8531",Ir="#FFA600",Br="#7aa7ce",Wr="#FFEAD2",Zr="#6E7E96",zo="#B9CBD8",Xe="#5C6B85",wt="#A6B9C7",_o="#A6B9C7",So="#7aa7ce",jr="#66BB6A",Vr="#FF6361",j={w:1160,h:310,boxX:452,boxY:34,boxW:256,boxH:68,topBarY:0,topBarH:24,srcY:102,fanY:158,zoneY:232,zoneXs:[92,286,480,674,868,1062],srcSpread:15,bgDstHW:28,srcHW:7},D={w:760,h:340,boxX:38,boxY:132,boxW:142,boxH:72,srcX:180,endX:386,nameX:446,midY:168,zoneYs:[58,104,150,196,242,288],spread:8,bgDstHW:15,srcHW:4},$r=`
.flow-wrap {
  width: 100%;
  border-radius: 8px;
  overflow: hidden;
...
`;F("flow-diagram",$r);function Gr(e,t){let o=String(ue(e)||"").trim();if(!o)return"";let r=o.toUpperCase();return r.length>t?r.slice(0,Math.max(1,t-1))+"\u2026":r}function Ur(e){if(!e)return null;let t=String(e).match(/(\d+)/);if(!t)return null;let o=Number(t[1]);return Number.isFinite(o)&&o>=1&&o<=8?o:null}function Xr(e,t){return t?e==null||Number.isNaN(e)?ko:e<.15?Or:e<.4?Hr:e<.7?qr:Ir:Rr}function Co(e){let t=e==="desktop"?"0 1":"1 0",o=[];o.push("<defs>"),o.push('<pattern id="'+e+'-fdots" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse"><circle cx="10" cy="10" r="1" fill="rgba(92,138,196,0.26)"/></pattern>'),o.push('<radialGradient id="'+e+'-fglow" cx="32%" cy="18%" r="78%"><stop offset="0%" stop-color="rgba(122,167,206,0.18)"/><stop offset="52%" stop-color="rgba(240,121,91,0.08)"/><stop offset="100%" stop-color="transparent"/></radialGradient>'),o.push('<linearGradient id="'+e+'-boxgrad" x1="0" y1="0" x2="'+t.split(" ")[0]+'" y2="'+t.split(" ")[1]+'"><stop offset="0%" stop-color="#9E4A18"/><stop offset="100%" stop-color="#ff8531"/></linearGradient>');for(let r=1;r<=de;r++)o.push('<linearGradient id="'+e+"-rg"+r+'" x1="0" y1="0" x2="'+t.split(" ")[0]+'" y2="'+t.split(" ")[1]+'">'),o.push('<stop id="'+e+"-rgs"+r+'" offset="0%" stop-color="#ff8531"/>'),o.push('<stop id="'+e+"-rga"+r+'" offset="100%" stop-color="#7aa7ce"/>'),o.push("</linearGradient>");return o.push("</defs>"),o.join("")}function Ye(e,t,o){let r=j.boxX+j.boxW/2+(e-2.5)*j.srcSpread,n=j.srcY,a=j.zoneXs[e],i=j.zoneY-20,d=j.fanY,b=j.fanY+34;return"M"+(r-t).toFixed(1)+" "+n+" C"+(r-t).toFixed(1)+" "+d+" "+(a-o).toFixed(1)+" "+b+" "+(a-o).toFixed(1)+" "+i+" L"+(a+o).toFixed(1)+" "+i+" C"+(a+o).toFixed(1)+" "+b+" "+(r+t).toFixed(1)+" "+d+" "+(r+t).toFixed(1)+" "+n+"Z"}function Ke(e,t,o){let r=D.midY+(e-2.5)*D.spread,n=D.zoneYs[e],a=D.endX-D.srcX,i=D.srcX+a*.34,d=D.srcX+a*.7;return"M"+D.srcX+" "+(r-t).toFixed(1)+" C"+i+" "+(r-t).toFixed(1)+" "+d+" "+(n-o).toFixed(1)+" "+D.endX+" "+(n-o).toFixed(1)+" L"+D.endX+" "+(n+o).toFixed(1)+" C"+d+" "+(n+o).toFixed(1)+" "+i+" "+(r+t).toFixed(1)+" "+D.srcX+" "+(r+t).toFixed(1)+"Z"}function Lo(e,t,o){return'<rect width="'+e+'" height="'+t+'" rx="22" fill="var(--card)"/><rect width="'+e+'" height="'+t+'" rx="22" fill="url(#'+o+'-fdots)" opacity="0.48"/><rect width="'+e+'" height="'+t+'" rx="22" fill="url(#'+o+'-fglow)"/>'}function Ao(e){let t=e==="desktop"?j:D,o=e==="desktop"?t.boxY+27:t.boxY+29,r=e==="desktop"?t.boxY+56:t.boxY+58;return'<rect x="'+t.boxX+'" y="'+t.boxY+'" width="'+t.boxW+'" height="'+t.boxH+'" rx="7" fill="#ff8531"/><text id="'+e+'-fd-flow-label" x="'+(t.boxX+t.boxW/2)+'" y="'+o+'" text-anchor="middle" font-size="'+(e==="desktop"?18:17)+'" font-weight="800" fill="var(--text-on-accent)" letter-spacing="2">'+f("overview.flowDiagram.flow")+'</text><text id="'+e+'-fd-flow-temp" class="flow-metric" x="'+(t.boxX+t.boxW/2)+'" y="'+r+'" text-anchor="middle" font-size="'+(e==="desktop"?26:24)+'" fill="var(--text-on-accent)">---</text>'}function Yr(){let e=[],t=j.w,o=j.h,r=j.zoneY-20;e.push('<svg class="flow-svg flow-svg-desktop" viewBox="0 5 '+t+" "+(o-5)+'" preserveAspectRatio="xMidYMid meet">'),e.push(Co("desktop")),e.push(Lo(t,o,"desktop")),e.push('<rect x="'+j.boxX+'" y="'+j.topBarY+'" width="'+j.boxW+'" height="'+j.topBarH+'" fill="url(#desktop-boxgrad)" rx="5"/>'),e.push(Ao("desktop")),e.push('<text id="desktop-fd-ret-temp" x="'+(j.boxX+j.boxW+24)+'" y="'+(j.boxY+20)+'" font-size="15" font-weight="800" fill="#7aa7ce" font-family="var(--mono)">'+f("overview.flowDiagram.returnShort")+" ---</text>"),e.push('<text id="desktop-fd-dt-label" x="'+(j.boxX+j.boxW+24)+'" y="'+(j.boxY+42)+'" font-size="12" font-weight="800" fill="'+_o+'" letter-spacing="2">'+f("overview.flowDiagram.dt")+"</text>"),e.push('<text id="desktop-fd-dt" x="'+(j.boxX+j.boxW+24)+'" y="'+(j.boxY+65)+'" class="flow-metric" font-size="22" fill="#ff8531">---</text>');for(let n=1;n<=de;n++)e.push('<path d="'+Ye(n-1,j.srcHW,j.bgDstHW)+'" fill="#021824" opacity="0.9"/>');for(let n=1;n<=de;n++)e.push('<path id="desktop-fd-path-'+n+'" class="flow-ribbon" d="'+Ye(n-1,j.srcHW,j.bgDstHW)+'" fill="url(#desktop-rg'+n+')" opacity="1"/>');e.push('<line x1="54" y1="'+r+'" x2="'+(t-54)+'" y2="'+r+'" stroke="#ff8531" stroke-width="2" opacity=".42"/>');for(let n=1;n<=de;n++){let a=j.zoneXs[n-1];e.push('<g class="flow-zone-hit">'),e.push('<line x1="'+a+'" y1="'+(r-8)+'" x2="'+a+'" y2="'+(r+8)+'" stroke="#ff8531" stroke-width="2" opacity=".5"/>'),e.push('<text id="desktop-fd-zn'+n+'" x="'+a+'" y="'+(r-13)+'" text-anchor="middle" font-size="13" fill="#FFEAD2" font-weight="800" letter-spacing="1.8">Z'+n+"</text>"),e.push('<text id="desktop-fd-zf'+n+'" x="'+a+'" y="'+(r+20)+'" text-anchor="middle" font-size="9.5" fill="#AFC1CD" font-weight="700" letter-spacing=".8">---</text>'),e.push('<text id="desktop-fd-zsp'+n+'" x="'+a+'" y="'+(r+20)+'" text-anchor="middle" font-size="9" fill="'+Xe+'" font-weight="600" font-family="var(--mono)"></text>'),e.push('<text id="desktop-fd-zt'+n+'" x="'+a+'" y="'+(r+42)+'" text-anchor="middle" class="flow-metric" font-size="15" fill="#F6ECE0">---\xB0C</text>'),e.push('<text id="desktop-fd-zv'+n+'" x="'+(a-28)+'" y="'+(r+61)+'" text-anchor="middle" class="flow-metric" font-size="13" fill="#C3D0D9">---%</text>'),e.push('<text id="desktop-fd-zr'+n+'" x="'+(a+28)+'" y="'+(r+61)+'" text-anchor="middle" class="flow-metric" font-size="13" fill="#C3D0D9">---</text>'),e.push("</g>")}return e.push("</svg>"),e.join("")}function Kr(){let e=[],t=D.w,o=D.h;e.push('<svg class="flow-svg flow-svg-mobile" viewBox="0 0 '+t+" "+o+'" preserveAspectRatio="xMidYMid meet">'),e.push(Co("mobile")),e.push(Lo(t,o,"mobile")),e.push('<rect x="0" y="'+D.boxY+'" width="'+(D.boxX-6)+'" height="'+D.boxH+'" fill="url(#mobile-boxgrad)" rx="4"/>'),e.push(Ao("mobile"));for(let r=1;r<=de;r++)e.push('<path d="'+Ke(r-1,D.srcHW,D.bgDstHW)+'" fill="#021824" opacity="0.9"/>');for(let r=1;r<=de;r++)e.push('<path id="mobile-fd-path-'+r+'" class="flow-ribbon" d="'+Ke(r-1,D.srcHW,D.bgDstHW)+'" fill="url(#mobile-rg'+r+')" opacity="1"/>');e.push('<rect x="'+(D.boxX+9)+'" y="'+(D.boxY+D.boxH+9)+'" width="'+(D.boxW-18)+'" height="60" rx="8" fill="rgba(2,29,43,.74)"/>'),e.push('<text id="mobile-fd-ret-temp" x="'+(D.boxX+D.boxW/2)+'" y="'+(D.boxY+D.boxH+27)+'" text-anchor="middle" font-size="12.5" font-weight="800" fill="#7aa7ce" font-family="var(--mono)">'+f("overview.flowDiagram.returnShort")+" ---</text>"),e.push('<text id="mobile-fd-dt-label" x="'+(D.boxX+D.boxW/2)+'" y="'+(D.boxY+D.boxH+43)+'" text-anchor="middle" font-size="9.5" font-weight="800" fill="'+_o+'" letter-spacing="1.1">'+f("overview.flowDiagram.dt")+"</text>"),e.push('<text id="mobile-fd-dt" x="'+(D.boxX+D.boxW/2)+'" y="'+(D.boxY+D.boxH+63)+'" text-anchor="middle" class="flow-metric" font-size="19" fill="#ff8531">---</text>'),e.push('<line x1="'+D.endX+'" y1="34" x2="'+D.endX+'" y2="'+(o-34)+'" stroke="#ff8531" stroke-width="2" opacity=".48"/>'),e.push('<text id="mobile-fd-temp-head" x="506" y="30" font-size="10" fill="'+wt+'" font-weight="700" letter-spacing="1.5">'+f("overview.graph.layers.temp").toUpperCase()+"</text>"),e.push('<text id="mobile-fd-flow-head" x="592" y="30" font-size="10" fill="'+wt+'" font-weight="700" letter-spacing="1.5">'+f("overview.flowDiagram.flow")+"</text>"),e.push('<text id="mobile-fd-ret-head" x="678" y="30" font-size="10" fill="'+wt+'" font-weight="700" letter-spacing="1.5">'+f("overview.flowDiagram.returnShort")+"</text>");for(let r=1;r<=de;r++){let n=D.zoneYs[r-1];e.push('<line x1="'+(D.endX-8)+'" y1="'+n+'" x2="'+(D.endX+8)+'" y2="'+n+'" stroke="#ff8531" stroke-width="2" opacity=".5"/>'),e.push('<text id="mobile-fd-zn'+r+'" x="'+(D.endX-14)+'" y="'+(n+4)+'" text-anchor="end" font-size="12" fill="#FFEAD2" font-weight="800" letter-spacing="1.4">Z'+r+"</text>"),e.push('<text id="mobile-fd-zf'+r+'" x="'+D.nameX+'" y="'+(n-8)+'" text-anchor="middle" font-size="9" fill="#AFC1CD" font-weight="700" letter-spacing=".7">---</text>'),e.push('<text id="mobile-fd-zsp'+r+'" x="'+D.nameX+'" y="'+(n+7)+'" text-anchor="middle" font-size="8.5" fill="'+Xe+'" font-weight="600" font-family="var(--mono)"></text>'),e.push('<text id="mobile-fd-zt'+r+'" x="506" y="'+(n+4)+'" class="flow-metric" font-size="13.5" fill="#F6ECE0">---\xB0C</text>'),e.push('<text id="mobile-fd-zv'+r+'" x="592" y="'+(n+4)+'" class="flow-metric" font-size="13.5" fill="#C3D0D9">---%</text>'),e.push('<text id="mobile-fd-zr'+r+'" x="678" y="'+(n+4)+'" class="flow-metric" font-size="13.5" fill="#C3D0D9">---</text>')}return e.push("</svg>"),e.join("")}var Jr=()=>'<div class="flow-wrap">'+Yr()+Kr()+"</div>";N({tag:"flow-diagram",render:Jr,onMount(e,t){let o=["desktop","mobile"],r={};o.forEach(m=>{r[m]={flowEl:t.querySelector("#"+m+"-fd-flow-temp"),flowLabelEl:t.querySelector("#"+m+"-fd-flow-label"),retEl:t.querySelector("#"+m+"-fd-ret-temp"),dtLabelEl:t.querySelector("#"+m+"-fd-dt-label"),dtEl:t.querySelector("#"+m+"-fd-dt"),zones:new Array(de+1)};for(let g=1;g<=de;g++)r[m].zones[g]={textTemp:t.querySelector("#"+m+"-fd-zt"+g),textSetpoint:t.querySelector("#"+m+"-fd-zsp"+g),textFlow:t.querySelector("#"+m+"-fd-zv"+g),textRet:t.querySelector("#"+m+"-fd-zr"+g),label:t.querySelector("#"+m+"-fd-zn"+g),friendly:t.querySelector("#"+m+"-fd-zf"+g),path:t.querySelector("#"+m+"-fd-path-"+g)}});function n(m,g){m&&(m.textContent=g)}function a(m,g,z,y,p){let u=r[m];n(u.flowLabelEl,f("overview.flowDiagram.flow")),n(u.flowEl,ae(g)),n(u.retEl,f("overview.flowDiagram.returnShort")+" "+ae(z)),n(u.dtLabelEl,f("overview.flowDiagram.dt")),n(u.dtEl,y==null?"---":y.toFixed(1)+"\xB0C"),u.dtEl&&u.dtEl.setAttribute("fill",p)}function i(){n(t.querySelector("#mobile-fd-temp-head"),f("overview.graph.layers.temp").toUpperCase()),n(t.querySelector("#mobile-fd-flow-head"),f("overview.flowDiagram.flow")),n(t.querySelector("#mobile-fd-ret-head"),f("overview.flowDiagram.returnShort"))}function d(m,g,z){let y=r[m].zones[g];if(!y)return;let{enabled:p,pct:u,temp:h,setpoint:l,valve:k,returnTemp:A,hasReturn:S}=z,x=Gr(g,m==="desktop"?11:12),L=ae(h),M=l!=null?ae(l):"";n(y.label,"Z"+g),n(y.friendly,m==="desktop"?(x||"---")+(M?" ("+M+")":""):x||"---"),n(y.textTemp,L),n(y.textSetpoint,m==="desktop"?"":M?"("+M+")":""),n(y.textFlow,Ie(k)),n(y.textRet,S?ae(A):"---"),y.label.setAttribute("fill",p?Wr:Zr),y.friendly.setAttribute("fill",p?zo:Xe),y.textSetpoint.setAttribute("fill",p?zo:Xe),y.textFlow.setAttribute("fill",Xr(u,p)),y.textRet.setAttribute("fill",S&&p?Br:ko);let W=y.path;if(!p)W.setAttribute("d",m==="desktop"?Ye(g-1,1,2):Ke(g-1,1,2)),W.setAttribute("fill","#021824"),W.setAttribute("opacity","0.38");else{let H=m==="desktop"?j:D,E=Math.max(2.5,u*H.bgDstHW),Z=Math.max(1.3,u*H.srcHW);W.setAttribute("d",m==="desktop"?Ye(g-1,Z,E):Ke(g-1,Z,E)),W.setAttribute("fill","url(#"+m+"-rg"+g+")"),W.setAttribute("opacity","1")}}function b(){let m=C(s.flow),g=C(s.ret),z=m!=null&&g!=null?Number(m)-Number(g):null,y=z==null||z<3?So:z>8?Vr:jr;o.forEach(p=>a(p,m,g,z,y));for(let p=1;p<=de;p++){let u=C(c.temp(p)),h=C(c.setpoint(p)),l=C(c.valve(p)),k=Y(c.enabled(p)),A=String(T(c.tempSource(p))||"Local Probe"),S=Ur(T(c.probe(p))||""),x=S?C(c.probeTemp(S)):null,L=A!=="Local Probe"&&x!=null&&!Number.isNaN(Number(x)),M=l!=null?Math.max(0,Math.min(100,Number(l)))/100:0,W={enabled:k,pct:M,temp:u,setpoint:h,valve:l,returnTemp:x,hasReturn:L};o.forEach(H=>d(H,p,W))}}w(s.flow,b),w(s.ret,b),B("zoneNames",b);for(let m=1;m<=de;m++)w(c.temp(m),b),w(c.setpoint(m),b),w(c.valve(m),b),w(c.enabled(m),b),w(c.probe(m),b),w(c.tempSource(m),b);for(let m=1;m<=8;m++)w(c.probeTemp(m),b);i(),b()}});var Qr={1:{label:"E",color:"#ff6361"},2:{label:"W",color:"#ffd380"},3:{label:"I",color:"#79d17e"},4:{label:"C",color:"#7aa7ce"},5:{label:"D",color:"rgba(214,228,255,.7)"},6:{label:"V",color:"rgba(214,228,255,.5)"},7:{label:"VV",color:"rgba(214,228,255,.4)"}},ea=`
.logs-view {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`;function oa(e){let t=Qr[e.level]||{label:"?",color:"var(--text-secondary)"},o=Mo(e.tag||""),r=Mo(e.msg||"");return'<div class="log-line"><span class="lv" style="color:'+t.color+'">'+t.label+'</span><span class="tag">'+o+'</span><span class="msg">'+r+"</span></div>"}function Mo(e){return String(e).replace(/[&<>]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[t])}var As=N({tag:"logs-view",render:ta,onMount(e,t){let o=t.querySelector(".logs-stream"),r=t.querySelector(".pause-btn"),n=t.querySelector(".clear-btn"),a=!1;function i(){if(a)return;let d=Mt();if(!d||!d.length){o.innerHTML='<div class="logs-empty">'+f("logs.waiting")+"</div>";return}let b=o.scrollHeight-o.scrollTop-o.clientHeight<40;o.innerHTML=d.map(oa).join(""),b&&(o.scrollTop=o.scrollHeight)}r.addEventListener("click",()=>{a=!a,r.textContent=a?f("logs.resume"):f("logs.pause"),r.classList.toggle("on",a),a||i()}),n.addEventListener("click",()=>{Et()}),B("deviceLog",i),_(t),i()}});var ra=`
.diag-i2c {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`,Ps=N({tag:"diag-i2c",render:aa,onMount(e,t){let o=t.querySelector("#i2c-result");function r(){o.textContent=O("i2cResult")||f("diagnostics.i2c.empty")}t.querySelector("#btn-i2c-scan").addEventListener("click",()=>{Ot()}),B("i2cResult",r),_(t),r()}});var na=`
.diag-manual-badge {
  display: none;
  align-items: center;
  gap: 10px;
...
`,Bs=N({tag:"diag-manual-badge",render:sa,onMount(e,t){let o=t.classList.contains("diag-manual-badge")?t:t.querySelector(".diag-manual-badge");function r(){let n=!!O("manualMode");o&&o.classList.toggle("on",n)}B("manualMode",r),_(t),r()}});var ia=`
.diag-zone-motor {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`;F("diag-zone-motor",ia);var la=e=>{let t=e.zone||O("selectedZone")||1,o="";for(let r=1;r<=6;r++)o+='<option value="'+r+'"'+(r===t?" selected":"")+">"+f("common.zone")+" "+r+"</option>";return`
  ...
  `},Xs=N({tag:"diag-zone-motor-card",render:la,onMount(e,t){let o=Number(e.zone||O("selectedZone")||1),r=!!O("manualMode"),n=t.querySelector(".manual-mode-toggle"),a=t.querySelector(".motor-gated"),i=t.querySelector(".motor-zone-select"),d=t.querySelector(".motor-target-input"),b=t.querySelector(".motor-open-btn"),m=t.querySelector(".motor-close-btn"),g=t.querySelector(".motor-stop-btn"),z=()=>{let h=i.value||String(o),l="";for(let k=1;k<=6;k++)l+='<option value="'+k+'">'+f("common.zone")+" "+k+"</option>";i.innerHTML=l,i.value=h};function y(h){r=!!h,n&&(n.classList.toggle("on",r),n.setAttribute("aria-checked",r?"true":"false")),a&&a.classList.toggle("locked",!r),[i,d,b,m,g].forEach(l=>{l&&(l.disabled=!r)})}function p(){let h=!r;if(y(h),h){lt(!0);for(let l=1;l<=6;l++)it(l)}else lt(!1)}function u(){let h=C(c.motorTarget(o));d&&h!=null?d.value=Number(h).toFixed(0):d&&(d.value="0")}i==null||i.addEventListener("change",()=>{o=Number(i.value||1),u()}),n==null||n.addEventListener("click",p),n==null||n.addEventListener("keydown",h=>{h.key!==" "&&h.key!=="Enter"||(h.preventDefault(),p())});for(let h=1;h<=6;h++)w(c.motorTarget(h),u);u(),y(r),B("manualMode",()=>{y(!!O("manualMode"))}),_(t),d==null||d.addEventListener("change",h=>{if(!r)return;let l=h.target.value;It(o,l)}),b==null||b.addEventListener("click",()=>{r&&Bt(o,1e4)}),m==null||m.addEventListener("click",()=>{r&&Wt(o,1e4)}),g==null||g.addEventListener("click",()=>{r&&it(o)})}});var da=`
.diag-zone-recovery {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`;F("diag-zone-recovery",da);var ca=()=>`
  ...
  `,oi=N({tag:"diag-zone-recovery-card",render:ca,onMount(e,t){let o=Number(O("selectedZone")||1),r=t.querySelector(".recovery-fault-btn"),n=t.querySelector(".recovery-factors-btn"),a=t.querySelector(".recovery-relearn-btn"),i=t.querySelector(".recovery-status");B("selectedZone",()=>{o=Number(O("selectedZone")||1)});let d=null;function b(g,z){i.textContent=g,i.className="recovery-status show "+(z?"ok":"err"),clearTimeout(d),d=setTimeout(()=>{i.classList.remove("show")},4e3)}function m(g,z){let y=g(o);b(z,!0),y&&typeof y.then=="function"&&y.then(p=>{p&&p.ok===!1&&b(f("diagnostics.recovery.rejected"),!1)}).catch(()=>b(f("diagnostics.recovery.unreachable"),!1))}r==null||r.addEventListener("click",()=>{m(Zt,"\u2713 "+f("diagnostics.recovery.faultSent",{zone:$(o)}))}),n==null||n.addEventListener("click",()=>{confirm(f("diagnostics.recovery.confirmFactors",{zone:$(o)}))&&m(jt,"\u2713 "+f("diagnostics.recovery.factorsReset",{zone:$(o)}))}),a==null||a.addEventListener("click",()=>{confirm(f("diagnostics.recovery.confirmRelearn",{zone:$(o)}))&&m(Vt,"\u2713 "+f("diagnostics.recovery.relearnStarted",{zone:$(o)}))}),_(t)}});var pa=`
...
`,ci=N({tag:"diag-system-card",render:ga,onMount(e,t){let o=t.querySelector('[data-k="cpu0"]'),r=t.querySelector('[data-k="cpu1"]'),n=t.querySelector('[data-k="heap"]'),a=t.querySelector('[data-k="psram"]'),i=t.querySelector('[data-bar="cpu0"]'),d=t.querySelector('[data-bar="cpu1"]'),b=(z,y,p)=>{if(p==null||!Number.isFinite(Number(p))){z.textContent="\u2014",z.classList.remove("warn"),y.style.width="0%";return}let u=Math.max(0,Math.min(100,Number(p)));z.textContent=u.toFixed(0)+"%",z.classList.toggle("warn",u>=90),y.style.width=u+"%",y.style.backgroundPosition=u+"% 0"},m=(z,y,p)=>{if(y==null||!Number.isFinite(Number(y))){z.textContent="\u2014";return}let u=Number(y);z.textContent=u+" KB",z.classList.toggle("warn",p!=null&&u<p)},g=()=>{b(o,i,C(s.cpuLoadCore0)),b(r,d,C(s.cpuLoadCore1)),m(n,C(s.freeInternalKb),48),m(a,C(s.freePsramKb),null)};t.querySelector(".sys-dump").addEventListener("click",()=>{$t().catch(z=>console.error("[System] dump failed:",z))}),w(s.cpuLoadCore0,g),w(s.cpuLoadCore1,g),w(s.freeInternalKb,g),w(s.freePsramKb,g),_(t),g()}});var ua=`
...
`;F("asgard-bridge-status-card",ua);var ma=()=>`
...
`,vi=N({tag:"asgard-bridge-status-card",render:ma,onMount(e,t){let o=t.querySelector(".role-badge"),r=t.querySelector(".ab-peer"),n=t.querySelector(".ab-push"),a=t.querySelector(".ab-setpoint"),i=t.querySelector(".ab-zones"),d=t.querySelector(".ab-error");function b(){let m=T(s.asgardRole)||"slave";o.textContent=m,o.className="role-badge "+(m==="master"?"master":"slave");let g=T(s.asgardPeerStatus)||f("common.na");r.textContent=g,r.classList.toggle("warn",g==="stale"||g==="unreachable");let z=C(s.asgardLastPushC),y=C(s.asgardLastPushAgeS);if(z!=null&&Number.isFinite(z)&&y!=null){let k=y<120?f("diagnostics.asgard.ageSeconds",{value:Math.round(y)}):f("diagnostics.asgard.ageMinutes",{value:Math.round(y/60)});n.textContent=`${z.toFixed(2)}\xB0C (${k})`}else n.textContent="\u2014";let p=C(s.asgardSetpointC);a.textContent=p!=null&&Number.isFinite(p)?`${p.toFixed(1)}\xB0C`:"\u2014";let u=C(s.asgardLocalZones),h=C(s.asgardPeerZones);i.textContent=u!=null?`${u} ${f("common.local")} + ${h||0} ${f("common.peer")}`:"\u2014";let l=T(s.asgardLastError);d.textContent=l||"\u2014",d.classList.toggle("warn",!!l)}[s.asgardRole,s.asgardPeerStatus,s.asgardLastPushC,s.asgardSetpointC,s.asgardLastPushAgeS,s.asgardLocalZones,s.asgardPeerZones,s.asgardLastError].forEach(m=>w(m,b)),_(t),b()}});var ba=`
...
`;F("settings-manifold-card",ba);var fa=()=>{let e="";for(let o=1;o<=8;o++)e+="<option>Probe "+o+"</option>";let t="";for(let o=1;o<=8;o++)t+='<div class="probe-cell"><div class="probe-name">Probe '+o+'</div><div class="probe-temp" data-probe="'+o+'">---</div></div>';return`
  ...
  `},Li=N({tag:"settings-manifold-card",render:fa,onMount(e,t){let o=t.querySelector(".sm-type"),r=t.querySelector(".sm-flow"),n=t.querySelector(".sm-ret"),a=re(t);a.select(o,{read:()=>T(s.manifoldType)||"NO (Normally Open)",commit:d=>ne("manifold_type",d)}),a.select(r,{read:()=>T(s.manifoldFlowProbe)||"Probe 7",commit:d=>ne("manifold_flow_probe",d)}),a.select(n,{read:()=>T(s.manifoldReturnProbe)||"Probe 8",commit:d=>ne("manifold_return_probe",d)});function i(){for(let d=1;d<=8;d++){let b=t.querySelector('[data-probe="'+d+'"]');b&&(b.textContent=ae(C(c.probeTemp(d))))}}w(s.manifoldType,a.refresh),w(s.manifoldFlowProbe,a.refresh),w(s.manifoldReturnProbe,a.refresh);for(let d=1;d<=8;d++)w(c.probeTemp(d),i);_(t),a.refresh(),i()}});var va=()=>`
...
`,Pi=N({tag:"settings-minimum-flow-card",render:va,onMount(e,t){let o=t.querySelector(".smf-always"),r=t.querySelector(".smf-pct"),n=re(t);n.toggle(o,{read:()=>Y(s.minimumFlowAlways),commit:a=>{let i=a?"on":"off";v(s.minimumFlowAlways,{state:i}),ne("minimum_flow_always",i).catch(()=>v(s.minimumFlowAlways,{state:a?"off":"on"}))}}),n.num(r,{read:()=>C(s.minZoneFlowPct),commit:a=>{v(s.minZoneFlowPct,{value:a}),se("min_zone_flow_pct",a)}}),w(s.minimumFlowAlways,n.refresh),w(s.minZoneFlowPct,n.refresh),_(t),n.refresh()}});var ha=`
...
`;F("settings-control-card",ha);var xa=()=>`
...
`,Bi=N({tag:"settings-control-card",render:xa,onMount(e,t){_(t),t.querySelector(".sc-reset-probe-map").addEventListener("click",()=>{ge("reset_1wire_probe_map_reboot")}),t.querySelector(".sc-dump-1wire").addEventListener("click",()=>{ge("dump_1wire_probe_diagnostics")}),t.querySelector(".sc-restart").addEventListener("click",()=>{ge("restart")})}});var ya=`
...
`;F("settings-motor-calibration-card",ya);var Je=[{cls:"safe-runtime",key:"generic_runtime_limit_seconds",id:s.genericRuntimeLimitSeconds,labelKey:"settings.motor.maxSafeRuntime",unit:"s"},{cls:"close-threshold",key:"close_threshold_multiplier",id:s.closeThresholdMultiplier,labelKey:"settings.motor.closeThreshold",unit:"x"},{cls:"close-slope-threshold",key:"close_slope_threshold",id:s.closeSlopeThreshold,labelKey:"settings.motor.closeSlope",unit:"mA/s"},{cls:"close-slope-floor",key:"close_slope_current_factor",id:s.closeSlopeCurrentFactor,labelKey:"settings.motor.closeSlopeFloor",unit:"x"},{cls:"open-threshold",key:"open_threshold_multiplier",id:s.openThresholdMultiplier,labelKey:"settings.motor.openThreshold",unit:"x"},{cls:"open-slope-threshold",key:"open_slope_threshold",id:s.openSlopeThreshold,labelKey:"settings.motor.openSlope",unit:"mA/s"},{cls:"open-slope-floor",key:"open_slope_current_factor",id:s.openSlopeCurrentFactor,labelKey:"settings.motor.openSlopeFloor",unit:"x"},{cls:"open-ripple-limit",key:"open_ripple_limit_factor",id:s.openRippleLimitFactor,labelKey:"settings.motor.openRippleLimit",unit:"x"},{cls:"relearn-movements",key:"relearn_after_movements",id:s.relearnAfterMovements,labelKey:"settings.motor.relearnMovements",unit:"count"},{cls:"relearn-hours",key:"relearn_after_hours",id:s.relearnAfterHours,labelKey:"settings.motor.relearnHours",unit:"h"},{cls:"learn-min-samples",key:"learned_factor_min_samples",id:s.learnedFactorMinSamples,labelKey:"settings.motor.learnMinSamples",unit:"count"},{cls:"learn-max-deviation",key:"learned_factor_max_deviation_pct",id:s.learnedFactorMaxDeviationPct,labelKey:"settings.motor.learnMaxDeviation",unit:"%"}],wa=()=>{let e="";for(let t=0;t<Je.length;t++){let o=Je[t];if(o.key==="generic_runtime_limit_seconds")continue;let r=za(o.key)?"1":"0.1";e+='<div class="ui-row"><span class="ui-label"><span data-i18n="'+o.labelKey+'">'+f(o.labelKey)+"</span> ("+o.unit+')</span><span class="ui-field"><input type="number" class="ui-input smc-'+o.cls+'" value="0" step="'+r+'"></span></div>'}return`
  ...
  `};function za(e){return e==="learned_factor_min_samples"||e==="generic_runtime_limit_seconds"||e==="relearn_after_movements"||e==="relearn_after_hours"}var Yi=N({tag:"settings-motor-calibration-card",render:wa,onMount(e,t){let o=t.querySelector(".smc-profile"),r=t.querySelector(".smc-safe-runtime"),n=t.querySelector(".mc-drivers-toggle"),a=re(t);function i(b){if(b==="HmIP VdMot"&&se("hmip_runtime_limit_seconds",40),b==="Generic"){let m=Number(C(s.genericRuntimeLimitSeconds));(!Number.isFinite(m)||m<=0)&&se("generic_runtime_limit_seconds",45)}}a.toggle(n,{read:()=>Y(s.drivers),commit:b=>Rt(b)}),a.select(o,{read:()=>T(s.motorProfileDefault)||"HmIP VdMot",commit:b=>{ne("motor_profile_default",b),i(b)}});function d(){let b=T(s.motorProfileDefault)||"HmIP VdMot";r.disabled=b==="HmIP VdMot"}a.num(r,{read:()=>(T(s.motorProfileDefault)||"HmIP VdMot")==="HmIP VdMot"?40:C(s.genericRuntimeLimitSeconds),commit:b=>{o.value==="Generic"&&se("generic_runtime_limit_seconds",b)}});for(let b=0;b<Je.length;b++){let m=Je[b];if(m.key==="generic_runtime_limit_seconds")continue;let g=t.querySelector(".smc-"+m.cls);g&&(a.num(g,{read:()=>C(m.id),commit:z=>se(m.key,z)}),w(m.id,a.refresh))}w(s.drivers,a.refresh),w(s.motorProfileDefault,()=>{a.refresh(),d()}),w(s.genericRuntimeLimitSeconds,a.refresh),w(s.hmipRuntimeLimitSeconds,a.refresh),_(t),i(T(s.motorProfileDefault)||"HmIP VdMot"),a.refresh(),d()}});var Sa=`
.settings-asgard-card .ui-row:last-child { margin-bottom: 0; }
`;F("settings-asgard-card",Sa);var ka=()=>`
...
`,nl=N({tag:"settings-asgard-card",render:ka,onMount(e,t){let o=t.querySelector(".sa-enable"),r=t.querySelector(".sa-coord"),n=t.querySelector(".sa-host"),a=t.querySelector(".sa-port"),i=t.querySelector(".sa-entity"),d=t.querySelector(".sa-peer"),b=t.querySelector(".sa-interval"),m=t.querySelector(".sa-body"),g=re(t);function z(h,l,k){return A=>{let S=A?"on":"off";v(h,{state:S}),ne(l,S).catch(x=>{console.error(`[Asgard] Failed to update ${k}:`,x),v(h,{state:A?"off":"on"})})}}let y=h=>m.classList.toggle("is-disabled",!h);g.toggle(o,{read:()=>Y(s.asgardEnabled),commit:z(s.asgardEnabled,"asgard_enabled","enabled"),onChange:y}),g.toggle(r,{read:()=>Y(s.asgardCoordinator),commit:z(s.asgardCoordinator,"asgard_coordinator","coordinator")});function p(h,l){return k=>{v(h,{state:k}),Ht(l,k).catch(A=>console.error(`[Asgard] Failed to update ${l}:`,A))}}g.text(n,{read:()=>T(s.asgardHost),commit:p(s.asgardHost,"asgard_host")}),g.text(i,{read:()=>T(s.asgardEntityName),commit:p(s.asgardEntityName,"asgard_entity_name")}),g.text(d,{read:()=>T(s.asgardPeerHost),commit:p(s.asgardPeerHost,"asgard_peer_host")});function u(h,l){return k=>{v(h,{value:k}),se(l,k).catch(A=>console.error(`[Asgard] Failed to update ${l}:`,A))}}g.num(a,{read:()=>C(s.asgardPort),commit:u(s.asgardPort,"asgard_port")}),g.num(b,{read:()=>C(s.asgardPushIntervalS),commit:u(s.asgardPushIntervalS,"asgard_push_interval_s")}),w(s.asgardEnabled,g.refresh),w(s.asgardCoordinator,g.refresh),w(s.asgardHost,g.refresh),w(s.asgardEntityName,g.refresh),w(s.asgardPeerHost,g.refresh),w(s.asgardPort,g.refresh),w(s.asgardPushIntervalS,g.refresh),_(t),g.refresh()}});var _a=`
...
`;F("smart-preheat-card",_a);var Ca=()=>`
...
`,ml=N({tag:"smart-preheat-card",render:Ca,onMount(e,t){let o=t.querySelector(".absorb-toggle"),r=t.querySelector(".absorb-badge"),n=t.querySelector(".absorb-band"),a=t.querySelector(".absorb-delta"),i=t.querySelector(".absorb-body"),d=re(t),b=g=>{i&&i.classList.toggle("is-disabled",!g)};d.toggle(o,{read:()=>Y(s.preheatAbsorbEnabled),onChange:b,commit:g=>{let z=g?"on":"off";v(s.preheatAbsorbEnabled,{state:z}),ne("preheat_absorb_enabled",z)}}),d.num(n,{read:()=>C(s.preheatAbsorbBandC),commit:g=>{v(s.preheatAbsorbBandC,{value:g}),se("preheat_absorb_band_c",g)}}),d.num(a,{read:()=>C(s.preheatDetectDeltaC),commit:g=>{v(s.preheatDetectDeltaC,{value:g}),se("preheat_detect_delta_c",g)}});function m(){let g=String(T(s.preheatAbsorbing)||"").toLowerCase()==="active";r.textContent=g?f("common.active"):f("common.idle"),r.classList.toggle("active",g)}w(s.preheatAbsorbEnabled,d.refresh),w(s.preheatAbsorbing,m),w(s.preheatAbsorbBandC,d.refresh),w(s.preheatDetectDeltaC,d.refresh),_(t),d.refresh(),m()}});var La=`
