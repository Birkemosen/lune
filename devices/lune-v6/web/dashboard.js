...
`;F("ui-kit",Ko);function pe(e){let t=f(e);return`<span class="help-badge" tabindex="0" role="img" aria-label="${String(t).replace(/"/g,"&quot;")}" data-i18n-label="${e}">?<span class="help-tip" data-i18n="${e}">${t}</span></span>`}function Jo(e,t){let o=Math.abs(Number(e));return!Number.isFinite(o)||o<1e3?t:Math.pow(10,Math.floor(Math.log10(o))-1)}function Qo(e){let t=String(e),o=t.indexOf(".");return o<0?0:t.length-o-1}function re(e,t={}){let o=e.querySelector(t.title||".ui-card-title"),r=document.createElement("div");r.className="ui-form-banner",r.innerHTML='<span class="ui-form-banner-msg" data-i18n="form.unsaved">Unsaved changes</span><span class="ui-form-banner-btns"><button type="button" class="ui-form-discard" data-i18n="form.discard">Discard</button><button type="button" class="ui-form-apply" data-i18n="form.apply">Apply</button></span>',o?o.insertAdjacentElement("afterend",r):e.insertAdjacentElement("afterbegin",r);let n=[],a=()=>r.classList.toggle("show",n.some(l=>l.dirty)),i=(l,S)=>{l.dirty=S,a()};function d(l){return l.markDirty=()=>i(l,!0),n.push(l),l}function b(l,S){let A={dirty:!1,input:l},k=S.baseStep!=null?S.baseStep:parseFloat(l.step)||1,x=Qo(k),C=S.min!=null?S.min:l.min!==""?parseFloat(l.min):-1/0,M=S.max!=null?S.max:l.max!==""?parseFloat(l.max):1/0,W=H=>x>0?Number(H).toFixed(x):String(Math.round(Number(H)));if(!S.nostep){let H=document.createElement("div");H.className="ui-stepper",l.parentNode.insertBefore(H,l);let E=document.createElement("button");E.type="button",E.className="ui-step-btn",E.textContent="\u2212",E.tabIndex=-1,E.setAttribute("aria-label",f("common.decrease"));let Z=document.createElement("button");Z.type="button",Z.className="ui-step-btn",Z.textContent="+",Z.tabIndex=-1,Z.setAttribute("aria-label",f("common.increase")),H.appendChild(E),H.appendChild(l),H.appendChild(Z),l.readOnly=!0;let I=X=>{if(l.disabled)return;let U=parseFloat(l.value);Number.isFinite(U)||(U=parseFloat(l.placeholder)),Number.isFinite(U)||(U=0);let _e=Math.min(M,Math.max(C,U+X*Jo(U,k)));l.value=W(_e),i(A,!0)};E.addEventListener("click",()=>I(-1)),Z.addEventListener("click",()=>I(1)),l.addEventListener("dblclick",()=>{l.disabled||(l.readOnly=!1,l.classList.add("editing"),l.focus(),l.select())}),l.addEventListener("blur",()=>{l.readOnly=!0,l.classList.remove("editing")}),l.addEventListener("keydown",X=>{X.key==="Enter"&&l.blur()})}return l.addEventListener("input",()=>i(A,!0)),A.sync=()=>{let H=S.read();l.value=H!=null&&Number.isFinite(Number(H))?W(H):""},A.commit=()=>{let H=parseFloat(l.value);Number.isFinite(H)&&S.commit(Math.min(M,Math.max(C,H)))},d(A)}function u(l,S){let A={dirty:!1,input:l};return l.addEventListener("input",()=>i(A,!0)),A.sync=()=>{let k=S.read();l.value=k!=null?k:""},A.commit=()=>S.commit(l.value.trim()),d(A)}function m(l,S){let A={dirty:!1,input:l};return l.addEventListener("change",()=>i(A,!0)),A.sync=()=>{let k=S.read();k!=null&&(l.value=k)},A.commit=()=>S.commit(l.value),d(A)}function z(l,S){let A={dirty:!1,input:l,staged:!1},k=l.closest(".ui-row"),x=()=>{l.classList.toggle("on",A.staged),k&&k.classList.toggle("is-on",A.staged),l.setAttribute("aria-checked",A.staged?"true":"false"),S.onChange&&S.onChange(A.staged)};return l.addEventListener("click",()=>{A.staged=!A.staged,i(A,!0),x()}),A.sync=()=>{A.staged=!!S.read(),x()},A.commit=()=>S.commit(A.staged),d(A)}function h(l){let S={dirty:!1,sync:l.sync,commit:l.commit};return d(S)}let c=()=>n.forEach(l=>{!l.dirty&&l.sync&&l.sync()}),g=()=>{n.forEach(l=>{l.dirty&&(l.commit&&l.commit(),l.dirty=!1)}),a(),t.onApply&&t.onApply()},y=()=>{n.forEach(l=>{l.dirty=!1,l.sync&&l.sync()}),a(),t.onDiscard&&t.onDiscard()};return r.querySelector(".ui-form-apply").addEventListener("click",g),r.querySelector(".ui-form-discard").addEventListener("click",y),_(r),{num:b,text:u,select:m,toggle:z,custom:h,refresh:c,apply:g,discard:y,isDirty:()=>n.some(l=>l.dirty)}}function ae(e){return e!=null&&!isNaN(e)?Math.round(e*10)/10+"\xB0C":"---"}function Ie(e){return e!=null&&!isNaN(e)?(e|0)+"%":"---"}function Be(e){if(!e||isNaN(e))return"---";e=e|0;var t=e/86400|0,o=e%86400/3600|0,r=e%3600/60|0;return t>0?t+"d "+o+"h "+r+"m":o>0?o+"h "+r+"m":r+"m"}function eo(e){return e==null||isNaN(e)?"---":(e=e|0,e>-50?e+" dBm \u2590\u2590\u2590\u2590":e>-60?e+" dBm \u2590\u2590\u2590\u2591":e>-70?e+" dBm \u2590\u2590\u2591\u2591":e>-80?e+" dBm \u2590\u2591\u2591\u2591":e+" dBm \u2591\u2591\u2591\u2591")}function to(e){if(e==null||isNaN(e))return"hh:mm";let t=Math.round(Date.now()/1e3-e),o=new Date(t*1e3),r=n=>String(n).padStart(2,"0");return`${r(o.getHours())}:${r(o.getMinutes())}`}var er=`
.topbar {
  position: static;
  margin-bottom: 14px;
  padding: 12px;
...
`,nn=T({tag:"hv6-header",render:tr,onMount(e,t){let o=t.querySelector("#hdr-dot"),r=t.querySelector("#hdr-sync"),n=t.querySelector("#hdr-up"),a=t.querySelector("#hdr-wifi"),i=t.querySelector("#hdr-asgard"),d=t.querySelector("#hdr-asgard-val"),b=t.querySelector("#hdr-asgard-time"),u=t.querySelector("#hdr-fw"),m=t.querySelectorAll(".menu-link");function z(){let c=O("section");m.forEach(g=>{g.classList.toggle("active",g.getAttribute("data-section")===c)})}function h(){let c=O("live"),g=O("pendingWrites"),y=!!(window.HV6_DASHBOARD_CONFIG&&window.HV6_DASHBOARD_CONFIG.mock);o.classList.toggle("on",!!c);let l,S;g>0?(l=f("status.saving"),S="saving"):y?(l=window.HV6_DASHBOARD_CONFIG.mockLabel||f("status.mock"),S="synced"):c?(l=f("status.live"),S="synced"):(l=f("status.offline"),S="offline"),r.textContent=l,r.className="meta-chip meta-chip-state "+S,n.textContent=Be(L(s.uptime)),a.textContent=eo(L(s.wifi));let A=L(s.asgardLastPushC),k=L(s.asgardLastPushAgeS),x=Y(s.asgardEnabled)&&A!=null&&Number.isFinite(A);i.hidden=!x,x&&(d.textContent=A.toFixed(2)+"\xB0C",b.textContent=to(k));let C=O("firmwareVersion")||N(s.firmware);u.textContent=C?"FW "+C:""}m.forEach(c=>{c.addEventListener("click",g=>{g.preventDefault(),kt(c.getAttribute("data-section"))})}),B("section",z),B("live",h),B("pendingWrites",h),B("firmwareVersion",h),w(s.uptime,h),w(s.wifi,h),w(s.asgardLastPushC,h),w(s.asgardLastPushAgeS,h),w(s.asgardEnabled,h),w(s.firmware,h),z(),_(t),h()}});var or=`
.connectivity-card {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`,mn=T({tag:"connectivity-card",render:rr,onMount(e,t){let o=t.querySelector(".cc-ip"),r=t.querySelector(".cc-ssid"),n=t.querySelector(".cc-mac"),a=t.querySelector(".cc-up");function i(){o.textContent=N(s.ip)||"---",r.textContent=N(s.ssid)||"---",n.textContent=N(s.mac)||"---",a.textContent=Be(L(s.uptime))}w(s.ip,i),w(s.ssid,i),w(s.mac,i),w(s.uptime,i),_(t),i()}});var ar="http://www.w3.org/2000/svg",nr=`
.chart-card {
  border: 1px solid var(--panel-border);
  border-radius: 8px;
  background: var(--panel-bg-vibrant);
...
`;F("chart-kit",nr);function oe(e,t,o){let r=document.createElementNS(ar,e);if(t)for(let n in t)r.setAttribute(n,t[n]);return o!=null&&(r.textContent=o),r}function oo(e){if(!e.length)return"";if(e.length<3)return"M "+e.map(r=>`${r.x.toFixed(2)} ${r.y.toFixed(2)}`).join(" L ");let t=.16,o=`M ${e[0].x.toFixed(2)} ${e[0].y.toFixed(2)}`;for(let r=0;r<e.length-1;r++){let n=e[r-1]||e[r],a=e[r],i=e[r+1],d=e[r+2]||i,b=a.x+(i.x-n.x)*t,u=a.y+(i.y-n.y)*t,m=i.x-(d.x-a.x)*t,z=i.y-(d.y-a.y)*t;o+=` C ${b.toFixed(2)} ${u.toFixed(2)}, ${m.toFixed(2)} ${z.toFixed(2)}, ${i.x.toFixed(2)} ${i.y.toFixed(2)}`}return o}function ro(e,t,o){let r=document.createElement("div");r.className="chart-tooltip",t.appendChild(r);let n=oe("g",{class:"chart-cursor",style:"display:none"}),a=oe("line",{class:"chart-cursor-line",y1:o.plotTop,y2:o.plotBottom});n.appendChild(a);let i=[];e.appendChild(n);function d(z){let h=0,c=1/0;for(let g=0;g<o.count;g++){let y=Math.abs(z-o.xAt(g));y<c&&(c=y,h=g)}return h}function b(z){let h=e.getScreenCTM();if(!h)return null;let c=e.createSVGPoint();return c.x=z.clientX,c.y=z.clientY,c.matrixTransform(h.inverse())}function u(z){if(!o.count)return;let h=b(z);if(!h)return;let c=d(h.x),g=o.xAt(c);a.setAttribute("x1",g),a.setAttribute("x2",g);let y=o.dots(c);for(;i.length<y.length;){let k=oe("circle",{class:"chart-cursor-dot",r:3.4});n.appendChild(k),i.push(k)}i.forEach((k,x)=>{x<y.length?(k.setAttribute("cx",g),k.setAttribute("cy",y[x].y),k.setAttribute("fill",y[x].color),k.style.display=""):k.style.display="none"}),n.style.display="";let l=o.rows(c).map(k=>`<div class="tt-row"><span class="tt-swatch" style="background:${k.color}"></span>${k.label}<span class="tt-val">${k.value}</span></div>`).join("");r.innerHTML=`<div class="tt-time">${o.label(c)}</div>${l}`,r.classList.add("show");let S=t.getBoundingClientRect(),A=z.clientX-S.left+14;A+r.offsetWidth>S.width-6&&(A=z.clientX-S.left-r.offsetWidth-14),r.style.left=Math.max(6,A)+"px",r.style.top=Math.max(6,z.clientY-S.top+12)+"px"}function m(){r.classList.remove("show"),n.style.display="none"}return e.addEventListener("pointermove",u),e.addEventListener("pointerleave",m),()=>{e.removeEventListener("pointermove",u),e.removeEventListener("pointerleave",m),r.remove()}}var Ae=1e3,bt=180,le=14,sr=42,ir=44,be=42,je=Ae-be-sr,me=bt-le-ir,ve=le+me,ft=24*3600,ao=Q+2,no=Q+3,We=Q+4,lr="var(--series-warm)",dr="var(--series-cool)",so="var(--series-solar)",cr=`
...
`;F("graph-widgets",cr);var io=()=>'<div class="chart-card"><div class="chart-head"><span class="chart-title" data-i18n="overview.graph.flowReturnDemand">Flow / Return / Demand</span><span class="chart-sub gw-dt">\u2014</span></div><div class="gw-controls" role="toolbar" data-i18n-label="overview.graph.layers" aria-label="Flow chart layers"><button type="button" class="gw-toggle" data-layer="flow" aria-pressed="true" data-i18n="overview.graph.layers.flow">Flow</button><button type="button" class="gw-toggle" data-layer="return" aria-pressed="true" data-i18n="overview.graph.layers.return">Return</button><button type="button" class="gw-toggle" data-layer="demand" aria-pressed="true" data-i18n="overview.graph.layers.demand">Demand</button></div><svg class="gw-flow"></svg></div>',lo=()=>'<div class="chart-card"><div class="chart-head"><span class="chart-title" data-i18n="overview.graph.demandIndex">Demand Index</span><span class="chart-sub gw-demand-text">\u2014</span></div><svg class="gw-demand"></svg></div>',pr=e=>e.variant==="flow-return"?`<div class="graph-widgets">${io()}</div>`:e.variant==="demand"?`<div class="graph-widgets">${lo()}</div>`:`<div class="graph-widgets">${io()}${lo()}</div>`;function co(e,t){return Number.isFinite(e)?t==="%"?Math.round(e)+"%":e.toFixed(1):"\u2014"}function gr(e,t){return Number.isFinite(e)?t==="%"?Math.round(e)+"%":e.toFixed(1)+"\xB0":"\u2014"}function vt(e,t,o){let r=[];for(let n=0;n<e.length;n++){let a=e[n];if(!a||a[0]<o)continue;let i=a[t];i==null||!Number.isFinite(i)||r.push({t:a[0],v:i})}return r}var Ve=(e,t)=>be+Math.max(0,Math.min(1,(e-t)/ft))*je;function ur(e,t,o){let r=Number(Date.now()/1e3)|0,n=3600,a=Math.ceil((r-ft)/n)*n,i=Math.floor(r/n)*n,d=Math.floor(r/n)*n;for(let u=a;u<=i;u+=n){let m=o-(r-u),z=Ve(m,t),h=new Date(u*1e3),c=u===d,g=ve+16;e.appendChild(oe("text",{x:z,y:g,"text-anchor":"end",transform:`rotate(-45 ${z.toFixed(1)} ${g})`,class:"chart-hour"+(c?" now":"")},String(h.getHours()).padStart(2,"0")))}let b=Ve(o,t);e.appendChild(oe("line",{x1:b,y1:le,x2:b,y2:ve,stroke:"var(--series-solar)","stroke-width":"1","stroke-dasharray":"2 3",opacity:".55","vector-effect":"non-scaling-stroke"}))}function mr(e){let t=[];if(e.forEach(a=>a.forEach(i=>t.push(i.v))),!t.length)return{min:0,max:10};let o=Math.min(...t),r=Math.max(...t);o===r&&(o-=.5,r+=.5);let n=(r-o)*.1;return o-=n,r+=n,{min:o,max:r}}function br(e,t,o){let r=e.filter(n=>n.unit==="C").map(n=>vt(t,n.index,o));return mr(r)}function po(e,t,o,r,n,a){e.innerHTML="",e.setAttribute("viewBox",`0 0 ${Ae} ${bt}`),e.setAttribute("preserveAspectRatio","xMidYMid meet");let i=o.map(g=>vt(r,g.index,n));if(!i.some(g=>g.length))return e.appendChild(oe("text",{x:Ae/2,y:bt/2,"text-anchor":"middle",class:"chart-empty"},"Collecting history\u2026")),null;let d=br(o,r,n),b=Math.max(.001,d.max-d.min),u=g=>le+(1-(g-d.min)/b)*me,m=g=>le+(1-Math.max(0,Math.min(100,g))/100)*me,z=(g,y)=>g.unit==="%"?m(y):u(y);for(let g=0;g<3;g++){let y=g/2,l=le+y*me;e.appendChild(oe("line",{x1:be,y1:l,x2:be+je,y2:l,class:"chart-grid"})),o.some(S=>S.unit==="C")&&e.appendChild(oe("text",{x:be-6,y:l+4,"text-anchor":"end",class:"chart-tick"},co(d.max-b*y,"C")+"\xB0")),o.some(S=>S.unit==="%")&&e.appendChild(oe("text",{x:be+je+6,y:l+4,"text-anchor":"start",class:"chart-tick"},co(100-100*y,"%")))}e.appendChild(oe("line",{x1:be,y1:ve,x2:be+je,y2:ve,class:"chart-axis"})),o.some(g=>g.unit==="C")&&e.appendChild(oe("text",{x:9,y:le+me/2,transform:`rotate(-90 9 ${(le+me/2).toFixed(1)})`,"text-anchor":"middle",class:"chart-axis-label"},f("overview.graph.axis.temp"))),o.some(g=>g.unit==="%")&&e.appendChild(oe("text",{x:Ae-9,y:le+me/2,transform:`rotate(90 ${Ae-9} ${(le+me/2).toFixed(1)})`,"text-anchor":"middle",class:"chart-axis-label"},f("overview.graph.axis.demand"))),ur(e,n,a),o.forEach((g,y)=>{let l=i[y].map(A=>({x:Ve(A.t,n),y:z(g,A.v)}));if(!l.length)return;let S=oo(l);g.fill&&e.appendChild(oe("path",{d:S+` L ${l[l.length-1].x.toFixed(1)} ${ve} L ${l[0].x.toFixed(1)} ${ve} Z`,fill:g.fill,stroke:"none"})),e.appendChild(oe("path",{d:S,fill:"none",stroke:g.color,"stroke-width":String(g.width||2.2),"stroke-linecap":"round","stroke-linejoin":"round"}))});let h=[];for(let g=0;g<r.length;g++){let y=r[g];if(!y||y[0]<n)continue;let l=o.map(S=>y[S.index]);l.every(S=>S==null||!Number.isFinite(S))||h.push({t:y[0],vals:l})}if(!h.length)return null;let c=Date.now();return ro(e,t,{count:h.length,plotTop:le,plotBottom:ve,xAt:g=>Ve(h[g].t,n),label:g=>new Date(c-(a-h[g].t)*1e3).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),dots:g=>o.map((y,l)=>({y:z(y,h[g].vals[l]),color:y.color})).filter((y,l)=>Number.isFinite(h[g].vals[l])),rows:g=>o.map((y,l)=>({color:y.color,label:y.label,value:gr(h[g].vals[l],y.unit)})).filter((y,l)=>Number.isFinite(h[g].vals[l]))})}function Ze(e,t,o){let r=vt(e,t,o);return r.length?r[r.length-1].v:null}var Sn=T({tag:"graph-widgets",state:e=>({variant:e&&e.variant||"both"}),render:pr,onMount(e,t){let o=t.querySelector(".gw-dt"),r=t.querySelector(".gw-demand-text"),n=t.querySelector(".gw-flow"),a=t.querySelector(".gw-demand"),i=Array.from(t.querySelectorAll(".gw-toggle")),d={flow:!0,return:!0,demand:!0},b=null,u=null;function m(){i.forEach(c=>{let g=c.dataset.layer;c.classList.toggle("is-off",!d[g]),c.setAttribute("aria-pressed",d[g]?"true":"false")})}function z(){let c=[];return d.flow&&c.push({index:ao,color:lr,label:f("overview.graph.layers.flow"),unit:"C",width:2.4}),d.return&&c.push({index:no,color:dr,label:f("overview.graph.layers.return"),unit:"C",width:2}),d.demand&&c.push({index:We,color:so,label:f("overview.graph.layers.demand"),unit:"%",width:1.8,fill:"rgba(255,193,77,.10)"}),c}function h(){let c=O("zoneStateHistory"),g=c&&Array.isArray(c.entries)?c.entries:[],y=c&&c.uptime_s||Number(Date.now()/1e3)|0,l=y-ft;if(n){b&&b();let S=Ze(g,ao,l),A=Ze(g,no,l),k=Ze(g,We,l),x=[];S!=null&&A!=null&&x.push("\u0394 "+(S-A).toFixed(1)+"\xB0"),k!=null&&x.push(Math.round(k)+"%"),o.textContent=x.length?x.join(" \xB7 "):"\u2014",b=po(n,n.closest(".chart-card"),z(),g,l,y)}if(a){u&&u();let S=Ze(g,We,l);r.textContent=S!=null?Math.round(S)+"%":"\u2014",u=po(a,a.closest(".chart-card"),[{index:We,color:so,label:f("overview.graph.layers.demand"),unit:"%",width:2.2,fill:"var(--series-cool-fill)"}],g,l,y)}}i.forEach(c=>{c.addEventListener("click",()=>{let g=c.dataset.layer;d[g]=!d[g],!d.flow&&!d.return&&!d.demand&&(d[g]=!0),m(),h()})}),B("zoneStateHistory",h),_(t),m(),h()}});var fe={0:{labelKey:"state.off",color:"#2c4875"},1:{labelKey:"state.manual",color:"#7aa7ce"},2:{labelKey:"state.calibrating",color:"#ffd380"},3:{labelKey:"state.waitCal",color:"#4e6977"},4:{labelKey:"state.waitTemp",color:"#4e6977"},5:{labelKey:"state.heating",color:"#ff8531"},6:{labelKey:"state.idle",color:"#39354c"},7:{labelKey:"state.overheated",color:"#ff6361"},255:{labelKey:"",color:"transparent"}},Me=24*3600,fr=Me,Ee=18,yt=4,he=54,Ge=32,ke=4,Ue=10,mo=6,bo="#ffc14d",ht=9,go=Q+1,fo=ke+Q*(Ee+yt)-yt,xt=fo+mo,$e=fo+mo+Ue+Ge,vr=`
.timeline-card {
  border: 1px solid var(--panel-border);
  border-radius: 8px;
  background: var(--panel-bg-vibrant);
...
`;function xr(e,t){if(!e||!e.entries||e.entries.length===0)return null;let o=e.entries,r=e.uptime_s||t||0,n=Number(Date.now()/1e3)|0,a=1e3,i=a-he;function d(k){let x=(k+Me)/fr;return he+Math.max(0,Math.min(1,x))*i}function b(k){return k-r}let u="http://www.w3.org/2000/svg",m=document.createElementNS(u,"svg");m.setAttribute("viewBox","0 0 "+a+" "+$e),m.classList.add("timeline-svg");let z=document.createElementNS(u,"rect");z.setAttribute("x",he),z.setAttribute("y",ke),z.setAttribute("width",i),z.setAttribute("height",$e-ke-Ge),z.setAttribute("fill","rgba(0,32,46,0.55)"),z.setAttribute("rx","4"),m.appendChild(z);let h=d(0),c=[-24,-18,-12,-6,0].map(k=>k*3600);for(let k of c){let x=d(k),C=document.createElementNS(u,"line");C.setAttribute("x1",x),C.setAttribute("y1",ke),C.setAttribute("x2",x),C.setAttribute("y2",$e-Ge),C.setAttribute("stroke",k===0?"var(--series-solar)":"rgba(120,146,200,.16)"),C.setAttribute("stroke-width","1"),k===0&&(C.setAttribute("stroke-dasharray","2 3"),C.setAttribute("opacity",".55"),C.setAttribute("vector-effect","non-scaling-stroke")),m.appendChild(C)}m.appendChild(yr(u,"text",{x:h+4,y:ke+11,"text-anchor":"start",fill:"rgba(255,211,128,.92)","font-size":"9","font-family":"Montserrat, sans-serif","font-weight":"600"},"now"));for(let k=0;k<Q;k++){let x=ke+k*(Ee+yt),C=document.createElementNS(u,"rect");C.setAttribute("x",he),C.setAttribute("y",x),C.setAttribute("width",i),C.setAttribute("height",Ee),C.setAttribute("fill",k%2===0?"rgba(124,155,208,0.05)":"rgba(124,155,208,0.00)"),m.appendChild(C);let M=document.createElementNS(u,"text");M.setAttribute("x",he-4),M.setAttribute("y",x+Ee/2+1),M.setAttribute("text-anchor","end"),M.setAttribute("dominant-baseline","middle"),M.setAttribute("fill","rgba(233,222,210,.62)"),M.setAttribute("font-size","9.5"),M.setAttribute("font-family","Montserrat, sans-serif"),M.setAttribute("font-weight","600"),M.textContent="Z"+(k+1),m.appendChild(M);let W=o.map(E=>({rel:b(E[0]),state:E[k+1]})).filter(E=>E.rel>=-Me&&E.rel<=0),H=(E,Z,I)=>{if(I===255)return;let X=fe[I]||fe[255];if(X.color==="transparent")return;let U=d(E),_e=d(Z),Qe=Math.max(1,_e-U),ce=document.createElementNS(u,"rect");ce.setAttribute("x",U),ce.setAttribute("y",x+(Ee-ht)/2),ce.setAttribute("width",Qe),ce.setAttribute("height",ht),ce.setAttribute("fill",X.color),ce.setAttribute("rx",String(ht/2)),ce.setAttribute("opacity","0.9"),m.appendChild(ce)};if(W.length){let E=W[0].rel,Z=W[0].state;for(let I=1;I<W.length;I++){let X=W[I];X.state!==Z&&(H(E,X.rel,Z),E=X.rel,Z=X.state)}H(E,0,Z)}}{let k=document.createElementNS(u,"rect");k.setAttribute("x",he),k.setAttribute("y",xt),k.setAttribute("width",i),k.setAttribute("height",Ue),k.setAttribute("fill","rgba(188,80,144,0.10)"),k.setAttribute("rx","2"),m.appendChild(k);let x=document.createElementNS(u,"text");x.setAttribute("x",he-4),x.setAttribute("y",xt+Ue/2+1),x.setAttribute("text-anchor","end"),x.setAttribute("dominant-baseline","middle"),x.setAttribute("fill","rgba(233,222,210,.62)"),x.setAttribute("font-size","8.5"),x.setAttribute("font-family","Montserrat, sans-serif"),x.setAttribute("font-weight","600"),x.textContent=f("overview.timeline.absorb"),m.appendChild(x);let C=o.map(M=>({rel:b(M[0]),on:M.length>go?M[go]:0})).filter(M=>M.rel>=-Me&&M.rel<=0);if(C.length){let M=(E,Z)=>{let I=d(E),X=Math.max(1,d(Z)-I),U=document.createElementNS(u,"rect");U.setAttribute("x",I),U.setAttribute("y",xt),U.setAttribute("width",X),U.setAttribute("height",Ue),U.setAttribute("fill",bo),U.setAttribute("rx","2"),U.setAttribute("opacity","0.9"),m.appendChild(U)},W=C[0].rel,H=C[0].on;for(let E=1;E<C.length;E++)C[E].on!==H&&(H&&M(W,C[E].rel),W=C[E].rel,H=C[E].on);H&&M(W,0)}}let g=$e-Ge+15,y=3600,l=Math.ceil((n-Me)/y)*y,S=Math.floor(n/y)*y,A=Math.floor(n/y)*y;for(let k=l;k<=S;k+=y){let x=k-n,C=d(x),M=new Date(k*1e3),W=String(M.getHours()).padStart(2,"0"),H=k===A,E=document.createElementNS(u,"text");E.setAttribute("x",C),E.setAttribute("y",g),E.setAttribute("text-anchor","end"),E.setAttribute("fill",H?"rgba(255,211,128,.95)":"rgba(202,219,248,.72)"),E.setAttribute("font-size","9"),E.setAttribute("font-family",'"Montserrat", sans-serif'),E.setAttribute("font-weight","500"),E.setAttribute("font-variant-numeric","tabular-nums lining-nums"),E.setAttribute("font-feature-settings",'"tnum" 1, "lnum" 1'),E.setAttribute("letter-spacing","0"),E.setAttribute("transform",`rotate(-45 ${C.toFixed(1)} ${g})`),E.textContent=W,m.appendChild(E)}return m}function yr(e,t,o,r){let n=document.createElementNS(e,t);for(let a in o)n.setAttribute(a,o[a]);return r!=null&&(n.textContent=r),n}function uo(e){e.innerHTML="";let t=[{code:5,...fe[5]},{code:6,...fe[6]},{code:0,...fe[0]},{code:1,...fe[1]},{code:7,...fe[7]},{code:2,...fe[2]}];for(let r of t){let n=document.createElement("div");n.className="tl-legend-item",n.innerHTML='<span class="tl-legend-dot" style="background:'+r.color+'"></span>'+(r.labelKey?f(r.labelKey):""),e.appendChild(n)}let o=document.createElement("div");o.className="tl-legend-item",o.innerHTML='<span class="tl-legend-dot" style="background:'+bo+'"></span>'+f("overview.timeline.preheatAbsorption"),e.appendChild(o)}var En=T({tag:"zone-state-timeline",render:hr,onMount(e,t){let o=t.querySelector(".tl-body"),r=t.querySelector(".timeline-legend");uo(r);function n(){let a=O("zoneStateHistory"),i=(()=>{let b=O&&O("zoneStateHistory");return b&&b.uptime_s||Number(Date.now()/1e3)|0})();if(o.innerHTML="",!a||!a.entries||a.entries.length===0){let b=document.createElement("div");b.className="timeline-empty",b.textContent=f("overview.timeline.noHistory"),o.appendChild(b);return}let d=xr(a,i);d&&o.appendChild(d)}B("zoneStateHistory",n),B("zoneNames",n),w(s.drivers,n);for(let a=1;a<=Q;a++)w(p.enabled(a),n),w(p.state(a),n),w(p.temp(a),n),w(p.setpoint(a),n),w(p.preheatAdvance(a),n);_(t),n()}});var wr=`
.zone-grid {
    display: grid;
...
`;F("zone-grid",wr);var zr=()=>'<div class="zone-grid"></div>',Dn=T({tag:"zone-grid",render:zr,onMount(e,t){for(let o=1;o<=6;o++)t.appendChild(V("zone-card",{zone:o}))}});var Sr=`
.zone-card {
	display: grid;
...
`,Wn=T({tag:"zone-card",state:e=>({zone:e.zone}),render:kr,onMount(e,t){let o=e.zone,r=p.temp(o),n=p.state(o),a=p.enabled(o),i=t.querySelector(".zc-state-label"),d=t.querySelector(".zc-dot"),b=t.querySelector(".zc-link"),u=t.querySelector(".zc-zone-name"),m=t.querySelector(".zc-friendly");function z(c){let g=String(c||"").match(/\d+/);return g?Number(g[0]):0}function h(){let c=Y(a),g=String(N(n)||"").toUpperCase()||"OFF",y=String(N(p.motorLastFault(o))||"").toUpperCase(),l=y&&y!=="NONE"&&y!=="OK",S=c&&(g==="FAULT"||l)?"FAULT":g,A=O("selectedZone")===o,k=ue(o);u.textContent=$(o),m.textContent=k||ae(L(r));let x=c?S:"OFF";i.textContent=x==="HEATING"?f("state.heating"):x==="IDLE"?f("state.idle"):x==="FAULT"?f("common.fault"):x==="MANUAL"?f("state.manual"):x==="OVERHEATED"?f("state.overheated"):x==="CALIBRATING"?f("state.calibrating"):f("state.off");let C=z(N(p.syncTo(o))),M=[];for(let I=1;I<=6;I++)I!==o&&z(N(p.syncTo(I)))===o&&M.push(I);let W=C>0&&C!==o||M.length>0;b.hidden=!W,b.textContent=C>0&&C!==o?f("zone.card.linkZone",{zone:C}):M.length>1?f("zone.card.groupCount",{count:M.length}):f("zone.card.linkZone",{zone:M[0]});let H=C>0&&C!==o?f("zone.card.groupedWith",{zones:$(C)}):M.length>0?f("zone.card.groupedWith",{zones:M.map($).join(", ")}):"";t.title=l?f("zone.card.fault",{fault:y}):H;let E=x==="HEATING"?"#ffd380":x==="IDLE"?"#7aa7ce":x==="FAULT"?"#ff6361":"#6E7E96",Z=x==="HEATING"?"#ff8531":x==="IDLE"?"#7aa7ce":x==="FAULT"?"#ff6361":"rgba(120,146,200,.35)";i.style.color=E,d.style.background=Z,d.style.boxShadow=x==="HEATING"?"0 0 5px rgba(255,133,49,.6)":x==="FAULT"?"0 0 5px rgba(255,100,100,.6)":"",t.classList.toggle("active",A),t.classList.toggle("disabled",!c),t.classList.toggle("zs-heating",c&&x==="HEATING"),t.classList.toggle("zs-fault",c&&x==="FAULT"),t.classList.toggle("zs-idle",c&&x!=="HEATING"&&x!=="FAULT"),t.classList.toggle("zs-off",!c)}t.addEventListener("click",()=>{_t(o)}),w(r,h),w(n,h),w(a,h),w(p.motorLastFault(o),h);for(let c=1;c<=6;c++)w(p.syncTo(c),h);B("selectedZone",h),B("zoneNames",h),h()}});var _r=`
.zone-detail {
...
`;function vo(e){return e!=null?Number(e).toFixed(2)+"x":"---"}function ho(e){return e!=null?Number(e).toFixed(0):"---"}function Lr(e){return e!=null?Number(e).toFixed(2)+"C":"---"}function Ar(e,t){if(!t)return f("common.disabled");let o=String(e||"IDLE").toUpperCase();return o==="HEATING"?f("state.heating"):o==="IDLE"?f("state.idle"):o==="OFF"?f("state.off"):o==="FAULT"?f("common.fault"):o==="MANUAL"?f("state.manual"):o==="OVERHEATED"?f("state.overheated"):o==="CALIBRATING"?f("state.calibrating"):o}var Kn=T({tag:"zone-detail",state:e=>({zone:e.zone,temp:"---",setpoint:"---",valve:"---",state:"---"}),render:Cr,methods:{update(e,t){let o=O("selectedZone"),r=String(N(p.state(o))||"").toUpperCase(),n=Y(p.enabled(o));this.zone=o,e.dataset.zone=String(o),t.title.textContent=$(o),t.setpoint.textContent=ae(L(p.setpoint(o))),t.temp.textContent=ae(L(p.temp(o))),t.ret.textContent=ae(L("sensor-manifold_return_temperature")),t.valve.textContent=Ie(L(p.valve(o)));let a=t.badge;a.textContent=Ar(r,n);let i=n?r==="HEATING"?"badge-heating":r==="IDLE"?"badge-idle":r==="FAULT"?"badge-fault":"":"badge-disabled";a.className="zd-badge"+(i?" "+i:""),t.toggle.classList.toggle("on",n),t.orip.textContent=ho(L(p.motorOpenRipples(o))),t.crip.textContent=ho(L(p.motorCloseRipples(o))),t.ofac.textContent=vo(L(p.motorOpenFactor(o))),t.cfac.textContent=vo(L(p.motorCloseFactor(o))),t.ph.textContent=Lr(L(p.preheatAdvance(o)));let d=String(N(p.motorLastFault(o))||"").toUpperCase(),b=d&&d!=="NONE"&&d!=="OK";t.fault.hidden=!b,b&&(t.faultVal.textContent=d)},incSetpoint(){let e=this.zone,t=L(p.setpoint(e))||20;nt(e,Number((t+.5).toFixed(1)))},decSetpoint(){let e=this.zone,t=L(p.setpoint(e))||20;nt(e,Number((t-.5).toFixed(1)))},toggleEnabled(){let e=this.zone,t=Y(p.enabled(e));Pt(e,!t)}},onMount(e,t){let o={title:t.querySelector(".zd-title"),setpoint:t.querySelector(".zd-setpoint"),temp:t.querySelector(".zd-temp"),ret:t.querySelector(".zd-ret"),valve:t.querySelector(".zd-valve"),badge:t.querySelector(".zd-badge"),toggle:t.querySelector(".btn-toggle"),inc:t.querySelector(".btn-inc"),dec:t.querySelector(".btn-dec"),orip:t.querySelector(".zd-orip"),crip:t.querySelector(".zd-crip"),ofac:t.querySelector(".zd-ofac"),cfac:t.querySelector(".zd-cfac"),ph:t.querySelector(".zd-ph"),fault:t.querySelector(".zd-fault"),faultVal:t.querySelector(".zd-fault-val")};o.inc.onclick=()=>e.incSetpoint(),o.dec.onclick=()=>e.decSetpoint(),o.toggle.onclick=()=>e.toggleEnabled();let r=()=>e.update(t,o),n=a=>{let i=O("selectedZone");(a===p.temp(i)||a===p.setpoint(i)||a===p.valve(i)||a===p.state(i)||a===p.enabled(i))&&r()};for(let a=1;a<=6;a++)w(p.temp(a),n),w(p.setpoint(a),n),w(p.valve(a),n),w(p.state(a),n),w(p.enabled(a),n),w(p.motorOpenRipples(a),r),w(p.motorCloseRipples(a),r),w(p.motorOpenFactor(a),r),w(p.motorCloseFactor(a),r),w(p.preheatAdvance(a),r),w(p.motorLastFault(a),r);w("sensor-manifold_return_temperature",r),B("selectedZone",r),_(t),r()}});var Mr=`
...
`;F("zone-sensor-card",Mr);var Er=()=>{let e='<option value="None" data-i18n="common.none">None</option>';for(let t=1;t<=8;t++)e+='<option value="Probe '+t+'">Probe '+t+"</option>";return`
  ...
  `};function xo(e,t){let o=e.value,r='<option value="None" data-i18n="common.none">'+f("common.none")+"</option>";for(let n=1;n<=6;n++)n!==t&&(r+='<option value="Zone '+n+'">'+f("common.zone")+" "+n+"</option>");e.innerHTML=r,e.value=o||"None"}function Fr(e){return e==="BLE"||e==="BLE Sensor"?"BLE Sensor":"Local Probe"}function Nr(e){return e==="BLE Sensor"?"BLE":"Local Probe"}function yo(e,t){let o='<option value="Local Probe" data-i18n="zone.sensor.localProbe">'+f("zone.sensor.localProbe")+'</option><option value="BLE Sensor" data-i18n="zone.sensor.bleSource">'+f("zone.sensor.bleSource")+"</option>";e.innerHTML!==o&&(e.innerHTML=o),e.value=t}function wo(e){let t=String(e||"").match(/\d+/);return t?Number(t[0]):0}var ss=T({tag:"zone-sensor-card",render:Er,onMount(e,t){let o=t.querySelector(".zs-probe"),r=t.querySelector(".zs-source"),n=t.querySelector(".zs-ble"),a=t.querySelector(".zs-sync"),i=t.querySelector(".zs-row-ble"),d=t.querySelector(".zs-scan"),b=t.querySelector(".zs-scan-list"),u=t.querySelector(".merge-visual"),m=t.querySelector(".merge-rail"),z=t.querySelector(".merge-caption"),h=0;function c(){return O("selectedZone")}function g(){i.style.display=r.value==="BLE Sensor"?"":"none"}function y(){let x=c(),C=wo(a.value),M=[];for(let Z=1;Z<=6;Z++)Z!==x&&wo(N(p.syncTo(Z)))===x&&M.push(Z);let W=C>0&&C!==x,H=W||M.length>0;if(u.classList.toggle("is-solo",!H),!H){m.innerHTML='<span class="merge-pill primary">'+$(x)+'</span><span class="merge-link"></span><span class="merge-pill">'+f("zone.sensor.noMerge")+"</span>",z.textContent=f("zone.sensor.soloCaption");return}if(W){m.innerHTML='<span class="merge-pill secondary">'+$(x)+'</span><span class="merge-link"></span><span class="merge-pill primary">'+$(C)+"</span>",z.textContent=f("zone.sensor.followsCaption",{zone:$(x),target:$(C)});return}let E='<span class="merge-pill primary">'+$(x)+"</span>";for(let Z of M)E+='<span class="merge-link"></span><span class="merge-pill secondary">'+$(Z)+"</span>";m.innerHTML=E,z.textContent=f("zone.sensor.primaryCaption",{zone:$(x),zones:M.map($).join(", ")})}let l=re(t);yo(r,"Local Probe"),l.select(o,{read:()=>N(p.probe(c()))||void 0,commit:x=>Se(c(),"zone_probe",x)}),l.select(r,{read:()=>Fr(String(N(p.tempSource(c()))||"")),commit:x=>Se(c(),"zone_temp_source",Nr(x))}),l.select(a,{read:()=>N(p.syncTo(c()))||"None",commit:x=>Se(c(),"zone_sync_to",x)});let S=l.text(n,{read:()=>N(p.ble(c()))||"",commit:x=>Le(c(),"zone_ble_mac",x)});r.addEventListener("change",g),a.addEventListener("change",y);function A(){let x=c();h!==x?(xo(a,x),h=x,b.style.display="none",l.discard()):l.refresh(),g(),y()}function k(x){let C=c();(x===p.probe(C)||x===p.tempSource(C)||x===p.syncTo(C)||x===p.ble(C)||/^select-zone_\d+_sync_to$/.test(x))&&(l.refresh(),g(),y())}d.addEventListener("click",()=>{if(d.disabled)return;d.disabled=!0,d.textContent="\u2026",b.style.display="",b.innerHTML='<div class="scan-msg">'+f("zone.sensor.scanning")+"</div>";let x=new AbortController,C=setTimeout(()=>x.abort(),8e3);fetch("/api/hv6/v1/ble-scan",{cache:"no-store",signal:x.signal}).then(M=>{if(!M.ok)throw new Error("HTTP "+M.status);return M.json()}).then(M=>{if(clearTimeout(C),d.disabled=!1,d.textContent=f("zone.sensor.scan"),!M.ok||!M.sensors||M.sensors.length===0){b.innerHTML='<div class="scan-msg">'+f("zone.sensor.noSensors")+"</div>";return}let W=c(),H=(N(p.ble(W))||"").toUpperCase(),E=I=>String(I).replace(/[&<>"']/g,X=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[X]),Z="";for(let I of M.sensors){let X=I.mac.toUpperCase(),U=I.name?E(I.name):"",_e=I.temp_c!=null?I.temp_c.toFixed(1)+"\xB0C":"\u2014",Qe=I.rssi!=null?I.rssi+" dBm":"",ce=I.age_s<60?f("common.secondsAgo",{value:I.age_s}):f("common.minutesAgo",{value:Math.round(I.age_s/60)}),et="";X===H?et='<span class="ble-badge">'+f("zone.sensor.assignedThisZone")+"</span>":I.zone>0&&(et='<span class="ble-badge">'+f("zone.sensor.zoneBadge",{zone:I.zone})+"</span>");let Eo=U?`<div class="ble-mac">${U}</div><div class="ble-meta">${X}</div>`:`<div class="ble-mac">${X}</div>`;Z+=`<div class="ble-scan-item">
              <div>
                ${Eo}
            ...
            </div>`}b.innerHTML=Z,b.querySelectorAll(".btn-assign").forEach(I=>{I.addEventListener("click",()=>{n.value=I.dataset.mac,S.markDirty(),b.style.display="none"})})}).catch(M=>{clearTimeout(C),d.disabled=!1,d.textContent=f("zone.sensor.scan");let W=M&&M.name==="AbortError"?f("zone.sensor.scanTimeout"):f("zone.sensor.scanFailed");b.innerHTML='<div class="scan-msg">'+W+"</div>"})}),B("selectedZone",A);for(let x=1;x<=6;x++)w(p.probe(x),k),w(p.tempSource(x),k),w(p.syncTo(x),k),w(p.ble(x),k);_(t),A()}});var Tr=`
...
`,bs=T({tag:"zone-room-card",render:Dr,onMount(e,t){let o=t.querySelector(".zr-friendly"),r=t.querySelector(".zr-area"),n=t.querySelector(".zr-spacing"),a=t.querySelector(".zr-pipe"),i=t.querySelector(".wall-btn-group").querySelectorAll(".wall-btn");function d(){return O("selectedZone")}let b=re(t);b.text(o,{read:()=>ue(d())||"",commit:c=>qt(d(),c)}),b.num(r,{read:()=>L(p.area(d())),commit:c=>st(d(),"zone_area_m2",c)}),b.num(n,{read:()=>L(p.spacing(d())),commit:c=>st(d(),"zone_pipe_spacing_mm",c||200)}),b.select(a,{read:()=>N(p.pipeType(d()))||"Unknown",commit:c=>Se(d(),"zone_pipe_type",c)});let u=[];function m(){i.forEach(c=>{let g=c.dataset.wall;c.classList.toggle("active",g==="None"?u.length===0:u.includes(g))})}let z=b.custom({sync:()=>{let c=N(p.exteriorWalls(d()))||"None";u=c==="None"?[]:c.split(",").filter(Boolean),m()},commit:()=>Le(d(),"zone_exterior_walls",u.length?u.join(","):"None")});i.forEach(c=>{c.addEventListener("click",()=>{let g=c.dataset.wall,y=u.slice();if(g==="None")y=[];else{let l=y.indexOf(g);l>=0?y.splice(l,1):y.push(g)}u=["N","S","E","W"].filter(l=>y.includes(l)),m(),z.markDirty()})});function h(c){let g=d();(c===p.area(g)||c===p.spacing(g)||c===p.pipeType(g)||c===p.exteriorWalls(g))&&b.refresh()}B("selectedZone",b.discard),B("zoneNames",b.refresh);for(let c=1;c<=6;c++)w(p.area(c),h),w(p.spacing(c),h),w(p.pipeType(c),h),w(p.exteriorWalls(c),h);_(t),b.refresh()}});var de=6,Pr="#6E7E96",ko="#5C6B85",Rr="#7aa7ce",Or="#9DBC78",Hr="#FF8531",qr="#FFA600",Ir="#7aa7ce",Br="#FFEAD2",Wr="#6E7E96",zo="#B9CBD8",Xe="#5C6B85",wt="#A6B9C7",_o="#A6B9C7",So="#7aa7ce",Zr="#66BB6A",jr="#FF6361",j={w:1160,h:310,boxX:452,boxY:34,boxW:256,boxH:68,topBarY:0,topBarH:24,srcY:102,fanY:158,zoneY:232,zoneXs:[92,286,480,674,868,1062],srcSpread:15,bgDstHW:28,srcHW:7},D={w:760,h:340,boxX:38,boxY:132,boxW:142,boxH:72,srcX:180,endX:386,nameX:446,midY:168,zoneYs:[58,104,150,196,242,288],spread:8,bgDstHW:15,srcHW:4},Vr=`
.flow-wrap {
  width: 100%;
  border-radius: 8px;
  overflow: hidden;
...
`;function ta(e){let t=Jr[e.level]||{label:"?",color:"var(--text-secondary)"},o=Mo(e.tag||""),r=Mo(e.msg||"");return'<div class="log-line"><span class="lv" style="color:'+t.color+'">'+t.label+'</span><span class="tag">'+o+'</span><span class="msg">'+r+"</span></div>"}function Mo(e){return String(e).replace(/[&<>]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[t])}var Ls=T({tag:"logs-view",render:ea,onMount(e,t){let o=t.querySelector(".logs-stream"),r=t.querySelector(".pause-btn"),n=t.querySelector(".clear-btn"),a=!1;function i(){if(a)return;let d=Mt();if(!d||!d.length){o.innerHTML='<div class="logs-empty">'+f("logs.waiting")+"</div>";return}let b=o.scrollHeight-o.scrollTop-o.clientHeight<40;o.innerHTML=d.map(ta).join(""),b&&(o.scrollTop=o.scrollHeight)}r.addEventListener("click",()=>{a=!a,r.textContent=a?f("logs.resume"):f("logs.pause"),r.classList.toggle("on",a),a||i()}),n.addEventListener("click",()=>{Et()}),B("deviceLog",i),_(t),i()}});var oa=`
.diag-i2c {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`,Ds=T({tag:"diag-i2c",render:ra,onMount(e,t){let o=t.querySelector("#i2c-result");function r(){o.textContent=O("i2cResult")||f("diagnostics.i2c.empty")}t.querySelector("#btn-i2c-scan").addEventListener("click",()=>{Ot()}),B("i2cResult",r),_(t),r()}});var aa=`
.diag-manual-badge {
  display: none;
  align-items: center;
  gap: 10px;
...
`,Is=T({tag:"diag-manual-badge",render:na,onMount(e,t){let o=t.classList.contains("diag-manual-badge")?t:t.querySelector(".diag-manual-badge");function r(){let n=!!O("manualMode");o&&o.classList.toggle("on",n)}B("manualMode",r),_(t),r()}});var sa=`
.diag-zone-motor {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`;F("diag-zone-motor",sa);var ia=e=>{let t=e.zone||O("selectedZone")||1,o="";for(let r=1;r<=6;r++)o+='<option value="'+r+'"'+(r===t?" selected":"")+">"+f("common.zone")+" "+r+"</option>";return`
  ...
  `},Us=T({tag:"diag-zone-motor-card",render:ia,onMount(e,t){let o=Number(e.zone||O("selectedZone")||1),r=!!O("manualMode"),n=t.querySelector(".manual-mode-toggle"),a=t.querySelector(".motor-gated"),i=t.querySelector(".motor-zone-select"),d=t.querySelector(".motor-target-input"),b=t.querySelector(".motor-open-btn"),u=t.querySelector(".motor-close-btn"),m=t.querySelector(".motor-stop-btn"),z=()=>{let y=i.value||String(o),l="";for(let S=1;S<=6;S++)l+='<option value="'+S+'">'+f("common.zone")+" "+S+"</option>";i.innerHTML=l,i.value=y};function h(y){r=!!y,n&&(n.classList.toggle("on",r),n.setAttribute("aria-checked",r?"true":"false")),a&&a.classList.toggle("locked",!r),[i,d,b,u,m].forEach(l=>{l&&(l.disabled=!r)})}function c(){let y=!r;if(h(y),y){lt(!0);for(let l=1;l<=6;l++)it(l)}else lt(!1)}function g(){let y=L(p.motorTarget(o));d&&y!=null?d.value=Number(y).toFixed(0):d&&(d.value="0")}i==null||i.addEventListener("change",()=>{o=Number(i.value||1),g()}),n==null||n.addEventListener("click",c),n==null||n.addEventListener("keydown",y=>{y.key!==" "&&y.key!=="Enter"||(y.preventDefault(),c())});for(let y=1;y<=6;y++)w(p.motorTarget(y),g);g(),h(r),B("manualMode",()=>{h(!!O("manualMode"))}),_(t),d==null||d.addEventListener("change",y=>{if(!r)return;let l=y.target.value;It(o,l)}),b==null||b.addEventListener("click",()=>{r&&Bt(o,1e4)}),u==null||u.addEventListener("click",()=>{r&&Wt(o,1e4)}),m==null||m.addEventListener("click",()=>{r&&it(o)})}});var la=`
.diag-zone-recovery {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 8px;
...
`;F("diag-zone-recovery",la);var da=()=>`
  ...
  `,ti=T({tag:"diag-zone-recovery-card",render:da,onMount(e,t){let o=Number(O("selectedZone")||1),r=t.querySelector(".recovery-fault-btn"),n=t.querySelector(".recovery-factors-btn"),a=t.querySelector(".recovery-relearn-btn"),i=t.querySelector(".recovery-status");B("selectedZone",()=>{o=Number(O("selectedZone")||1)});let d=null;function b(m,z){i.textContent=m,i.className="recovery-status show "+(z?"ok":"err"),clearTimeout(d),d=setTimeout(()=>{i.classList.remove("show")},4e3)}function u(m,z){let h=m(o);b(z,!0),h&&typeof h.then=="function"&&h.then(c=>{c&&c.ok===!1&&b(f("diagnostics.recovery.rejected"),!1)}).catch(()=>b(f("diagnostics.recovery.unreachable"),!1))}r==null||r.addEventListener("click",()=>{u(Zt,"\u2713 "+f("diagnostics.recovery.faultSent",{zone:$(o)}))}),n==null||n.addEventListener("click",()=>{confirm(f("diagnostics.recovery.confirmFactors",{zone:$(o)}))&&u(jt,"\u2713 "+f("diagnostics.recovery.factorsReset",{zone:$(o)}))}),a==null||a.addEventListener("click",()=>{confirm(f("diagnostics.recovery.confirmRelearn",{zone:$(o)}))&&u(Vt,"\u2713 "+f("diagnostics.recovery.relearnStarted",{zone:$(o)}))}),_(t)}});var ca=`
...
`,di=T({tag:"diag-system-card",render:pa,onMount(e,t){let o=t.querySelector('[data-k="cpu0"]'),r=t.querySelector('[data-k="cpu1"]'),n=t.querySelector('[data-k="heap"]'),a=t.querySelector('[data-k="psram"]'),i=t.querySelector('[data-bar="cpu0"]'),d=t.querySelector('[data-bar="cpu1"]'),b=(z,h,c)=>{if(c==null||!Number.isFinite(Number(c))){z.textContent="\u2014",z.classList.remove("warn"),h.style.width="0%";return}let g=Math.max(0,Math.min(100,Number(c)));z.textContent=g.toFixed(0)+"%",z.classList.toggle("warn",g>=90),h.style.width=g+"%",h.style.backgroundPosition=g+"% 0"},u=(z,h,c)=>{if(h==null||!Number.isFinite(Number(h))){z.textContent="\u2014";return}let g=Number(h);z.textContent=g+" KB",z.classList.toggle("warn",c!=null&&g<c)},m=()=>{b(o,i,L(s.cpuLoadCore0)),b(r,d,L(s.cpuLoadCore1)),u(n,L(s.freeInternalKb),48),u(a,L(s.freePsramKb),null)};t.querySelector(".sys-dump").addEventListener("click",()=>{$t().catch(z=>console.error("[System] dump failed:",z))}),w(s.cpuLoadCore0,m),w(s.cpuLoadCore1,m),w(s.freeInternalKb,m),w(s.freePsramKb,m),_(t),m()}});var ga=`
...
`;F("asgard-bridge-status-card",ga);var ua=()=>`
...
`,fi=T({tag:"asgard-bridge-status-card",render:ua,onMount(e,t){let o=t.querySelector(".role-badge"),r=t.querySelector(".ab-peer"),n=t.querySelector(".ab-push"),a=t.querySelector(".ab-setpoint"),i=t.querySelector(".ab-zones"),d=t.querySelector(".ab-error");function b(){let u=N(s.asgardRole)||"slave";o.textContent=u,o.className="role-badge "+(u==="master"?"master":"slave");let m=N(s.asgardPeerStatus)||f("common.na");r.textContent=m,r.classList.toggle("warn",m==="stale"||m==="unreachable");let z=L(s.asgardLastPushC),h=L(s.asgardLastPushAgeS);if(z!=null&&Number.isFinite(z)&&h!=null){let S=h<120?f("diagnostics.asgard.ageSeconds",{value:Math.round(h)}):f("diagnostics.asgard.ageMinutes",{value:Math.round(h/60)});n.textContent=`${z.toFixed(2)}\xB0C (${S})`}else n.textContent="\u2014";let c=L(s.asgardSetpointC);a.textContent=c!=null&&Number.isFinite(c)?`${c.toFixed(1)}\xB0C`:"\u2014";let g=L(s.asgardLocalZones),y=L(s.asgardPeerZones);i.textContent=g!=null?`${g} ${f("common.local")} + ${y||0} ${f("common.peer")}`:"\u2014";let l=N(s.asgardLastError);d.textContent=l||"\u2014",d.classList.toggle("warn",!!l)}[s.asgardRole,s.asgardPeerStatus,s.asgardLastPushC,s.asgardSetpointC,s.asgardLastPushAgeS,s.asgardLocalZones,s.asgardPeerZones,s.asgardLastError].forEach(u=>w(u,b)),_(t),b()}});var ma=`
...
`;F("settings-manifold-card",ma);var ba=()=>{let e="";for(let o=1;o<=8;o++)e+="<option>Probe "+o+"</option>";let t="";for(let o=1;o<=8;o++)t+='<div class="probe-cell"><div class="probe-name">Probe '+o+'</div><div class="probe-temp" data-probe="'+o+'">---</div></div>';return`
  ...
  `},Ci=T({tag:"settings-manifold-card",render:ba,onMount(e,t){let o=t.querySelector(".sm-type"),r=t.querySelector(".sm-flow"),n=t.querySelector(".sm-ret"),a=re(t);a.select(o,{read:()=>N(s.manifoldType)||"NO (Normally Open)",commit:d=>ne("manifold_type",d)}),a.select(r,{read:()=>N(s.manifoldFlowProbe)||"Probe 7",commit:d=>ne("manifold_flow_probe",d)}),a.select(n,{read:()=>N(s.manifoldReturnProbe)||"Probe 8",commit:d=>ne("manifold_return_probe",d)});function i(){for(let d=1;d<=8;d++){let b=t.querySelector('[data-probe="'+d+'"]');b&&(b.textContent=ae(L(p.probeTemp(d))))}}w(s.manifoldType,a.refresh),w(s.manifoldFlowProbe,a.refresh),w(s.manifoldReturnProbe,a.refresh);for(let d=1;d<=8;d++)w(p.probeTemp(d),i);_(t),a.refresh(),i()}});var fa=()=>`
...
`,Di=T({tag:"settings-minimum-flow-card",render:fa,onMount(e,t){let o=t.querySelector(".smf-always"),r=t.querySelector(".smf-pct"),n=re(t);n.toggle(o,{read:()=>Y(s.minimumFlowAlways),commit:a=>{let i=a?"on":"off";v(s.minimumFlowAlways,{state:i}),ne("minimum_flow_always",i).catch(()=>v(s.minimumFlowAlways,{state:a?"off":"on"}))}}),n.num(r,{read:()=>L(s.minZoneFlowPct),commit:a=>{v(s.minZoneFlowPct,{value:a}),se("min_zone_flow_pct",a)}}),w(s.minimumFlowAlways,n.refresh),w(s.minZoneFlowPct,n.refresh),_(t),n.refresh()}});var va=`
...
`;F("settings-control-card",va);var ha=()=>`
...
`,Ii=T({tag:"settings-control-card",render:ha,onMount(e,t){_(t),t.querySelector(".sc-reset-probe-map").addEventListener("click",()=>{ge("reset_1wire_probe_map_reboot")}),t.querySelector(".sc-dump-1wire").addEventListener("click",()=>{ge("dump_1wire_probe_diagnostics")}),t.querySelector(".sc-restart").addEventListener("click",()=>{ge("restart")})}});var xa=`
...
`;F("settings-motor-calibration-card",xa);var Je=[{cls:"safe-runtime",key:"generic_runtime_limit_seconds",id:s.genericRuntimeLimitSeconds,labelKey:"settings.motor.maxSafeRuntime",unit:"s"},{cls:"close-threshold",key:"close_threshold_multiplier",id:s.closeThresholdMultiplier,labelKey:"settings.motor.closeThreshold",unit:"x"},{cls:"close-slope-threshold",key:"close_slope_threshold",id:s.closeSlopeThreshold,labelKey:"settings.motor.closeSlope",unit:"mA/s"},{cls:"close-slope-floor",key:"close_slope_current_factor",id:s.closeSlopeCurrentFactor,labelKey:"settings.motor.closeSlopeFloor",unit:"x"},{cls:"open-threshold",key:"open_threshold_multiplier",id:s.openThresholdMultiplier,labelKey:"settings.motor.openThreshold",unit:"x"},{cls:"open-slope-threshold",key:"open_slope_threshold",id:s.openSlopeThreshold,labelKey:"settings.motor.openSlope",unit:"mA/s"},{cls:"open-slope-floor",key:"open_slope_current_factor",id:s.openSlopeCurrentFactor,labelKey:"settings.motor.openSlopeFloor",unit:"x"},{cls:"open-ripple-limit",key:"open_ripple_limit_factor",id:s.openRippleLimitFactor,labelKey:"settings.motor.openRippleLimit",unit:"x"},{cls:"relearn-movements",key:"relearn_after_movements",id:s.relearnAfterMovements,labelKey:"settings.motor.relearnMovements",unit:"count"},{cls:"relearn-hours",key:"relearn_after_hours",id:s.relearnAfterHours,labelKey:"settings.motor.relearnHours",unit:"h"},{cls:"learn-min-samples",key:"learned_factor_min_samples",id:s.learnedFactorMinSamples,labelKey:"settings.motor.learnMinSamples",unit:"count"},{cls:"learn-max-deviation",key:"learned_factor_max_deviation_pct",id:s.learnedFactorMaxDeviationPct,labelKey:"settings.motor.learnMaxDeviation",unit:"%"}],ya=()=>{let e="";for(let t=0;t<Je.length;t++){let o=Je[t];if(o.key==="generic_runtime_limit_seconds")continue;let r=wa(o.key)?"1":"0.1";e+='<div class="ui-row"><span class="ui-label"><span data-i18n="'+o.labelKey+'">'+f(o.labelKey)+"</span> ("+o.unit+')</span><span class="ui-field"><input type="number" class="ui-input smc-'+o.cls+'" value="0" step="'+r+'"></span></div>'}return`
  ...
  `};function wa(e){return e==="learned_factor_min_samples"||e==="generic_runtime_limit_seconds"||e==="relearn_after_movements"||e==="relearn_after_hours"}var Xi=T({tag:"settings-motor-calibration-card",render:ya,onMount(e,t){let o=t.querySelector(".smc-profile"),r=t.querySelector(".smc-safe-runtime"),n=t.querySelector(".mc-drivers-toggle"),a=re(t);function i(b){if(b==="HmIP VdMot"&&se("hmip_runtime_limit_seconds",40),b==="Generic"){let u=Number(L(s.genericRuntimeLimitSeconds));(!Number.isFinite(u)||u<=0)&&se("generic_runtime_limit_seconds",45)}}a.toggle(n,{read:()=>Y(s.drivers),commit:b=>Rt(b)}),a.select(o,{read:()=>N(s.motorProfileDefault)||"HmIP VdMot",commit:b=>{ne("motor_profile_default",b),i(b)}});function d(){let b=N(s.motorProfileDefault)||"HmIP VdMot";r.disabled=b==="HmIP VdMot"}a.num(r,{read:()=>(N(s.motorProfileDefault)||"HmIP VdMot")==="HmIP VdMot"?40:L(s.genericRuntimeLimitSeconds),commit:b=>{o.value==="Generic"&&se("generic_runtime_limit_seconds",b)}});for(let b=0;b<Je.length;b++){let u=Je[b];if(u.key==="generic_runtime_limit_seconds")continue;let m=t.querySelector(".smc-"+u.cls);m&&(a.num(m,{read:()=>L(u.id),commit:z=>se(u.key,z)}),w(u.id,a.refresh))}w(s.drivers,a.refresh),w(s.motorProfileDefault,()=>{a.refresh(),d()}),w(s.genericRuntimeLimitSeconds,a.refresh),w(s.hmipRuntimeLimitSeconds,a.refresh),_(t),i(N(s.motorProfileDefault)||"HmIP VdMot"),a.refresh(),d()}});var za=`
.settings-asgard-card .ui-row:last-child { margin-bottom: 0; }
`;F("settings-asgard-card",za);var Sa=()=>`
...
`,al=T({tag:"settings-asgard-card",render:Sa,onMount(e,t){let o=t.querySelector(".sa-enable"),r=t.querySelector(".sa-coord"),n=t.querySelector(".sa-host"),a=t.querySelector(".sa-port"),i=t.querySelector(".sa-entity"),d=t.querySelector(".sa-peer"),b=t.querySelector(".sa-interval"),u=t.querySelector(".sa-body"),m=re(t);function z(y,l,S){return A=>{let k=A?"on":"off";v(y,{state:k}),ne(l,k).catch(x=>{console.error(`[Asgard] Failed to update ${S}:`,x),v(y,{state:A?"off":"on"})})}}let h=y=>u.classList.toggle("is-disabled",!y);m.toggle(o,{read:()=>Y(s.asgardEnabled),commit:z(s.asgardEnabled,"asgard_enabled","enabled"),onChange:h}),m.toggle(r,{read:()=>Y(s.asgardCoordinator),commit:z(s.asgardCoordinator,"asgard_coordinator","coordinator")});function c(y,l){return S=>{v(y,{state:S}),Ht(l,S).catch(A=>console.error(`[Asgard] Failed to update ${l}:`,A))}}m.text(n,{read:()=>N(s.asgardHost),commit:c(s.asgardHost,"asgard_host")}),m.text(i,{read:()=>N(s.asgardEntityName),commit:c(s.asgardEntityName,"asgard_entity_name")}),m.text(d,{read:()=>N(s.asgardPeerHost),commit:c(s.asgardPeerHost,"asgard_peer_host")});function g(y,l){return S=>{v(y,{value:S}),se(l,S).catch(A=>console.error(`[Asgard] Failed to update ${l}:`,A))}}m.num(a,{read:()=>L(s.asgardPort),commit:g(s.asgardPort,"asgard_port")}),m.num(b,{read:()=>L(s.asgardPushIntervalS),commit:g(s.asgardPushIntervalS,"asgard_push_interval_s")}),w(s.asgardEnabled,m.refresh),w(s.asgardCoordinator,m.refresh),w(s.asgardHost,m.refresh),w(s.asgardEntityName,m.refresh),w(s.asgardPeerHost,m.refresh),w(s.asgardPort,m.refresh),w(s.asgardPushIntervalS,m.refresh),_(t),m.refresh()}});var ka=`
...
`;F("smart-preheat-card",ka);var _a=()=>`
...
`,ul=T({tag:"smart-preheat-card",render:_a,onMount(e,t){let o=t.querySelector(".absorb-toggle"),r=t.querySelector(".absorb-badge"),n=t.querySelector(".absorb-band"),a=t.querySelector(".absorb-delta"),i=t.querySelector(".absorb-body"),d=re(t),b=m=>{i&&i.classList.toggle("is-disabled",!m)};d.toggle(o,{read:()=>Y(s.preheatAbsorbEnabled),onChange:b,commit:m=>{let z=m?"on":"off";v(s.preheatAbsorbEnabled,{state:z}),ne("preheat_absorb_enabled",z)}}),d.num(n,{read:()=>L(s.preheatAbsorbBandC),commit:m=>{v(s.preheatAbsorbBandC,{value:m}),se("preheat_absorb_band_c",m)}}),d.num(a,{read:()=>L(s.preheatDetectDeltaC),commit:m=>{v(s.preheatDetectDeltaC,{value:m}),se("preheat_detect_delta_c",m)}});function u(){let m=String(N(s.preheatAbsorbing)||"").toLowerCase()==="active";r.textContent=m?f("common.active"):f("common.idle"),r.classList.toggle("active",m)}w(s.preheatAbsorbEnabled,d.refresh),w(s.preheatAbsorbing,u),w(s.preheatAbsorbBandC,d.refresh),w(s.preheatDetectDeltaC,d.refresh),_(t),d.refresh(),u()}});var Ca=`
