(()=>{var D=new Set,c={section:"overview",loading:!1,error:"",overview:null,nodes:[],zones:[],strategy:null,forecast:null,commands:[],diagnostics:null,scanResult:null};function B(e){return D.add(e),()=>D.delete(e)}function H(){for(let e of D)e(c)}function O(e){c.section=e,H()}function F(e){Object.assign(c,e),H()}var ie=[["overview","House"],["zones","Zones"],["manifolds","Manifolds"],["forecast","Weather"],["commands","Commands"],["settings","Settings"],["diagnostics","Diagnostics"]];function U(){var e,t,s,a,o,r;return`
    ...
    <svg class="forecast-chart" viewBox="0 0 ${s} ${a}" preserveAspectRatio="xMidYMid meet">
      ${M}<line x1="${o}" y1="${b}" x2="${o+_}" y2="${b}" class="chart-axis"></line>${q}
  ...
  </section>`}function ae(){var u,_;let e=c.scanResult,t=(e==null?void 0:e.found)||[],s=c.strategy||{},a=s.physical||{},o=s.comfort||{},r=s.driver||{},n=((u=c.diagnostics)==null?void 0:u.commissioning)||{};return`<section class="panel two-col">
  ...
  </section>`}function se(){var f,v,S;let e=c.diagnostics||{},t=e.polling||{},s=e.commissioning||{},a=e.ota||{},o=e.learning||{},r=e.forecast_commands||((f=c.forecast)==null?void 0:f.commands)||{},n=_e(c.commands),u=c.commands.filter(be).slice(-5).reverse(),_=c.zones.filter(l=>l.room_id&&l.status!=="unused").map(l=>`<option value="${g(l.room_id)}">${g(l.name||l.room_id)} (${R(l.node_index)} / Z${Number(l.zone_index)+1})</option>`).join(""),m=c.strategy||e.strategy||{},b=m.physical||{},h=m.comfort||{},i=m.driver||{},d=m.schedule||{};return`<section class="panel">
    ...
    <div class="diagnostics-layout">
      ...
      <div class="ops-panel">
        <h3>Asgard / Odin</h3>
        <p>Physical ${b.has_temperature?k(b.temperature_c):"missing"} from ${b.contributing_zones||0} zones</p>
